...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_stack.disconnected_operations.images" /></td></tr>
</tbody></table>
...
type,
updateProperties
FROM azure_stack.disconnected_operations.images
...
```sql
EXEC azure_stack.disconnected_operations.images.list_download_uri 
