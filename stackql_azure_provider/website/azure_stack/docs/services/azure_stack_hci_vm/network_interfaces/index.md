...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_stack.azure_stack_hci_vm.network_interfaces" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_stack.azure_stack_hci_vm.network_interfaces
...
```sql
INSERT INTO azure_stack.azure_stack_hci_vm.network_interfaces (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure_stack.azure_stack_hci_vm.network_interfaces
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_stack.azure_stack_hci_vm.network_interfaces
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_stack.azure_stack_hci_vm.network_interfaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_interface_name = '{{ network_interface_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
