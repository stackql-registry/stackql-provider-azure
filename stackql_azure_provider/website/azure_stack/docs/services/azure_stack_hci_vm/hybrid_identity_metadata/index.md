...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_stack.azure_stack_hci_vm.hybrid_identity_metadata" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_stack.azure_stack_hci_vm.hybrid_identity_metadata
...
```sql
EXEC azure_stack.azure_stack_hci_vm.hybrid_identity_metadata.list_by_virtual_machine_instance 
