...
const providerName = "azure_extras";
const providerTitle = "Azure Extras";
...
const config = {
  ...
  // Override via env for GitHub Pages: SITE_URL=https://<org>.github.io BASE_URL=/<repo>/
  url: process.env.SITE_URL || `https://${providerName}-provider.stackql.io`,
  ...
  organizationName: process.env.GH_ORG || 'stackql', // Usually your GitHub org/user name.
