...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.media.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get private endpoint connection. Get the details of a private endpoint connection.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List private endpoint connections. List all private endpoint connections.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update a private endpoint connection. Update an existing private endpoint connection.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a private endpoint connection. Deletes a private endpoint connection.</td>
</tr>
</tbody>
</table>
...
provisioningState,
type
FROM azure_extras.media.private_endpoint_connections
...
```sql
INSERT INTO azure_extras.media.private_endpoint_connections (
properties,
resource_group_name,
account_name,
name,
...
```sql
REPLACE azure_extras.media.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure_extras.media.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
