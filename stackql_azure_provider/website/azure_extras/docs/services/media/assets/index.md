...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.media.assets" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.media.assets.list_streaming_locators 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@asset_name='{{ asset_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.media.assets.get_encryption_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@asset_name='{{ asset_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
