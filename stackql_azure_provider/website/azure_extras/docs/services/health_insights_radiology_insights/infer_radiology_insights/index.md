...
keywords:
  ...
  - health_insights_radiology_insights
  - azure_extras
...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.health_insights_radiology_insights.infer_radiology_insights" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.health_insights_radiology_insights.infer_radiology_insights.infer_radiology_insights 
@id='{{ id }}' --required, 
