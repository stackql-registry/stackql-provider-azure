...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.spring_app_discovery.springbootservers" /></td></tr>
</tbody></table>
...
totalApps,
type
FROM azure_extras.spring_app_discovery.springbootservers
...
```sql
INSERT INTO azure_extras.spring_app_discovery.springbootservers (
tags,
properties,
resource_group_name,
site_name,
...
```sql
UPDATE azure_extras.spring_app_discovery.springbootservers
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_extras.spring_app_discovery.springbootservers
SET 
tags = '{{ tags }}',
properties = '{{ properties }}'
WHERE 
...
```sql
DELETE FROM azure_extras.spring_app_discovery.springbootservers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND site_name = '{{ site_name }}' --required
AND springbootservers_name = '{{ springbootservers_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
