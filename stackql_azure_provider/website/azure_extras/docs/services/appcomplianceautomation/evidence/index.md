...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.appcomplianceautomation.evidence" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.appcomplianceautomation.evidence
...
```sql
INSERT INTO azure_extras.appcomplianceautomation.evidence (
properties,
report_name,
evidence_name,
offerGuid,
...
```sql
REPLACE azure_extras.appcomplianceautomation.evidence
SET 
...
```sql
DELETE FROM azure_extras.appcomplianceautomation.evidence
WHERE report_name = '{{ report_name }}' --required
AND evidence_name = '{{ evidence_name }}' --required
;
```
...
```sql
EXEC azure_extras.appcomplianceautomation.evidence.download 
@report_name='{{ report_name }}' --required, 
