...
Creates, updates, deletes, gets or lists a <code>scoping_configuration</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="scoping_configuration" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.appcomplianceautomation.scoping_configuration" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>List of scoping question answers.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-report_name"><code>report_name</code></a>, <a href="#parameter-scoping_configuration_name"><code>scoping_configuration_name</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-report_name"><code>report_name</code></a>, <a href="#parameter-scoping_configuration_name"><code>scoping_configuration_name</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
    <td>Get the AppComplianceAutomation scoping configuration of the specific report.</td>
</tr>
<tr>
...
<tr id="parameter-scoping_configuration_name">
    <td><CopyableCode code="scoping_configuration_name" /></td>
    <td><code>string</code></td>
    <td>The scoping configuration of the specific report. Required.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure_extras.appcomplianceautomation.scoping_configuration
...
```sql
INSERT INTO azure_extras.appcomplianceautomation.scoping_configuration (
properties,
report_name,
...
```sql
REPLACE azure_extras.appcomplianceautomation.scoping_configuration
SET 
...
```sql
DELETE FROM azure_extras.appcomplianceautomation.scoping_configuration
WHERE report_name = '{{ report_name }}' --required
AND scoping_configuration_name = '{{ scoping_configuration_name }}' --required
;
```
