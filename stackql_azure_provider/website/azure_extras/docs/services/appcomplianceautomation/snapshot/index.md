...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.appcomplianceautomation.snapshot" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.appcomplianceautomation.snapshot
...
```sql
EXEC azure_extras.appcomplianceautomation.snapshot.download 
