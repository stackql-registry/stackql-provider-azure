...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.appcomplianceautomation.report" /></td></tr>
</tbody></table>
...
triggerTime,
type
FROM azure_extras.appcomplianceautomation.report
...
```sql
INSERT INTO azure_extras.appcomplianceautomation.report (
properties,
report_name
)
SELECT 
...
```sql
UPDATE azure_extras.appcomplianceautomation.report
SET 
...
```sql
REPLACE azure_extras.appcomplianceautomation.report
SET 
properties = '{{ properties }}'
WHERE 
report_name = '{{ report_name }}' --required
...
```sql
DELETE FROM azure_extras.appcomplianceautomation.report
WHERE report_name = '{{ report_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure_extras.appcomplianceautomation.report.get_scoping_questions 
@report_name='{{ report_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure_extras.appcomplianceautomation.report.nested_resource_check_name_availability 
@report_name='{{ report_name }}' --required 
@@json=
'{
"name": "{{ name }}", 
...
```sql
EXEC azure_extras.appcomplianceautomation.report.fix 
@report_name='{{ report_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure_extras.appcomplianceautomation.report.sync_cert_record 
@report_name='{{ report_name }}' --required 
@@json=
'{
...
```sql
EXEC azure_extras.appcomplianceautomation.report.verify 
@report_name='{{ report_name }}' --required
;
```
</TabItem>
