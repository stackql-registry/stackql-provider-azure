...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.sphere.products" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.sphere.products
...
```sql
INSERT INTO azure_extras.sphere.products (
properties,
resource_group_name,
catalog_name,
product_name,
...
```sql
UPDATE azure_extras.sphere.products
SET 
...
```sql
REPLACE azure_extras.sphere.products
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure_extras.sphere.products
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND catalog_name = '{{ catalog_name }}' --required
AND product_name = '{{ product_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.sphere.products.count_devices 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_extras.sphere.products.generate_default_device_groups 
@resource_group_name='{{ resource_group_name }}' --required, 
@catalog_name='{{ catalog_name }}' --required, 
@product_name='{{ product_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
