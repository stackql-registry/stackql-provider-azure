...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.sphere.devices" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.sphere.devices
...
```sql
INSERT INTO azure_extras.sphere.devices (
properties,
resource_group_name,
catalog_name,
product_name,
...
```sql
UPDATE azure_extras.sphere.devices
SET 
...
```sql
REPLACE azure_extras.sphere.devices
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure_extras.sphere.devices
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND catalog_name = '{{ catalog_name }}' --required
AND product_name = '{{ product_name }}' --required
AND device_group_name = '{{ device_group_name }}' --required
...
```sql
EXEC azure_extras.sphere.devices.generate_capability_image 
@resource_group_name='{{ resource_group_name }}' --required, 
