...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.health_data_services.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Enum. Indicates the action type. "Internal" refers to actions that are for internal only APIs. "Internal" (Internal)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Default value is 'user,system'.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td></td>
    <td>Lists all of the available operations supported by Microsoft Healthcare resource provider.</td>
</tr>
</tbody>
</table>
...
FROM azure_extras.health_data_services.operations
;
```
</TabItem>
</Tabs>
