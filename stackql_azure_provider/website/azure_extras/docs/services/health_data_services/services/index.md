...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.health_data_services.services" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_extras.health_data_services.services
...
```sql
INSERT INTO azure_extras.health_data_services.services (
tags,
location,
properties,
kind,
...
```sql
UPDATE azure_extras.health_data_services.services
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_extras.health_data_services.services
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_extras.health_data_services.services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
