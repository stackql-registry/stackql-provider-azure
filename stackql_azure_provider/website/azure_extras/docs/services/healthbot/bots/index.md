...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.healthbot.bots" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_extras.healthbot.bots
...
```sql
INSERT INTO azure_extras.healthbot.bots (
tags,
location,
properties,
sku,
...
```sql
UPDATE azure_extras.healthbot.bots
SET 
...
```sql
DELETE FROM azure_extras.healthbot.bots
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND bot_name = '{{ bot_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.healthbot.bots.list_secrets 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_extras.healthbot.bots.regenerate_api_jwt_secret 
@resource_group_name='{{ resource_group_name }}' --required, 
@bot_name='{{ bot_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
