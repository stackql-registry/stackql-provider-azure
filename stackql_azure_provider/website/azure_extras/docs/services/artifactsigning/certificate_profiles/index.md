...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.artifactsigning.certificate_profiles" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.artifactsigning.certificate_profiles
...
```sql
INSERT INTO azure_extras.artifactsigning.certificate_profiles (
properties,
resource_group_name,
account_name,
profile_name,
...
```sql
DELETE FROM azure_extras.artifactsigning.certificate_profiles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND profile_name = '{{ profile_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.artifactsigning.certificate_profiles.revoke_certificates 
