...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.springappdiscovery.springbootsites" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_extras.springappdiscovery.springbootsites
...
```sql
INSERT INTO azure_extras.springappdiscovery.springbootsites (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure_extras.springappdiscovery.springbootsites
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure_extras.springappdiscovery.springbootsites
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_extras.springappdiscovery.springbootsites
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND springbootsites_name = '{{ springbootsites_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.springappdiscovery.springbootsites.trigger_refresh_site 
@resource_group_name='{{ resource_group_name }}' --required, 
