...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.nutrient_analyses" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.agrifood_farming.nutrient_analyses (
party_id,
...
```sql
REPLACE azure_extras.agrifood_farming.nutrient_analyses
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.nutrient_analyses
...
```sql
EXEC azure_extras.agrifood_farming.nutrient_analyses.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.nutrient_analyses.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.nutrient_analyses.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@parentType='{{ parentType }}', 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
