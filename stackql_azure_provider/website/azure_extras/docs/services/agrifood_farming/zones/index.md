...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.zones" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-zone_id"><code>zone_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates a Zone resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-zone_id"><code>zone_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified zone resource under a particular party.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-zone_id"><code>zone_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified zone resource under a particular party.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of zone resources across all parties.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of zone resources under a particular party.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-zoneId"><code>zoneId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create a cascade delete job for specified zone.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-zoneId">
    ...
    <td><code>string</code></td>
    <td>ID of the zone to be deleted. Required.</td>
</tr>
<tr id="parameter-zone_id">
    <td><CopyableCode code="zone_id" /></td>
    <td><code>string</code></td>
    <td>Id of the zone. Required.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.zones (
party_id,
zone_id,
endpoint
)
...
```sql
REPLACE azure_extras.agrifood_farming.zones
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.zones
...
```sql
EXEC azure_extras.agrifood_farming.zones.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.zones.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.zones.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure_extras.agrifood_farming.zones.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.zones.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
