...
Creates, updates, deletes, gets or lists a <code>sensor_data_models</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="sensor_data_models" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.sensor_data_models" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-sensor_partner_id"><code>sensor_partner_id</code></a>, <a href="#parameter-sensor_data_model_id"><code>sensor_data_model_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create a sensor data model entity.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-sensor_partner_id"><code>sensor_partner_id</code></a>, <a href="#parameter-sensor_data_model_id"><code>sensor_data_model_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a sensor data model entity.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-sensor_partner_id"><code>sensor_partner_id</code></a>, <a href="#parameter-sensor_data_model_id"><code>sensor_data_model_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a sensor data model entity.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of sensor data model resources.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-sensor_data_model_id">
    <td><CopyableCode code="sensor_data_model_id" /></td>
    <td><code>string</code></td>
    <td>Id of the sensor data model resource. Required.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.sensor_data_models (
sensor_partner_id,
...
- name: sensor_data_models
  props:
    - name: sensor_partner_id
      value: "{{ sensor_partner_id }}"
      description: Required parameter for the sensor_data_models resource.
    - name: sensor_data_model_id
      value: "{{ sensor_data_model_id }}"
      description: Required parameter for the sensor_data_models resource.
    - name: endpoint
      value: "{{ endpoint }}"
      description: Required parameter for the sensor_data_models resource.
...
```sql
REPLACE azure_extras.agrifood_farming.sensor_data_models
SET 
-- No updatable properties
WHERE 
sensor_partner_id = '{{ sensor_partner_id }}' --required
AND sensor_data_model_id = '{{ sensor_data_model_id }}' --required
...
```sql
DELETE FROM azure_extras.agrifood_farming.sensor_data_models
...
```sql
EXEC azure_extras.agrifood_farming.sensor_data_models.get_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@sensor_data_model_id='{{ sensor_data_model_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.sensor_data_models.list_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
