...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.farms" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.agrifood_farming.farms.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.farms.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure_extras.agrifood_farming.farms.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.farms.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
