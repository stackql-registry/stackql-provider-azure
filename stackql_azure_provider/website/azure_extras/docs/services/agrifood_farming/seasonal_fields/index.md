...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.seasonal_fields" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.agrifood_farming.seasonal_fields (
party_id,
seasonal_field_id,
endpoint
)
...
```sql
REPLACE azure_extras.agrifood_farming.seasonal_fields
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.seasonal_fields
...
```sql
EXEC azure_extras.agrifood_farming.seasonal_fields.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.seasonal_fields.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.seasonal_fields.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure_extras.agrifood_farming.seasonal_fields.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.seasonal_fields.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
