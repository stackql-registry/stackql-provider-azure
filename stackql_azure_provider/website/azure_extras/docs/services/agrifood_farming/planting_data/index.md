...
Creates, updates, deletes, gets or lists a <code>planting_data</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="planting_data" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.planting_data" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-planting_data_id"><code>planting_data_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates an planting data resource under a particular party.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-planting_data_id"><code>planting_data_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified planting data resource under a particular party.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-minAvgPlantingRate"><code>minAvgPlantingRate</code></a>, <a href="#parameter-maxAvgPlantingRate"><code>maxAvgPlantingRate</code></a>, <a href="#parameter-minTotalMaterial"><code>minTotalMaterial</code></a>, <a href="#parameter-maxTotalMaterial"><code>maxTotalMaterial</code></a>, <a href="#parameter-minAvgMaterial"><code>minAvgMaterial</code></a>, <a href="#parameter-maxAvgMaterial"><code>maxAvgMaterial</code></a>, <a href="#parameter-minOperationStartDateTime"><code>minOperationStartDateTime</code></a>, <a href="#parameter-maxOperationStartDateTime"><code>maxOperationStartDateTime</code></a>, <a href="#parameter-minOperationEndDateTime"><code>minOperationEndDateTime</code></a>, <a href="#parameter-maxOperationEndDateTime"><code>maxOperationEndDateTime</code></a>, <a href="#parameter-minOperationModifiedDateTime"><code>minOperationModifiedDateTime</code></a>, <a href="#parameter-maxOperationModifiedDateTime"><code>maxOperationModifiedDateTime</code></a>, <a href="#parameter-minArea"><code>minArea</code></a>, <a href="#parameter-maxArea"><code>maxArea</code></a>, <a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of planting data resources under a particular party.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get cascade delete job for planting data resource.</td>
</tr>
<tr>
    <td><a href="#create_cascade_delete_job"><CopyableCode code="create_cascade_delete_job" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-plantingDataId"><code>plantingDataId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create cascade delete job for planting data resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-plantingDataId">
    <td><CopyableCode code="plantingDataId" /></td>
    <td><code>string</code></td>
    <td>Id of the planting data. Required.</td>
</tr>
<tr id="parameter-planting_data_id">
    <td><CopyableCode code="planting_data_id" /></td>
    <td><code>string</code></td>
    <td>ID of the planting data resource. Required.</td>
</tr>
...
<tr id="parameter-maxAvgMaterial">
    ...
    <td><code>number</code></td>
    <td>Maximum AvgMaterial value (inclusive). Default value is None.</td>
</tr>
<tr id="parameter-maxAvgPlantingRate">
    <td><CopyableCode code="maxAvgPlantingRate" /></td>
    <td><code>number</code></td>
    <td>Maximum AvgPlantingRate value (inclusive). Default value is None.</td>
</tr>
...
<tr id="parameter-maxTotalMaterial">
    ...
    <td><code>number</code></td>
    <td>Maximum TotalMaterial value (inclusive). Default value is None.</td>
</tr>
...
<tr id="parameter-minAvgMaterial">
    ...
    <td><code>number</code></td>
    <td>Minimum AvgMaterial value(inclusive). Default value is None.</td>
</tr>
<tr id="parameter-minAvgPlantingRate">
    <td><CopyableCode code="minAvgPlantingRate" /></td>
    <td><code>number</code></td>
    <td>Minimum AvgPlantingRate value(inclusive). Default value is None.</td>
</tr>
...
<tr id="parameter-minTotalMaterial">
    ...
    <td><code>number</code></td>
    <td>Minimum TotalMaterial value(inclusive). Default value is None.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.planting_data (
party_id,
planting_data_id,
endpoint
)
...
- name: planting_data
  props:
    - name: party_id
      value: "{{ party_id }}"
      description: Required parameter for the planting_data resource.
    - name: planting_data_id
      value: "{{ planting_data_id }}"
      description: Required parameter for the planting_data resource.
    - name: endpoint
      value: "{{ endpoint }}"
      description: Required parameter for the planting_data resource.
...
```sql
REPLACE azure_extras.agrifood_farming.planting_data
SET 
-- No updatable properties
WHERE 
party_id = '{{ party_id }}' --required
AND planting_data_id = '{{ planting_data_id }}' --required
...
```sql
DELETE FROM azure_extras.agrifood_farming.planting_data
...
```sql
EXEC azure_extras.agrifood_farming.planting_data.get_raw 
@party_id='{{ party_id }}' --required, 
@planting_data_id='{{ planting_data_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.planting_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
@minAvgPlantingRate='{{ minAvgPlantingRate }}', 
@maxAvgPlantingRate='{{ maxAvgPlantingRate }}', 
...
```sql
EXEC azure_extras.agrifood_farming.planting_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minAvgPlantingRate='{{ minAvgPlantingRate }}', 
@maxAvgPlantingRate='{{ maxAvgPlantingRate }}', 
...
```sql
EXEC azure_extras.agrifood_farming.planting_data.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.planting_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
@partyId='{{ partyId }}' --required, 
@plantingDataId='{{ plantingDataId }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
</TabItem>
