...
Creates, updates, deletes, gets or lists a <code>parties</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="parties" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.parties" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Creates or updates a party resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified party resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified party resource.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of party resources.</td>
</tr>
<tr>
...
<tr id="parameter-partyId">
    ...
    <td><code>string</code></td>
    <td>ID of the party to be deleted. Required.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.parties (
party_id,
endpoint
)
SELECT 
...
```sql
REPLACE azure_extras.agrifood_farming.parties
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.parties
...
```sql
EXEC azure_extras.agrifood_farming.parties.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.parties.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.parties.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.parties.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
