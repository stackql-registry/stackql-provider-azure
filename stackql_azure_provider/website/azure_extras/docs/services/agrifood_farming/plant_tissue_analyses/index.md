...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.plant_tissue_analyses" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.agrifood_farming.plant_tissue_analyses (
party_id,
...
```sql
REPLACE azure_extras.agrifood_farming.plant_tissue_analyses
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.plant_tissue_analyses
...
```sql
EXEC azure_extras.agrifood_farming.plant_tissue_analyses.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.plant_tissue_analyses.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.plant_tissue_analyses.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure_extras.agrifood_farming.plant_tissue_analyses.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.plant_tissue_analyses.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
