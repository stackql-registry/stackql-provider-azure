...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.fields" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-field_id"><code>field_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or Updates a field resource under a particular party.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-field_id"><code>field_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified field resource under a particular party.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-field_id"><code>field_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified field resource under a particular party.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of field resources across all parties.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of field resources under a particular party.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get a cascade delete job for specified field.</td>
</tr>
<tr>
    <td><a href="#create_cascade_delete_job"><CopyableCode code="create_cascade_delete_job" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-fieldId"><code>fieldId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create a cascade delete job for specified field.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-fieldId">
    <td><CopyableCode code="fieldId" /></td>
    <td><code>string</code></td>
    <td>ID of the field to be deleted. Required.</td>
</tr>
<tr id="parameter-field_id">
    <td><CopyableCode code="field_id" /></td>
    <td><code>string</code></td>
    <td>Id of the field. Required.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.fields (
party_id,
field_id,
endpoint
)
...
```sql
REPLACE azure_extras.agrifood_farming.fields
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.fields
...
```sql
EXEC azure_extras.agrifood_farming.fields.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.fields.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.fields.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure_extras.agrifood_farming.fields.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.fields.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
