...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.devices" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.agrifood_farming.devices (
sensor_partner_id,
device_id,
endpoint
)
...
```sql
REPLACE azure_extras.agrifood_farming.devices
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.devices
...
```sql
EXEC azure_extras.agrifood_farming.devices.get_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.devices.list_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
