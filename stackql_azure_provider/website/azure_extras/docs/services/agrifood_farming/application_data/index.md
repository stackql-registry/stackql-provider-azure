...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.application_data" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.agrifood_farming.application_data (
party_id,
application_data_id,
endpoint
)
...
```sql
REPLACE azure_extras.agrifood_farming.application_data
SET 
...
```sql
DELETE FROM azure_extras.agrifood_farming.application_data
...
```sql
EXEC azure_extras.agrifood_farming.application_data.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.application_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.application_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minAvgMaterial='{{ minAvgMaterial }}', 
@maxAvgMaterial='{{ maxAvgMaterial }}', 
...
```sql
EXEC azure_extras.agrifood_farming.application_data.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.application_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
@partyId='{{ partyId }}' --required, 
@applicationDataId='{{ applicationDataId }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
</TabItem>
