...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.image_processing" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.agrifood_farming.image_processing.get_rasterize_job 
...
```sql
EXEC azure_extras.agrifood_farming.image_processing.create_rasterize_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
