...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.model_inference" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.agrifood_farming.model_inference.create_biomass_model_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure_extras.agrifood_farming.model_inference.get_sensor_placement_model_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure_extras.agrifood_farming.model_inference.create_sensor_placement_model_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure_extras.agrifood_farming.model_inference.get_soil_moisture_model_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure_extras.agrifood_farming.model_inference.create_soil_moisture_model_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
