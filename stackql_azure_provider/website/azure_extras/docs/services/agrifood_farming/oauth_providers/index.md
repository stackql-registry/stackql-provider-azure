...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.oauth_providers" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.agrifood_farming.oauth_providers.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.oauth_providers.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.oauth_providers.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
