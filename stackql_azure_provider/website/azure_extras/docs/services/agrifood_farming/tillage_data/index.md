...
Creates, updates, deletes, gets or lists a <code>tillage_data</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="tillage_data" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.agrifood_farming.tillage_data" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-tillage_data_id"><code>tillage_data_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates an tillage data resource under a particular party.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-tillage_data_id"><code>tillage_data_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified tillage data resource under a particular party.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-minTillageDepth"><code>minTillageDepth</code></a>, <a href="#parameter-maxTillageDepth"><code>maxTillageDepth</code></a>, <a href="#parameter-minTillagePressure"><code>minTillagePressure</code></a>, <a href="#parameter-maxTillagePressure"><code>maxTillagePressure</code></a>, <a href="#parameter-minOperationStartDateTime"><code>minOperationStartDateTime</code></a>, <a href="#parameter-maxOperationStartDateTime"><code>maxOperationStartDateTime</code></a>, <a href="#parameter-minOperationEndDateTime"><code>minOperationEndDateTime</code></a>, <a href="#parameter-maxOperationEndDateTime"><code>maxOperationEndDateTime</code></a>, <a href="#parameter-minOperationModifiedDateTime"><code>minOperationModifiedDateTime</code></a>, <a href="#parameter-maxOperationModifiedDateTime"><code>maxOperationModifiedDateTime</code></a>, <a href="#parameter-minArea"><code>minArea</code></a>, <a href="#parameter-maxArea"><code>maxArea</code></a>, <a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of tillage data resources under a particular farm.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get cascade delete job for tillage data resource.</td>
</tr>
<tr>
    <td><a href="#create_cascade_delete_job"><CopyableCode code="create_cascade_delete_job" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-tillageDataId"><code>tillageDataId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create cascade delete job for tillage data resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-tillageDataId">
    <td><CopyableCode code="tillageDataId" /></td>
    <td><code>string</code></td>
    <td>Id of the tillage data. Required.</td>
</tr>
<tr id="parameter-tillage_data_id">
    <td><CopyableCode code="tillage_data_id" /></td>
    <td><code>string</code></td>
    <td>ID of the tillage data resource. Required.</td>
</tr>
...
<tr id="parameter-maxTillageDepth">
    <td><CopyableCode code="maxTillageDepth" /></td>
    <td><code>number</code></td>
    <td>Maximum measured tillage depth (inclusive). Default value is None.</td>
</tr>
<tr id="parameter-maxTillagePressure">
    <td><CopyableCode code="maxTillagePressure" /></td>
    <td><code>number</code></td>
    <td>Maximum pressure applied to a tillage implement (inclusive). Default value is None.</td>
</tr>
...
<tr id="parameter-minTillageDepth">
    <td><CopyableCode code="minTillageDepth" /></td>
    <td><code>number</code></td>
    <td>Minimum measured tillage depth (inclusive). Default value is None.</td>
</tr>
<tr id="parameter-minTillagePressure">
    <td><CopyableCode code="minTillagePressure" /></td>
    <td><code>number</code></td>
    <td>Minimum pressure applied to a tillage implement (inclusive). Default value is None.</td>
</tr>
...
```sql
INSERT INTO azure_extras.agrifood_farming.tillage_data (
party_id,
tillage_data_id,
endpoint
)
...
- name: tillage_data
  props:
    - name: party_id
      value: "{{ party_id }}"
      description: Required parameter for the tillage_data resource.
    - name: tillage_data_id
      value: "{{ tillage_data_id }}"
      description: Required parameter for the tillage_data resource.
    - name: endpoint
      value: "{{ endpoint }}"
      description: Required parameter for the tillage_data resource.
...
```sql
REPLACE azure_extras.agrifood_farming.tillage_data
SET 
-- No updatable properties
WHERE 
party_id = '{{ party_id }}' --required
AND tillage_data_id = '{{ tillage_data_id }}' --required
...
```sql
DELETE FROM azure_extras.agrifood_farming.tillage_data
...
```sql
EXEC azure_extras.agrifood_farming.tillage_data.get_raw 
@party_id='{{ party_id }}' --required, 
@tillage_data_id='{{ tillage_data_id }}' --required, 
...
```sql
EXEC azure_extras.agrifood_farming.tillage_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
@minTillageDepth='{{ minTillageDepth }}', 
@maxTillageDepth='{{ maxTillageDepth }}', 
@minTillagePressure='{{ minTillagePressure }}', 
@maxTillagePressure='{{ maxTillagePressure }}', 
...
```sql
EXEC azure_extras.agrifood_farming.tillage_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minTillageDepth='{{ minTillageDepth }}', 
@maxTillageDepth='{{ maxTillageDepth }}', 
...
```sql
EXEC azure_extras.agrifood_farming.tillage_data.get_cascade_delete_job_details 
...
```sql
EXEC azure_extras.agrifood_farming.tillage_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
@partyId='{{ partyId }}' --required, 
@tillageDataId='{{ tillageDataId }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
</TabItem>
