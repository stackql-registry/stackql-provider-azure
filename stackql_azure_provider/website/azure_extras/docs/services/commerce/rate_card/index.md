...
Creates, updates, deletes, gets or lists a <code>rate_card</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="rate_card" /></td></tr>
...
<tr id="parameter-$filter">
    ...
    <td><code>string</code></td>
    <td>The filter to apply on the operation. It ONLY supports the 'eq' and 'and' logical operators at this time. All the 4 query parameters 'OfferDurableId', 'Currency', 'Locale', 'Region' are required to be a part of the $filter. Required.</td>
</tr>
...
Meters,
OfferTerms
FROM azure_extras.commerce.rate_card
