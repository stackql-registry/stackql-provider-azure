...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.app_platform.storages" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The type of the storage. Required. "StorageAccount"</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-storage_name"><code>storage_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr id="parameter-storage_name">
    ...
    <td><code>string</code></td>
    <td>The name of the storage resource. Required.</td>
</tr>
...
systemData,
type
FROM azure_extras.app_platform.storages
...
```sql
INSERT INTO azure_extras.app_platform.storages (
properties,
resource_group_name,
service_name,
storage_name,
...
```sql
REPLACE azure_extras.app_platform.storages
SET 
...
```sql
DELETE FROM azure_extras.app_platform.storages
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND storage_name = '{{ storage_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
