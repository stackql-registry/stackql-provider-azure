...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.app_platform.build_service_builder" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.app_platform.build_service_builder
...
```sql
INSERT INTO azure_extras.app_platform.build_service_builder (
properties,
resource_group_name,
service_name,
build_service_name,
...
```sql
REPLACE azure_extras.app_platform.build_service_builder
SET 
...
```sql
DELETE FROM azure_extras.app_platform.build_service_builder
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND build_service_name = '{{ build_service_name }}' --required
AND builder_name = '{{ builder_name }}' --required
...
```sql
EXEC azure_extras.app_platform.build_service_builder.list_deployments 
@resource_group_name='{{ resource_group_name }}' --required, 
