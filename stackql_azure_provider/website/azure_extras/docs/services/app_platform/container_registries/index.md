...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.app_platform.container_registries" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.app_platform.container_registries
...
```sql
INSERT INTO azure_extras.app_platform.container_registries (
properties,
resource_group_name,
service_name,
...
```sql
REPLACE azure_extras.app_platform.container_registries
SET 
...
```sql
DELETE FROM azure_extras.app_platform.container_registries
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND container_registry_name = '{{ container_registry_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.app_platform.container_registries.validate 
@resource_group_name='{{ resource_group_name }}' --required, 
