...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.app_platform.services" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_extras.app_platform.services (
location,
tags,
properties,
sku,
...
```sql
UPDATE azure_extras.app_platform.services
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure_extras.app_platform.services
SET 
location = '{{ location }}',
tags = '{{ tags }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_extras.app_platform.services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.list_test_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_extras.app_platform.services.list_supported_apm_types 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.list_globally_enabled_apms 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.list_supported_server_versions 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.regenerate_test_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.app_platform.services.disable_test_endpoint 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.enable_test_endpoint 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.flush_vnet_dns_setting 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.app_platform.services.enable_apm_globally 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.app_platform.services.disable_apm_globally 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
