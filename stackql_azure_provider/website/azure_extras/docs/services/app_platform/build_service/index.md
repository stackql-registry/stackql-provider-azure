...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.app_platform.build_service" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.app_platform.build_service
...
```sql
INSERT INTO azure_extras.app_platform.build_service (
properties,
resource_group_name,
service_name,
build_service_name,
...
```sql
REPLACE azure_extras.app_platform.build_service
SET 
...
```sql
DELETE FROM azure_extras.app_platform.build_service
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND build_service_name = '{{ build_service_name }}' --required
AND build_name = '{{ build_name }}' --required
...
```sql
EXEC azure_extras.app_platform.build_service.get_build_service 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_extras.app_platform.build_service.list_supported_buildpacks 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@build_service_name='{{ build_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.app_platform.build_service.list_supported_stacks 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@build_service_name='{{ build_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.app_platform.build_service.get_build 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@build_service_name='{{ build_service_name }}' --required, 
...
```sql
EXEC azure_extras.app_platform.build_service.get_build_result_log 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@build_service_name='{{ build_service_name }}' --required, 
@build_name='{{ build_name }}' --required, 
...
```sql
EXEC azure_extras.app_platform.build_service.get_resource_upload_url 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@build_service_name='{{ build_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
