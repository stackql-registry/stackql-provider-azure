...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.selfhelp.troubleshooters" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.selfhelp.troubleshooters
...
```sql
INSERT INTO azure_extras.selfhelp.troubleshooters (
properties,
scope,
troubleshooter_name
)
...
```sql
EXEC azure_extras.selfhelp.troubleshooters.continue_method 
...
```sql
EXEC azure_extras.selfhelp.troubleshooters.end 
@scope='{{ scope }}' --required, 
@troubleshooter_name='{{ troubleshooter_name }}' --required
;
```
...
```sql
EXEC azure_extras.selfhelp.troubleshooters.restart 
@scope='{{ scope }}' --required, 
@troubleshooter_name='{{ troubleshooter_name }}' --required
;
```
