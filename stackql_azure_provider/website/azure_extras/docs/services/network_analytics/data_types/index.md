...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.network_analytics.data_types" /></td></tr>
</tbody></table>
...
type,
visualizationUrl
FROM azure_extras.network_analytics.data_types
...
```sql
INSERT INTO azure_extras.network_analytics.data_types (
properties,
resource_group_name,
data_product_name,
data_type_name,
...
```sql
UPDATE azure_extras.network_analytics.data_types
SET 
...
```sql
DELETE FROM azure_extras.network_analytics.data_types
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND data_product_name = '{{ data_product_name }}' --required
AND data_type_name = '{{ data_type_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_extras.network_analytics.data_types.delete_data 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_extras.network_analytics.data_types.generate_storage_container_sas_token 
@resource_group_name='{{ resource_group_name }}' --required, 
@data_product_name='{{ data_product_name }}' --required, 
@data_type_name='{{ data_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
