...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.hybrid_network.network_service_design_groups" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_extras.hybrid_network.network_service_design_groups
...
```sql
INSERT INTO azure_extras.hybrid_network.network_service_design_groups (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_extras.hybrid_network.network_service_design_groups
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.hybrid_network.network_service_design_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_extras.hybrid_network.network_service_design_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND network_service_design_group_name = '{{ network_service_design_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
