...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_function_definition_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.hybrid_network.network_function_definition_groups" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The network function definition group description.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The provisioning state of the network function definition groups resource. Known values are: "Unknown", "Succeeded", "Accepted", "Deleting", "Failed", "Canceled", "Deleted", and "Converging".</td>
</tr>
<tr>
...
tags,
type
FROM azure_extras.hybrid_network.network_function_definition_groups
...
```sql
INSERT INTO azure_extras.hybrid_network.network_function_definition_groups (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_extras.hybrid_network.network_function_definition_groups
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.hybrid_network.network_function_definition_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_extras.hybrid_network.network_function_definition_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND network_function_definition_group_name = '{{ network_function_definition_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
