...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.hybrid_network.publishers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The provisioning state of the publisher resource. Known values are: "Unknown", "Succeeded", "Accepted", "Deleting", "Failed", "Canceled", "Deleted", and "Converging".</td>
</tr>
<tr>
    <td><CopyableCode code="scope" /></td>
    <td><code>string</code></td>
    <td>The publisher scope. Known values are: "Unknown" and "Private".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-publisher_name"><code>publisher_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
...
tags,
type
FROM azure_extras.hybrid_network.publishers
...
```sql
INSERT INTO azure_extras.hybrid_network.publishers (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure_extras.hybrid_network.publishers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.hybrid_network.publishers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_extras.hybrid_network.publishers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
