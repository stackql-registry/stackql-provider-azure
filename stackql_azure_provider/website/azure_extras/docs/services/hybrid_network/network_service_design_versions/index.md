...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.hybrid_network.network_service_design_versions" /></td></tr>
</tbody></table>
...
type,
versionState
FROM azure_extras.hybrid_network.network_service_design_versions
...
```sql
INSERT INTO azure_extras.hybrid_network.network_service_design_versions (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_extras.hybrid_network.network_service_design_versions
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.hybrid_network.network_service_design_versions
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_extras.hybrid_network.network_service_design_versions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND network_service_design_group_name = '{{ network_service_design_group_name }}' --required
AND network_service_design_version_name = '{{ network_service_design_version_name }}' --required
...
```sql
EXEC azure_extras.hybrid_network.network_service_design_versions.update_state 
@resource_group_name='{{ resource_group_name }}' --required, 
