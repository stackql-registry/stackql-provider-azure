...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.rdbms.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Updates tags on private endpoint connection. Updates private endpoint connection with the specified tags.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
provisioningState,
type
FROM azure_extras.rdbms.private_endpoint_connections
...
```sql
INSERT INTO azure_extras.rdbms.private_endpoint_connections (
properties,
resource_group_name,
server_name,
...
```sql
UPDATE azure_extras.rdbms.private_endpoint_connections
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.rdbms.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure_extras.rdbms.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
