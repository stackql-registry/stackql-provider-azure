...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.managed_network_fabric.access_control_lists" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.managed_network_fabric.access_control_lists.resync 
@resource_group_name='{{ resource_group_name }}' --required, 
@access_control_list_name='{{ access_control_list_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.managed_network_fabric.access_control_lists.validate_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@access_control_list_name='{{ access_control_list_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
