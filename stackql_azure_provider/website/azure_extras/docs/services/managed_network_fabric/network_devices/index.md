...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.managed_network_fabric.network_devices" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.refresh_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.update_administrative_state 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.upgrade 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.run_ro_command 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.run_rw_command 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.resync_passwords 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.managed_network_fabric.network_devices.resync_certificates 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_device_name='{{ network_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
