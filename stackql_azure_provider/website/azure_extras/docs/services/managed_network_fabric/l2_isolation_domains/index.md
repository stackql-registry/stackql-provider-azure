...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.managed_network_fabric.l2_isolation_domains" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.managed_network_fabric.l2_isolation_domains.validate_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@l2_isolation_domain_name='{{ l2_isolation_domain_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.managed_network_fabric.l2_isolation_domains.commit_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@l2_isolation_domain_name='{{ l2_isolation_domain_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
