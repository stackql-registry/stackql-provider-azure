...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.managed_network_fabric.network_tap_rules" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.managed_network_fabric.network_tap_rules.resync 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_tap_rule_name='{{ network_tap_rule_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_extras.managed_network_fabric.network_tap_rules.validate_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_tap_rule_name='{{ network_tap_rule_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
