...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ip_communities" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.managed_network_fabric.ip_communities" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="ipCommunityRules" /></td>
    <td><code>array</code></td>
    <td>List of IP Community Rules. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-ip_community_name"><code>ip_community_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-ip_community_name"><code>ip_community_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-ip_community_name">
    <td><CopyableCode code="ip_community_name" /></td>
    <td><code>string</code></td>
    <td>Name of the IP Community. Required.</td>
</tr>
...
tags,
type
FROM azure_extras.managed_network_fabric.ip_communities
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND ip_community_name = '{{ ip_community_name }}' -- required
...
```sql
INSERT INTO azure_extras.managed_network_fabric.ip_communities (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_extras.managed_network_fabric.ip_communities
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure_extras.managed_network_fabric.ip_communities
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND ip_community_name = '{{ ip_community_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
