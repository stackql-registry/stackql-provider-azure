...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.chaos.private_accesses" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.chaos.private_accesses
...
```sql
INSERT INTO azure_extras.chaos.private_accesses (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_extras.chaos.private_accesses
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.chaos.private_accesses
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
EXEC azure_extras.chaos.private_accesses.list_private_endpoint_connections 
@resource_group_name='{{ resource_group_name }}' --required, 
