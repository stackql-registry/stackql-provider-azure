...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.chaos.scenario_runs" /></td></tr>
</tbody></table>
...
workspaceName,
zoneResolution
FROM azure_extras.chaos.scenario_runs
...
```sql
EXEC azure_extras.chaos.scenario_runs.cancel 
