...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.healthcareapis.iot_connector_fhir_destination" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_extras.healthcareapis.iot_connector_fhir_destination
...
```sql
INSERT INTO azure_extras.healthcareapis.iot_connector_fhir_destination (
properties,
etag,
location,
resource_group_name,
...
```sql
REPLACE azure_extras.healthcareapis.iot_connector_fhir_destination
SET 
...
```sql
DELETE FROM azure_extras.healthcareapis.iot_connector_fhir_destination
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND iot_connector_name = '{{ iot_connector_name }}' --required
AND fhir_destination_name = '{{ fhir_destination_name }}' --required
