...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.network_cloud.trunked_networks" /></td></tr>
</tbody></table>
...
vlans
FROM azure_extras.network_cloud.trunked_networks
...
```sql
INSERT INTO azure_extras.network_cloud.trunked_networks (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure_extras.network_cloud.trunked_networks
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_extras.network_cloud.trunked_networks
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_extras.network_cloud.trunked_networks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND trunked_network_name = '{{ trunked_network_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
