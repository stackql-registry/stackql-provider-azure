...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.time_series_insights.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The provisioning state of the private endpoint connection resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Provisioning state of the private endpoint connection. Known values are: "Succeeded", "Creating", "Deleting", and "Failed".</td>
</tr>
<tr>
...
provisioningState,
type
FROM azure_extras.time_series_insights.private_endpoint_connections
...
```sql
INSERT INTO azure_extras.time_series_insights.private_endpoint_connections (
properties,
resource_group_name,
environment_name,
...
```sql
REPLACE azure_extras.time_series_insights.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure_extras.time_series_insights.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND environment_name = '{{ environment_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
