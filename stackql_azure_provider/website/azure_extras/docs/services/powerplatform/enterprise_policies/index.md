...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.powerplatform.enterprise_policies" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_extras.powerplatform.enterprise_policies
...
```sql
INSERT INTO azure_extras.powerplatform.enterprise_policies (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure_extras.powerplatform.enterprise_policies
SET 
tags = '{{ tags }}',
location = '{{ location }}',
identity = '{{ identity }}',
...
```sql
REPLACE azure_extras.powerplatform.enterprise_policies
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_extras.powerplatform.enterprise_policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
