...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="firmwares" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.iot_firmware_defense.firmwares" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>User-specified description of the firmware.</td>
</tr>
<tr>
    <td><CopyableCode code="fileName" /></td>
    <td><code>string</code></td>
    <td>File name for a firmware that user uploaded.</td>
</tr>
<tr>
    <td><CopyableCode code="fileSize" /></td>
    <td><code>integer</code></td>
    <td>File size of the uploaded firmware image.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The status of firmware scan. Known values are: "Pending", "Extracting", "Analyzing", "Ready", and "Error". (Pending, Extracting, Analyzing, Ready, Error)</td>
</tr>
<tr>
    <td><CopyableCode code="statusMessages" /></td>
    <td><code>array</code></td>
    <td>A list of errors or other messages generated during firmware analysis.</td>
</tr>
<tr>
...
vendor,
version
FROM azure_extras.iot_firmware_defense.firmwares
...
```sql
INSERT INTO azure_extras.iot_firmware_defense.firmwares (
properties,
resource_group_name,
workspace_name,
firmware_id,
...
```sql
UPDATE azure_extras.iot_firmware_defense.firmwares
SET 
...
```sql
DELETE FROM azure_extras.iot_firmware_defense.firmwares
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND firmware_id = '{{ firmware_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
