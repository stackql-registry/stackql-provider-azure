...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.health_deidentification.cancel_jobs" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.health_deidentification.cancel_jobs.cancel_job 
@name='{{ name }}' --required, 
