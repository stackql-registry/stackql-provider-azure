...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.health_deidentification.deidentify_documents" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_extras.health_deidentification.deidentify_documents.deidentify_documents 
@name='{{ name }}' --required, 
