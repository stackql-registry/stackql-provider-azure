...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.video_indexer.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The intended executor of the operation; as in Resource Based Access Control (RBAC) and audit logs UX. Default value is "user,system" (user, system, user,system)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td></td>
    <td>Lists all of the available Azure Video Indexer provider operations.</td>
</tr>
</tbody>
</table>
...
isDataAction,
origin
FROM azure_extras.video_indexer.operations
;
```
</TabItem>
</Tabs>
