...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.video_analyzer.private_link_resources" /></td></tr>
</tbody></table>
...
<tr id="parameter-name">
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>Name of the private link resource (Group ID).</td>
</tr>
...
Get group ID. Get group ID for video analyzer account.
...
systemData,
type
FROM azure_extras.video_analyzer.private_link_resources
...
Get list of group IDs. Get list of group IDs for video analyzer account.
