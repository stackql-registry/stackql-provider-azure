...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.oracledatabase.cloud_exadata_infrastructures" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_isv.oracledatabase.cloud_exadata_infrastructures.configure_exascale 
@resource_group_name='{{ resource_group_name }}' --required, 
@cloudexadatainfrastructurename='{{ cloudexadatainfrastructurename }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
