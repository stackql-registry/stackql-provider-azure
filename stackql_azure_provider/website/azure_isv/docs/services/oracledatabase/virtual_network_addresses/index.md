...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.oracledatabase.virtual_network_addresses" /></td></tr>
</tbody></table>
...
type,
vmOcid
FROM azure_isv.oracledatabase.virtual_network_addresses
...
```sql
INSERT INTO azure_isv.oracledatabase.virtual_network_addresses (
properties,
resource_group_name,
cloudvmclustername,
...
```sql
REPLACE azure_isv.oracledatabase.virtual_network_addresses
SET 
...
```sql
DELETE FROM azure_isv.oracledatabase.virtual_network_addresses
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cloudvmclustername = '{{ cloudvmclustername }}' --required
AND virtualnetworkaddressname = '{{ virtualnetworkaddressname }}' --required
AND subscription_id = '{{ subscription_id }}' --required
