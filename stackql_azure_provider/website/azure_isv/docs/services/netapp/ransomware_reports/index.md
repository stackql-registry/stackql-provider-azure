...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.ransomware_reports" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.netapp.ransomware_reports
...
```sql
EXEC azure_isv.netapp.ransomware_reports.clear_suspects 
