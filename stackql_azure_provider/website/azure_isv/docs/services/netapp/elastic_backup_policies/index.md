...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.elastic_backup_policies" /></td></tr>
</tbody></table>
...
type,
weeklyBackupsToKeep
FROM azure_isv.netapp.elastic_backup_policies
...
```sql
INSERT INTO azure_isv.netapp.elastic_backup_policies (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_isv.netapp.elastic_backup_policies
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.netapp.elastic_backup_policies
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure_isv.netapp.elastic_backup_policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND backup_policy_name = '{{ backup_policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
