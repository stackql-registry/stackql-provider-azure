...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.elastic_snapshots" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.netapp.elastic_snapshots
...
```sql
INSERT INTO azure_isv.netapp.elastic_snapshots (
properties,
resource_group_name,
account_name,
pool_name,
...
```sql
REPLACE azure_isv.netapp.elastic_snapshots
SET 
...
```sql
DELETE FROM azure_isv.netapp.elastic_snapshots
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND pool_name = '{{ pool_name }}' --required
AND volume_name = '{{ volume_name }}' --required
