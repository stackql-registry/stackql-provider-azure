...
Creates, updates, deletes, gets or lists an <code>elastic_accounts</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="elastic_accounts" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.elastic_accounts" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get the NetApp Elastic Account.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List and describe all NetApp elastic accounts in the resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List and describe all NetApp elastic accounts in the subscription.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create or update the specified NetApp Elastic Account within the resource group.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Patch the specified NetApp Elastic Account.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete the specified NetApp elastic account.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure_isv.netapp.elastic_accounts
...
```sql
INSERT INTO azure_isv.netapp.elastic_accounts (
tags,
location,
properties,
identity,
...
- name: elastic_accounts
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the elastic_accounts resource.
    - name: account_name
      value: "{{ account_name }}"
      description: Required parameter for the elastic_accounts resource.
...
```sql
UPDATE azure_isv.netapp.elastic_accounts
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.netapp.elastic_accounts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_isv.netapp.elastic_accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
