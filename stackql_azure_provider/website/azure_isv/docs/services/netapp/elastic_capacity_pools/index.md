...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.elastic_capacity_pools" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure_isv.netapp.elastic_capacity_pools (
tags,
location,
properties,
zones,
...
```sql
UPDATE azure_isv.netapp.elastic_capacity_pools
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.netapp.elastic_capacity_pools
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_isv.netapp.elastic_capacity_pools
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND pool_name = '{{ pool_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_isv.netapp.elastic_capacity_pools.change_zone 
@resource_group_name='{{ resource_group_name }}' --required, 
