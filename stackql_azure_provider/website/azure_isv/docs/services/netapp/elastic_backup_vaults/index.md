--- 
title: elastic_backup_vaults
hide_title: false
hide_table_of_contents: false
keywords:
  - elastic_backup_vaults
  - netapp
  - azure_isv
...
Creates, updates, deletes, gets or lists an <code>elastic_backup_vaults</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="elastic_backup_vaults" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.netapp.elastic_backup_vaults" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get the Elastic Backup Vault.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List and describe all Elastic Backup Vaults in the elastic account.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create or update the specified Elastic Backup Vault in the Elastic NetApp account.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-backup_vault_name"><code>backup_vault_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Patch the specified NetApp Elastic Backup Vault.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-backup_vault_name"><code>backup_vault_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete the specified Elastic Backup Vault.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure_isv.netapp.elastic_backup_vaults
...
```sql
INSERT INTO azure_isv.netapp.elastic_backup_vaults (
tags,
location,
properties,
resource_group_name,
...
- name: elastic_backup_vaults
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the elastic_backup_vaults resource.
    - name: account_name
      value: "{{ account_name }}"
      description: Required parameter for the elastic_backup_vaults resource.
...
```sql
UPDATE azure_isv.netapp.elastic_backup_vaults
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_isv.netapp.elastic_backup_vaults
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_isv.netapp.elastic_backup_vaults
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND backup_vault_name = '{{ backup_vault_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
