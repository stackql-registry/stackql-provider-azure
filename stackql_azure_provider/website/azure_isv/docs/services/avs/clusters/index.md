...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.avs.clusters" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="clusterSize" /></td>
    <td><code>integer</code></td>
    <td>The cluster size.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The state of the cluster provisioning. Known values are: "Succeeded", "Failed", "Canceled", "Cancelled", "Deleting", and "Updating". (Succeeded, Failed, Canceled, Cancelled, Deleting, Updating)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="vsanDatastoreName" /></td>
    <td><code>string</code></td>
    <td>Name of the vsan datastore associated with the cluster.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>List Cluster resources by PrivateCloud.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-private_cloud_name"><code>private_cloud_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-sku"><code>sku</code></a></td>
    <td></td>
...
<tr>
    <td><a href="#list_zones"><CopyableCode code="list_zones" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-private_cloud_name"><code>private_cloud_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>List hosts by zone in a cluster.</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO azure_isv.avs.clusters (
properties,
sku,
resource_group_name,
private_cloud_name,
...
```sql
REPLACE azure_isv.avs.clusters
SET 
properties = '{{ properties }}',
sku = '{{ sku }}'
WHERE 
...
```sql
DELETE FROM azure_isv.avs.clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND private_cloud_name = '{{ private_cloud_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
<Tabs
    defaultValue="list_zones"
    values={[
        { label: 'list_zones', value: 'list_zones' }
    ]}
>
<TabItem value="list_zones">

List hosts by zone in a cluster.

```sql
EXEC azure_isv.avs.clusters.list_zones 
@resource_group_name='{{ resource_group_name }}' --required, 
