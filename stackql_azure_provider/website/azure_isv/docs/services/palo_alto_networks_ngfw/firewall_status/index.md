...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.firewall_status" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.palo_alto_networks_ngfw.firewall_status
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.firewall_status.list_by_firewalls 
