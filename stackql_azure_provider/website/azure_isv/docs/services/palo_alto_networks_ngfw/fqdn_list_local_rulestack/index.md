...
Creates, updates, deletes, gets or lists a <code>fqdn_list_local_rulestack</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="fqdn_list_local_rulestack" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.fqdn_list_local_rulestack" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.palo_alto_networks_ngfw.fqdn_list_local_rulestack
...
```sql
INSERT INTO azure_isv.palo_alto_networks_ngfw.fqdn_list_local_rulestack (
properties,
resource_group_name,
...
- name: fqdn_list_local_rulestack
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the fqdn_list_local_rulestack resource.
...
```sql
REPLACE azure_isv.palo_alto_networks_ngfw.fqdn_list_local_rulestack
SET 
...
```sql
DELETE FROM azure_isv.palo_alto_networks_ngfw.fqdn_list_local_rulestack
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND local_rulestack_name = '{{ local_rulestack_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
