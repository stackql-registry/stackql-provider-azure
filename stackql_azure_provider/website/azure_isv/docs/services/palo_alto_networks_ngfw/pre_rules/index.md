...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pre_rules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.pre_rules" /></td></tr>
</tbody></table>
...
<tr id="parameter-priority">
    <td><CopyableCode code="priority" /></td>
    <td><code>string</code></td>
    <td>Pre Rule priority. Required.</td>
</tr>
...
tags,
type
FROM azure_isv.palo_alto_networks_ngfw.pre_rules
...
```sql
INSERT INTO azure_isv.palo_alto_networks_ngfw.pre_rules (
properties,
...
```sql
REPLACE azure_isv.palo_alto_networks_ngfw.pre_rules
SET 
...
```sql
DELETE FROM azure_isv.palo_alto_networks_ngfw.pre_rules
WHERE global_rulestack_name = '{{ global_rulestack_name }}' --required
AND priority = '{{ priority }}' --required
;
```
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.pre_rules.get_counters 
@global_rulestack_name='{{ global_rulestack_name }}' --required, 
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.pre_rules.refresh_counters 
@global_rulestack_name='{{ global_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@firewallName='{{ firewallName }}'
;
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.pre_rules.reset_counters 
@global_rulestack_name='{{ global_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@firewallName='{{ firewallName }}'
;
