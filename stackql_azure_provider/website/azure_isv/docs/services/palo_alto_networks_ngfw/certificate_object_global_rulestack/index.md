...
Creates, updates, deletes, gets or lists a <code>certificate_object_global_rulestack</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="certificate_object_global_rulestack" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.certificate_object_global_rulestack" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.palo_alto_networks_ngfw.certificate_object_global_rulestack
...
```sql
INSERT INTO azure_isv.palo_alto_networks_ngfw.certificate_object_global_rulestack (
properties,
...
```sql
REPLACE azure_isv.palo_alto_networks_ngfw.certificate_object_global_rulestack
SET 
...
```sql
DELETE FROM azure_isv.palo_alto_networks_ngfw.certificate_object_global_rulestack
WHERE global_rulestack_name = '{{ global_rulestack_name }}' --required
AND name = '{{ name }}' --required
;
```
