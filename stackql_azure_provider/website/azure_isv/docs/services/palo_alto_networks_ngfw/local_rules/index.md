...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="local_rules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.local_rules" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-local_rulestack_name"><code>local_rulestack_name</code></a>, <a href="#parameter-priority"><code>priority</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-local_rulestack_name"><code>local_rulestack_name</code></a>, <a href="#parameter-priority"><code>priority</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
tags,
type
FROM azure_isv.palo_alto_networks_ngfw.local_rules
...
```sql
INSERT INTO azure_isv.palo_alto_networks_ngfw.local_rules (
properties,
resource_group_name,
...
```sql
REPLACE azure_isv.palo_alto_networks_ngfw.local_rules
SET 
...
```sql
DELETE FROM azure_isv.palo_alto_networks_ngfw.local_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND local_rulestack_name = '{{ local_rulestack_name }}' --required
AND priority = '{{ priority }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.local_rules.get_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.local_rules.refresh_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
@local_rulestack_name='{{ local_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
...
```sql
EXEC azure_isv.palo_alto_networks_ngfw.local_rules.reset_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
@local_rulestack_name='{{ local_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
