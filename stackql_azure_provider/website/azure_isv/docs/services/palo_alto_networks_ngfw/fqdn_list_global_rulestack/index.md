...
Creates, updates, deletes, gets or lists a <code>fqdn_list_global_rulestack</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="fqdn_list_global_rulestack" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.palo_alto_networks_ngfw.fqdn_list_global_rulestack" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="fqdnList" /></td>
    <td><code>array</code></td>
    <td>fqdn list. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get a FqdnListGlobalRulestackResource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List FqdnListGlobalRulestackResource resources by Tenant.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a FqdnListGlobalRulestackResource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-global_rulestack_name"><code>global_rulestack_name</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Delete a FqdnListGlobalRulestackResource.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure_isv.palo_alto_networks_ngfw.fqdn_list_global_rulestack
...
```sql
INSERT INTO azure_isv.palo_alto_networks_ngfw.fqdn_list_global_rulestack (
properties,
...
```sql
REPLACE azure_isv.palo_alto_networks_ngfw.fqdn_list_global_rulestack
SET 
...
```sql
DELETE FROM azure_isv.palo_alto_networks_ngfw.fqdn_list_global_rulestack
WHERE global_rulestack_name = '{{ global_rulestack_name }}' --required
AND name = '{{ name }}' --required
;
```
