--- 
title: avs_storage_container_volumes
hide_title: false
hide_table_of_contents: false
keywords:
  - avs_storage_container_volumes
  - pure_storage_block
  - azure_isv
...
Creates, updates, deletes, gets or lists an <code>avs_storage_container_volumes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="avs_storage_container_volumes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.pure_storage_block.avs_storage_container_volumes" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_avs_storage_container', value: 'list_by_avs_storage_container' }
    ]}
>
<TabItem value="get">
...
<TabItem value="list_by_avs_storage_container">
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-storage_pool_name"><code>storage_pool_name</code></a>, <a href="#parameter-storage_container_name"><code>storage_container_name</code></a>, <a href="#parameter-volume_id"><code>volume_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a volume in an AVS storage container.</td>
</tr>
<tr>
    <td><a href="#list_by_avs_storage_container"><CopyableCode code="list_by_avs_storage_container" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td></td>
    <td>List volumes in an AVS storage container.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-storage_pool_name"><code>storage_pool_name</code></a>, <a href="#parameter-storage_container_name"><code>storage_container_name</code></a>, <a href="#parameter-volume_id"><code>volume_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update a volume in an AVS storage container.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-storage_pool_name"><code>storage_pool_name</code></a>, <a href="#parameter-storage_container_name"><code>storage_container_name</code></a>, <a href="#parameter-volume_id"><code>volume_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a volume in an AVS storage container.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-volume_id">
    ...
    <td><code>string</code></td>
    <td>ID of the volume in the storage container. Required.</td>
</tr>
</tbody>
</table>
...
volumeInternalId,
volumeType
FROM azure_isv.pure_storage_block.avs_storage_container_volumes
...
```sql
UPDATE azure_isv.pure_storage_block.avs_storage_container_volumes
SET 
...
```sql
DELETE FROM azure_isv.pure_storage_block.avs_storage_container_volumes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND storage_pool_name = '{{ storage_pool_name }}' --required
AND storage_container_name = '{{ storage_container_name }}' --required
AND volume_id = '{{ volume_id }}' --required
