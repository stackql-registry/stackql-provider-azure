...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.vmwarecloudsimple.virtual_networks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>virtual network id (privateCloudId:vsphereId). Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-region_id"><code>region_id</code></a>, <a href="#parameter-pc_name"><code>pc_name</code></a>, <a href="#parameter-virtual_network_name"><code>virtual_network_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Implements virtual network GET method. Return virtual network by its name.</td>
</tr>
<tr>
    <td><a href="#list"><CopyableCode code="list" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region_id"><code>region_id</code></a>, <a href="#parameter-pc_name"><code>pc_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-resourcePoolName"><code>resourcePoolName</code></a></td>
    <td></td>
    <td>Implements list available virtual networks within a subscription method. Return list of virtual networks in location for private cloud.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resourcePoolName">
    ...
    <td><code>string</code></td>
    <td>Resource pool used to derive vSphere cluster which contains virtual networks. Required.</td>
</tr>
...
<tr id="parameter-virtual_network_name">
    ...
    <td><code>string</code></td>
    <td>virtual network id (vsphereId). Required.</td>
</tr>
</tbody>
</table>
...
privateCloudId,
type
FROM azure_isv.vmwarecloudsimple.virtual_networks
