...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.vmwarecloudsimple.dedicated_cloud_nodes" /></td></tr>
</tbody></table>
...
type,
vmwareClusterName
FROM azure_isv.vmwarecloudsimple.dedicated_cloud_nodes
...
```sql
INSERT INTO azure_isv.vmwarecloudsimple.dedicated_cloud_nodes (
location,
sku,
tags,
properties,
...
```sql
UPDATE azure_isv.vmwarecloudsimple.dedicated_cloud_nodes
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure_isv.vmwarecloudsimple.dedicated_cloud_nodes
SET 
location = '{{ location }}',
sku = '{{ sku }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure_isv.vmwarecloudsimple.dedicated_cloud_nodes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND dedicated_cloud_node_name = '{{ dedicated_cloud_node_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
