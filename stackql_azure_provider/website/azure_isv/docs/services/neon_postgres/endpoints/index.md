...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.neon_postgres.endpoints" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The ID of the branch this endpoint belongs to.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The type of the endpoint. Known values are: "read_only" and "read_write". (read_only, read_write)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The ID of the project this endpoint belongs to.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-organization_name"><code>organization_name</code></a>, <a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-branch_name"><code>branch_name</code></a>, <a href="#parameter-endpoint_name"><code>endpoint_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a Endpoint.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List Endpoint resources by Branch.</td>
</tr>
<tr>
...
<tr id="parameter-endpoint_name">
    ...
    <td><code>string</code></td>
    <td>The name of the Endpoint. Required.</td>
</tr>
...
systemData,
type
FROM azure_isv.neon_postgres.endpoints
...
```sql
INSERT INTO azure_isv.neon_postgres.endpoints (
properties,
resource_group_name,
organization_name,
project_name,
...
```sql
UPDATE azure_isv.neon_postgres.endpoints
SET 
...
```sql
REPLACE azure_isv.neon_postgres.endpoints
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure_isv.neon_postgres.endpoints
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND organization_name = '{{ organization_name }}' --required
AND project_name = '{{ project_name }}' --required
AND branch_name = '{{ branch_name }}' --required
