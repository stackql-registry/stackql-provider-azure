...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.napster_omni_agent_api.organizations" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="partnerProperties" /></td>
    <td><code>object</code></td>
    <td>partner properties. Required.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="singleSignOnProperties" /></td>
    <td><code>object</code></td>
    <td>Single sign-on properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get a OrganizationResource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List OrganizationResource resources by resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List OrganizationResource resources by subscription ID.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-organizationname"><code>organizationname</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>Create a OrganizationResource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-organizationname"><code>organizationname</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update a OrganizationResource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-organizationname"><code>organizationname</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Returns the latest SaaS linked to the Napster organization of the underlying monitor.</td>
</tr>
</tbody>
</table>
...
type,
user
FROM azure_isv.napster_omni_agent_api.organizations
...
```sql
INSERT INTO azure_isv.napster_omni_agent_api.organizations (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure_isv.napster_omni_agent_api.organizations
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure_isv.napster_omni_agent_api.organizations
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure_isv.napster_omni_agent_api.organizations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND organizationname = '{{ organizationname }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.napster_omni_agent_api.organizations.link_saas 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.napster_omni_agent_api.organizations.latest_linked_saas 
@resource_group_name='{{ resource_group_name }}' --required, 
@organizationname='{{ organizationname }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
