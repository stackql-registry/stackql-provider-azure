...
<tr>
    <td><CopyableCode code="certificateError" /></td>
    <td><code>object</code></td>
    <td>Nginx Certificate Error Response Body.</td>
</tr>
<tr>
    <td><CopyableCode code="certificateVirtualPath" /></td>
    <td><code>string</code></td>
    <td>:vartype certificate_virtual_path: str</td>
</tr>
<tr>
    <td><CopyableCode code="keyVaultSecretCreated" /></td>
    <td><code>string (date-time)</code></td>
    <td>:vartype key_vault_secret_created: ~datetime.datetime</td>
</tr>
<tr>
    <td><CopyableCode code="keyVaultSecretId" /></td>
    <td><code>string</code></td>
    <td>:vartype key_vault_secret_id: str</td>
</tr>
<tr>
    <td><CopyableCode code="keyVaultSecretVersion" /></td>
    <td><code>string</code></td>
    <td>:vartype key_vault_secret_version: str</td>
</tr>
<tr>
    <td><CopyableCode code="keyVirtualPath" /></td>
    <td><code>string</code></td>
    <td>:vartype key_virtual_path: str</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="sha1Thumbprint" /></td>
    <td><code>string</code></td>
    <td>:vartype sha1_thumbprint: str</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-deployment_name"><code>deployment_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a certificate of given NGINX deployment.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List all certificates of given NGINX deployment.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-deployment_name"><code>deployment_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update the NGINX certificates for given NGINX deployment.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-deployment_name"><code>deployment_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes a certificate from the NGINX deployment.</td>
</tr>
</tbody>
</table>
