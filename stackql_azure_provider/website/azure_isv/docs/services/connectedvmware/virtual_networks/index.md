...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.connectedvmware.virtual_networks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the inventory Item ID for the virtual network.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the vCenter Managed Object name for the virtual network.</td>
</tr>
<tr>
    <td><CopyableCode code="moRefId" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the vCenter MoRef (Managed Object Reference) ID for the virtual network.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets a virtual network. Implements virtual network GET method.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Implements GET virtualNetworks in a resource group. List of virtualNetworks in a resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Implements GET virtualNetworks in a subscription. List of virtualNetworks in a subscription.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Implements virtual network PUT method. Create Or Update virtual network.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-virtual_network_name"><code>virtual_network_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Updates a virtual network. API to update certain properties of the virtual network resource.</td>
</tr>
<tr>
    ...
    <td>Deletes an virtual network. Implements virtual network DELETE method.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-virtual_network_name">
    ...
    <td><code>string</code></td>
    <td>Name of the virtual network resource. Required.</td>
</tr>
...
uuid,
vCenterId
FROM azure_isv.connectedvmware.virtual_networks
...
```sql
INSERT INTO azure_isv.connectedvmware.virtual_networks (
location,
extendedLocation,
tags,
kind,
...
```sql
UPDATE azure_isv.connectedvmware.virtual_networks
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
DELETE FROM azure_isv.connectedvmware.virtual_networks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_network_name = '{{ virtual_network_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
AND force = '{{ force }}'
