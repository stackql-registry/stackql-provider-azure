...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.dell_storage.file_systems" /></td></tr>
</tbody></table>
...
type,
user
FROM azure_isv.dell_storage.file_systems
...
```sql
INSERT INTO azure_isv.dell_storage.file_systems (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure_isv.dell_storage.file_systems
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.dell_storage.file_systems
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_isv.dell_storage.file_systems
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND filesystem_name = '{{ filesystem_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
