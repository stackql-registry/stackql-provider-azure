...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.oracle_database.cloud_vm_clusters" /></td></tr>
</tbody></table>
...
ocid,
subnetId
FROM azure_isv.oracle_database.cloud_vm_clusters
...
```sql
INSERT INTO azure_isv.oracle_database.cloud_vm_clusters (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_isv.oracle_database.cloud_vm_clusters
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.oracle_database.cloud_vm_clusters
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure_isv.oracle_database.cloud_vm_clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cloudvmclustername = '{{ cloudvmclustername }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.oracle_database.cloud_vm_clusters.add_vms 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.oracle_database.cloud_vm_clusters.remove_vms 
@resource_group_name='{{ resource_group_name }}' --required, 
@cloudvmclustername='{{ cloudvmclustername }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
