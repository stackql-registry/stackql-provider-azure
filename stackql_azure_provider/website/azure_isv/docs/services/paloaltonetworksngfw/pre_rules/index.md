...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.paloaltonetworksngfw.pre_rules" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_isv.paloaltonetworksngfw.pre_rules.refresh_counters 
@global_rulestack_name='{{ global_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@firewallName='{{ firewallName }}'
;
...
```sql
EXEC azure_isv.paloaltonetworksngfw.pre_rules.reset_counters 
@global_rulestack_name='{{ global_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@firewallName='{{ firewallName }}'
;
