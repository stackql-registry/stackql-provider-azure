...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.paloaltonetworksngfw.fqdn_list_local_rulestack" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.paloaltonetworksngfw.fqdn_list_local_rulestack
...
```sql
INSERT INTO azure_isv.paloaltonetworksngfw.fqdn_list_local_rulestack (
properties,
resource_group_name,
...
```sql
REPLACE azure_isv.paloaltonetworksngfw.fqdn_list_local_rulestack
SET 
...
```sql
DELETE FROM azure_isv.paloaltonetworksngfw.fqdn_list_local_rulestack
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND local_rulestack_name = '{{ local_rulestack_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
