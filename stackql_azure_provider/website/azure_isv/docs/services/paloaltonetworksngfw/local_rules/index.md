...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.paloaltonetworksngfw.local_rules" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure_isv.paloaltonetworksngfw.local_rules
...
```sql
INSERT INTO azure_isv.paloaltonetworksngfw.local_rules (
properties,
resource_group_name,
...
```sql
REPLACE azure_isv.paloaltonetworksngfw.local_rules
SET 
...
```sql
DELETE FROM azure_isv.paloaltonetworksngfw.local_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND local_rulestack_name = '{{ local_rulestack_name }}' --required
AND priority = '{{ priority }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_isv.paloaltonetworksngfw.local_rules.get_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.paloaltonetworksngfw.local_rules.refresh_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
@local_rulestack_name='{{ local_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
...
```sql
EXEC azure_isv.paloaltonetworksngfw.local_rules.reset_counters 
@resource_group_name='{{ resource_group_name }}' --required, 
@local_rulestack_name='{{ local_rulestack_name }}' --required, 
@priority='{{ priority }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
