...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.workloadssapvirtualinstance.sap_virtual_instances" /></td></tr>
</tbody></table>
...
```sql
EXEC azure_isv.workloadssapvirtualinstance.sap_virtual_instances.start 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.workloadssapvirtualinstance.sap_virtual_instances.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@sap_virtual_instance_name='{{ sap_virtual_instance_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
