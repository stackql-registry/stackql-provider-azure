...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.workloads.sap_application_server_instances" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Puts the SAP Application Server Instance resource. This will be used by service only. PUT by end user will return a Bad Request error.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-sap_virtual_instance_name"><code>sap_virtual_instance_name</code></a>, <a href="#parameter-application_instance_name"><code>application_instance_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes the SAP Application Server Instance resource. This operation will be used by service only. Delete by end user will return a Bad Request error.</td>
</tr>
<tr>
...
type,
vmDetails
FROM azure_isv.workloads.sap_application_server_instances
...
Puts the SAP Application Server Instance resource. This will be used by service only. PUT by end user will return a Bad Request error.

```sql
INSERT INTO azure_isv.workloads.sap_application_server_instances (
tags,
location,
resource_group_name,
...
```sql
UPDATE azure_isv.workloads.sap_application_server_instances
SET 
tags = '{{ tags }}'
WHERE 
...
Deletes the SAP Application Server Instance resource. This operation will be used by service only. Delete by end user will return a Bad Request error.

```sql
DELETE FROM azure_isv.workloads.sap_application_server_instances
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sap_virtual_instance_name = '{{ sap_virtual_instance_name }}' --required
AND application_instance_name = '{{ application_instance_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure_isv.workloads.sap_application_server_instances.start_instance 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.workloads.sap_application_server_instances.stop_instance 
@resource_group_name='{{ resource_group_name }}' --required, 
@sap_virtual_instance_name='{{ sap_virtual_instance_name }}' --required, 
@application_instance_name='{{ application_instance_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
