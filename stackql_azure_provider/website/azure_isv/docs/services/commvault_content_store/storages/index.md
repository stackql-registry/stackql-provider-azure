...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.commvault_content_store.storages" /></td></tr>
</tbody></table>
...
type,
vendor
FROM azure_isv.commvault_content_store.storages
...
```sql
INSERT INTO azure_isv.commvault_content_store.storages (
properties,
resource_group_name,
cloud_account_name,
storage_name,
...
```sql
REPLACE azure_isv.commvault_content_store.storages
SET 
...
```sql
DELETE FROM azure_isv.commvault_content_store.storages
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cloud_account_name = '{{ cloud_account_name }}' --required
AND storage_name = '{{ storage_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
