...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.commvault_content_store.cloud_accounts" /></td></tr>
</tbody></table>
...
type,
user
FROM azure_isv.commvault_content_store.cloud_accounts
...
```sql
INSERT INTO azure_isv.commvault_content_store.cloud_accounts (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure_isv.commvault_content_store.cloud_accounts
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure_isv.commvault_content_store.cloud_accounts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure_isv.commvault_content_store.cloud_accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cloud_account_name = '{{ cloud_account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.commvault_content_store.cloud_accounts.link_saas 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.commvault_content_store.cloud_accounts.latest_linked_saas 
@resource_group_name='{{ resource_group_name }}' --required, 
@cloud_account_name='{{ cloud_account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
