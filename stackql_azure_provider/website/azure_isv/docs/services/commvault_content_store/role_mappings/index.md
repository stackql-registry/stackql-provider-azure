...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.commvault_content_store.role_mappings" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.commvault_content_store.role_mappings
...
```sql
INSERT INTO azure_isv.commvault_content_store.role_mappings (
properties,
resource_group_name,
cloud_account_name,
subscription_id
...
```sql
REPLACE azure_isv.commvault_content_store.role_mappings
SET 
...
```sql
DELETE FROM azure_isv.commvault_content_store.role_mappings
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cloud_account_name = '{{ cloud_account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.commvault_content_store.role_mappings.list_raw 
@resource_group_name='{{ resource_group_name }}' --required, 
