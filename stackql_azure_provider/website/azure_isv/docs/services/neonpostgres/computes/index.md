...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.neonpostgres.computes" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure_isv.neonpostgres.computes
...
```sql
INSERT INTO azure_isv.neonpostgres.computes (
properties,
resource_group_name,
organization_name,
project_name,
...
```sql
UPDATE azure_isv.neonpostgres.computes
SET 
...
```sql
REPLACE azure_isv.neonpostgres.computes
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure_isv.neonpostgres.computes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND organization_name = '{{ organization_name }}' --required
AND project_name = '{{ project_name }}' --required
AND branch_name = '{{ branch_name }}' --required
