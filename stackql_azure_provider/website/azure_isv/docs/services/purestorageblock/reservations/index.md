...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.purestorageblock.reservations" /></td></tr>
</tbody></table>
...
type,
user
FROM azure_isv.purestorageblock.reservations
...
```sql
INSERT INTO azure_isv.purestorageblock.reservations (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure_isv.purestorageblock.reservations
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure_isv.purestorageblock.reservations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND reservation_name = '{{ reservation_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.purestorageblock.reservations.get_resource_limits 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure_isv.purestorageblock.reservations.get_billing_status 
@resource_group_name='{{ resource_group_name }}' --required, 
@reservation_name='{{ reservation_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure_isv.purestorageblock.reservations.get_billing_report 
@resource_group_name='{{ resource_group_name }}' --required, 
@reservation_name='{{ reservation_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
