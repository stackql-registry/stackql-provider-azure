...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.purestorageblock.avs_storage_container_volumes" /></td></tr>
</tbody></table>
...
volumeInternalId,
volumeType
FROM azure_isv.purestorageblock.avs_storage_container_volumes
...
```sql
UPDATE azure_isv.purestorageblock.avs_storage_container_volumes
SET 
...
```sql
DELETE FROM azure_isv.purestorageblock.avs_storage_container_volumes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND storage_pool_name = '{{ storage_pool_name }}' --required
AND storage_container_name = '{{ storage_container_name }}' --required
AND volume_id = '{{ volume_id }}' --required
