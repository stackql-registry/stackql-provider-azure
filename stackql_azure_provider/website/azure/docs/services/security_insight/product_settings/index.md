...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_insight.product_settings" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.security_insight.product_settings
...
```sql
UPDATE azure.security_insight.product_settings
SET 
kind = '{{ kind }}',
etag = '{{ etag }}'
WHERE 
...
```sql
DELETE FROM azure.security_insight.product_settings
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND settings_name = '{{ settings_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
