...
Creates, updates, deletes, gets or lists a <code>bookmark_relations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="bookmark_relations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_insight.bookmark_relations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-bookmark_id"><code>bookmark_id</code></a>, <a href="#parameter-relation_name"><code>relation_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets a bookmark relation.</td>
</tr>
<tr>
    ...
    <td>Gets all bookmark relations.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-bookmark_id"><code>bookmark_id</code></a>, <a href="#parameter-relation_name"><code>relation_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates the bookmark relation.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-bookmark_id"><code>bookmark_id</code></a>, <a href="#parameter-relation_name"><code>relation_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete the bookmark relation.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.security_insight.bookmark_relations
...
```sql
INSERT INTO azure.security_insight.bookmark_relations (
properties,
etag,
resource_group_name,
workspace_name,
...
- name: bookmark_relations
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the bookmark_relations resource.
    - name: workspace_name
...
```sql
REPLACE azure.security_insight.bookmark_relations
SET 
...
```sql
DELETE FROM azure.security_insight.bookmark_relations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND bookmark_id = '{{ bookmark_id }}' --required
AND relation_name = '{{ relation_name }}' --required
