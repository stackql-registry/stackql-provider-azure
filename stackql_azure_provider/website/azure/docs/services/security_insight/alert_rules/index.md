...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_insight.alert_rules" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.security_insight.alert_rules
...
```sql
INSERT INTO azure.security_insight.alert_rules (
kind,
etag,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.security_insight.alert_rules
SET 
kind = '{{ kind }}',
etag = '{{ etag }}'
WHERE 
...
```sql
DELETE FROM azure.security_insight.alert_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND rule_id = '{{ rule_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
