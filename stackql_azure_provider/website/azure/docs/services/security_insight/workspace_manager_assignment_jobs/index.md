--- 
title: workspace_manager_assignment_jobs
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>workspace_manager_assignment_jobs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_manager_assignment_jobs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security_insight.workspace_manager_assignment_jobs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The time the job completed.</td>
</tr>
<tr>
    <td><CopyableCode code="errorMessage" /></td>
    <td><code>string</code></td>
    <td>Message to describe error, if an error exists.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>List of items published by the job.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>State of the job. Known values are: "Accepted", "InProgress", "Succeeded", "Failed", and "Canceled". (Accepted, InProgress, Succeeded, Failed, Canceled)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-workspace_manager_assignment_name"><code>workspace_manager_assignment_name</code></a>, <a href="#parameter-job_name"><code>job_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets a job.</td>
</tr>
<tr>
    ...
    <td>Get all jobs for the specified workspace manager assignment.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-workspace_manager_assignment_name"><code>workspace_manager_assignment_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create a job for the specified workspace manager assignment.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-workspace_manager_assignment_name"><code>workspace_manager_assignment_name</code></a>, <a href="#parameter-job_name"><code>job_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes the specified job from the specified workspace manager assignment.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.security_insight.workspace_manager_assignment_jobs
...
```sql
INSERT INTO azure.security_insight.workspace_manager_assignment_jobs (
resource_group_name,
workspace_name,
...
- name: workspace_manager_assignment_jobs
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the workspace_manager_assignment_jobs resource.
    - name: workspace_name
...
```sql
DELETE FROM azure.security_insight.workspace_manager_assignment_jobs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND workspace_manager_assignment_name = '{{ workspace_manager_assignment_name }}' --required
AND job_name = '{{ job_name }}' --required
