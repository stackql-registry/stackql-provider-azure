...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_policy.policy_tokens" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.resource_policy.policy_tokens.acquire 
...
```sql
EXEC azure.resource_policy.policy_tokens.acquire_at_management_group 
