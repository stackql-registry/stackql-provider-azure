...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_policy.variables" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.resource_policy.variables
...
```sql
INSERT INTO azure.resource_policy.variables (
properties,
variable_name,
subscription_id
)
...
```sql
REPLACE azure.resource_policy.variables
SET 
...
```sql
DELETE FROM azure.resource_policy.variables
WHERE variable_name = '{{ variable_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
```
