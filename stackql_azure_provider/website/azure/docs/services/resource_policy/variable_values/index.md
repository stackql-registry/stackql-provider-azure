...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_policy.variable_values" /></td></tr>
</tbody></table>
...
type,
values
FROM azure.resource_policy.variable_values
...
```sql
INSERT INTO azure.resource_policy.variable_values (
properties,
variable_name,
variable_value_name,
subscription_id
...
```sql
REPLACE azure.resource_policy.variable_values
SET 
...
```sql
DELETE FROM azure.resource_policy.variable_values
WHERE variable_name = '{{ variable_name }}' --required
AND variable_value_name = '{{ variable_value_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
