...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.bookmark_relations" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securityinsight.bookmark_relations
...
```sql
INSERT INTO azure.securityinsight.bookmark_relations (
properties,
etag,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.securityinsight.bookmark_relations
SET 
...
```sql
DELETE FROM azure.securityinsight.bookmark_relations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND bookmark_id = '{{ bookmark_id }}' --required
AND relation_name = '{{ relation_name }}' --required
