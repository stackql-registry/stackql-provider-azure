...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.watchlists" /></td></tr>
</tbody></table>
...
watchlistId,
watchlistType
FROM azure.securityinsight.watchlists
...
```sql
INSERT INTO azure.securityinsight.watchlists (
properties,
etag,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.securityinsight.watchlists
SET 
...
```sql
DELETE FROM azure.securityinsight.watchlists
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND watchlist_alias = '{{ watchlist_alias }}' --required
AND subscription_id = '{{ subscription_id }}' --required
