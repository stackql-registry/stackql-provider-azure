...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.watchlist_items" /></td></tr>
</tbody></table>
...
watchlistItemId,
watchlistItemType
FROM azure.securityinsight.watchlist_items
...
```sql
INSERT INTO azure.securityinsight.watchlist_items (
properties,
etag,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.securityinsight.watchlist_items
SET 
...
```sql
DELETE FROM azure.securityinsight.watchlist_items
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND watchlist_alias = '{{ watchlist_alias }}' --required
AND watchlist_item_id = '{{ watchlist_item_id }}' --required
