...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.entity_queries" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securityinsight.entity_queries
...
```sql
INSERT INTO azure.securityinsight.entity_queries (
etag,
kind,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.securityinsight.entity_queries
SET 
etag = '{{ etag }}',
kind = '{{ kind }}'
WHERE 
...
```sql
DELETE FROM azure.securityinsight.entity_queries
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND entity_query_id = '{{ entity_query_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
