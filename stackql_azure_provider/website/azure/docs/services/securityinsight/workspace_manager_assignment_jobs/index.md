...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.workspace_manager_assignment_jobs" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securityinsight.workspace_manager_assignment_jobs
...
```sql
INSERT INTO azure.securityinsight.workspace_manager_assignment_jobs (
resource_group_name,
workspace_name,
...
```sql
DELETE FROM azure.securityinsight.workspace_manager_assignment_jobs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND workspace_manager_assignment_name = '{{ workspace_manager_assignment_name }}' --required
AND job_name = '{{ job_name }}' --required
