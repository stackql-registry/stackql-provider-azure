...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.workspace_manager_assignments" /></td></tr>
</tbody></table>
...
targetResourceName,
type
FROM azure.securityinsight.workspace_manager_assignments
...
```sql
INSERT INTO azure.securityinsight.workspace_manager_assignments (
properties,
resource_group_name,
workspace_name,
...
```sql
REPLACE azure.securityinsight.workspace_manager_assignments
SET 
...
```sql
DELETE FROM azure.securityinsight.workspace_manager_assignments
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND workspace_manager_assignment_name = '{{ workspace_manager_assignment_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
