...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.source_controls" /></td></tr>
</tbody></table>
...
FROM azure.securityinsight.source_controls
...
```sql
INSERT INTO azure.securityinsight.source_controls (
properties,
etag,
resource_group_name,
workspace_name,
...
```sql
DELETE FROM azure.securityinsight.source_controls
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND source_control_id = '{{ source_control_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
