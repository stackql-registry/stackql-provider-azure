...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securityinsight.content_package" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM azure.securityinsight.content_package
...
```sql
EXEC azure.securityinsight.content_package.install 
