...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datashare.accounts" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.datashare.accounts (
location,
tags,
identity,
resource_group_name,
...
```sql
UPDATE azure.datashare.accounts
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
DELETE FROM azure.datashare.accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
