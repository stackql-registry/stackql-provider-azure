...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datashare.shares" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.datashare.shares (
properties,
resource_group_name,
account_name,
share_name,
...
```sql
DELETE FROM azure.datashare.shares
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND share_name = '{{ share_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.datashare.shares.list_synchronization_details 
...
```sql
EXEC azure.datashare.shares.list_synchronizations 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@share_name='{{ share_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
