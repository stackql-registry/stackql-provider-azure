...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datashare.data_sets" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.datashare.data_sets
...
```sql
INSERT INTO azure.datashare.data_sets (
kind,
resource_group_name,
account_name,
share_name,
...
```sql
DELETE FROM azure.datashare.data_sets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND share_name = '{{ share_name }}' --required
AND data_set_name = '{{ data_set_name }}' --required
