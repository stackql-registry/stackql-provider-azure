...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.redis_enterprise.access_policy_assignment" /></td></tr>
</tbody></table>
...
type,
user
FROM azure.redis_enterprise.access_policy_assignment
...
```sql
INSERT INTO azure.redis_enterprise.access_policy_assignment (
properties,
resource_group_name,
cluster_name,
database_name,
...
```sql
REPLACE azure.redis_enterprise.access_policy_assignment
SET 
...
```sql
DELETE FROM azure.redis_enterprise.access_policy_assignment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND database_name = '{{ database_name }}' --required
AND access_policy_assignment_name = '{{ access_policy_assignment_name }}' --required
