...
<tr>
    ...
    <td>Gets the unit of measurement. Known values are: "Count", "Bytes", "Seconds", "Percent", "CountsPerSecond", and "BytesPerSecond". (Count, Bytes, Seconds, Percent, CountsPerSecond, BytesPerSecond)</td>
</tr>
</tbody>
</table>
</TabItem>
