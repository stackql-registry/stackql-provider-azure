--- 
title: storage_task_assignments_instances_report
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>storage_task_assignments_instances_report</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="storage_task_assignments_instances_report" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.storage.storage_task_assignments_instances_report" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>End time of the run instance. Filter options such as startTime gt '2023-06-26T20:51:24.4494016Z' and other comparison operators can be used as described for DateTime properties in `https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators `_.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Start time of the run instance. Filter options such as startTime gt '2023-06-26T20:51:24.4494016Z' and other comparison operators can be used as described for DateTime properties in `https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators `_.</td>
</tr>
<tr>
    <td><CopyableCode code="storageAccountId" /></td>
    <td><code>string</code></td>
    <td>Represents the Storage Account Id where the storage task definition was applied and executed.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Represents the Storage Task Assignment Id associated with the storage task that provided an execution context.</td>
</tr>
<tr>
    <td><CopyableCode code="taskId" /></td>
    <td><code>string</code></td>
    <td>Storage Task Arm Id.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Fetch the report summary of all the storage task assignments and instances in an account.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-$filter">
    ...
    <td><code>string</code></td>
    <td>Optional. When specified, it can be used to query using reporting properties. See `Constructing Filter Strings `_ for details. Default value is None.</td>
</tr>
