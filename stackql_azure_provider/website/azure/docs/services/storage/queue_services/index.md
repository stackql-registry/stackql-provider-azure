...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="queue_services" /></td></tr>
...
<tr>
    ...
    <td>List of queue services returned.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>List all queue services for the storage account.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Sets the properties of a storage account’s Queue service, including properties for Storage Analytics and CORS (Cross-Origin Resource Sharing) rules.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the properties of a storage account’s Queue service, including properties for Storage Analytics and CORS (Cross-Origin Resource Sharing) rules.</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE azure.storage.queue_services
SET 
...
```sql
EXEC azure.storage.queue_services.get_service_properties 
@resource_group_name='{{ resource_group_name }}' --required, 
