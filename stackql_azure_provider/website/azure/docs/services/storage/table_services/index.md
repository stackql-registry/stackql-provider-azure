...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="table_services" /></td></tr>
...
<tr>
    ...
    <td>List of table services returned.</td>
</tr>
</tbody>
</table>
</TabItem>
...
```sql
EXEC azure.storage.table_services.get_service_properties 
