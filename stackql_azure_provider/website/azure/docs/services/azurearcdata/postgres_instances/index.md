...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurearcdata.postgres_instances" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.azurearcdata.postgres_instances
...
```sql
INSERT INTO azure.azurearcdata.postgres_instances (
tags,
location,
extendedLocation,
properties,
...
```sql
UPDATE azure.azurearcdata.postgres_instances
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.azurearcdata.postgres_instances
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND postgres_instance_name = '{{ postgres_instance_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
