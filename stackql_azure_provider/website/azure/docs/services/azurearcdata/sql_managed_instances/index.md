...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurearcdata.sql_managed_instances" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.azurearcdata.sql_managed_instances
...
```sql
INSERT INTO azure.azurearcdata.sql_managed_instances (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurearcdata.sql_managed_instances
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
DELETE FROM azure.azurearcdata.sql_managed_instances
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sql_managed_instance_name = '{{ sql_managed_instance_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
