...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mysql_flexible_servers.databases" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The charset of the database.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>List all the databases in a given server.</td>
</tr>
<tr>
...
systemData,
type
FROM azure.mysql_flexible_servers.databases
...
```sql
INSERT INTO azure.mysql_flexible_servers.databases (
properties,
resource_group_name,
server_name,
database_name,
...
```sql
REPLACE azure.mysql_flexible_servers.databases
SET 
...
```sql
DELETE FROM azure.mysql_flexible_servers.databases
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND database_name = '{{ database_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
