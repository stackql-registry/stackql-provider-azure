...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mysql_flexible_servers.backups" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.mysql_flexible_servers.backups
...
```sql
EXEC azure.mysql_flexible_servers.backups.put 
