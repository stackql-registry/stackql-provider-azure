...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mysql_flexible_servers.backup_and_export" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.mysql_flexible_servers.backup_and_export (
backupSettings,
targetDetails,
resource_group_name,
server_name,
...
```sql
EXEC azure.mysql_flexible_servers.backup_and_export.validate_backup 
