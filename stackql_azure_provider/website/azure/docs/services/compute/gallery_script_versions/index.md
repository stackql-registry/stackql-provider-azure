...
Creates, updates, deletes, gets or lists a <code>gallery_script_versions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="gallery_script_versions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.compute.gallery_script_versions" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_gallery_script', value: 'list_by_gallery_script' }
    ]}
>
<TabItem value="get">
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The safety profile of the Gallery Script Version.</td>
</tr>
<tr>
...
<TabItem value="list_by_gallery_script">
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-gallery_name"><code>gallery_name</code></a>, <a href="#parameter-gallery_script_name"><code>gallery_script_name</code></a>, <a href="#parameter-gallery_script_version_name"><code>gallery_script_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Custom ArmResourceRead operation template with CloudError as Error.</td>
</tr>
<tr>
    <td><a href="#list_by_gallery_script"><CopyableCode code="list_by_gallery_script" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td></td>
    <td>List gallery Script Versions in a gallery Script Definition.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create or update a gallery Script Version.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-gallery_name"><code>gallery_name</code></a>, <a href="#parameter-gallery_script_name"><code>gallery_script_name</code></a>, <a href="#parameter-gallery_script_version_name"><code>gallery_script_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update a gallery Script Version.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-gallery_name"><code>gallery_name</code></a>, <a href="#parameter-gallery_script_name"><code>gallery_script_name</code></a>, <a href="#parameter-gallery_script_version_name"><code>gallery_script_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a gallery Script Version.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-gallery_script_version_name">
    <td><CopyableCode code="gallery_script_version_name" /></td>
    <td><code>string</code></td>
    <td>The name of the gallery Script Version to be retrieved. Required.</td>
</tr>
...
tags,
type
FROM azure.compute.gallery_script_versions
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND gallery_name = '{{ gallery_name }}' -- required
AND gallery_script_name = '{{ gallery_script_name }}' -- required
AND gallery_script_version_name = '{{ gallery_script_version_name }}' -- required
...
```sql
INSERT INTO azure.compute.gallery_script_versions (
tags,
location,
properties,
resource_group_name,
...
- name: gallery_script_versions
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the gallery_script_versions resource.
    - name: gallery_name
      value: "{{ gallery_name }}"
      description: Required parameter for the gallery_script_versions resource.
    - name: gallery_script_name
      ...
      description: Required parameter for the gallery_script_versions resource.
    - name: gallery_script_version_name
      value: "{{ gallery_script_version_name }}"
      description: Required parameter for the gallery_script_versions resource.
...
```sql
UPDATE azure.compute.gallery_script_versions
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.compute.gallery_script_versions
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.compute.gallery_script_versions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND gallery_name = '{{ gallery_name }}' --required
AND gallery_script_name = '{{ gallery_script_name }}' --required
AND gallery_script_version_name = '{{ gallery_script_version_name }}' --required
