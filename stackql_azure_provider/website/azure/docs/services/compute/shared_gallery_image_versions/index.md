...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="shared_gallery_image_versions" /></td></tr>
...
<tr id="parameter-gallery_image_version_name">
    ...
    <td><code>string</code></td>
    <td>The name of the gallery image version to be created. Needs to follow semantic version name pattern: The allowed characters are digit and period. Digits must be within the range of a 32-bit integer. Format: ... Required.</td>
</tr>
