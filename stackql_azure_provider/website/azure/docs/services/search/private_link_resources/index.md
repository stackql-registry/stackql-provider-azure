...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.search.private_link_resources" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_supported"
    values={[
        { label: 'list_supported', value: 'list_supported' }
    ]}
>
<TabItem value="list_supported">
...
<tr>
    ...
    <td>The list of required members of the private link resource.</td>
</tr>
<tr>
    <td><CopyableCode code="requiredZoneNames" /></td>
    <td><code>array</code></td>
    <td>The list of required DNS zone names of the private link resource.</td>
</tr>
<tr>
    <td><CopyableCode code="shareablePrivateLinkResourceTypes" /></td>
    <td><code>array</code></td>
    <td>The list of resources that are onboarded to private link service, that are supported by Azure AI Search.</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#list_supported"><CopyableCode code="list_supported" /></a></td>
...
systemData,
type
FROM azure.search.private_link_resources
