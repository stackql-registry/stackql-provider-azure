...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.domains" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.eventgrid.domains (
tags,
location,
properties,
sku,
...
```sql
UPDATE azure.eventgrid.domains
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.eventgrid.domains
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.eventgrid.domains
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND domain_name = '{{ domain_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventgrid.domains.list_shared_access_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventgrid.domains.regenerate_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@domain_name='{{ domain_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
