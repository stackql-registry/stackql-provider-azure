...
Creates, updates, deletes, gets or lists a <code>system_topic_event_subscriptions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="system_topic_event_subscriptions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.system_topic_event_subscriptions" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_system_topic', value: 'list_by_system_topic' }
    ]}
>
<TabItem value="get">
...
<TabItem value="list_by_system_topic">
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-system_topic_name"><code>system_topic_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get an event subscription of a system topic. Get an event subscription.</td>
</tr>
<tr>
    <td><a href="#list_by_system_topic"><CopyableCode code="list_by_system_topic" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>List event subscriptions of a system topic. List event subscriptions that belong to a specific system topic.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-system_topic_name"><code>system_topic_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update an event subscription for a system topic. Asynchronously creates or updates an event subscription with the specified parameters. Existing event subscriptions will be updated with this API.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-system_topic_name"><code>system_topic_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update event subscription of a system topic. Update an existing event subscription of a system topic.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-system_topic_name"><code>system_topic_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete an event subscription of a system topic. Delete an existing event subscription of a system topic.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-system_topic_name"><code>system_topic_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get full URL of an event subscription of a system topic. Get the full endpoint URL for an event subscription of a system topic.</td>
</tr>
</tbody>
</table>
...
topic,
type
FROM azure.eventgrid.system_topic_event_subscriptions
...
```sql
INSERT INTO azure.eventgrid.system_topic_event_subscriptions (
properties,
resource_group_name,
system_topic_name,
...
```sql
UPDATE azure.eventgrid.system_topic_event_subscriptions
SET 
...
```sql
REPLACE azure.eventgrid.system_topic_event_subscriptions
SET 
...
```sql
DELETE FROM azure.eventgrid.system_topic_event_subscriptions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND system_topic_name = '{{ system_topic_name }}' --required
AND event_subscription_name = '{{ event_subscription_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.eventgrid.system_topic_event_subscriptions.get_delivery_attributes 
@resource_group_name='{{ resource_group_name }}' --required, 
@system_topic_name='{{ system_topic_name }}' --required, 
...
```sql
EXEC azure.eventgrid.system_topic_event_subscriptions.get_full_url 
@resource_group_name='{{ resource_group_name }}' --required, 
@system_topic_name='{{ system_topic_name }}' --required, 
@event_subscription_name='{{ event_subscription_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
