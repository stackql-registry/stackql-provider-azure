...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.partner_topics" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.eventgrid.partner_topics
...
```sql
INSERT INTO azure.eventgrid.partner_topics (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.eventgrid.partner_topics
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure.eventgrid.partner_topics
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.eventgrid.partner_topics
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND partner_topic_name = '{{ partner_topic_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventgrid.partner_topics.activate 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventgrid.partner_topics.deactivate 
@resource_group_name='{{ resource_group_name }}' --required, 
@partner_topic_name='{{ partner_topic_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
