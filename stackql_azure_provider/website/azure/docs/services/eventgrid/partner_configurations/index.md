...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="partner_configurations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.partner_configurations" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="partnerAuthorization" /></td>
    <td><code>object</code></td>
    <td>The details of authorized partners.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>Provisioning state of the partner configuration. Known values are: "Creating", "Updating", "Deleting", "Succeeded", "Canceled", and "Failed". (Creating, Updating, Deleting, Succeeded, Canceled, Failed)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get a partner configuration. Get properties of a partner configuration.</td>
</tr>
<tr>
    ...
    <td>List partner configurations under an Azure subscription. List all the partner configurations under an Azure subscription.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update a partner configuration. Synchronously creates or updates a partner configuration with the specified parameters.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update a partner configuration. Synchronously updates a partner configuration with the specified parameters.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a partner configuration. Delete existing partner configuration.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>List partner configurations under a resource group. List all the partner configurations under a resource group.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Authorize a partner. Authorize a single partner either by partner registration immutable Id or by partner name.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Unauthorize a partner. Unauthorize a single partner either by partner registration immutable Id or by partner name.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.eventgrid.partner_configurations
...
```sql
INSERT INTO azure.eventgrid.partner_configurations (
properties,
tags,
location,
resource_group_name,
...
```sql
UPDATE azure.eventgrid.partner_configurations
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.eventgrid.partner_configurations
SET 
properties = '{{ properties }}',
tags = '{{ tags }}',
location = '{{ location }}'
...
```sql
DELETE FROM azure.eventgrid.partner_configurations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
```
...
```sql
EXEC azure.eventgrid.partner_configurations.list_by_resource_group 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventgrid.partner_configurations.authorize_partner 
@resource_group_name='{{ resource_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.eventgrid.partner_configurations.unauthorize_partner 
@resource_group_name='{{ resource_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
