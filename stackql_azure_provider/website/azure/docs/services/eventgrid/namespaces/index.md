...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.namespaces" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.eventgrid.namespaces (
tags,
location,
properties,
sku,
...
```sql
UPDATE azure.eventgrid.namespaces
SET 
tags = '{{ tags }}',
identity = '{{ identity }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.eventgrid.namespaces
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.eventgrid.namespaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventgrid.namespaces.list_shared_access_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventgrid.namespaces.regenerate_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.eventgrid.namespaces.validate_custom_domain_ownership 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
