...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="domain_topics" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.domain_topics" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Provisioning state of the domain topic. Known values are: "Creating", "Updating", "Deleting", "Succeeded", "Canceled", and "Failed". (Creating, Updating, Deleting, Succeeded, Canceled, Failed)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-domain_topic_name"><code>domain_topic_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a domain topic. Get properties of a domain topic.</td>
</tr>
<tr>
    ...
    <td>List domain topics. List all the topics in a domain.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-domain_topic_name"><code>domain_topic_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update a domain topic. Asynchronously creates or updates a new domain topic with the specified parameters.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-domain_topic_name"><code>domain_topic_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a domain topic. Delete existing domain topic.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-domain_topic_name">
    <td><CopyableCode code="domain_topic_name" /></td>
    <td><code>string</code></td>
...
systemData,
type
FROM azure.eventgrid.domain_topics
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND domain_name = '{{ domain_name }}' -- required
AND domain_topic_name = '{{ domain_topic_name }}' -- required
...
```sql
INSERT INTO azure.eventgrid.domain_topics (
resource_group_name,
domain_name,
domain_topic_name,
subscription_id
...
- name: domain_topics
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the domain_topics resource.
    - name: domain_name
      value: "{{ domain_name }}"
      description: Required parameter for the domain_topics resource.
    - name: domain_topic_name
      value: "{{ domain_topic_name }}"
      description: Required parameter for the domain_topics resource.
...
```sql
REPLACE azure.eventgrid.domain_topics
SET 
...
```sql
DELETE FROM azure.eventgrid.domain_topics
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND domain_name = '{{ domain_name }}' --required
AND domain_topic_name = '{{ domain_topic_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
