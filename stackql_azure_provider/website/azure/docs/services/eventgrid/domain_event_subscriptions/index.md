...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="domain_event_subscriptions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventgrid.domain_event_subscriptions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get an event subscription of a domain. Get properties of an event subscription of a domain.</td>
</tr>
<tr>
    ...
    <td>List all event subscriptions for a specific domain. List all event subscriptions that have been created for a specific topic.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update an event subscription to a domain. Asynchronously creates a new event subscription or updates an existing event subscription.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update an event subscription for a domain. Update an existing event subscription for a topic.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete an event subscription for a domain. Delete an existing event subscription for a domain.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get delivery attributes for an event subscription for domain. Get all delivery attributes for an event subscription for domain.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-event_subscription_name"><code>event_subscription_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get full URL of an event subscription for domain. Get the full endpoint URL for an event subscription for domain.</td>
</tr>
</tbody>
</table>
...
topic,
type
FROM azure.eventgrid.domain_event_subscriptions
...
```sql
INSERT INTO azure.eventgrid.domain_event_subscriptions (
properties,
resource_group_name,
domain_name,
...
```sql
UPDATE azure.eventgrid.domain_event_subscriptions
SET 
...
```sql
REPLACE azure.eventgrid.domain_event_subscriptions
SET 
...
```sql
DELETE FROM azure.eventgrid.domain_event_subscriptions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND domain_name = '{{ domain_name }}' --required
AND event_subscription_name = '{{ event_subscription_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.eventgrid.domain_event_subscriptions.get_delivery_attributes 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventgrid.domain_event_subscriptions.get_full_url 
@resource_group_name='{{ resource_group_name }}' --required, 
@domain_name='{{ domain_name }}' --required, 
@event_subscription_name='{{ event_subscription_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
