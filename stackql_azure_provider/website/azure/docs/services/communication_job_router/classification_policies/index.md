...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.communication_job_router.classification_policies" /></td></tr>
</tbody></table>
...
FROM azure.communication_job_router.classification_policies
...
```sql
DELETE FROM azure.communication_job_router.classification_policies
WHERE classification_policy_id = '{{ classification_policy_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
