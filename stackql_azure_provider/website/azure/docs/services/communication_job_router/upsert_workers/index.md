...
Creates, updates, deletes, gets or lists a <code>upsert_workers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="upsert_workers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.communication_job_router.upsert_workers" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#upsert_worker"><CopyableCode code="upsert_worker" /></a></td>
    ...
    <td>Creates or updates a worker. Creates or updates a worker.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="upsert_worker"
    values={[
        { label: 'upsert_worker', value: 'upsert_worker' }
    ]}
>
<TabItem value="upsert_worker">

Creates or updates a worker. Creates or updates a worker.

```sql
EXEC azure.communication_job_router.upsert_workers.upsert_worker 
