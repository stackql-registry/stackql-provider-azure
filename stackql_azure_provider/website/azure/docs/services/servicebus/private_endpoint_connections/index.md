...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicebus.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Provisioning state of the Private Endpoint Connection. Known values are: "Creating", "Updating", "Deleting", "Succeeded", "Canceled", and "Failed".</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets a description for the specified Private Endpoint Connection. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639379.aspx</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets the available PrivateEndpointConnections within a namespace. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639412.aspx</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-namespace_name"><code>namespace_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates PrivateEndpointConnections of service namespace. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639408.aspx</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-namespace_name"><code>namespace_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes an existing Private Endpoint Connection. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639389.aspx</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-private_endpoint_connection_name">
    ...
    <td><code>string</code></td>
    <td>The PrivateEndpointConnection name. Required.</td>
</tr>
...
Gets a description for the specified Private Endpoint Connection. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639379.aspx
...
systemData,
type
FROM azure.servicebus.private_endpoint_connections
...
```sql
INSERT INTO azure.servicebus.private_endpoint_connections (
properties,
resource_group_name,
namespace_name,
...
```sql
REPLACE azure.servicebus.private_endpoint_connections
SET 
...
Deletes an existing Private Endpoint Connection. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639389.aspx

```sql
DELETE FROM azure.servicebus.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
