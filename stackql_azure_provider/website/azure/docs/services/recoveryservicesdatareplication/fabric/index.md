...
Creates, updates, deletes, gets or lists a <code>fabric</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="fabric" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recoveryservicesdatareplication.fabric" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Fabric model custom properties. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="health" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the fabric health. Known values are: "Normal", "Warning", and "Critical". (Normal, Warning, Critical)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the provisioning state of the fabric. Known values are: "Canceled", "Creating", "Deleting", "Deleted", "Failed", "Succeeded", and "Updating". (Canceled, Creating, Deleting, Deleted, Failed, Succeeded, Updating)</td>
</tr>
<tr>
    <td><CopyableCode code="serviceEndpoint" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the service endpoint.</td>
</tr>
<tr>
    <td><CopyableCode code="serviceResourceId" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the service resource Id.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-fabric_name"><code>fabric_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
...
<tr id="parameter-continuationToken">
    ...
    <td><code>string</code></td>
    <td>Continuation token from the previous call. Default value is None.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.recoveryservicesdatareplication.fabric
...
```sql
INSERT INTO azure.recoveryservicesdatareplication.fabric (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.recoveryservicesdatareplication.fabric
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.recoveryservicesdatareplication.fabric
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND fabric_name = '{{ fabric_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
