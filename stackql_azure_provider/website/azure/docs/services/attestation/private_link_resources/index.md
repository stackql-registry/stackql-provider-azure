...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.attestation.private_link_resources" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_by_provider"
    values={[
        { label: 'list_by_provider', value: 'list_by_provider' }
    ]}
>
<TabItem value="list_by_provider">
...
<tbody>
<tr>
    <td><a href="#list_by_provider"><CopyableCode code="list_by_provider" /></a></td>
    ...
    <td></td>
    <td>Gets the private link resources supported for the attestation provider.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.attestation.private_link_resources
