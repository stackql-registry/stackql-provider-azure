...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.bot_service.private_link_resources" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_by_bot_resource"
    values={[
        { label: 'list_by_bot_resource', value: 'list_by_bot_resource' }
    ]}
>
<TabItem value="list_by_bot_resource">
...
<tbody>
<tr>
    <td><a href="#list_by_bot_resource"><CopyableCode code="list_by_bot_resource" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-resource_name"><code>resource_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the private link resources that need to be created for a Bot.</td>
</tr>
</tbody>
</table>
...
requiredZoneNames,
type
FROM azure.bot_service.private_link_resources
