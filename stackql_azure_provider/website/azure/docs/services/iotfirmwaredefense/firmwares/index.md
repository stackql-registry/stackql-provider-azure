...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iotfirmwaredefense.firmwares" /></td></tr>
</tbody></table>
...
vendor,
version
FROM azure.iotfirmwaredefense.firmwares
...
```sql
INSERT INTO azure.iotfirmwaredefense.firmwares (
properties,
resource_group_name,
workspace_name,
firmware_id,
...
```sql
UPDATE azure.iotfirmwaredefense.firmwares
SET 
...
```sql
DELETE FROM azure.iotfirmwaredefense.firmwares
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND firmware_id = '{{ firmware_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
