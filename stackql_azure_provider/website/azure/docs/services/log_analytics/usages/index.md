...
<tr>
    ...
    <td><code>number</code></td>
    <td>The quota limit for the metric.</td>
</tr>
<tr>
    <td><CopyableCode code="nextResetTime" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time that the metric's value will reset.</td>
</tr>
<tr>
    <td><CopyableCode code="quotaPeriod" /></td>
    <td><code>string</code></td>
    <td>The quota period that determines the length of time between value resets.</td>
</tr>
<tr>
    <td><CopyableCode code="unit" /></td>
    <td><code>string</code></td>
    <td>The units used for the metric.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Gets a list of usage metrics for a workspace.</td>
</tr>
</tbody>
</table>
