--- 
title: disable_job_schedules
hide_title: false
hide_table_of_contents: false
keywords:
  - disable_job_schedules
  - batch_dataplane
  - azure
...
Creates, updates, deletes, gets or lists a <code>disable_job_schedules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="disable_job_schedules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.disable_job_schedules" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#disable_job_schedule"><CopyableCode code="disable_job_schedule" /></a></td>
    ...
    <td>Disables a Job Schedule. No new Jobs will be created until the Job Schedule is enabled again.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-job_schedule_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the Job Schedule to disable. Required.</td>
</tr>
...
<Tabs
    defaultValue="disable_job_schedule"
    values={[
        { label: 'disable_job_schedule', value: 'disable_job_schedule' }
    ]}
>
<TabItem value="disable_job_schedule">

Disables a Job Schedule. No new Jobs will be created until the Job Schedule is enabled again.

```sql
EXEC azure.batch_dataplane.disable_job_schedules.disable_job_schedule 
