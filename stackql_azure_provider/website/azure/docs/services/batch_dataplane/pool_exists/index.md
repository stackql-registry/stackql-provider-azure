...
Creates, updates, deletes, gets or lists a <code>pool_exists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pool_exists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.pool_exists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#pool_exists"><CopyableCode code="pool_exists" /></a></td>
    ...
    <td>Gets basic properties of a Pool.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="pool_exists"
    values={[
        { label: 'pool_exists', value: 'pool_exists' }
    ]}
>
<TabItem value="pool_exists">

Gets basic properties of a Pool.

```sql
EXEC azure.batch_dataplane.pool_exists.pool_exists 
