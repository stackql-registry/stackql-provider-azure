...
Creates, updates, deletes, gets or lists a <code>replace_tasks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="replace_tasks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.replace_tasks" /></td></tr>
</tbody></table>
...
<tr id="parameter-task_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the Task to update. Required.</td>
</tr>
...
<Tabs
    ...
    values={[
        { label: 'replace_task', value: 'replace_task' }
    ]}
>
<TabItem value="replace_task">
