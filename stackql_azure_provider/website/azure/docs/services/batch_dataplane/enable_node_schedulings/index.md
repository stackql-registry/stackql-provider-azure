--- 
title: enable_node_schedulings
hide_title: false
hide_table_of_contents: false
keywords:
  - enable_node_schedulings
  - batch_dataplane
  - azure
...
Creates, updates, deletes, gets or lists an <code>enable_node_schedulings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="enable_node_schedulings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.enable_node_schedulings" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#enable_node_scheduling"><CopyableCode code="enable_node_scheduling" /></a></td>
    ...
    <td>Enables Task scheduling on the specified Compute Node. You can enable Task scheduling on a Compute Node only if its current scheduling state is disabled.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-node_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the Compute Node on which you want to enable Task scheduling. Required.</td>
</tr>
...
<Tabs
    defaultValue="enable_node_scheduling"
    values={[
        { label: 'enable_node_scheduling', value: 'enable_node_scheduling' }
    ]}
>
<TabItem value="enable_node_scheduling">
...
```sql
EXEC azure.batch_dataplane.enable_node_schedulings.enable_node_scheduling 
