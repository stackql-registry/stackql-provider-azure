--- 
title: enable_job_schedules
hide_title: false
hide_table_of_contents: false
keywords:
  - enable_job_schedules
  - batch_dataplane
  - azure
...
Creates, updates, deletes, gets or lists an <code>enable_job_schedules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="enable_job_schedules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.enable_job_schedules" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#enable_job_schedule"><CopyableCode code="enable_job_schedule" /></a></td>
    ...
    <td>Enables a Job Schedule. Enables a Job Schedule.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-job_schedule_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the Job Schedule to enable. Required.</td>
</tr>
...
<Tabs
    defaultValue="enable_job_schedule"
    values={[
        { label: 'enable_job_schedule', value: 'enable_job_schedule' }
    ]}
>
<TabItem value="enable_job_schedule">

Enables a Job Schedule. Enables a Job Schedule.

```sql
EXEC azure.batch_dataplane.enable_job_schedules.enable_job_schedule 
