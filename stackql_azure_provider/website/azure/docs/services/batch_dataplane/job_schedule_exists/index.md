...
Creates, updates, deletes, gets or lists a <code>job_schedule_exists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="job_schedule_exists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.batch_dataplane.job_schedule_exists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#job_schedule_exists"><CopyableCode code="job_schedule_exists" /></a></td>
    ...
    <td>Checks the specified Job Schedule exists. Checks the specified Job Schedule exists.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-job_schedule_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the Job Schedule which you want to check. Required.</td>
</tr>
...
<Tabs
    defaultValue="job_schedule_exists"
    values={[
        { label: 'job_schedule_exists', value: 'job_schedule_exists' }
    ]}
>
<TabItem value="job_schedule_exists">

Checks the specified Job Schedule exists. Checks the specified Job Schedule exists.

```sql
EXEC azure.batch_dataplane.job_schedule_exists.job_schedule_exists 
