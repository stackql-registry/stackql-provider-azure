...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.scvmm.guest_agents" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets the guest agent status.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets a unique identifier for this resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_uri"><code>resource_uri</code></a></td>
    <td></td>
    <td>Deletes a GuestAgent resource. Implements GuestAgent DELETE method.</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.scvmm.guest_agents (
properties,
resource_uri
)
SELECT 
...
```sql
DELETE FROM azure.scvmm.guest_agents
WHERE resource_uri = '{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.scvmm.guest_agents.list_by_virtual_machine_instance 
