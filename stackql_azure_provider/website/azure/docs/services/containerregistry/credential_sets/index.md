...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="credential_sets" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerregistry.credential_sets" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="authCredentials" /></td>
    <td><code>array</code></td>
    <td>List of authentication credentials stored for an upstream. Usually consists of a primary and an optional secondary credential.</td>
</tr>
<tr>
    <td><CopyableCode code="creationDate" /></td>
    <td><code>string (date-time)</code></td>
    <td>The creation date of credential store resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The credentials are stored for this upstream or login server.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-registry_name"><code>registry_name</code></a>, <a href="#parameter-credential_set_name"><code>credential_set_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-credential_set_name">
    <td><CopyableCode code="credential_set_name" /></td>
    <td><code>string</code></td>
    <td>The name of the credential set. Required.</td>
</tr>
...
systemData,
type
FROM azure.containerregistry.credential_sets
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND registry_name = '{{ registry_name }}' -- required
AND credential_set_name = '{{ credential_set_name }}' -- required
...
```sql
INSERT INTO azure.containerregistry.credential_sets (
properties,
identity,
resource_group_name,
registry_name,
...
```sql
UPDATE azure.containerregistry.credential_sets
SET 
...
```sql
DELETE FROM azure.containerregistry.credential_sets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND registry_name = '{{ registry_name }}' --required
AND credential_set_name = '{{ credential_set_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
