...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.secretsstoreextension.azure_key_vault_secret_provider_classes" /></td></tr>
</tbody></table>
...
tenantId,
type
FROM azure.secretsstoreextension.azure_key_vault_secret_provider_classes
...
```sql
INSERT INTO azure.secretsstoreextension.azure_key_vault_secret_provider_classes (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.secretsstoreextension.azure_key_vault_secret_provider_classes
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.secretsstoreextension.azure_key_vault_secret_provider_classes
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.secretsstoreextension.azure_key_vault_secret_provider_classes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND azure_key_vault_secret_provider_class_name = '{{ azure_key_vault_secret_provider_class_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
