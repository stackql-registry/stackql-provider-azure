...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.secretsstoreextension.secret_syncs" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.secretsstoreextension.secret_syncs
...
```sql
INSERT INTO azure.secretsstoreextension.secret_syncs (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.secretsstoreextension.secret_syncs
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.secretsstoreextension.secret_syncs
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.secretsstoreextension.secret_syncs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND secret_sync_name = '{{ secret_sync_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
