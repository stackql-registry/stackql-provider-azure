--- 
title: services_event_lists
hide_title: false
hide_table_of_contents: false
keywords:
  - services_event_lists
...
Creates, updates, deletes, gets or lists a <code>services_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="services_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.services_event_lists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#get_services_event_list"><CopyableCode code="get_services_event_list" /></a></td>
    ...
    <td>Gets all Services-related events. The response is list of ServiceEvent objects.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="get_services_event_list"
    values={[
        { label: 'get_services_event_list', value: 'get_services_event_list' }
    ]}
>
<TabItem value="get_services_event_list">

Gets all Services-related events. The response is list of ServiceEvent objects.

```sql
EXEC azure.service_fabric_dataplane.services_event_lists.get_services_event_list 
