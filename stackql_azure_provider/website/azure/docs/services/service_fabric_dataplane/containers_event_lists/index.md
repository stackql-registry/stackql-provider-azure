--- 
title: containers_event_lists
hide_title: false
hide_table_of_contents: false
keywords:
  - containers_event_lists
...
Creates, updates, deletes, gets or lists a <code>containers_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="containers_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.containers_event_lists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#get_containers_event_list"><CopyableCode code="get_containers_event_list" /></a></td>
    ...
    <td>Gets all Containers-related events. The response is list of ContainerInstanceEvent objects.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="get_containers_event_list"
    values={[
        { label: 'get_containers_event_list', value: 'get_containers_event_list' }
    ]}
>
<TabItem value="get_containers_event_list">

Gets all Containers-related events. The response is list of ContainerInstanceEvent objects.

```sql
EXEC azure.service_fabric_dataplane.containers_event_lists.get_containers_event_list 
