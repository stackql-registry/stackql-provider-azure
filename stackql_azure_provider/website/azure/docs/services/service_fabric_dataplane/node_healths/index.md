...
Creates, updates, deletes, gets or lists a <code>node_healths</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="node_healths" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.node_healths" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_node_health"
    values={[
        { label: 'get_node_health', value: 'get_node_health' }
    ]}
>
<TabItem value="get_node_health">
...
<tbody>
<tr>
    <td><a href="#get_node_health"><CopyableCode code="get_node_health" /></a></td>
    ...
    <td>Gets the health of a Service Fabric node. Gets the health of a Service Fabric node. Use EventsHealthStateFilter to filter the collection of health events reported on the node based on the health state. If the node that you specify by name does not exist in the health store, this returns an error.</td>
</tr>
</tbody>
</table>
...
Gets the health of a Service Fabric node. Gets the health of a Service Fabric node. Use EventsHealthStateFilter to filter the collection of health events reported on the node based on the health state. If the node that you specify by name does not exist in the health store, this returns an error.
...
FROM azure.service_fabric_dataplane.node_healths
