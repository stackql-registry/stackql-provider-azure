...
Creates, updates, deletes, gets or lists a <code>cluster_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cluster_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.cluster_event_lists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#get_cluster_event_list"><CopyableCode code="get_cluster_event_list" /></a></td>
    ...
    <td>Gets all Cluster-related events. The response is list of ClusterEvent objects.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="get_cluster_event_list"
    values={[
        { label: 'get_cluster_event_list', value: 'get_cluster_event_list' }
    ]}
>
<TabItem value="get_cluster_event_list">

Gets all Cluster-related events. The response is list of ClusterEvent objects.

```sql
EXEC azure.service_fabric_dataplane.cluster_event_lists.get_cluster_event_list 
