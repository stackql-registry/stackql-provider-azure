...
Creates, updates, deletes, gets or lists a <code>nodes_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="nodes_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.nodes_event_lists" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#get_nodes_event_list"><CopyableCode code="get_nodes_event_list" /></a></td>
    ...
    <td>Gets all Nodes-related Events. The response is list of NodeEvent objects.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="get_nodes_event_list"
    values={[
        { label: 'get_nodes_event_list', value: 'get_nodes_event_list' }
    ]}
>
<TabItem value="get_nodes_event_list">

Gets all Nodes-related Events. The response is list of NodeEvent objects.

```sql
EXEC azure.service_fabric_dataplane.nodes_event_lists.get_nodes_event_list 
