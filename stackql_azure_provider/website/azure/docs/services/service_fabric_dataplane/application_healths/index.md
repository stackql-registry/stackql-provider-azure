...
Creates, updates, deletes, gets or lists an <code>application_healths</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="application_healths" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.application_healths" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_application_health"
    values={[
        { label: 'get_application_health', value: 'get_application_health' }
    ]}
>
<TabItem value="get_application_health">
...
<tbody>
<tr>
    <td><a href="#get_application_health"><CopyableCode code="get_application_health" /></a></td>
    ...
    <td>Gets the health of the service fabric application. Returns the heath state of the service fabric application. The response reports either Ok, Error or Warning health state. If the entity is not found in the health store, it will return Error.</td>
</tr>
</tbody>
</table>
...
Gets the health of the service fabric application. Returns the heath state of the service fabric application. The response reports either Ok, Error or Warning health state. If the entity is not found in the health store, it will return Error.
...
FROM azure.service_fabric_dataplane.application_healths
