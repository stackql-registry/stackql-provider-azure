...
Creates, updates, deletes, gets or lists a <code>data_loss_progress</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="data_loss_progress" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.data_loss_progress" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_data_loss_progress"
    values={[
        { label: 'get_data_loss_progress', value: 'get_data_loss_progress' }
    ]}
>
<TabItem value="get_data_loss_progress">
...
<tbody>
<tr>
    <td><CopyableCode code="InvokeDataLossResult" /></td>
...
<tbody>
<tr>
    <td><a href="#get_data_loss_progress"><CopyableCode code="get_data_loss_progress" /></a></td>
    ...
    <td>Gets the progress of a partition data loss operation started using the StartDataLoss API. Gets the progress of a data loss operation started with StartDataLoss, using the OperationId.</td>
</tr>
</tbody>
</table>
...
State
FROM azure.service_fabric_dataplane.data_loss_progress
