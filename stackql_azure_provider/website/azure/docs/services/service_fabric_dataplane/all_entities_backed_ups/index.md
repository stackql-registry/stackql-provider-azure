--- 
title: all_entities_backed_ups
hide_title: false
hide_table_of_contents: false
keywords:
  - all_entities_backed_ups
...
Creates, updates, deletes, gets or lists an <code>all_entities_backed_ups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="all_entities_backed_ups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.all_entities_backed_ups" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_all_entities_backed_up_by_policy"
    values={[
        { label: 'get_all_entities_backed_up_by_policy', value: 'get_all_entities_backed_up_by_policy' }
    ]}
>
<TabItem value="get_all_entities_backed_up_by_policy">
...
<tbody>
<tr>
    <td><a href="#get_all_entities_backed_up_by_policy"><CopyableCode code="get_all_entities_backed_up_by_policy" /></a></td>
    ...
    <td>Gets the list of backup entities that are associated with this policy. Returns a list of Service Fabric application, service or partition which are associated with this backup policy.</td>
</tr>
</tbody>
</table>
...
Gets the list of backup entities that are associated with this policy. Returns a list of Service Fabric application, service or partition which are associated with this backup policy.

```sql
SELECT
ContinuationToken,
Items
FROM azure.service_fabric_dataplane.all_entities_backed_ups
