...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.partition_loads" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.service_fabric_dataplane.partition_loads.update_partition_load 
