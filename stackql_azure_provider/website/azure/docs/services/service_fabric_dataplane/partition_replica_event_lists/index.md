--- 
title: partition_replica_event_lists
hide_title: false
hide_table_of_contents: false
keywords:
  - partition_replica_event_lists
...
Creates, updates, deletes, gets or lists a <code>partition_replica_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="partition_replica_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.partition_replica_event_lists" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_partition_replica_event_list"
    values={[
        { label: 'get_partition_replica_event_list', value: 'get_partition_replica_event_list' }
    ]}
>
<TabItem value="get_partition_replica_event_list">

Gets a Partition Replica-related events. The response is list of ReplicaEvent objects.

```sql
EXEC azure.service_fabric_dataplane.partition_replica_event_lists.get_partition_replica_event_list 
