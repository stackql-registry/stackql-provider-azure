...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.services" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.service_fabric_dataplane.services (
ApplicationName,
ServiceName,
ServiceTypeName,
InitializationData,
...
```sql
DELETE FROM azure.service_fabric_dataplane.services
...
```sql
EXEC azure.service_fabric_dataplane.services.update_service 
