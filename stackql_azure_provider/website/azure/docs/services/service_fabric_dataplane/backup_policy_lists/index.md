...
Creates, updates, deletes, gets or lists a <code>backup_policy_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="backup_policy_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_fabric_dataplane.backup_policy_lists" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_backup_policy_list"
    values={[
        { label: 'get_backup_policy_list', value: 'get_backup_policy_list' }
    ]}
>
<TabItem value="get_backup_policy_list">
...
<tbody>
<tr>
    <td><a href="#get_backup_policy_list"><CopyableCode code="get_backup_policy_list" /></a></td>
    ...
    <td>Gets all the backup policies configured. Get a list of all the backup policies configured.</td>
</tr>
</tbody>
</table>
...
Gets all the backup policies configured. Get a list of all the backup policies configured.

```sql
SELECT
ContinuationToken,
Items
FROM azure.service_fabric_dataplane.backup_policy_lists
