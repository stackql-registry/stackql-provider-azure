...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventhub.clusters" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.eventhub.clusters (
location,
tags,
sku,
properties,
...
```sql
UPDATE azure.eventhub.clusters
SET 
location = '{{ location }}',
tags = '{{ tags }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.eventhub.clusters
SET 
location = '{{ location }}',
tags = '{{ tags }}',
sku = '{{ sku }}',
...
```sql
DELETE FROM azure.eventhub.clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventhub.clusters.list_available_cluster_region 
...
```sql
EXEC azure.eventhub.clusters.list_namespaces 
@resource_group_name='{{ resource_group_name }}' --required, 
