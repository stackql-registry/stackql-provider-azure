...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventhub.namespaces" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.eventhub.namespaces
...
```sql
UPDATE azure.eventhub.namespaces
SET 
location = '{{ location }}',
tags = '{{ tags }}',
sku = '{{ sku }}',
...
```sql
EXEC azure.eventhub.namespaces.list_network_rule_set 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.eventhub.namespaces.list_authorization_rules 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventhub.namespaces.list_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
...
```sql
EXEC azure.eventhub.namespaces.get_network_rule_set 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.eventhub.namespaces.create_or_update_network_rule_set 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.eventhub.namespaces.regenerate_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@authorization_rule_name='{{ authorization_rule_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.eventhub.namespaces.check_name_availability 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
"name": "{{ name }}"
