...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventhub.network_security_perimeter_configurations" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.eventhub.network_security_perimeter_configurations (
resource_group_name,
namespace_name,
...
```sql
REPLACE azure.eventhub.network_security_perimeter_configurations
SET 
