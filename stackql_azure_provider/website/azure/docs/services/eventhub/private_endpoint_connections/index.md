...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.eventhub.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets a description for the specified Private Endpoint Connection name. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639379.aspx</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-namespace_name"><code>namespace_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes a Private Endpoint Connection. .. seealso:: - https://msdn.microsoft.com/en-us/library/azure/mt639389.aspx</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.eventhub.private_endpoint_connections
...
```sql
INSERT INTO azure.eventhub.private_endpoint_connections (
properties,
resource_group_name,
namespace_name,
...
```sql
REPLACE azure.eventhub.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.eventhub.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
