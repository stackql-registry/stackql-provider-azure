...
Creates, updates, deletes, gets or lists an <code>api_operation</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_operation" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_operation" /></td></tr>
</tbody></table>
...
type,
urlTemplate
FROM azure.apimanagement.api_operation
...
```sql
INSERT INTO azure.apimanagement.api_operation (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
UPDATE azure.apimanagement.api_operation
SET 
...
```sql
REPLACE azure.apimanagement.api_operation
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.api_operation
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND operation_id = '{{ operation_id }}' --required
...
```sql
EXEC azure.apimanagement.api_operation.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
