...
Creates, updates, deletes, gets or lists a <code>gateway_api</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="gateway_api" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.gateway_api" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-gateway_id"><code>gateway_id</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-gateway_id"><code>gateway_id</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Checks that API entity specified by identifier is associated with the Gateway entity.</td>
</tr>
</tbody>
</table>
...
termsOfServiceUrl,
type
FROM azure.apimanagement.gateway_api
...
```sql
INSERT INTO azure.apimanagement.gateway_api (
properties,
resource_group_name,
service_name,
gateway_id,
...
```sql
REPLACE azure.apimanagement.gateway_api
SET 
...
```sql
DELETE FROM azure.apimanagement.gateway_api
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND gateway_id = '{{ gateway_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.apimanagement.gateway_api.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
