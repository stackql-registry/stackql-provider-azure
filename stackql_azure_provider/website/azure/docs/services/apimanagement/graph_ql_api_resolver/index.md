...
Creates, updates, deletes, gets or lists a <code>graph_ql_api_resolver</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="graph_ql_api_resolver" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.graph_ql_api_resolver" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Description of the resolver. May include HTML formatting tags.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Path is type/field being resolved.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates a new resolver in the GraphQL API or updates an existing one.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the GraphQL API resolver specified by its identifier.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.apimanagement.graph_ql_api_resolver
...
```sql
INSERT INTO azure.apimanagement.graph_ql_api_resolver (
properties,
resource_group_name,
service_name,
api_id,
...
- name: graph_ql_api_resolver
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the graph_ql_api_resolver resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the graph_ql_api_resolver resource.
    - name: api_id
...
```sql
UPDATE azure.apimanagement.graph_ql_api_resolver
SET 
...
```sql
REPLACE azure.apimanagement.graph_ql_api_resolver
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.graph_ql_api_resolver
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND resolver_id = '{{ resolver_id }}' --required
...
```sql
EXEC azure.apimanagement.graph_ql_api_resolver.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
