...
Creates, updates, deletes, gets or lists a <code>policy_restriction</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="policy_restriction" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.policy_restriction" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="requireBase" /></td>
    <td><code>string</code></td>
    <td>Indicates if base policy should be enforced for the policy document. Known values are: "true" and "false". (true, false)</td>
</tr>
<tr>
    <td><CopyableCode code="scope" /></td>
    <td><code>string</code></td>
    <td>Path to the policy document.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-policy_restriction_id"><code>policy_restriction_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-policy_restriction_id"><code>policy_restriction_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the policy restriction in the Api Management service.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-policy_restriction_id">
    <td><CopyableCode code="policy_restriction_id" /></td>
    <td><code>string</code></td>
    <td>Policy restrictions after an entity level. Required.</td>
</tr>
...
systemData,
type
FROM azure.apimanagement.policy_restriction
...
```sql
INSERT INTO azure.apimanagement.policy_restriction (
properties,
resource_group_name,
service_name,
...
```sql
UPDATE azure.apimanagement.policy_restriction
SET 
...
```sql
REPLACE azure.apimanagement.policy_restriction
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.policy_restriction
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND policy_restriction_id = '{{ policy_restriction_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.policy_restriction.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
