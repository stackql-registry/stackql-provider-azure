...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_policy" /></td></tr>
</tbody></table>
...
type,
value
FROM azure.apimanagement.api_policy
...
```sql
INSERT INTO azure.apimanagement.api_policy (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
REPLACE azure.apimanagement.api_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.api_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND policy_id = '{{ policy_id }}' --required
...
```sql
EXEC azure.apimanagement.api_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
