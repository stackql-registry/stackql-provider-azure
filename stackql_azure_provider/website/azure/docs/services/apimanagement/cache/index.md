...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.cache" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Runtime connection string to cache. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Original uri of entity in external system cache points to.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="useFromLocation" /></td>
    <td><code>string</code></td>
    <td>Location identifier to use cache from (should be either 'default' or valid Azure region identifier). Required.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-cache_id"><code>cache_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-cache_id"><code>cache_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the Cache specified by its identifier.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-cache_id">
    ...
    <td><code>string</code></td>
    <td>Identifier of the Cache entity. Cache identifier (should be either 'default' or valid Azure region identifier). Required.</td>
</tr>
...
type,
useFromLocation
FROM azure.apimanagement.cache
...
```sql
INSERT INTO azure.apimanagement.cache (
properties,
resource_group_name,
service_name,
cache_id,
...
```sql
UPDATE azure.apimanagement.cache
SET 
...
```sql
REPLACE azure.apimanagement.cache
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.cache
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND cache_id = '{{ cache_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.cache.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
