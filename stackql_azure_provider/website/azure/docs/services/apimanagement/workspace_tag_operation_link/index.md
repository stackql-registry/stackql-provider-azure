...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_tag_operation_link" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.workspace_tag_operation_link
...
```sql
INSERT INTO azure.apimanagement.workspace_tag_operation_link (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
REPLACE azure.apimanagement.workspace_tag_operation_link
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_tag_operation_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND tag_id = '{{ tag_id }}' --required
