...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.certificate" /></td></tr>
</tbody></table>
...
thumbprint,
type
FROM azure.apimanagement.certificate
...
```sql
INSERT INTO azure.apimanagement.certificate (
properties,
resource_group_name,
service_name,
certificate_id,
...
```sql
REPLACE azure.apimanagement.certificate
SET 
...
```sql
DELETE FROM azure.apimanagement.certificate
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND certificate_id = '{{ certificate_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.certificate.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.certificate.refresh_secret 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@certificate_id='{{ certificate_id }}' --required, 
@subscription_id='{{ subscription_id }}' --required
