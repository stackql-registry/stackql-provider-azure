...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.quota_by_period_keys" /></td></tr>
</tbody></table>
...
periodStartTime,
value
FROM azure.apimanagement.quota_by_period_keys
...
```sql
UPDATE azure.apimanagement.quota_by_period_keys
SET 
