...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_release" /></td></tr>
</tbody></table>
...
type,
updatedDateTime
FROM azure.apimanagement.api_release
...
```sql
INSERT INTO azure.apimanagement.api_release (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
UPDATE azure.apimanagement.api_release
SET 
...
```sql
REPLACE azure.apimanagement.api_release
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.api_release
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND release_id = '{{ release_id }}' --required
...
```sql
EXEC azure.apimanagement.api_release.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
