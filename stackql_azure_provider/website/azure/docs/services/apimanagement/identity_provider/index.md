...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.identity_provider" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.identity_provider
...
```sql
INSERT INTO azure.apimanagement.identity_provider (
properties,
resource_group_name,
service_name,
...
```sql
UPDATE azure.apimanagement.identity_provider
SET 
...
```sql
REPLACE azure.apimanagement.identity_provider
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.identity_provider
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND identity_provider_name = '{{ identity_provider_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.identity_provider.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.identity_provider.list_secrets 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@identity_provider_name='{{ identity_provider_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
