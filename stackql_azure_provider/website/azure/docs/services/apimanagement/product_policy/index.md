...
Creates, updates, deletes, gets or lists a <code>product_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="product_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.product_policy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-product_id"><code>product_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
type,
value
FROM azure.apimanagement.product_policy
...
```sql
INSERT INTO azure.apimanagement.product_policy (
properties,
resource_group_name,
service_name,
product_id,
...
- name: product_policy
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the product_policy resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the product_policy resource.
    - name: product_id
...
```sql
REPLACE azure.apimanagement.product_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.product_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND product_id = '{{ product_id }}' --required
AND policy_id = '{{ policy_id }}' --required
...
```sql
EXEC azure.apimanagement.product_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
