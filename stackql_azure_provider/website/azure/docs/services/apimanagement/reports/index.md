...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.reports" /></td></tr>
</tbody></table>
...
userId,
zip
FROM azure.apimanagement.reports
...
```sql
EXEC azure.apimanagement.reports.list_by_user 
...
```sql
EXEC azure.apimanagement.reports.list_by_operation 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}' --required, 
...
```sql
EXEC azure.apimanagement.reports.list_by_product 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}' --required, 
...
```sql
EXEC azure.apimanagement.reports.list_by_geo 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}' --required, 
...
```sql
EXEC azure.apimanagement.reports.list_by_subscription 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}' --required, 
...
```sql
EXEC azure.apimanagement.reports.list_by_request 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}' --required, 
