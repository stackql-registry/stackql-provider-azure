...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_api" /></td></tr>
</tbody></table>
...
termsOfServiceUrl,
type
FROM azure.apimanagement.workspace_api
...
```sql
INSERT INTO azure.apimanagement.workspace_api (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.apimanagement.workspace_api
SET 
...
```sql
REPLACE azure.apimanagement.workspace_api
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.workspace_api
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_api.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
