...
Creates, updates, deletes, gets or lists an <code>authorization_access_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="authorization_access_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.authorization_access_policy" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="appIds" /></td>
    <td><code>array</code></td>
    <td>The allowed Azure Active Directory Application IDs.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-authorization_provider_id"><code>authorization_provider_id</code></a>, <a href="#parameter-authorization_id"><code>authorization_id</code></a>, <a href="#parameter-authorization_access_policy_id"><code>authorization_access_policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-authorization_access_policy_id">
    <td><CopyableCode code="authorization_access_policy_id" /></td>
    <td><code>string</code></td>
    <td>Identifier of the authorization access policy. Required.</td>
</tr>
...
tenantId,
type
FROM azure.apimanagement.authorization_access_policy
...
AND authorization_access_policy_id = '{{ authorization_access_policy_id }}' -- required
...
```sql
INSERT INTO azure.apimanagement.authorization_access_policy (
properties,
resource_group_name,
service_name,
...
- name: authorization_access_policy
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the authorization_access_policy resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the authorization_access_policy resource.
    ...
    - name: authorization_access_policy_id
      value: "{{ authorization_access_policy_id }}"
      description: Required parameter for the authorization_access_policy resource.
...
```sql
REPLACE azure.apimanagement.authorization_access_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.authorization_access_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND authorization_provider_id = '{{ authorization_provider_id }}' --required
AND authorization_id = '{{ authorization_id }}' --required
