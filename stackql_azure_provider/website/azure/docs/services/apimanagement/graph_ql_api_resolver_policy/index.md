...
Creates, updates, deletes, gets or lists a <code>graph_ql_api_resolver_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="graph_ql_api_resolver_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.graph_ql_api_resolver_policy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates policy configuration for the GraphQL API Resolver level.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-resolver_id"><code>resolver_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the GraphQL API resolver policy specified by its identifier.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resolver_id">
    <td><CopyableCode code="resolver_id" /></td>
    <td><code>string</code></td>
    <td>Resolver identifier within a GraphQL API. Must be unique in the current API Management service instance. Required.</td>
</tr>
...
type,
value
FROM azure.apimanagement.graph_ql_api_resolver_policy
...
```sql
INSERT INTO azure.apimanagement.graph_ql_api_resolver_policy (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
REPLACE azure.apimanagement.graph_ql_api_resolver_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.graph_ql_api_resolver_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND resolver_id = '{{ resolver_id }}' --required
...
```sql
EXEC azure.apimanagement.graph_ql_api_resolver_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
