...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.portal_revision" /></td></tr>
</tbody></table>
...
type,
updatedDateTime
FROM azure.apimanagement.portal_revision
...
```sql
INSERT INTO azure.apimanagement.portal_revision (
properties,
resource_group_name,
service_name,
portal_revision_id,
...
```sql
UPDATE azure.apimanagement.portal_revision
SET 
...
```sql
REPLACE azure.apimanagement.portal_revision
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
EXEC azure.apimanagement.portal_revision.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
