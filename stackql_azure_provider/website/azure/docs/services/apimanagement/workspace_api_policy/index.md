...
Creates, updates, deletes, gets or lists a <code>workspace_api_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_api_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_api_policy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-workspace_id"><code>workspace_id</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
type,
value
FROM azure.apimanagement.workspace_api_policy
...
```sql
INSERT INTO azure.apimanagement.workspace_api_policy (
properties,
resource_group_name,
service_name,
workspace_id,
...
- name: workspace_api_policy
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the workspace_api_policy resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the workspace_api_policy resource.
    - name: workspace_id
...
```sql
REPLACE azure.apimanagement.workspace_api_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_api_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_api_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
