...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.private_endpoint_connection" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-private_link_sub_resource_name"><code>private_link_sub_resource_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr id="parameter-private_link_sub_resource_name">
    <td><CopyableCode code="private_link_sub_resource_name" /></td>
    <td><code>string</code></td>
...
systemData,
type
FROM azure.apimanagement.private_endpoint_connection
...
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND service_name = '{{ service_name }}' -- required
AND private_link_sub_resource_name = '{{ private_link_sub_resource_name }}' -- required
AND subscription_id = '{{ subscription_id }}' -- required
;
```
</TabItem>
...
```sql
INSERT INTO azure.apimanagement.private_endpoint_connection (
id,
properties,
resource_group_name,
service_name,
...
- name: private_endpoint_connection
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the private_endpoint_connection resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the private_endpoint_connection resource.
...
```sql
REPLACE azure.apimanagement.private_endpoint_connection
SET 
id = '{{ id }}',
...
```sql
DELETE FROM azure.apimanagement.private_endpoint_connection
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
<Tabs
    defaultValue="list_private_link_resources"
    values={[
...
```sql
EXEC azure.apimanagement.private_endpoint_connection.list_private_link_resources 
@resource_group_name='{{ resource_group_name }}' --required, 
