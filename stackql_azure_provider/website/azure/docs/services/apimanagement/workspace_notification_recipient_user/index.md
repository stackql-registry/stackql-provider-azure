...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_notification_recipient_user" /></td></tr>
</tbody></table>
...
type,
userId
FROM azure.apimanagement.workspace_notification_recipient_user
...
```sql
INSERT INTO azure.apimanagement.workspace_notification_recipient_user (
resource_group_name,
service_name,
workspace_id,
notification_name,
...
```sql
REPLACE azure.apimanagement.workspace_notification_recipient_user
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_notification_recipient_user
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND notification_name = '{{ notification_name }}' --required
...
```sql
EXEC azure.apimanagement.workspace_notification_recipient_user.check_entity_exists 
@resource_group_name='{{ resource_group_name }}' --required, 
