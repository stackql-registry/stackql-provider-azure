...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.subscription" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.subscription
...
```sql
INSERT INTO azure.apimanagement.subscription (
properties,
resource_group_name,
service_name,
sid,
...
```sql
UPDATE azure.apimanagement.subscription
SET 
...
```sql
REPLACE azure.apimanagement.subscription
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.subscription
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND sid = '{{ sid }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.subscription.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.subscription.list_secrets 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@sid='{{ sid }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.subscription.regenerate_primary_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@sid='{{ sid }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.subscription.regenerate_secondary_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@sid='{{ sid }}' --required, 
@subscription_id='{{ subscription_id }}' --required
