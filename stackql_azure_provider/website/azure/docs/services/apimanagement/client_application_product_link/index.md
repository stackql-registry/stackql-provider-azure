--- 
title: client_application_product_link
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>client_application_product_link</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="client_application_product_link" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.client_application_product_link" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_client_applications', value: 'list_by_client_applications' }
    ]}
>
<TabItem value="get">
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The unique resource identifier of the Product. Required.</td>
</tr>
<tr>
...
<TabItem value="list_by_client_applications">
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-client_application_id"><code>client_application_id</code></a>, <a href="#parameter-client_application_product_link_id"><code>client_application_product_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the product link for the client application.</td>
</tr>
<tr>
    <td><a href="#list_by_client_applications"><CopyableCode code="list_by_client_applications" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>Lists a collection of product links associated with the specified client application.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-client_application_id"><code>client_application_id</code></a>, <a href="#parameter-client_application_product_link_id"><code>client_application_product_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Adds an Product to the specified Client Application via link.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-client_application_id"><code>client_application_id</code></a>, <a href="#parameter-client_application_product_link_id"><code>client_application_product_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes the specified Product from the specified client application.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-client_application_product_link_id">
    <td><CopyableCode code="client_application_product_link_id" /></td>
    <td><code>string</code></td>
    <td>Client Application Product Link identifier. Must be unique in the current API Management service instance. Required.</td>
</tr>
...
systemData,
type
FROM azure.apimanagement.client_application_product_link
...
```sql
INSERT INTO azure.apimanagement.client_application_product_link (
properties,
resource_group_name,
service_name,
...
```sql
DELETE FROM azure.apimanagement.client_application_product_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND client_application_id = '{{ client_application_id }}' --required
AND client_application_product_link_id = '{{ client_application_product_link_id }}' --required
