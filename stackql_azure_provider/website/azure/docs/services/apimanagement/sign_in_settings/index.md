...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.sign_in_settings" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.sign_in_settings
...
```sql
INSERT INTO azure.apimanagement.sign_in_settings (
properties,
resource_group_name,
service_name,
subscription_id
...
```sql
UPDATE azure.apimanagement.sign_in_settings
SET 
...
```sql
REPLACE azure.apimanagement.sign_in_settings
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
EXEC azure.apimanagement.sign_in_settings.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
