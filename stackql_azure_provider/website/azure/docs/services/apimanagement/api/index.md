...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.apimanagement.api (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
UPDATE azure.apimanagement.api
SET 
...
```sql
REPLACE azure.apimanagement.api
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.api
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.api.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.api.list_by_tags 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}', 
