...
Creates, updates, deletes, gets or lists an <code>api_issue_comment</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_issue_comment" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_issue_comment" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A resource identifier for the user who left the comment. Required.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-issue_id"><code>issue_id</code></a>, <a href="#parameter-comment_id"><code>comment_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the details of the issue Comment for an API specified by its identifier.</td>
</tr>
<tr>
    ...
    <td>Lists all comments for the Issue associated with the specified API.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-issue_id"><code>issue_id</code></a>, <a href="#parameter-comment_id"><code>comment_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates a new Comment for the Issue in an API or updates an existing one.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-issue_id"><code>issue_id</code></a>, <a href="#parameter-comment_id"><code>comment_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the issue Comment for an API specified by its identifier.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-comment_id">
    ...
    <td><code>string</code></td>
    <td>Comment identifier within an Issue. Must be unique in the current Issue. Required.</td>
</tr>
...
type,
userId
FROM azure.apimanagement.api_issue_comment
...
```sql
INSERT INTO azure.apimanagement.api_issue_comment (
properties,
resource_group_name,
service_name,
api_id,
...
- name: api_issue_comment
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the api_issue_comment resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the api_issue_comment resource.
    - name: api_id
...
```sql
REPLACE azure.apimanagement.api_issue_comment
SET 
...
```sql
DELETE FROM azure.apimanagement.api_issue_comment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND issue_id = '{{ issue_id }}' --required
...
```sql
EXEC azure.apimanagement.api_issue_comment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
