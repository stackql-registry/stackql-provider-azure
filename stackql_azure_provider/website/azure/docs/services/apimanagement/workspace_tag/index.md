...
Creates, updates, deletes, gets or lists a <code>workspace_tag</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_tag" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_tag" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.workspace_tag
...
```sql
INSERT INTO azure.apimanagement.workspace_tag (
properties,
resource_group_name,
service_name,
workspace_id,
...
- name: workspace_tag
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the workspace_tag resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the workspace_tag resource.
    - name: workspace_id
...
```sql
UPDATE azure.apimanagement.workspace_tag
SET 
...
```sql
REPLACE azure.apimanagement.workspace_tag
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.workspace_tag
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND tag_id = '{{ tag_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_tag.get_entity_state 
@resource_group_name='{{ resource_group_name }}' --required, 
