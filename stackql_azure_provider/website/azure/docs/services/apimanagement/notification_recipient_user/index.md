...
Creates, updates, deletes, gets or lists a <code>notification_recipient_user</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="notification_recipient_user" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.notification_recipient_user" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-notification_name"><code>notification_name</code></a>, <a href="#parameter-user_id"><code>user_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
type,
userId
FROM azure.apimanagement.notification_recipient_user
...
```sql
INSERT INTO azure.apimanagement.notification_recipient_user (
resource_group_name,
service_name,
notification_name,
user_id,
...
- name: notification_recipient_user
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the notification_recipient_user resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the notification_recipient_user resource.
...
```sql
REPLACE azure.apimanagement.notification_recipient_user
SET 
...
```sql
DELETE FROM azure.apimanagement.notification_recipient_user
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND notification_name = '{{ notification_name }}' --required
AND user_id = '{{ user_id }}' --required
...
```sql
EXEC azure.apimanagement.notification_recipient_user.check_entity_exists 
@resource_group_name='{{ resource_group_name }}' --required, 
