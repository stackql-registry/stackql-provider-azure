...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.workspace
...
```sql
INSERT INTO azure.apimanagement.workspace (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.apimanagement.workspace
SET 
...
```sql
REPLACE azure.apimanagement.workspace
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.workspace
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
