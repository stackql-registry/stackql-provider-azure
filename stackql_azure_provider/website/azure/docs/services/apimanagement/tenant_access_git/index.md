...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.tenant_access_git" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.apimanagement.tenant_access_git.regenerate_primary_key 
...
```sql
EXEC azure.apimanagement.tenant_access_git.regenerate_secondary_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@access_name='{{ access_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
