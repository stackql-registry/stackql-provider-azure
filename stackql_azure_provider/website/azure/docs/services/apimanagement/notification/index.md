...
Creates, updates, deletes, gets or lists a <code>notification</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="notification" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.notification" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-notification_name"><code>notification_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or Update API Management publisher notification.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
title,
type
FROM azure.apimanagement.notification
...
```sql
INSERT INTO azure.apimanagement.notification (
resource_group_name,
service_name,
notification_name,
subscription_id
...
- name: notification
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the notification resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the notification resource.
...
```sql
REPLACE azure.apimanagement.notification
SET 
