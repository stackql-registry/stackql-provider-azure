...
Creates, updates, deletes, gets or lists a <code>gateway_certificate_authority</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="gateway_certificate_authority" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.gateway_certificate_authority" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="isTrusted" /></td>
    <td><code>boolean</code></td>
    <td>Determines whether certificate authority is trusted.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-gateway_id"><code>gateway_id</code></a>, <a href="#parameter-certificate_id"><code>certificate_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-gateway_id"><code>gateway_id</code></a>, <a href="#parameter-certificate_id"><code>certificate_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Checks if Certificate entity is assigned to Gateway entity as Certificate Authority.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-$filter">
    ...
    <td><code>string</code></td>
    <td>| Field | Usage | Supported operators | Supported functions ||-------------|-------------|-------------|-------------|| name | filter | eq, ne | |. Default value is None.</td>
</tr>
...
systemData,
type
FROM azure.apimanagement.gateway_certificate_authority
...
```sql
INSERT INTO azure.apimanagement.gateway_certificate_authority (
properties,
resource_group_name,
service_name,
gateway_id,
...
- name: gateway_certificate_authority
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the gateway_certificate_authority resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the gateway_certificate_authority resource.
    - name: gateway_id
...
```sql
REPLACE azure.apimanagement.gateway_certificate_authority
SET 
...
```sql
DELETE FROM azure.apimanagement.gateway_certificate_authority
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND gateway_id = '{{ gateway_id }}' --required
AND certificate_id = '{{ certificate_id }}' --required
...
```sql
EXEC azure.apimanagement.gateway_certificate_authority.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
