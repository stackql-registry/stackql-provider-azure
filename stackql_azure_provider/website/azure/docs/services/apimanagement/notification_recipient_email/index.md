...
Creates, updates, deletes, gets or lists a <code>notification_recipient_email</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="notification_recipient_email" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.notification_recipient_email" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-notification_name"><code>notification_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-notification_name"><code>notification_name</code></a>, <a href="#parameter-email"><code>email</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.apimanagement.notification_recipient_email
...
```sql
INSERT INTO azure.apimanagement.notification_recipient_email (
resource_group_name,
service_name,
notification_name,
email,
...
- name: notification_recipient_email
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the notification_recipient_email resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the notification_recipient_email resource.
...
```sql
REPLACE azure.apimanagement.notification_recipient_email
SET 
...
```sql
DELETE FROM azure.apimanagement.notification_recipient_email
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND notification_name = '{{ notification_name }}' --required
AND email = '{{ email }}' --required
...
```sql
EXEC azure.apimanagement.notification_recipient_email.check_entity_exists 
@resource_group_name='{{ resource_group_name }}' --required, 
