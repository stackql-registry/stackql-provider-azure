...
Creates, updates, deletes, gets or lists a <code>tag_product_link</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="tag_product_link" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.tag_product_link" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-tag_id"><code>tag_id</code></a>, <a href="#parameter-product_link_id"><code>product_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.apimanagement.tag_product_link
...
```sql
INSERT INTO azure.apimanagement.tag_product_link (
properties,
resource_group_name,
service_name,
tag_id,
...
- name: tag_product_link
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the tag_product_link resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the tag_product_link resource.
    - name: tag_id
...
```sql
REPLACE azure.apimanagement.tag_product_link
SET 
...
```sql
DELETE FROM azure.apimanagement.tag_product_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND tag_id = '{{ tag_id }}' --required
AND product_link_id = '{{ product_link_id }}' --required
