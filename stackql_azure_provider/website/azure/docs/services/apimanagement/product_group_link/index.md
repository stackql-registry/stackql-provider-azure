...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.product_group_link" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.product_group_link
...
```sql
INSERT INTO azure.apimanagement.product_group_link (
properties,
resource_group_name,
service_name,
product_id,
...
```sql
REPLACE azure.apimanagement.product_group_link
SET 
...
```sql
DELETE FROM azure.apimanagement.product_group_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND product_id = '{{ product_id }}' --required
AND group_link_id = '{{ group_link_id }}' --required
