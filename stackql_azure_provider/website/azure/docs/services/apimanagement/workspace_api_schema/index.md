...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_api_schema" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.workspace_api_schema
...
```sql
INSERT INTO azure.apimanagement.workspace_api_schema (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
REPLACE azure.apimanagement.workspace_api_schema
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_api_schema
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_api_schema.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
