...
Creates, updates, deletes, gets or lists a <code>workspace_product</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_product" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_product" /></td></tr>
</tbody></table>
...
terms,
type
FROM azure.apimanagement.workspace_product
...
```sql
INSERT INTO azure.apimanagement.workspace_product (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.apimanagement.workspace_product
SET 
...
```sql
REPLACE azure.apimanagement.workspace_product
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.apimanagement.workspace_product
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND product_id = '{{ product_id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_product.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
