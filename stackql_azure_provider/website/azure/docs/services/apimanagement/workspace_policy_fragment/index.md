...
Creates, updates, deletes, gets or lists a <code>workspace_policy_fragment</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_policy_fragment" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_policy_fragment" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-workspace_id"><code>workspace_id</code></a>, <a href="#parameter-id"><code>id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
<tr>
    ...
    <td>Gets all policy fragments defined within a workspace.</td>
</tr>
<tr>
...
type,
value
FROM azure.apimanagement.workspace_policy_fragment
...
```sql
INSERT INTO azure.apimanagement.workspace_policy_fragment (
properties,
resource_group_name,
service_name,
workspace_id,
...
- name: workspace_policy_fragment
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the workspace_policy_fragment resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the workspace_policy_fragment resource.
    - name: workspace_id
...
```sql
REPLACE azure.apimanagement.workspace_policy_fragment
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_policy_fragment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND id = '{{ id }}' --required
...
```sql
EXEC azure.apimanagement.workspace_policy_fragment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.workspace_policy_fragment.list_references 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@workspace_id='{{ workspace_id }}' --required, 
@id='{{ id }}' --required, 
