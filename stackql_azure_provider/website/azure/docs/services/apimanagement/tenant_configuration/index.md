...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.tenant_configuration" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.tenant_configuration
...
```sql
EXEC azure.apimanagement.tenant_configuration.deploy 
...
```sql
EXEC azure.apimanagement.tenant_configuration.save 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@configuration_name='{{ configuration_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.apimanagement.tenant_configuration.validate 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@configuration_name='{{ configuration_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
