...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.content_item" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.content_item
...
```sql
INSERT INTO azure.apimanagement.content_item (
properties,
resource_group_name,
service_name,
content_type_id,
...
```sql
REPLACE azure.apimanagement.content_item
SET 
...
```sql
DELETE FROM azure.apimanagement.content_item
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND content_type_id = '{{ content_type_id }}' --required
AND content_item_id = '{{ content_item_id }}' --required
...
```sql
EXEC azure.apimanagement.content_item.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
