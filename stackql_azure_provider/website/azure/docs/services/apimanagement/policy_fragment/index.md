...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.policy_fragment" /></td></tr>
</tbody></table>
...
type,
value
FROM azure.apimanagement.policy_fragment
...
```sql
INSERT INTO azure.apimanagement.policy_fragment (
properties,
resource_group_name,
service_name,
id,
...
```sql
REPLACE azure.apimanagement.policy_fragment
SET 
...
```sql
DELETE FROM azure.apimanagement.policy_fragment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND id = '{{ id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apimanagement.policy_fragment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.apimanagement.policy_fragment.list_references 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@id='{{ id }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
