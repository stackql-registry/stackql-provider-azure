...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.deleted_services" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.deleted_services
...
```sql
DELETE FROM azure.apimanagement.deleted_services
WHERE service_name = '{{ service_name }}' --required
AND location = '{{ location }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
