...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_gateway_config_connection" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.apimanagement.api_gateway_config_connection
...
```sql
INSERT INTO azure.apimanagement.api_gateway_config_connection (
properties,
resource_group_name,
gateway_name,
...
```sql
REPLACE azure.apimanagement.api_gateway_config_connection
SET 
...
```sql
DELETE FROM azure.apimanagement.api_gateway_config_connection
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND gateway_name = '{{ gateway_name }}' --required
AND config_connection_name = '{{ config_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
