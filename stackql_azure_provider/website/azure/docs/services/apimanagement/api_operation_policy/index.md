...
Creates, updates, deletes, gets or lists an <code>api_operation_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_operation_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.api_operation_policy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-operation_id"><code>operation_id</code></a>, <a href="#parameter-policy_id"><code>policy_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
type,
value
FROM azure.apimanagement.api_operation_policy
...
```sql
INSERT INTO azure.apimanagement.api_operation_policy (
properties,
resource_group_name,
service_name,
api_id,
...
- name: api_operation_policy
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the api_operation_policy resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the api_operation_policy resource.
    - name: api_id
...
```sql
REPLACE azure.apimanagement.api_operation_policy
SET 
...
```sql
DELETE FROM azure.apimanagement.api_operation_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND operation_id = '{{ operation_id }}' --required
...
```sql
EXEC azure.apimanagement.api_operation_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
