...
Creates, updates, deletes, gets or lists a <code>workspace_product_api_link</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_product_api_link" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apimanagement.workspace_product_api_link" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-workspace_id"><code>workspace_id</code></a>, <a href="#parameter-product_id"><code>product_id</code></a>, <a href="#parameter-api_link_id"><code>api_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.apimanagement.workspace_product_api_link
...
```sql
INSERT INTO azure.apimanagement.workspace_product_api_link (
properties,
resource_group_name,
service_name,
workspace_id,
...
- name: workspace_product_api_link
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the workspace_product_api_link resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the workspace_product_api_link resource.
    - name: workspace_id
...
```sql
REPLACE azure.apimanagement.workspace_product_api_link
SET 
...
```sql
DELETE FROM azure.apimanagement.workspace_product_api_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND product_id = '{{ product_id }}' --required
