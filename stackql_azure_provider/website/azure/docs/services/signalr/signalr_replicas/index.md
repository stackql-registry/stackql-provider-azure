...
Creates, updates, deletes, gets or lists a <code>signalr_replicas</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="signalr_replicas" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.signalr.signalr_replicas" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.signalr.signalr_replicas
...
```sql
INSERT INTO azure.signalr.signalr_replicas (
tags,
location,
sku,
properties,
...
- name: signalr_replicas
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the signalr_replicas resource.
    - name: resource_name
      value: "{{ resource_name }}"
      description: Required parameter for the signalr_replicas resource.
    - name: replica_name
...
```sql
UPDATE azure.signalr.signalr_replicas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.signalr.signalr_replicas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
DELETE FROM azure.signalr.signalr_replicas
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND replica_name = '{{ replica_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.signalr.signalr_replicas.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
