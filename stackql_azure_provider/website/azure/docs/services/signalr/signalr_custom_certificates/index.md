--- 
title: signalr_custom_certificates
hide_title: false
hide_table_of_contents: false
keywords:
  - signalr_custom_certificates
  - signalr
  - azure
...
Creates, updates, deletes, gets or lists a <code>signalr_custom_certificates</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="signalr_custom_certificates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.signalr.signalr_custom_certificates" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.signalr.signalr_custom_certificates
...
```sql
INSERT INTO azure.signalr.signalr_custom_certificates (
properties,
resource_group_name,
resource_name,
certificate_name,
...
- name: signalr_custom_certificates
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the signalr_custom_certificates resource.
    - name: resource_name
      value: "{{ resource_name }}"
      description: Required parameter for the signalr_custom_certificates resource.
...
```sql
REPLACE azure.signalr.signalr_custom_certificates
SET 
...
```sql
DELETE FROM azure.signalr.signalr_custom_certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
