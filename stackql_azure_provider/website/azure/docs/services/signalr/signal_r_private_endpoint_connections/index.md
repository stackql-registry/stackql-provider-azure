...
Creates, updates, deletes, gets or lists a <code>signal_r_private_endpoint_connections</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="signal_r_private_endpoint_connections" /></td></tr>
...
systemData,
type
FROM azure.signalr.signal_r_private_endpoint_connections
...
```sql
UPDATE azure.signalr.signal_r_private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.signalr.signal_r_private_endpoint_connections
WHERE private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
