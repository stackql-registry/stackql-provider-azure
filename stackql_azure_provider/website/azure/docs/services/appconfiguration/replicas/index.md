...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appconfiguration.replicas" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The URI of the replica where the replica API will be available.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The provisioning state of the replica. Known values are: "Creating", "Succeeded", "Deleting", "Failed", and "Canceled". (Creating, Succeeded, Deleting, Failed, Canceled)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-config_store_name"><code>config_store_name</code></a>, <a href="#parameter-replica_name"><code>replica_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.appconfiguration.replicas
...
```sql
INSERT INTO azure.appconfiguration.replicas (
properties,
location,
resource_group_name,
config_store_name,
...
```sql
DELETE FROM azure.appconfiguration.replicas
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND config_store_name = '{{ config_store_name }}' --required
AND replica_name = '{{ replica_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
