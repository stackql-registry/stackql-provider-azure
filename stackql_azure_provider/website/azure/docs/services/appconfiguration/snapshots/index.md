...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appconfiguration.snapshots" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.appconfiguration.snapshots
...
```sql
INSERT INTO azure.appconfiguration.snapshots (
properties,
resource_group_name,
config_store_name,
snapshot_name,
