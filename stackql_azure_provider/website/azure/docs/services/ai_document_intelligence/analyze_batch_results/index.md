...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_document_intelligence.analyze_batch_results" /></td></tr>
</tbody></table>
...
resultId,
status
FROM azure.ai_document_intelligence.analyze_batch_results
...
```sql
DELETE FROM azure.ai_document_intelligence.analyze_batch_results
WHERE model_id = '{{ model_id }}' --required
AND result_id = '{{ result_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
