...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.operationsmanagement.solutions" /></td></tr>
</tbody></table>
...
type,
workspaceResourceId
FROM azure.operationsmanagement.solutions
...
```sql
INSERT INTO azure.operationsmanagement.solutions (
location,
tags,
plan,
properties,
...
```sql
UPDATE azure.operationsmanagement.solutions
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.operationsmanagement.solutions
SET 
location = '{{ location }}',
tags = '{{ tags }}',
plan = '{{ plan }}',
...
```sql
DELETE FROM azure.operationsmanagement.solutions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND solution_name = '{{ solution_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
