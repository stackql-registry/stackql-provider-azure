...
<tr>
    ...
    <td>The creation date of the user profile.</td>
</tr>
<tr>
    <td><CopyableCode code="identity" /></td>
    <td><code>object</code></td>
    <td>The identity of the user.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The secret store of the user.</td>
</tr>
<tr>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Specify the $expand query. Example: 'properties($select=identity)'. Default value is None.</td>
</tr>
...
```sql
REPLACE azure.dev_test_labs.users
SET 
location = '{{ location }}',
tags = '{{ tags }}',
