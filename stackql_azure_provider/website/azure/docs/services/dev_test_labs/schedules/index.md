...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dev_test_labs.schedules" /></td></tr>
</tbody></table>
...
```sql
REPLACE azure.dev_test_labs.schedules
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
EXEC azure.dev_test_labs.schedules.list_applicable 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.dev_test_labs.schedules.execute 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@name='{{ name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
