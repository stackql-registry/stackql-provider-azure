...
Creates, updates, deletes, gets or lists an <code>arm_templates</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="arm_templates" /></td></tr>
...
<tr>
    ...
    <td>The contents of the ARM template.</td>
</tr>
<tr>
    <td><CopyableCode code="createdDate" /></td>
    <td><code>string (date-time)</code></td>
    <td>The creation date of the armTemplate.</td>
</tr>
<tr>
    <td><CopyableCode code="description" /></td>
    <td><code>string</code></td>
    <td>The description of the ARM template.</td>
</tr>
<tr>
    <td><CopyableCode code="displayName" /></td>
    <td><code>string</code></td>
    <td>The display name of the ARM template.</td>
</tr>
<tr>
    <td><CopyableCode code="enabled" /></td>
    <td><code>boolean</code></td>
    <td>Whether or not ARM template is enabled for use by lab user.</td>
</tr>
<tr>
    <td><CopyableCode code="icon" /></td>
    <td><code>string</code></td>
    <td>The URI to the icon of the ARM template.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="parametersValueFilesInfo" /></td>
    <td><code>array</code></td>
    <td>File name and parameter values information from all azuredeploy.*.parameters.json for the ARM template.</td>
</tr>
<tr>
    <td><CopyableCode code="publisher" /></td>
    <td><code>string</code></td>
    <td>The publisher of the ARM template.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Get azure resource manager template.</td>
</tr>
<tr>
    ...
    <td>List azure resource manager templates in a given artifact source.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-name">
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>The name of the azure resource manager template. Required.</td>
</tr>
