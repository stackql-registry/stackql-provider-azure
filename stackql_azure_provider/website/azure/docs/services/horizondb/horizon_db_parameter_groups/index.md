...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.horizondb.horizon_db_parameter_groups" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.horizondb.horizon_db_parameter_groups
...
```sql
INSERT INTO azure.horizondb.horizon_db_parameter_groups (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.horizondb.horizon_db_parameter_groups
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.horizondb.horizon_db_parameter_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.horizondb.horizon_db_parameter_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND parameter_group_name = '{{ parameter_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.horizondb.horizon_db_parameter_groups.list_connections 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.horizondb.horizon_db_parameter_groups.list_versions 
@resource_group_name='{{ resource_group_name }}' --required, 
@parameter_group_name='{{ parameter_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@version='{{ version }}'
