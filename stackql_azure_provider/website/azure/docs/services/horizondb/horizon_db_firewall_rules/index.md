...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.horizondb.horizon_db_firewall_rules" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.horizondb.horizon_db_firewall_rules
...
```sql
INSERT INTO azure.horizondb.horizon_db_firewall_rules (
properties,
resource_group_name,
cluster_name,
pool_name,
...
```sql
REPLACE azure.horizondb.horizon_db_firewall_rules
SET 
...
```sql
DELETE FROM azure.horizondb.horizon_db_firewall_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND pool_name = '{{ pool_name }}' --required
AND firewall_rule_name = '{{ firewall_rule_name }}' --required
