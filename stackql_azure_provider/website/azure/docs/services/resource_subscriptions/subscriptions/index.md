...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_subscriptions.subscriptions" /></td></tr>
</tbody></table>
...
tags,
tenantId
FROM azure.resource_subscriptions.subscriptions
...
```sql
EXEC azure.resource_subscriptions.subscriptions.list_locations 
...
```sql
EXEC azure.resource_subscriptions.subscriptions.check_zone_peers 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
"location": "{{ location }}", 
