--- 
title: recover_deleted_keys
hide_title: false
hide_table_of_contents: false
keywords:
  - recover_deleted_keys
  - key_vault_keys
  - azure
...
Creates, updates, deletes, gets or lists a <code>recover_deleted_keys</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="recover_deleted_keys" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.key_vault_keys.recover_deleted_keys" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="recover_deleted_key"
    values={[
        { label: 'recover_deleted_key', value: 'recover_deleted_key' }
    ]}
>
<TabItem value="recover_deleted_key">

Recovers the deleted key to its latest version. The Recover Deleted Key operation is applicable for deleted keys in soft-delete enabled vaults. It recovers the deleted key back to its latest version under /keys. An attempt to recover an non-deleted key will return an error. Consider this the inverse of the delete operation on soft-delete enabled vaults. This operation requires the keys/recover permission.

```sql
EXEC azure.key_vault_keys.recover_deleted_keys.recover_deleted_key 
