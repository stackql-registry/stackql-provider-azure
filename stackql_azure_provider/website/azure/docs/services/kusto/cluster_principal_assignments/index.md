...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cluster_principal_assignments" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.kusto.cluster_principal_assignments" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The principal ID assigned to the cluster principal. It can be a user email, application ID, or security group name. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Cluster principal role. Required. Known values are: "AllDatabasesAdmin", "AllDatabasesViewer", and "AllDatabasesMonitor". (AllDatabasesAdmin, AllDatabasesViewer, AllDatabasesMonitor)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-principal_assignment_name"><code>principal_assignment_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
tenantName,
type
FROM azure.kusto.cluster_principal_assignments
...
```sql
INSERT INTO azure.kusto.cluster_principal_assignments (
properties,
resource_group_name,
cluster_name,
...
```sql
REPLACE azure.kusto.cluster_principal_assignments
SET 
...
```sql
DELETE FROM azure.kusto.cluster_principal_assignments
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND principal_assignment_name = '{{ principal_assignment_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.kusto.cluster_principal_assignments.check_name_availability 
@resource_group_name='{{ resource_group_name }}' --required, 
