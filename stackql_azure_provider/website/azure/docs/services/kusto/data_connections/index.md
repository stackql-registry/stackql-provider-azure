...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="data_connections" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.kusto.data_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Kind of the endpoint for the data connection. Required. Known values are: "EventHub", "EventGrid", "IotHub", "CosmosDb", "EventHubWithManagedIdentity", and "EventGridWithManagedIdentity".</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.kusto.data_connections (
location,
kind,
resource_group_name,
cluster_name,
...
- name: data_connections
  props:
    ...
    - name: kind
      value: "{{ kind }}"
      description: |
        Kind of the endpoint for the data connection. Required. Known values are: "EventHub", "EventGrid", "IotHub", "CosmosDb", "EventHubWithManagedIdentity", and "EventGridWithManagedIdentity".
`}</CodeBlock>
...
```sql
UPDATE azure.kusto.data_connections
SET 
location = '{{ location }}',
kind = '{{ kind }}'
WHERE 
...
```sql
REPLACE azure.kusto.data_connections
SET 
location = '{{ location }}',
kind = '{{ kind }}'
WHERE 
...
```sql
DELETE FROM azure.kusto.data_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND database_name = '{{ database_name }}' --required
AND data_connection_name = '{{ data_connection_name }}' --required
...
```sql
EXEC azure.kusto.data_connections.data_connection_validation 
@resource_group_name='{{ resource_group_name }}' --required, 
