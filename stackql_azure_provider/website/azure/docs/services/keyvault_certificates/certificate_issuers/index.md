...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.keyvault_certificates.certificate_issuers" /></td></tr>
</tbody></table>
...
```sql
UPDATE azure.keyvault_certificates.certificate_issuers
SET 
provider = '{{ provider }}',
...
```sql
REPLACE azure.keyvault_certificates.certificate_issuers
SET 
provider = '{{ provider }}',
credentials = '{{ credentials }}',
org_details = '{{ org_details }}',
