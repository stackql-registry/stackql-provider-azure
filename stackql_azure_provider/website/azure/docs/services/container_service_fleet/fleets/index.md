...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.container_service_fleet.fleets" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="hubProfile" /></td>
    <td><code>object</code></td>
    <td>The FleetHubProfile configures the Fleet's hub.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Status information for the fleet.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Lists fleets in the specified subscription and resource group.</td>
</tr>
<tr>
    ...
    <td>Lists fleets in the specified subscription.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Creates or updates a Fleet.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-fleet_name"><code>fleet_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Lists the user credentials of a Fleet.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.container_service_fleet.fleets
...
```sql
INSERT INTO azure.container_service_fleet.fleets (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.container_service_fleet.fleets
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure.container_service_fleet.fleets
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.container_service_fleet.fleets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND fleet_name = '{{ fleet_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.container_service_fleet.fleets.list_credentials 
@resource_group_name='{{ resource_group_name }}' --required, 
