...
Creates, updates, deletes, gets or lists an <code>analyze_form_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="analyze_form_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_formrecognizer.analyze_form_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_analyze_form_result"
    values={[
        { label: 'get_analyze_form_result', value: 'get_analyze_form_result' }
    ]}
>
<TabItem value="get_analyze_form_result">
...
<tbody>
<tr>
    <td><a href="#get_analyze_form_result"><CopyableCode code="get_analyze_form_result" /></a></td>
    ...
    <td></td>
    <td>Get Analyze Form Result. Obtain current status and the result of the analyze form operation.</td>
</tr>
</tbody>
</table>
...
status,
trainResult
FROM azure.ai_formrecognizer.analyze_form_results
