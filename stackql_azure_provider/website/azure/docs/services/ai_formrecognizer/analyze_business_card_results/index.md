--- 
title: analyze_business_card_results
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>analyze_business_card_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="analyze_business_card_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_formrecognizer.analyze_business_card_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_analyze_business_card_result"
    values={[
        { label: 'get_analyze_business_card_result', value: 'get_analyze_business_card_result' }
    ]}
>
<TabItem value="get_analyze_business_card_result">
...
<tbody>
<tr>
    <td><a href="#get_analyze_business_card_result"><CopyableCode code="get_analyze_business_card_result" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-result_id"><code>result_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Get Analyze Business Card Result. Track the progress and obtain the result of the analyze business card operation.</td>
</tr>
</tbody>
</table>
...
status,
trainResult
FROM azure.ai_formrecognizer.analyze_business_card_results
