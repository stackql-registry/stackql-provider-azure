...
Creates, updates, deletes, gets or lists a <code>backup_resource_storage_configs_non_crr</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="backup_resource_storage_configs_non_crr" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recoveryservicesbackup.backup_resource_storage_configs_non_crr" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="dedupState" /></td>
    <td><code>string</code></td>
    <td>Vault Dedup state. Known values are: "Invalid", "Enabled", and "Disabled". (Invalid, Enabled, Disabled)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="xcoolState" /></td>
    <td><code>string</code></td>
    <td>Vault x-cool state. Known values are: "Invalid", "Enabled", and "Disabled". (Invalid, Enabled, Disabled)</td>
</tr>
</tbody>
</table>
</TabItem>
...
type,
xcoolState
FROM azure.recoveryservicesbackup.backup_resource_storage_configs_non_crr
...
```sql
UPDATE azure.recoveryservicesbackup.backup_resource_storage_configs_non_crr
SET 
...
```sql
EXEC azure.recoveryservicesbackup.backup_resource_storage_configs_non_crr.patch 
@vault_name='{{ vault_name }}' --required, 
