...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.durabletask.schedulers" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.durabletask.schedulers
...
```sql
EXEC azure.durabletask.schedulers.list_private_links 
@resource_group_name='{{ resource_group_name }}' --required, 
