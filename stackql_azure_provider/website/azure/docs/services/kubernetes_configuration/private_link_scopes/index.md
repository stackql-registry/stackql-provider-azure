...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.kubernetes_configuration.private_link_scopes" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.kubernetes_configuration.private_link_scopes
...
```sql
INSERT INTO azure.kubernetes_configuration.private_link_scopes (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.kubernetes_configuration.private_link_scopes
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.kubernetes_configuration.private_link_scopes
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.kubernetes_configuration.private_link_scopes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND scope_name = '{{ scope_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
