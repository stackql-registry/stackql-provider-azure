...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iotoperations.broker_authentication" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.iotoperations.broker_authentication
...
```sql
INSERT INTO azure.iotoperations.broker_authentication (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
```sql
REPLACE azure.iotoperations.broker_authentication
SET 
...
```sql
DELETE FROM azure.iotoperations.broker_authentication
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND broker_name = '{{ broker_name }}' --required
AND authentication_name = '{{ authentication_name }}' --required
