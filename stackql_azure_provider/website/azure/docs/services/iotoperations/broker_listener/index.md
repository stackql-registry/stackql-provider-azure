...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iotoperations.broker_listener" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.iotoperations.broker_listener
...
```sql
INSERT INTO azure.iotoperations.broker_listener (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
```sql
REPLACE azure.iotoperations.broker_listener
SET 
...
```sql
DELETE FROM azure.iotoperations.broker_listener
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND broker_name = '{{ broker_name }}' --required
AND listener_name = '{{ listener_name }}' --required
