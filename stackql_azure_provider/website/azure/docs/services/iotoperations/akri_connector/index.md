...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iotoperations.akri_connector" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.iotoperations.akri_connector
...
```sql
INSERT INTO azure.iotoperations.akri_connector (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
```sql
REPLACE azure.iotoperations.akri_connector
SET 
...
```sql
DELETE FROM azure.iotoperations.akri_connector
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND akri_connector_template_name = '{{ akri_connector_template_name }}' --required
AND connector_name = '{{ connector_name }}' --required
