...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iotoperations.instance" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.iotoperations.instance
...
```sql
INSERT INTO azure.iotoperations.instance (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.iotoperations.instance
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure.iotoperations.instance
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.iotoperations.instance
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
