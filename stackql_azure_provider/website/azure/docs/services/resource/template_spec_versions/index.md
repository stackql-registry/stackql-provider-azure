...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource.template_spec_versions" /></td></tr>
</tbody></table>
...
type,
uiFormDefinition
FROM azure.resource.template_spec_versions
...
```sql
INSERT INTO azure.resource.template_spec_versions (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.resource.template_spec_versions
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.resource.template_spec_versions
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.resource.template_spec_versions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND template_spec_name = '{{ template_spec_name }}' --required
AND template_spec_version = '{{ template_spec_version }}' --required
AND subscription_id = '{{ subscription_id }}' --required
