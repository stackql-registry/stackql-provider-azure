...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource.template_specs" /></td></tr>
</tbody></table>
...
type,
versions
FROM azure.resource.template_specs
...
```sql
INSERT INTO azure.resource.template_specs (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.resource.template_specs
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.resource.template_specs
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.resource.template_specs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND template_spec_name = '{{ template_spec_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
