...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource.deployment_stacks_what_if_results_at_resource_group" /></td></tr>
</tbody></table>
...
type,
validationLevel
FROM azure.resource.deployment_stacks_what_if_results_at_resource_group
...
```sql
INSERT INTO azure.resource.deployment_stacks_what_if_results_at_resource_group (
properties,
location,
tags,
resource_group_name,
...
```sql
REPLACE azure.resource.deployment_stacks_what_if_results_at_resource_group
SET 
...
```sql
DELETE FROM azure.resource.deployment_stacks_what_if_results_at_resource_group
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND deployment_stacks_what_if_result_name = '{{ deployment_stacks_what_if_result_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.resource.deployment_stacks_what_if_results_at_resource_group.what_if 
@resource_group_name='{{ resource_group_name }}' --required, 
