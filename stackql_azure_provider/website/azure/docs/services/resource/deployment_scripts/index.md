...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource.deployment_scripts" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.resource.deployment_scripts
...
```sql
INSERT INTO azure.resource.deployment_scripts (
identity,
location,
tags,
kind,
...
```sql
UPDATE azure.resource.deployment_scripts
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
DELETE FROM azure.resource.deployment_scripts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND script_name = '{{ script_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.resource.deployment_scripts.get_logs 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.resource.deployment_scripts.get_logs_default 
@resource_group_name='{{ resource_group_name }}' --required, 
@script_name='{{ script_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@tail='{{ tail }}'
