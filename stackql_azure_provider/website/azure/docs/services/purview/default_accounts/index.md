...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="default_accounts" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The scope where the default account is set. Known values are: "Tenant" and "Subscription".</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Gets the default account information set for the scope. Get the default account for the scope.</td>
</tr>
<tr>
    ...
    <td></td>
    <td></td>
    <td>Sets the default account for the scope. Sets the default account for the scope.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-scopeTenantId"><code>scopeTenantId</code></a>, <a href="#parameter-scopeType"><code>scopeType</code></a></td>
    <td><a href="#parameter-scope"><code>scope</code></a></td>
    <td>Removes the default account from the scope. Removes the default account from the scope.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-scopeTenantId">
    <td><CopyableCode code="scopeTenantId" /></td>
    <td><code>string</code></td>
    <td>The tenant ID. Required.</td>
</tr>
<tr id="parameter-scopeType">
    <td><CopyableCode code="scopeType" /></td>
    <td><code>string</code></td>
    <td>The scope for the default account. Known values are: "Tenant" and "Subscription". Required.</td>
</tr>
<tr id="parameter-scope">
    <td><CopyableCode code="scope" /></td>
    <td><code>string</code></td>
    <td>The Id of the scope object, for example if the scope is "Subscription" then it is the ID of that subscription. Default value is None.</td>
</tr>
</tbody>
</table>
