...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recoveryservicessiterecovery.replication_jobs" /></td></tr>
</tbody></table>
...
tasks,
type
FROM azure.recoveryservicessiterecovery.replication_jobs
...
```sql
EXEC azure.recoveryservicessiterecovery.replication_jobs.cancel 
...
```sql
EXEC azure.recoveryservicessiterecovery.replication_jobs.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@job_name='{{ job_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.recoveryservicessiterecovery.replication_jobs.resume 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@job_name='{{ job_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.recoveryservicessiterecovery.replication_jobs.export 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
