...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.schema_versions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-schema_version_name"><code>schema_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a Schema Version Resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-schema_version_name"><code>schema_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update a Schema Version Resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-schema_version_name"><code>schema_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>update a Schema Version Resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-schema_version_name"><code>schema_version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a Schema Version Resource.</td>
</tr>
</tbody>
</table>
...
type,
value
FROM azure.workload_orchestration.schema_versions
...
```sql
INSERT INTO azure.workload_orchestration.schema_versions (
properties,
resource_group_name,
schema_name,
schema_version_name,
...
```sql
UPDATE azure.workload_orchestration.schema_versions
SET 
...
```sql
REPLACE azure.workload_orchestration.schema_versions
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.workload_orchestration.schema_versions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND schema_version_name = '{{ schema_version_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
