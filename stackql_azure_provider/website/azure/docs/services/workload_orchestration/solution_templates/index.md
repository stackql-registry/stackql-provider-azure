...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.solution_templates" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.workload_orchestration.solution_templates
...
```sql
INSERT INTO azure.workload_orchestration.solution_templates (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.workload_orchestration.solution_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workload_orchestration.solution_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workload_orchestration.solution_templates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND solution_template_name = '{{ solution_template_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.workload_orchestration.solution_templates.create_version 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.workload_orchestration.solution_templates.remove_version 
@resource_group_name='{{ resource_group_name }}' --required, 
@solution_template_name='{{ solution_template_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
