...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.workflows" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="workflowTemplateId" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-context_name"><code>context_name</code></a>, <a href="#parameter-workflow_name"><code>workflow_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update a Workflow resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-context_name"><code>context_name</code></a>, <a href="#parameter-workflow_name"><code>workflow_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>update a Workflow resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-context_name"><code>context_name</code></a>, <a href="#parameter-workflow_name"><code>workflow_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a Workflow resource.</td>
</tr>
</tbody>
</table>
...
type,
workflowTemplateId
FROM azure.workload_orchestration.workflows
...
```sql
INSERT INTO azure.workload_orchestration.workflows (
properties,
extendedLocation,
resource_group_name,
context_name,
...
```sql
UPDATE azure.workload_orchestration.workflows
SET 
...
```sql
REPLACE azure.workload_orchestration.workflows
SET 
properties = '{{ properties }}',
extendedLocation = '{{ extendedLocation }}'
WHERE 
...
```sql
DELETE FROM azure.workload_orchestration.workflows
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND context_name = '{{ context_name }}' --required
AND workflow_name = '{{ workflow_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
