...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.schemas" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Current Version of schema.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>update a Schema Resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-version"><code>version</code></a></td>
    <td></td>
    <td>Remove Schema Version Resource.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.workload_orchestration.schemas
...
```sql
INSERT INTO azure.workload_orchestration.schemas (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.workload_orchestration.schemas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workload_orchestration.schemas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workload_orchestration.schemas
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.workload_orchestration.schemas.create_version 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.workload_orchestration.schemas.remove_version 
@resource_group_name='{{ resource_group_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
