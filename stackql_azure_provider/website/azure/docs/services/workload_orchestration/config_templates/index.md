...
Creates, updates, deletes, gets or lists a <code>config_templates</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="config_templates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.config_templates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Description of config template. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Latest config template version.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get a Config Template Resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-config_template_name"><code>config_template_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>update a Config Template Resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-config_template_name"><code>config_template_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-version"><code>version</code></a></td>
    <td></td>
    <td>Remove Config Template Version Resource.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-config_template_name">
    <td><CopyableCode code="config_template_name" /></td>
    <td><code>string</code></td>
    <td>The name of the ConfigTemplate. Required.</td>
</tr>
...
tags,
type
FROM azure.workload_orchestration.config_templates
...
```sql
INSERT INTO azure.workload_orchestration.config_templates (
tags,
location,
properties,
resource_group_name,
...
- name: config_templates
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the config_templates resource.
...
```sql
UPDATE azure.workload_orchestration.config_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workload_orchestration.config_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workload_orchestration.config_templates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND config_template_name = '{{ config_template_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.workload_orchestration.config_templates.create_version 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.workload_orchestration.config_templates.remove_version 
@resource_group_name='{{ resource_group_name }}' --required, 
@config_template_name='{{ config_template_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
