...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workload_orchestration.contexts" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>array</code></td>
    <td>List of Hierarchies. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-context_name"><code>context_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>Create or update Context Resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-context_name"><code>context_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>update an Context Resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
tags,
type
FROM azure.workload_orchestration.contexts
...
```sql
INSERT INTO azure.workload_orchestration.contexts (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.workload_orchestration.contexts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workload_orchestration.contexts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workload_orchestration.contexts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND context_name = '{{ context_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
