...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.storagecache.caches" /></td></tr>
</tbody></table>
...
upgradeStatus,
zones
FROM azure.storagecache.caches
...
```sql
INSERT INTO azure.storagecache.caches (
properties,
tags,
location,
identity,
...
```sql
UPDATE azure.storagecache.caches
SET 
...
```sql
REPLACE azure.storagecache.caches
SET 
properties = '{{ properties }}',
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.storagecache.caches
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cache_name = '{{ cache_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.storagecache.caches.debug_info 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.storagecache.caches.flush 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.storagecache.caches.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.storagecache.caches.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.storagecache.caches.start_priming_job 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.storagecache.caches.stop_priming_job 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.storagecache.caches.pause_priming_job 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.storagecache.caches.resume_priming_job 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.storagecache.caches.upgrade_firmware 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.storagecache.caches.space_allocation 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
