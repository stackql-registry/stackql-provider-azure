...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.storagecache.storage_target" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.storagecache.storage_target.flush 
...
```sql
EXEC azure.storagecache.storage_target.suspend 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@storage_target_name='{{ storage_target_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.storagecache.storage_target.resume 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@storage_target_name='{{ storage_target_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.storagecache.storage_target.invalidate 
@resource_group_name='{{ resource_group_name }}' --required, 
@cache_name='{{ cache_name }}' --required, 
@storage_target_name='{{ storage_target_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
