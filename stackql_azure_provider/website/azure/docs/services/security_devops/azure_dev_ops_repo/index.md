...
type,
visibility
FROM azure.security_devops.azure_dev_ops_repo
...
```sql
INSERT INTO azure.security_devops.azure_dev_ops_repo (
properties,
resource_group_name,
...
```sql
UPDATE azure.security_devops.azure_dev_ops_repo
SET 
...
```sql
REPLACE azure.security_devops.azure_dev_ops_repo
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
