...
systemData,
type
FROM azure.security_devops.azure_dev_ops_project
...
```sql
INSERT INTO azure.security_devops.azure_dev_ops_project (
properties,
resource_group_name,
...
```sql
UPDATE azure.security_devops.azure_dev_ops_project
SET 
...
```sql
REPLACE azure.security_devops.azure_dev_ops_project
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
