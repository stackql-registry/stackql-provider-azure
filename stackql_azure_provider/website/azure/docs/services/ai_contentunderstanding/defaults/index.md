...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_contentunderstanding.defaults" /></td></tr>
</tbody></table>
...
SELECT
modelDeployments
FROM azure.ai_contentunderstanding.defaults
...
```sql
UPDATE azure.ai_contentunderstanding.defaults
SET 
