...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_contentunderstanding.analyzers" /></td></tr>
</tbody></table>
...
tags,
warnings
FROM azure.ai_contentunderstanding.analyzers
...
```sql
INSERT INTO azure.ai_contentunderstanding.analyzers (
description,
tags,
baseAnalyzerId,
config,
...
```sql
UPDATE azure.ai_contentunderstanding.analyzers
SET 
description = '{{ description }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.ai_contentunderstanding.analyzers
WHERE analyzer_id = '{{ analyzer_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
