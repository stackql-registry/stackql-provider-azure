...
systemData,
type
FROM azure.web_pubsub.web_pub_sub_custom_certificates
...
```sql
INSERT INTO azure.web_pubsub.web_pub_sub_custom_certificates (
properties,
resource_group_name,
resource_name,
certificate_name,
...
```sql
REPLACE azure.web_pubsub.web_pub_sub_custom_certificates
SET 
...
```sql
DELETE FROM azure.web_pubsub.web_pub_sub_custom_certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
