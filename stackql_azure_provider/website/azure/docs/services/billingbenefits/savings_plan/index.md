...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.billingbenefits.savings_plan" /></td></tr>
</tbody></table>
...
utilization
FROM azure.billingbenefits.savings_plan
...
```sql
UPDATE azure.billingbenefits.savings_plan
SET 
...
```sql
EXEC azure.billingbenefits.savings_plan.validate_update 
@savings_plan_order_id='{{ savings_plan_order_id }}' --required, 
