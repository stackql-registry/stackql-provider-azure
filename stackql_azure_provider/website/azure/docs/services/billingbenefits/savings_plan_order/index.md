...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.billingbenefits.savings_plan_order" /></td></tr>
</tbody></table>
...
term,
type
FROM azure.billingbenefits.savings_plan_order
...
```sql
EXEC azure.billingbenefits.savings_plan_order.elevate 
