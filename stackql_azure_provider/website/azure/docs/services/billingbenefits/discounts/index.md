...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.billingbenefits.discounts" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.billingbenefits.discounts (
tags,
location,
properties,
managedBy,
...
```sql
DELETE FROM azure.billingbenefits.discounts
...
```sql
EXEC azure.billingbenefits.discounts.resource_group_list 
...
```sql
EXEC azure.billingbenefits.discounts.subscription_list 
@subscription_id='{{ subscription_id }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.billingbenefits.discounts.cancel 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.billingbenefits.discounts.scope_list 
