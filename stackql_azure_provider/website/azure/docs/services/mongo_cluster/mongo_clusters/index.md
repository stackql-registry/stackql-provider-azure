...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mongo_cluster.mongo_clusters" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.mongo_cluster.mongo_clusters
...
```sql
INSERT INTO azure.mongo_cluster.mongo_clusters (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.mongo_cluster.mongo_clusters
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.mongo_cluster.mongo_clusters
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.mongo_cluster.mongo_clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND mongo_cluster_name = '{{ mongo_cluster_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.mongo_cluster.mongo_clusters.list_connection_strings 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.mongo_cluster.mongo_clusters.promote 
@resource_group_name='{{ resource_group_name }}' --required, 
@mongo_cluster_name='{{ mongo_cluster_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
