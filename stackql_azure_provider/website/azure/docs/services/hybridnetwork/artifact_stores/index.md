...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridnetwork.artifact_stores" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.hybridnetwork.artifact_stores
...
```sql
INSERT INTO azure.hybridnetwork.artifact_stores (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.hybridnetwork.artifact_stores
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.hybridnetwork.artifact_stores
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.hybridnetwork.artifact_stores
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND artifact_store_name = '{{ artifact_store_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
