...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridnetwork.network_function_definition_groups" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.hybridnetwork.network_function_definition_groups
...
```sql
INSERT INTO azure.hybridnetwork.network_function_definition_groups (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.hybridnetwork.network_function_definition_groups
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.hybridnetwork.network_function_definition_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.hybridnetwork.network_function_definition_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND network_function_definition_group_name = '{{ network_function_definition_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
