...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridnetwork.publishers" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.hybridnetwork.publishers
...
```sql
INSERT INTO azure.hybridnetwork.publishers (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.hybridnetwork.publishers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.hybridnetwork.publishers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.hybridnetwork.publishers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND publisher_name = '{{ publisher_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
