...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.disconnectedoperations.disconnected_operations" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.disconnectedoperations.disconnected_operations
...
```sql
INSERT INTO azure.disconnectedoperations.disconnected_operations (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.disconnectedoperations.disconnected_operations
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.disconnectedoperations.disconnected_operations
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.disconnectedoperations.disconnected_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.disconnectedoperations.disconnected_operations.list_deployment_manifest 
@resource_group_name='{{ resource_group_name }}' --required, 
@name='{{ name }}' --required, 
