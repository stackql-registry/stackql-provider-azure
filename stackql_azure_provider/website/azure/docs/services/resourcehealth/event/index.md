...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resourcehealth.event" /></td></tr>
</tbody></table>
...
title,
type
FROM azure.resourcehealth.event
...
```sql
EXEC azure.resourcehealth.event.fetch_details_by_subscription_id_and_tracking_id 
...
```sql
EXEC azure.resourcehealth.event.fetch_billling_communication_details_by_subscription_id_and_tracking_id 
@event_tracking_id='{{ event_tracking_id }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
```
...
```sql
EXEC azure.resourcehealth.event.fetch_details_by_tenant_id_and_tracking_id 
@event_tracking_id='{{ event_tracking_id }}' --required
;
```
</TabItem>
