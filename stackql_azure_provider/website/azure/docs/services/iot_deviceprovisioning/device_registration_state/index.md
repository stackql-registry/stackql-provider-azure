...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iot_deviceprovisioning.device_registration_state" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM azure.iot_deviceprovisioning.device_registration_state
...
```sql
EXEC azure.iot_deviceprovisioning.device_registration_state.get_raw 
@id='{{ id }}' --required, 
...
```sql
EXEC azure.iot_deviceprovisioning.device_registration_state.query 
@id='{{ id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
