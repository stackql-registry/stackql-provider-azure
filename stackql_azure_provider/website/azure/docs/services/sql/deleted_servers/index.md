...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="deleted_servers" /></td></tr>
...
<tr>
    ...
    <td>The deletion time of the deleted server.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="originalId" /></td>
    <td><code>string</code></td>
    <td>The original ID of the server before deletion.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The version of the deleted server.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-location_name"><code>location_name</code></a>, <a href="#parameter-deleted_server_name"><code>deleted_server_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-deleted_server_name">
    <td><CopyableCode code="deleted_server_name" /></td>
    <td><code>string</code></td>
    <td>The name of the deleted server. Required.</td>
</tr>
...
AND deleted_server_name = '{{ deleted_server_name }}' -- required
...
@deleted_server_name='{{ deleted_server_name }}' --required, 
