...
Creates, updates, deletes, gets or lists an <code>encryption_protectors</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="encryption_protectors" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The version of the server key being used as encryption protector.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-encryption_protector_name"><code>encryption_protector_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets a server encryption protector.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets a list of server encryption protectors.</td>
</tr>
<tr>
...
- name: encryption_protectors
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the encryption_protectors resource.
    - name: server_name
      value: "{{ server_name }}"
      description: Required parameter for the encryption_protectors resource.
