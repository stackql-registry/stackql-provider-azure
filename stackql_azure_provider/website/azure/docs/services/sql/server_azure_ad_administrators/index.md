...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="server_azure_ad_administrators" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Type of the sever administrator. "ActiveDirectory" (ActiveDirectory)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Login name of the server administrator. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="sid" /></td>
    <td><code>string</code></td>
    <td>SID (object ID) of the server administrator. Required.</td>
</tr>
<tr>
...
<tr id="parameter-administrator_name">
    ...
    <td><code>string</code></td>
    <td>The name of server active directory administrator. "ActiveDirectory" Required.</td>
</tr>
...
```sql
REPLACE azure.sql.server_azure_ad_administrators
SET 
