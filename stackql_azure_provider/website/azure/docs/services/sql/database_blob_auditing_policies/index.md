...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="database_blob_auditing_policies" /></td></tr>
...
```sql
REPLACE azure.sql.database_blob_auditing_policies
SET 
...
```sql
EXEC azure.sql.database_blob_auditing_policies.list_by_database 
@resource_group_name='{{ resource_group_name }}' --required, 
