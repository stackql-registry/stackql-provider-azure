...
<tr>
    ...
    <td><code>string</code></td>
    <td>State of the private endpoint connection. Known values are: "Approving", "Ready", "Dropping", "Failed", and "Rejecting". (Approving, Ready, Dropping, Failed, Rejecting)</td>
</tr>
<tr>
...
```sql
REPLACE azure.sql.private_endpoint_connections
SET 
