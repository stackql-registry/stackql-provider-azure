...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="server_connection_policies" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The server connection type. Required. Known values are: "Default", "Redirect", and "Proxy". (Default, Redirect, Proxy)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-connection_policy_name"><code>connection_policy_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
```sql
REPLACE azure.sql.server_connection_policies
SET 
