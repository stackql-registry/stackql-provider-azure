...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="server_advanced_threat_protection_settings" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Specifies the state of the Advanced Threat Protection, whether it is enabled or disabled or a state has not been applied yet on the specific database or server. Required. Known values are: "New", "Enabled", and "Disabled". (New, Enabled, Disabled)</td>
</tr>
<tr>
...
- name: server_advanced_threat_protection_settings
  props:
    ...
    - name: advanced_threat_protection_name
      value: "{{ advanced_threat_protection_name }}"
      description: Required parameter for the server_advanced_threat_protection_settings resource.
...
```sql
REPLACE azure.sql.server_advanced_threat_protection_settings
SET 
