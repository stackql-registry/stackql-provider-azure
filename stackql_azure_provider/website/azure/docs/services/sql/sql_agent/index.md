...
Creates, updates, deletes, gets or lists a <code>sql_agent</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="sql_agent" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.sql.sql_agent" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The state of Sql Agent. Known values are: "Enabled" and "Disabled". (Enabled, Disabled)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets current instance sql agent configuration.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Puts new sql agent configuration to instance.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
```sql
INSERT INTO azure.sql.sql_agent (
properties,
resource_group_name,
...
- name: sql_agent
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the sql_agent resource.
