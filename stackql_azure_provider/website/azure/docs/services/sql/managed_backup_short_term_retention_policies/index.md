...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="managed_backup_short_term_retention_policies" /></td></tr>
...
```sql
REPLACE azure.sql.managed_backup_short_term_retention_policies
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
