...
<tr>
    ...
    <td><code>string</code></td>
    <td>Virtual Network Rule State. Known values are: "Initializing", "InProgress", "Ready", "Failed", "Deleting", and "Unknown". (Initializing, InProgress, Ready, Failed, Deleting, Unknown)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The ARM resource id of the virtual network subnet. Required.</td>
</tr>
</tbody>
</table>
</TabItem>
...
```sql
REPLACE azure.sql.virtual_network_rules
SET 
