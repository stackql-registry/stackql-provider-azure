...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="backup_short_term_retention_policies" /></td></tr>
...
<tr>
    <td><CopyableCode code="diffBackupIntervalInHours" /></td>
    <td><code>object</code></td>
    <td>The differential backup interval in hours. This is how many interval hours between each differential backup will be supported. This is only applicable to live databases but not dropped databases. Known values are: 12 and 24.</td>
</tr>
<tr>
...
```sql
REPLACE azure.sql.backup_short_term_retention_policies
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
