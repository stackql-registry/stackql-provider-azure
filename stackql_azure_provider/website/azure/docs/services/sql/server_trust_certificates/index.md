...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="server_trust_certificates" /></td></tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets a server trust certificate that was uploaded from SQL Server to SQL Managed Instance.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets a list of the server trust certificates used to secure communication between SQL Server and the specified SQL Managed Instance.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Uploads a server trust certificate from SQL Server to SQL Managed Instance.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes a server trust certificate that was uploaded from SQL Server to SQL Managed Instance.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-certificate_name">
    ...
    <td><code>string</code></td>
    <td>Name of of the certificate to get. Required.</td>
</tr>
...
```sql
REPLACE azure.sql.server_trust_certificates
SET 
