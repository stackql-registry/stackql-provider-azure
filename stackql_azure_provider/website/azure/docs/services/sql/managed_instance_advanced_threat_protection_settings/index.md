...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="managed_instance_advanced_threat_protection_settings" /></td></tr>
...
<tr>
    ...
    <td></td>
    <td>Get the managed instance's Advanced Threat Protection settings.</td>
</tr>
<tr>
...
```sql
REPLACE azure.sql.managed_instance_advanced_threat_protection_settings
SET 
