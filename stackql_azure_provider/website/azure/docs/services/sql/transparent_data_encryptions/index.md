...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="transparent_data_encryptions" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Specifies the encryption scan state of the transparent data encryption. Known values are: "None", "Resume", "Running", "Suspend", "Aborted", and "Completed". (None, Resume, Running, Suspend, Aborted, Completed)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-tde_name"><code>tde_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-tde_name"><code>tde_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Resume ongoing logical database's Transparent Data Encryption scan configuration.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-tde_name"><code>tde_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Suspend ongoing logical database's Transparent Data Encryption scan configuration.</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE azure.sql.transparent_data_encryptions
SET 
...
```sql
EXEC azure.sql.transparent_data_encryptions.resume 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@database_name='{{ database_name }}' --required, 
@tde_name='{{ tde_name }}' --required, 
...
```sql
EXEC azure.sql.transparent_data_encryptions.suspend 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@database_name='{{ database_name }}' --required, 
@tde_name='{{ tde_name }}' --required, 
