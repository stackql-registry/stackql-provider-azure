...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="managed_instance_private_endpoint_connections" /></td></tr>
...
- name: managed_instance_private_endpoint_connections
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the managed_instance_private_endpoint_connections resource.
...
```sql
REPLACE azure.sql.managed_instance_private_endpoint_connections
SET 
