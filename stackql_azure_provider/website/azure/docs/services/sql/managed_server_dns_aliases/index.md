...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="managed_server_dns_aliases" /></td></tr>
...
<tr>
    <td><CopyableCode code="azureDnsRecord" /></td>
    <td><code>string</code></td>
    <td>The fully qualified DNS record for managed server alias.</td>
</tr>
<tr>
    <td><CopyableCode code="publicAzureDnsRecord" /></td>
    <td><code>string</code></td>
    <td>The fully qualified public DNS record for managed server alias.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-dns_alias_name"><code>dns_alias_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td></td>
    <td>Gets a list of managed server DNS aliases for a managed server.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-managed_instance_name"><code>managed_instance_name</code></a>, <a href="#parameter-dns_alias_name"><code>dns_alias_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-oldManagedServerDnsAliasResourceId"><code>oldManagedServerDnsAliasResourceId</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-dns_alias_name">
    <td><CopyableCode code="dns_alias_name" /></td>
    <td><code>string</code></td>
    <td>Required.</td>
</tr>
...
AND dns_alias_name = '{{ dns_alias_name }}' -- required
...
```sql
REPLACE azure.sql.managed_server_dns_aliases
SET 
...
@dns_alias_name='{{ dns_alias_name }}' --required, 
