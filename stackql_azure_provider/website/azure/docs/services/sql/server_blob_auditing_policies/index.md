...
Creates, updates, deletes, gets or lists a <code>server_blob_auditing_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="server_blob_auditing_policies" /></td></tr>
...
<tr>
    ...
    <td></td>
    <td>Gets a server's blob auditing policy.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a server's blob auditing policy.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-server_name"><code>server_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Lists auditing settings of a server.</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE azure.sql.server_blob_auditing_policies
SET 
...
```sql
EXEC azure.sql.server_blob_auditing_policies.list_by_server 
@resource_group_name='{{ resource_group_name }}' --required, 
