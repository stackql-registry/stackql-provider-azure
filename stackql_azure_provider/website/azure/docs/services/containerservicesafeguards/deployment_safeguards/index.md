...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservicesafeguards.deployment_safeguards" /></td></tr>
</tbody></table>
...
type
FROM azure.containerservicesafeguards.deployment_safeguards
...
```sql
INSERT INTO azure.containerservicesafeguards.deployment_safeguards (
properties,
resource_uri
)
SELECT 
...
```sql
DELETE FROM azure.containerservicesafeguards.deployment_safeguards
WHERE resource_uri = '{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.containerservicesafeguards.deployment_safeguards.list_raw 
