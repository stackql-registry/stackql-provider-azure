...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.linked_services" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-linked_service_name"><code>linked_service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-linked_service_name"><code>linked_service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
type,
version
FROM azure.datafactory.linked_services
...
```sql
INSERT INTO azure.datafactory.linked_services (
properties,
resource_group_name,
factory_name,
linked_service_name,
...
```sql
REPLACE azure.datafactory.linked_services
SET 
...
```sql
DELETE FROM azure.datafactory.linked_services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND linked_service_name = '{{ linked_service_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
