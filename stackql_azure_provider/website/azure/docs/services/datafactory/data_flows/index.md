...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="data_flows" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.data_flows" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-data_flow_name"><code>data_flow_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-data_flow_name"><code>data_flow_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.datafactory.data_flows
...
```sql
INSERT INTO azure.datafactory.data_flows (
properties,
resource_group_name,
factory_name,
data_flow_name,
...
```sql
REPLACE azure.datafactory.data_flows
SET 
...
```sql
DELETE FROM azure.datafactory.data_flows
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND data_flow_name = '{{ data_flow_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
