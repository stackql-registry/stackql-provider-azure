...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="managed_virtual_networks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.managed_virtual_networks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Managed Virtual Network alias.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Managed Virtual Network ID.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Gets a managed Virtual Network.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Lists managed Virtual Networks.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-managed_virtual_network_name"><code>managed_virtual_network_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
    <td>Creates or updates a managed Virtual Network.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
type,
vNetId
FROM azure.datafactory.managed_virtual_networks
...
```sql
INSERT INTO azure.datafactory.managed_virtual_networks (
properties,
resource_group_name,
factory_name,
...
- name: managed_virtual_networks
  props:
    ...
    - name: properties
      description: |
        Managed Virtual Network properties. Required.
      value:
        vNetId: "{{ vNetId }}"
        alias: "{{ alias }}"
`}</CodeBlock>
...
```sql
REPLACE azure.datafactory.managed_virtual_networks
SET 
