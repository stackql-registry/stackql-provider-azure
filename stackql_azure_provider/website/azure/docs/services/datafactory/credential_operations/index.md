...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="credential_operations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.credential_operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>List of tags that can be used for describing the Credential.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-credential_name"><code>credential_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-credential_name"><code>credential_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-credential_name">
    <td><CopyableCode code="credential_name" /></td>
    <td><code>string</code></td>
    <td>Credential name. Required.</td>
</tr>
...
systemData,
type
FROM azure.datafactory.credential_operations
...
```sql
INSERT INTO azure.datafactory.credential_operations (
properties,
resource_group_name,
factory_name,
credential_name,
...
- name: credential_operations
  props:
    ...
    - name: properties
      description: |
        Properties of credentials. Required.
      value:
        type: "{{ type }}"
...
```sql
REPLACE azure.datafactory.credential_operations
SET 
...
```sql
DELETE FROM azure.datafactory.credential_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND credential_name = '{{ credential_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
