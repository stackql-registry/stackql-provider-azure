...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.datasets" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-dataset_name"><code>dataset_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-factory_name"><code>factory_name</code></a>, <a href="#parameter-dataset_name"><code>dataset_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.datafactory.datasets
...
```sql
INSERT INTO azure.datafactory.datasets (
properties,
resource_group_name,
factory_name,
dataset_name,
...
```sql
REPLACE azure.datafactory.datasets
SET 
...
```sql
DELETE FROM azure.datafactory.datasets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND dataset_name = '{{ dataset_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
