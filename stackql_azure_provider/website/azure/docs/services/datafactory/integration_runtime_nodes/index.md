...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datafactory.integration_runtime_nodes" /></td></tr>
</tbody></table>
...
version,
versionStatus
FROM azure.datafactory.integration_runtime_nodes
...
```sql
UPDATE azure.datafactory.integration_runtime_nodes
SET 
...
```sql
DELETE FROM azure.datafactory.integration_runtime_nodes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND integration_runtime_name = '{{ integration_runtime_name }}' --required
AND node_name = '{{ node_name }}' --required
...
```sql
EXEC azure.datafactory.integration_runtime_nodes.get_ip_address 
@resource_group_name='{{ resource_group_name }}' --required, 
