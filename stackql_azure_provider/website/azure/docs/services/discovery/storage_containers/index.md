...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.discovery.storage_containers" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="storageStore" /></td>
    <td><code>object</code></td>
    <td>Storage store properties. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>List StorageContainer resources by resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List StorageContainer resources by subscription ID.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a StorageContainer.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-storage_container_name"><code>storage_container_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>Update a StorageContainer.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-storage_container_name"><code>storage_container_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a StorageContainer.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.discovery.storage_containers
...
```sql
INSERT INTO azure.discovery.storage_containers (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.discovery.storage_containers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.discovery.storage_containers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.discovery.storage_containers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND storage_container_name = '{{ storage_container_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
