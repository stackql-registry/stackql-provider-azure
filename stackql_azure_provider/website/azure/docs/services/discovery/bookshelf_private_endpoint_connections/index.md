--- 
title: bookshelf_private_endpoint_connections
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>bookshelf_private_endpoint_connections</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="bookshelf_private_endpoint_connections" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.discovery.bookshelf_private_endpoint_connections" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_bookshelf', value: 'list_by_bookshelf' }
    ]}
>
<TabItem value="get">
...
<TabItem value="list_by_bookshelf">
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-bookshelf_name"><code>bookshelf_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the specified private endpoint connection associated with the bookshelf.</td>
</tr>
<tr>
    <td><a href="#list_by_bookshelf"><CopyableCode code="list_by_bookshelf" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td></td>
    <td>Lists all private endpoint connections for a bookshelf.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-bookshelf_name"><code>bookshelf_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Approves or updates the specified private endpoint connection.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
systemData,
type
FROM azure.discovery.bookshelf_private_endpoint_connections
...
```sql
INSERT INTO azure.discovery.bookshelf_private_endpoint_connections (
properties,
resource_group_name,
bookshelf_name,
...
- name: bookshelf_private_endpoint_connections
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the bookshelf_private_endpoint_connections resource.
    - name: bookshelf_name
...
```sql
REPLACE azure.discovery.bookshelf_private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.discovery.bookshelf_private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND bookshelf_name = '{{ bookshelf_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
