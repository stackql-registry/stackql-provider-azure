...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.connected_vmware.vcenters" /></td></tr>
</tbody></table>
...
uuid,
version
FROM azure.connected_vmware.vcenters
...
```sql
INSERT INTO azure.connected_vmware.vcenters (
location,
extendedLocation,
tags,
kind,
...
```sql
UPDATE azure.connected_vmware.vcenters
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
DELETE FROM azure.connected_vmware.vcenters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND vcenter_name = '{{ vcenter_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
AND force = '{{ force }}'
