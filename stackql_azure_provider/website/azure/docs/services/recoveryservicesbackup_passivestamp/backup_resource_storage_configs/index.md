...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recoveryservicesbackup_passivestamp.backup_resource_storage_configs" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.recoveryservicesbackup_passivestamp.backup_resource_storage_configs
...
```sql
UPDATE azure.recoveryservicesbackup_passivestamp.backup_resource_storage_configs
SET 
location = '{{ location }}',
tags = '{{ tags }}',
eTag = '{{ eTag }}',
...
```sql
EXEC azure.recoveryservicesbackup_passivestamp.backup_resource_storage_configs.patch 
@vault_name='{{ vault_name }}' --required, 
