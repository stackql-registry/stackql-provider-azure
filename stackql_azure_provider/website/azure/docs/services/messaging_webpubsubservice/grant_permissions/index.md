...
Creates, updates, deletes, gets or lists a <code>grant_permissions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="grant_permissions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.messaging_webpubsubservice.grant_permissions" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#grant_permission"><CopyableCode code="grant_permission" /></a></td>
    ...
    <td>Grant permission to the connection. Grant permission to the connection.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="grant_permission"
    values={[
        { label: 'grant_permission', value: 'grant_permission' }
    ]}
>
<TabItem value="grant_permission">

Grant permission to the connection. Grant permission to the connection.

```sql
EXEC azure.messaging_webpubsubservice.grant_permissions.grant_permission 
