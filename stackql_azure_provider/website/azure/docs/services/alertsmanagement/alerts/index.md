...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.alertsmanagement.alerts" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.alertsmanagement.alerts
...
```sql
EXEC azure.alertsmanagement.alerts.get_history_tenant 
...
```sql
EXEC azure.alertsmanagement.alerts.get_history 
...
```sql
EXEC azure.alertsmanagement.alerts.get_enrichments 
@scope='{{ scope }}' --required, 
@alert_id='{{ alert_id }}' --required
;
```
...
```sql
EXEC azure.alertsmanagement.alerts.change_state_tenant 
@alert_id='{{ alert_id }}' --required, 
...
```sql
EXEC azure.alertsmanagement.alerts.change_state 
@scope='{{ scope }}' --required, 
@alert_id='{{ alert_id }}' --required, 
@newState='{{ newState }}' --required 
@@json=
...
```sql
EXEC azure.alertsmanagement.alerts.meta_data 
