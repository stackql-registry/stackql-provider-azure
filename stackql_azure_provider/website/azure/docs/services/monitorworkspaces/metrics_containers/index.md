...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.monitorworkspaces.metrics_containers" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.monitorworkspaces.metrics_containers
...
```sql
INSERT INTO azure.monitorworkspaces.metrics_containers (
properties,
resource_group_name,
...
```sql
REPLACE azure.monitorworkspaces.metrics_containers
SET 
