...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.data_box_edge.monitoring_config" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.data_box_edge.monitoring_config
...
```sql
INSERT INTO azure.data_box_edge.monitoring_config (
properties,
device_name,
role_name,
resource_group_name,
...
```sql
REPLACE azure.data_box_edge.monitoring_config
SET 
...
```sql
DELETE FROM azure.data_box_edge.monitoring_config
WHERE device_name = '{{ device_name }}' --required
AND role_name = '{{ role_name }}' --required
AND resource_group_name = '{{ resource_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.data_box_edge.monitoring_config.list_raw 
@device_name='{{ device_name }}' --required, 
