...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.data_box_edge.diagnostic_settings" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.data_box_edge.diagnostic_settings.get_diagnostic_remote_support_settings 
@device_name='{{ device_name }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.data_box_edge.diagnostic_settings.update_diagnostic_remote_support_settings 
@device_name='{{ device_name }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
