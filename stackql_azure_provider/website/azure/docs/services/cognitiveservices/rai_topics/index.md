...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.rai_topics" /></td></tr>
</tbody></table>
...
topicName,
type
FROM azure.cognitiveservices.rai_topics
...
```sql
INSERT INTO azure.cognitiveservices.rai_topics (
properties,
tags,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cognitiveservices.rai_topics
SET 
...
```sql
DELETE FROM azure.cognitiveservices.rai_topics
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND rai_topic_name = '{{ rai_topic_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
