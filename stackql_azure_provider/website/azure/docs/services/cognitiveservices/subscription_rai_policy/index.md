...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.subscription_rai_policy" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.cognitiveservices.subscription_rai_policy
...
```sql
INSERT INTO azure.cognitiveservices.subscription_rai_policy (
properties,
tags,
rai_policy_name,
subscription_id
...
```sql
REPLACE azure.cognitiveservices.subscription_rai_policy
SET 
...
```sql
DELETE FROM azure.cognitiveservices.subscription_rai_policy
WHERE rai_policy_name = '{{ rai_policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
```
