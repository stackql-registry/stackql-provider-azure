...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.test_rai_external_safety_provider" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.cognitiveservices.test_rai_external_safety_provider (
properties,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cognitiveservices.test_rai_external_safety_provider
SET 
