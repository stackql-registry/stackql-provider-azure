...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.deleted_accounts" /></td></tr>
</tbody></table>
...
type,
userOwnedStorage
FROM azure.cognitiveservices.deleted_accounts
...
```sql
DELETE FROM azure.cognitiveservices.deleted_accounts
WHERE location = '{{ location }}' --required
AND resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
