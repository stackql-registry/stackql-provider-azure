...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.agent_applications" /></td></tr>
</tbody></table>
...
type
FROM azure.cognitiveservices.agent_applications
...
```sql
INSERT INTO azure.cognitiveservices.agent_applications (
properties,
resource_group_name,
account_name,
project_name,
...
```sql
REPLACE azure.cognitiveservices.agent_applications
SET 
...
```sql
DELETE FROM azure.cognitiveservices.agent_applications
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND project_name = '{{ project_name }}' --required
AND name = '{{ name }}' --required
...
```sql
EXEC azure.cognitiveservices.agent_applications.list_agents 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.cognitiveservices.agent_applications.enable 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@project_name='{{ project_name }}' --required, 
@name='{{ name }}' --required, 
...
```sql
EXEC azure.cognitiveservices.agent_applications.disable 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@project_name='{{ project_name }}' --required, 
@name='{{ name }}' --required, 
