...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The private link resource group ids.</td>
</tr>
<tr>
...
<tr id="parameter-private_endpoint_connection_name">
    ...
    <td><code>string</code></td>
    <td>The name of the private endpoint connection associated with the Cognitive Services Account. Required.</td>
</tr>
...
systemData,
type
FROM azure.cognitiveservices.private_endpoint_connections
...
```sql
INSERT INTO azure.cognitiveservices.private_endpoint_connections (
properties,
location,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cognitiveservices.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.cognitiveservices.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
