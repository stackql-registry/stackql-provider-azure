...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.accounts" /></td></tr>
</tbody></table>
...
type,
userOwnedStorage
FROM azure.cognitiveservices.accounts
...
```sql
INSERT INTO azure.cognitiveservices.accounts (
properties,
tags,
location,
kind,
...
```sql
UPDATE azure.cognitiveservices.accounts
SET 
...
```sql
DELETE FROM azure.cognitiveservices.accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.cognitiveservices.accounts.list_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.cognitiveservices.accounts.list_skus 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.cognitiveservices.accounts.list_usages 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}'
...
```sql
EXEC azure.cognitiveservices.accounts.list_models 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.cognitiveservices.accounts.regenerate_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.cognitiveservices.accounts.evaluate_deployment_policies 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
