...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="rai_blocklists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.rai_blocklists" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Description of the block list.</td>
</tr>
<tr>
...
tags,
type
FROM azure.cognitiveservices.rai_blocklists
...
```sql
INSERT INTO azure.cognitiveservices.rai_blocklists (
properties,
tags,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cognitiveservices.rai_blocklists
SET 
...
```sql
DELETE FROM azure.cognitiveservices.rai_blocklists
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND rai_blocklist_name = '{{ rai_blocklist_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
