...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.computes" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.cognitiveservices.computes
...
```sql
INSERT INTO azure.cognitiveservices.computes (
properties,
location,
tags,
kind,
...
```sql
UPDATE azure.cognitiveservices.computes
SET 
...
```sql
REPLACE azure.cognitiveservices.computes
SET 
properties = '{{ properties }}',
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.cognitiveservices.computes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND compute_name = '{{ compute_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.cognitiveservices.computes.start 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.cognitiveservices.computes.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@compute_name='{{ compute_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.cognitiveservices.computes.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@compute_name='{{ compute_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
