...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitiveservices.rai_tool_labels" /></td></tr>
</tbody></table>
...
toolConnectionName,
type
FROM azure.cognitiveservices.rai_tool_labels
...
```sql
INSERT INTO azure.cognitiveservices.rai_tool_labels (
properties,
tags,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cognitiveservices.rai_tool_labels
SET 
...
```sql
DELETE FROM azure.cognitiveservices.rai_tool_labels
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND rai_tool_connection_name = '{{ rai_tool_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
