...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerorchestratorruntime.bgp_peers" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="myAsn" /></td>
    <td><code>integer</code></td>
    <td>My ASN. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="peerAddress" /></td>
    <td><code>string</code></td>
    <td>Peer Address. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="peerAsn" /></td>
    <td><code>integer</code></td>
    <td>Peer ASN. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_uri"><code>resource_uri</code></a>, <a href="#parameter-bgp_peer_name"><code>bgp_peer_name</code></a></td>
    <td></td>
    <td>Get a BgpPeer.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List BgpPeer resources by parent.</td>
</tr>
<tr>
...
<tbody>
<tr id="parameter-bgp_peer_name">
    <td><CopyableCode code="bgp_peer_name" /></td>
    <td><code>string</code></td>
    <td>The name of the BgpPeer. Required.</td>
</tr>
...
systemData,
type
FROM azure.containerorchestratorruntime.bgp_peers
...
```sql
INSERT INTO azure.containerorchestratorruntime.bgp_peers (
properties,
resource_uri,
bgp_peer_name
)
...
```sql
REPLACE azure.containerorchestratorruntime.bgp_peers
SET 
...
```sql
DELETE FROM azure.containerorchestratorruntime.bgp_peers
WHERE resource_uri = '{{ resource_uri }}' --required
AND bgp_peer_name = '{{ bgp_peer_name }}' --required
;
```
