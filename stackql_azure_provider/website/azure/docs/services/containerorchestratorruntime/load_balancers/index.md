...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerorchestratorruntime.load_balancers" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.containerorchestratorruntime.load_balancers
...
```sql
INSERT INTO azure.containerorchestratorruntime.load_balancers (
properties,
resource_uri,
load_balancer_name
)
...
```sql
REPLACE azure.containerorchestratorruntime.load_balancers
SET 
...
```sql
DELETE FROM azure.containerorchestratorruntime.load_balancers
WHERE resource_uri = '{{ resource_uri }}' --required
AND load_balancer_name = '{{ load_balancer_name }}' --required
;
```
