...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_linker.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Enum. Indicates the action type. "Internal" refers to actions that are for internal only APIs. Known values are: "Internal", "enable", and "optOut".</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td></td>
    <td>Lists the available ServiceLinker REST API operations.</td>
</tr>
</tbody>
</table>
...
isDataAction,
origin
FROM azure.service_linker.operations
;
```
</TabItem>
</Tabs>
