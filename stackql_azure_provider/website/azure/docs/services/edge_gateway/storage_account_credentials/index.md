...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edge_gateway.storage_account_credentials" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.edge_gateway.storage_account_credentials.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
