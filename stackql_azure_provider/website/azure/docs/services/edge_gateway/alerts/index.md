...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edge_gateway.alerts" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-accept-language"><code>accept-language</code></a></td>
    <td>Gets all the alerts for a data box edge/gateway device.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.edge_gateway.alerts.get_raw 
...
```sql
EXEC azure.edge_gateway.alerts.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
