...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edge_gateway.triggers" /></td></tr>
</tbody></table>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Specify $filter='CustomContextTag eq ' to filter on custom context tag property</td>
</tr>
...
```sql
EXEC azure.edge_gateway.triggers.get_raw 
...
```sql
EXEC azure.edge_gateway.triggers.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}', 
