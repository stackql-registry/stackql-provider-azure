...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edge_gateway.shares" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-accept-language"><code>accept-language</code></a></td>
    <td>Lists all the shares in a data box edge/gateway device.</td>
</tr>
<tr>
    ...
    <td></td>
    <td></td>
    <td>Refreshes the share metadata with the data from the cloud.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.edge_gateway.shares.get_raw 
...
```sql
EXEC azure.edge_gateway.shares.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
...
```sql
EXEC azure.edge_gateway.shares.refresh 
