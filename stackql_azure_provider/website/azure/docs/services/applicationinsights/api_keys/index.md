...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.applicationinsights.api_keys" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-resource_name"><code>resource_name</code></a>, <a href="#parameter-key_id"><code>key_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr id="parameter-key_id">
    ...
    <td><code>string</code></td>
    <td>The API Key ID. This is unique within a Application Insights component. Required.</td>
</tr>
...
FROM azure.applicationinsights.api_keys
...
```sql
INSERT INTO azure.applicationinsights.api_keys (
name,
linkedReadProperties,
linkedWriteProperties,
resource_group_name,
...
```sql
DELETE FROM azure.applicationinsights.api_keys
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND key_id = '{{ key_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
