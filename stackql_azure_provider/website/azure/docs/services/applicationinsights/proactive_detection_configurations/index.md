...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.applicationinsights.proactive_detection_configurations" /></td></tr>
</tbody></table>
...
FROM azure.applicationinsights.proactive_detection_configurations
...
```sql
UPDATE azure.applicationinsights.proactive_detection_configurations
SET 
name = '{{ name }}',
enabled = {{ enabled }},
