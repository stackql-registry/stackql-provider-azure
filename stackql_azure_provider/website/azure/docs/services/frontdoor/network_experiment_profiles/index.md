...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.frontdoor.network_experiment_profiles" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.frontdoor.network_experiment_profiles
...
```sql
INSERT INTO azure.frontdoor.network_experiment_profiles (
location,
tags,
properties,
etag,
...
```sql
UPDATE azure.frontdoor.network_experiment_profiles
SET 
...
```sql
REPLACE azure.frontdoor.network_experiment_profiles
SET 
location = '{{ location }}',
tags = '{{ tags }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.frontdoor.network_experiment_profiles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND profile_name = '{{ profile_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
