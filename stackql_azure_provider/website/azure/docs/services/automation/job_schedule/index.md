...
Creates, updates, deletes, gets or lists a <code>job_schedule</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="job_schedule" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the id of job schedule.</td>
</tr>
<tr>
    <td><CopyableCode code="parameters" /></td>
    <td><code>object</code></td>
    <td>Gets or sets the parameters of the job schedule.</td>
</tr>
<tr>
    <td><CopyableCode code="runOn" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the hybrid worker group that the scheduled job should run on.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Gets or sets the schedule.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-automation_account_name"><code>automation_account_name</code></a>, <a href="#parameter-job_schedule_id"><code>job_schedule_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-automation_account_name"><code>automation_account_name</code></a>, <a href="#parameter-job_schedule_id"><code>job_schedule_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
<tr id="parameter-job_schedule_id">
    ...
    <td><code>string</code></td>
    <td>The job schedule name. Required.</td>
</tr>
...
systemData,
type
FROM azure.automation.job_schedule
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND automation_account_name = '{{ automation_account_name }}' -- required
AND job_schedule_id = '{{ job_schedule_id }}' -- required
...
```sql
INSERT INTO azure.automation.job_schedule (
properties,
resource_group_name,
...
- name: job_schedule
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the job_schedule resource.
    - name: automation_account_name
      value: "{{ automation_account_name }}"
      description: Required parameter for the job_schedule resource.
    - name: job_schedule_id
      value: "{{ job_schedule_id }}"
      description: Required parameter for the job_schedule resource.
...
```sql
DELETE FROM azure.automation.job_schedule
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND automation_account_name = '{{ automation_account_name }}' --required
AND job_schedule_id = '{{ job_schedule_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
