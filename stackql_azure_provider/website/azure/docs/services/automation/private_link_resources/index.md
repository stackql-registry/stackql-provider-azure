...
<tbody>
<tr>
    <td><a href="#automation"><CopyableCode code="automation" /></a></td>
    ...
    <td></td>
    <td>Gets the private link resources that need to be created for Automation account.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.automation.private_link_resources.automation 
