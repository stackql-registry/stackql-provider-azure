...
<tr>
    ...
    <td><code>string (date-time)</code></td>
    <td>Gets or sets the expiry time.</td>
</tr>
<tr>
    <td><CopyableCode code="isEnabled" /></td>
    <td><code>boolean</code></td>
    <td>Gets or sets the value of the enabled flag of the webhook.</td>
</tr>
<tr>
    <td><CopyableCode code="lastInvokedTime" /></td>
    <td><code>string (date-time)</code></td>
    <td>Gets or sets the last invoked time.</td>
</tr>
<tr>
    <td><CopyableCode code="lastModifiedBy" /></td>
    <td><code>string</code></td>
    <td>Details of the user who last modified the Webhook.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Gets or sets the parameters of the job that is created when the webhook calls the runbook it is associated with.</td>
</tr>
<tr>
    <td><CopyableCode code="runOn" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the name of the hybrid worker group the webhook job will run on.</td>
</tr>
<tr>
    <td><CopyableCode code="runbook" /></td>
    <td><code>object</code></td>
    <td>Gets or sets the runbook the webhook is associated with.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the webhook uri.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-automation_account_name"><code>automation_account_name</code></a>, <a href="#parameter-webhook_name"><code>webhook_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-automation_account_name"><code>automation_account_name</code></a>, <a href="#parameter-webhook_name"><code>webhook_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
...
<tr id="parameter-webhook_name">
    ...
    <td><code>string</code></td>
    <td>The webhook name. Required.</td>
</tr>
