...
Creates, updates, deletes, gets or lists a <code>database_migrations_sql_vm</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="database_migrations_sql_vm" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.data_migration.database_migrations_sql_vm" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-sql_virtual_machine_name"><code>sql_virtual_machine_name</code></a>, <a href="#parameter-target_db_name"><code>target_db_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
<tr id="parameter-sql_virtual_machine_name">
    ...
    <td><code>string</code></td>
    <td>The name of the target SQL Virtual Machine. Required.</td>
</tr>
...
type
FROM azure.data_migration.database_migrations_sql_vm
...
```sql
INSERT INTO azure.data_migration.database_migrations_sql_vm (
properties,
resource_group_name,
...
- name: database_migrations_sql_vm
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the database_migrations_sql_vm resource.
...
```sql
REPLACE azure.data_migration.database_migrations_sql_vm
SET 
...
```sql
DELETE FROM azure.data_migration.database_migrations_sql_vm
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sql_virtual_machine_name = '{{ sql_virtual_machine_name }}' --required
AND target_db_name = '{{ target_db_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.data_migration.database_migrations_sql_vm.cancel 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.data_migration.database_migrations_sql_vm.cutover 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_virtual_machine_name='{{ sql_virtual_machine_name }}' --required, 
@target_db_name='{{ target_db_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
