...
type
FROM azure.data_migration.database_migrations_sql_mi
...
```sql
INSERT INTO azure.data_migration.database_migrations_sql_mi (
properties,
resource_group_name,
...
```sql
REPLACE azure.data_migration.database_migrations_sql_mi
SET 
...
```sql
DELETE FROM azure.data_migration.database_migrations_sql_mi
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND managed_instance_name = '{{ managed_instance_name }}' --required
AND target_db_name = '{{ target_db_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.data_migration.database_migrations_sql_mi.cancel 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.data_migration.database_migrations_sql_mi.cutover 
@resource_group_name='{{ resource_group_name }}' --required, 
@managed_instance_name='{{ managed_instance_name }}' --required, 
@target_db_name='{{ target_db_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
