...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.napsteromniagentapi.organizations" /></td></tr>
</tbody></table>
...
type,
user
FROM azure.napsteromniagentapi.organizations
...
```sql
INSERT INTO azure.napsteromniagentapi.organizations (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.napsteromniagentapi.organizations
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure.napsteromniagentapi.organizations
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.napsteromniagentapi.organizations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND organizationname = '{{ organizationname }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
