...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridcontainerservice.provisioned_cluster_instances" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.hybridcontainerservice.provisioned_cluster_instances
...
```sql
INSERT INTO azure.hybridcontainerservice.provisioned_cluster_instances (
properties,
extendedLocation,
...
```sql
REPLACE azure.hybridcontainerservice.provisioned_cluster_instances
SET 
...
```sql
DELETE FROM azure.hybridcontainerservice.provisioned_cluster_instances
WHERE connected_cluster_resource_uri = '{{ connected_cluster_resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.hybridcontainerservice.provisioned_cluster_instances.list_user_kubeconfig 
@connected_cluster_resource_uri='{{ connected_cluster_resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.hybridcontainerservice.provisioned_cluster_instances.list_admin_kubeconfig 
@connected_cluster_resource_uri='{{ connected_cluster_resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.hybridcontainerservice.provisioned_cluster_instances.get_upgrade_profile 
@connected_cluster_resource_uri='{{ connected_cluster_resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.hybridcontainerservice.provisioned_cluster_instances.list_raw 
@connected_cluster_resource_uri='{{ connected_cluster_resource_uri }}' --required
;
```
</TabItem>
