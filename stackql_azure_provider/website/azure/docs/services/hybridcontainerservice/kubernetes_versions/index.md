...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridcontainerservice.kubernetes_versions" /></td></tr>
</tbody></table>
...
type,
values
FROM azure.hybridcontainerservice.kubernetes_versions
...
```sql
DELETE FROM azure.hybridcontainerservice.kubernetes_versions
WHERE custom_location_resource_uri = '{{ custom_location_resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.hybridcontainerservice.kubernetes_versions.get_kubernetes_versions 
...
```sql
EXEC azure.hybridcontainerservice.kubernetes_versions.put_kubernetes_versions 
@custom_location_resource_uri='{{ custom_location_resource_uri }}' --required 
@@json=
'{
