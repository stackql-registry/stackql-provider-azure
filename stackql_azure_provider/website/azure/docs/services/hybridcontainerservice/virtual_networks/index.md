...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybridcontainerservice.virtual_networks" /></td></tr>
</tbody></table>
...
vlanID,
vmipPool
FROM azure.hybridcontainerservice.virtual_networks
...
```sql
INSERT INTO azure.hybridcontainerservice.virtual_networks (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.hybridcontainerservice.virtual_networks
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.hybridcontainerservice.virtual_networks
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.hybridcontainerservice.virtual_networks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_network_name = '{{ virtual_network_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.hybridcontainerservice.virtual_networks.retrieve 
@resource_group_name='{{ resource_group_name }}' --required, 
