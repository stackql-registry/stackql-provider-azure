...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.storage_cache.expansion_jobs" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.storage_cache.expansion_jobs
...
```sql
INSERT INTO azure.storage_cache.expansion_jobs (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.storage_cache.expansion_jobs
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.storage_cache.expansion_jobs
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.storage_cache.expansion_jobs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND aml_filesystem_name = '{{ aml_filesystem_name }}' --required
AND expansion_job_name = '{{ expansion_job_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
