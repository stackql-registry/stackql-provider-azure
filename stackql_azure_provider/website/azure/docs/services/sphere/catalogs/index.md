...
```sql
EXEC azure.sphere.catalogs.list_deployments 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.sphere.catalogs.list_device_groups 
@resource_group_name='{{ resource_group_name }}' --required, 
@catalog_name='{{ catalog_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}', 
...
```sql
EXEC azure.sphere.catalogs.list_device_insights 
@resource_group_name='{{ resource_group_name }}' --required, 
@catalog_name='{{ catalog_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}', 
...
```sql
EXEC azure.sphere.catalogs.list_devices 
@resource_group_name='{{ resource_group_name }}' --required, 
@catalog_name='{{ catalog_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@$filter='{{ $filter }}', 
