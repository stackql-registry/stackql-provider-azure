...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_deployments.deployments" /></td></tr>
</tbody></table>
...
validatedResources,
validationLevel
FROM azure.resource_deployments.deployments
...
```sql
INSERT INTO azure.resource_deployments.deployments (
location,
properties,
tags,
identity,
...
```sql
REPLACE azure.resource_deployments.deployments
SET 
location = '{{ location }}',
...
```sql
DELETE FROM azure.resource_deployments.deployments
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND deployment_name = '{{ deployment_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.resource_deployments.deployments.check_existence 
@resource_group_name='{{ resource_group_name }}' --required, 
@deployment_name='{{ deployment_name }}' --required, 
...
```sql
EXEC azure.resource_deployments.deployments.check_existence_at_scope 
@scope='{{ scope }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.check_existence_at_tenant_scope 
@deployment_name='{{ deployment_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.resource_deployments.deployments.check_existence_at_management_group_scope 
@group_id='{{ group_id }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.check_existence_at_subscription_scope 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.cancel_at_scope 
@scope='{{ scope }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.validate_at_scope 
@scope='{{ scope }}' --required, 
@deployment_name='{{ deployment_name }}' --required 
@@json=
'{
...
```sql
EXEC azure.resource_deployments.deployments.export_template_at_scope 
@scope='{{ scope }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.cancel_at_tenant_scope 
@deployment_name='{{ deployment_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.resource_deployments.deployments.validate_at_tenant_scope 
@deployment_name='{{ deployment_name }}' --required 
@@json=
'{
"location": "{{ location }}", 
...
```sql
EXEC azure.resource_deployments.deployments.what_if_at_tenant_scope 
@deployment_name='{{ deployment_name }}' --required 
@@json=
'{
"location": "{{ location }}", 
...
```sql
EXEC azure.resource_deployments.deployments.export_template_at_tenant_scope 
@deployment_name='{{ deployment_name }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.resource_deployments.deployments.cancel_at_management_group_scope 
@group_id='{{ group_id }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.validate_at_management_group_scope 
@group_id='{{ group_id }}' --required, 
@deployment_name='{{ deployment_name }}' --required 
@@json=
'{
...
```sql
EXEC azure.resource_deployments.deployments.what_if_at_management_group_scope 
@group_id='{{ group_id }}' --required, 
@deployment_name='{{ deployment_name }}' --required 
@@json=
'{
...
```sql
EXEC azure.resource_deployments.deployments.export_template_at_management_group_scope 
@group_id='{{ group_id }}' --required, 
@deployment_name='{{ deployment_name }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.cancel_at_subscription_scope 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.validate_at_subscription_scope 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.resource_deployments.deployments.what_if_at_subscription_scope 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.resource_deployments.deployments.export_template_at_subscription_scope 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
```
...
```sql
EXEC azure.resource_deployments.deployments.cancel 
@resource_group_name='{{ resource_group_name }}' --required, 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.resource_deployments.deployments.validate 
@resource_group_name='{{ resource_group_name }}' --required, 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.resource_deployments.deployments.what_if 
@resource_group_name='{{ resource_group_name }}' --required, 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.resource_deployments.deployments.export_template 
@resource_group_name='{{ resource_group_name }}' --required, 
@deployment_name='{{ deployment_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.resource_deployments.deployments.calculate_template_hash 
