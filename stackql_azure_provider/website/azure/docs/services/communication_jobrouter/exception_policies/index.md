...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.communication_jobrouter.exception_policies" /></td></tr>
</tbody></table>
...
etag,
exceptionRules
FROM azure.communication_jobrouter.exception_policies
...
```sql
DELETE FROM azure.communication_jobrouter.exception_policies
WHERE exception_policy_id = '{{ exception_policy_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
