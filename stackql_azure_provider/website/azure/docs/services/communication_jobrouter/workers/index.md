...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.communication_jobrouter.workers" /></td></tr>
</tbody></table>
...
state,
tags
FROM azure.communication_jobrouter.workers
...
```sql
DELETE FROM azure.communication_jobrouter.workers
WHERE worker_id = '{{ worker_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
