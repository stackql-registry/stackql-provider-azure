...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.communication_jobrouter.distribution_policies" /></td></tr>
</tbody></table>
...
FROM azure.communication_jobrouter.distribution_policies
...
```sql
DELETE FROM azure.communication_jobrouter.distribution_policies
WHERE distribution_policy_id = '{{ distribution_policy_id }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
