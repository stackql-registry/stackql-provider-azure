...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.databasewatcher.alert_rule_resources" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.databasewatcher.alert_rule_resources
...
```sql
INSERT INTO azure.databasewatcher.alert_rule_resources (
properties,
resource_group_name,
watcher_name,
...
```sql
REPLACE azure.databasewatcher.alert_rule_resources
SET 
...
```sql
DELETE FROM azure.databasewatcher.alert_rule_resources
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND watcher_name = '{{ watcher_name }}' --required
AND alert_rule_resource_name = '{{ alert_rule_resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
