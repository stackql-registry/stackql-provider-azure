...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.prescription_maps" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.prescription_maps (
party_id,
prescription_map_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.prescription_maps
SET 
...
```sql
DELETE FROM azure.agrifood_farming.prescription_maps
...
```sql
EXEC azure.agrifood_farming.prescription_maps.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.prescription_maps.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.prescription_maps.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure.agrifood_farming.prescription_maps.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.prescription_maps.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
