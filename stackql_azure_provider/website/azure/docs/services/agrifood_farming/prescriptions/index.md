...
Creates, updates, deletes, gets or lists a <code>prescriptions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="prescriptions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.prescriptions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-prescription_id"><code>prescription_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or Updates a prescription resource under a particular party.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-prescription_id"><code>prescription_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified prescription resource under a particular party.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-prescription_id"><code>prescription_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified prescription resource under a particular party.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of prescription resources across all parties.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of prescription resources under a particular party.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get a cascade delete job for specified prescription.</td>
</tr>
<tr>
    <td><a href="#create_cascade_delete_job"><CopyableCode code="create_cascade_delete_job" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-prescriptionId"><code>prescriptionId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create a cascade delete job for specified prescription.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-prescriptionId">
    <td><CopyableCode code="prescriptionId" /></td>
    <td><code>string</code></td>
    <td>ID of the prescription to be deleted. Required.</td>
</tr>
<tr id="parameter-prescription_id">
    <td><CopyableCode code="prescription_id" /></td>
    <td><code>string</code></td>
    <td>Id of the prescription. Required.</td>
</tr>
...
```sql
INSERT INTO azure.agrifood_farming.prescriptions (
party_id,
prescription_id,
endpoint
)
...
- name: prescriptions
  props:
    - name: party_id
      value: "{{ party_id }}"
      description: Required parameter for the prescriptions resource.
...
```sql
REPLACE azure.agrifood_farming.prescriptions
SET 
...
```sql
DELETE FROM azure.agrifood_farming.prescriptions
...
```sql
EXEC azure.agrifood_farming.prescriptions.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.prescriptions.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.prescriptions.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure.agrifood_farming.prescriptions.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.prescriptions.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
@partyId='{{ partyId }}' --required, 
@prescriptionId='{{ prescriptionId }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
</TabItem>
