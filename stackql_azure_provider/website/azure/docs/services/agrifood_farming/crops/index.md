...
Creates, updates, deletes, gets or lists a <code>crops</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="crops" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.crops" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-crop_id"><code>crop_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates a crop resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-crop_id"><code>crop_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes Crop for given crop id.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-crop_id"><code>crop_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified crop resource.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of crop resources.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-crop_id">
    <td><CopyableCode code="crop_id" /></td>
    <td><code>string</code></td>
    <td>Id of the crop. Required.</td>
</tr>
...
```sql
INSERT INTO azure.agrifood_farming.crops (
crop_id,
endpoint
)
SELECT 
...
```sql
REPLACE azure.agrifood_farming.crops
SET 
...
```sql
DELETE FROM azure.agrifood_farming.crops
...
```sql
EXEC azure.agrifood_farming.crops.get_raw 
@crop_id='{{ crop_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.crops.list_raw 
@endpoint='{{ endpoint }}' --required, 
