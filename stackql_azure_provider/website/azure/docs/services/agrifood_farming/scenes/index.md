...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.scenes" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.agrifood_farming.scenes.list_raw 
...
```sql
EXEC azure.agrifood_farming.scenes.get_stac_feature 
...
```sql
EXEC azure.agrifood_farming.scenes.download 
...
```sql
EXEC azure.agrifood_farming.scenes.search_features 
@collection_id='{{ collection_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
