...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.sensor_partner_integrations" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.sensor_partner_integrations (
sensor_partner_id,
integration_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.sensor_partner_integrations
SET 
...
```sql
DELETE FROM azure.agrifood_farming.sensor_partner_integrations
...
```sql
EXEC azure.agrifood_farming.sensor_partner_integrations.get_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.sensor_partner_integrations.list_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.sensor_partner_integrations.check_consent 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@integration_id='{{ integration_id }}' --required, 
@key='{{ key }}' --required, 
@endpoint='{{ endpoint }}' --required
...
```sql
EXEC azure.agrifood_farming.sensor_partner_integrations.generate_consent_link 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@integration_id='{{ integration_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
