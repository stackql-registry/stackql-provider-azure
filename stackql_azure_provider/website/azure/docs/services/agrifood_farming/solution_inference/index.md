...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.solution_inference" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.solution_inference (
solution_id,
endpoint
)
SELECT 
...
```sql
REPLACE azure.agrifood_farming.solution_inference
SET 
...
```sql
EXEC azure.agrifood_farming.solution_inference.cancel 
@solution_id='{{ solution_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.solution_inference.fetch 
@solution_id='{{ solution_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
