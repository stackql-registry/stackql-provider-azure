...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.tillage_data" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.tillage_data (
party_id,
tillage_data_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.tillage_data
SET 
...
```sql
DELETE FROM azure.agrifood_farming.tillage_data
...
```sql
EXEC azure.agrifood_farming.tillage_data.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.tillage_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.tillage_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minTillageDepth='{{ minTillageDepth }}', 
@maxTillageDepth='{{ maxTillageDepth }}', 
...
```sql
EXEC azure.agrifood_farming.tillage_data.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.tillage_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
