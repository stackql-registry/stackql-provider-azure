...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.insights" /></td></tr>
</tbody></table>
...
```sql
REPLACE azure.agrifood_farming.insights
SET 
...
```sql
DELETE FROM azure.agrifood_farming.insights
...
```sql
EXEC azure.agrifood_farming.insights.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.insights.list_by_party_id_model_id_and_resource 
@party_id='{{ party_id }}' --required, 
@model_id='{{ model_id }}' --required, 
@resource_type='{{ resource_type }}' --required, 
@resource_id='{{ resource_id }}' --required, 
