...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.sensor_data_models" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.sensor_data_models (
sensor_partner_id,
...
```sql
REPLACE azure.agrifood_farming.sensor_data_models
SET 
...
```sql
DELETE FROM azure.agrifood_farming.sensor_data_models
...
```sql
EXEC azure.agrifood_farming.sensor_data_models.get_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.sensor_data_models.list_raw 
@sensor_partner_id='{{ sensor_partner_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
