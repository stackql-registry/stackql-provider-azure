...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.zones" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.zones (
party_id,
zone_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.zones
SET 
...
```sql
DELETE FROM azure.agrifood_farming.zones
...
```sql
EXEC azure.agrifood_farming.zones.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.zones.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.zones.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure.agrifood_farming.zones.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.zones.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
