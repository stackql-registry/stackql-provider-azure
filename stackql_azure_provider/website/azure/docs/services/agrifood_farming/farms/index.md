...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.farms" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-farm_id"><code>farm_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates a farm resource under a particular party.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-farm_id"><code>farm_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified farm resource under a particular party.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-party_id"><code>party_id</code></a>, <a href="#parameter-farm_id"><code>farm_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified farm resource under a particular party.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of farm resources across all parties.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-minCreatedDateTime"><code>minCreatedDateTime</code></a>, <a href="#parameter-maxCreatedDateTime"><code>maxCreatedDateTime</code></a>, <a href="#parameter-minLastModifiedDateTime"><code>minLastModifiedDateTime</code></a>, <a href="#parameter-maxLastModifiedDateTime"><code>maxLastModifiedDateTime</code></a>, <a href="#parameter-skipToken"><code>skipToken</code></a></td>
    <td>Returns a paginated list of farm resources under a particular party.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get a cascade delete job for specified farm.</td>
</tr>
<tr>
    <td><a href="#create_cascade_delete_job"><CopyableCode code="create_cascade_delete_job" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-job_id"><code>job_id</code></a>, <a href="#parameter-partyId"><code>partyId</code></a>, <a href="#parameter-farmId"><code>farmId</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Create a cascade delete job for specified farm.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-farmId">
    <td><CopyableCode code="farmId" /></td>
    <td><code>string</code></td>
    <td>ID of the farm to be deleted. Required.</td>
</tr>
<tr id="parameter-farm_id">
    <td><CopyableCode code="farm_id" /></td>
    <td><code>string</code></td>
    <td>ID of the farm resource. Required.</td>
</tr>
...
```sql
INSERT INTO azure.agrifood_farming.farms (
party_id,
farm_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.farms
SET 
...
```sql
DELETE FROM azure.agrifood_farming.farms
...
```sql
EXEC azure.agrifood_farming.farms.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.farms.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.farms.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure.agrifood_farming.farms.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.farms.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
