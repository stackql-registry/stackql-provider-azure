...
Creates, updates, deletes, gets or lists a <code>crop_products</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="crop_products" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.crop_products" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-crop_product_id"><code>crop_product_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Creates or updates a crop Product resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-crop_product_id"><code>crop_product_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Deletes a specified crop Product resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-crop_product_id"><code>crop_product_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Gets a specified crop Product resource.</td>
</tr>
<tr>
    ...
    <td>Returns a paginated list of crop product resources.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-crop_product_id">
    <td><CopyableCode code="crop_product_id" /></td>
    <td><code>string</code></td>
    <td>Id of the crop Product. Required.</td>
</tr>
...
```sql
INSERT INTO azure.agrifood_farming.crop_products (
crop_product_id,
endpoint
)
SELECT 
...
```sql
REPLACE azure.agrifood_farming.crop_products
SET 
...
```sql
DELETE FROM azure.agrifood_farming.crop_products
...
```sql
EXEC azure.agrifood_farming.crop_products.get_raw 
@crop_product_id='{{ crop_product_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.crop_products.list_raw 
@endpoint='{{ endpoint }}' --required, 
