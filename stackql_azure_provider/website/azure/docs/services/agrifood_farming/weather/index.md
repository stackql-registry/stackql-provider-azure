...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.weather" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.agrifood_farming.weather.list_raw 
...
```sql
EXEC azure.agrifood_farming.weather.get_data_ingestion_job_details 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure.agrifood_farming.weather.create_data_ingestion_job 
@job_id='{{ job_id }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
