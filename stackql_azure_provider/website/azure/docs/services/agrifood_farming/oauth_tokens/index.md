...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.oauth_tokens" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_oauth_connection_link"
    values={[
        { label: 'get_oauth_connection_link', value: 'get_oauth_connection_link' }
    ]}
>
<TabItem value="get_oauth_connection_link">
...
<tbody>
<tr>
    <td><a href="#get_oauth_connection_link"><CopyableCode code="get_oauth_connection_link" /></a></td>
...
SELECT
value
FROM azure.agrifood_farming.oauth_tokens
...
```sql
EXEC azure.agrifood_farming.oauth_tokens.list_raw 
...
```sql
EXEC azure.agrifood_farming.oauth_tokens.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.oauth_tokens.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
