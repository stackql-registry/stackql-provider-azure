...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.harvest_data" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.harvest_data (
party_id,
harvest_data_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.harvest_data
SET 
...
```sql
DELETE FROM azure.agrifood_farming.harvest_data
...
```sql
EXEC azure.agrifood_farming.harvest_data.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.harvest_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.harvest_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minTotalYield='{{ minTotalYield }}', 
@maxTotalYield='{{ maxTotalYield }}', 
...
```sql
EXEC azure.agrifood_farming.harvest_data.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.harvest_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
