...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.sensor_mappings" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.sensor_mappings (
sensor_mapping_id,
endpoint
)
SELECT 
...
```sql
REPLACE azure.agrifood_farming.sensor_mappings
SET 
...
```sql
DELETE FROM azure.agrifood_farming.sensor_mappings
...
```sql
EXEC azure.agrifood_farming.sensor_mappings.get_raw 
@sensor_mapping_id='{{ sensor_mapping_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.sensor_mappings.list_raw 
@endpoint='{{ endpoint }}' --required, 
