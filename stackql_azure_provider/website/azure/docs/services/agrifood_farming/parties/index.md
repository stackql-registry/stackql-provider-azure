...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.parties" /></td></tr>
</tbody></table>
...
```sql
REPLACE azure.agrifood_farming.parties
SET 
...
```sql
DELETE FROM azure.agrifood_farming.parties
...
```sql
EXEC azure.agrifood_farming.parties.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.parties.list_raw 
@endpoint='{{ endpoint }}' --required, 
