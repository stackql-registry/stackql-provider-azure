...
Creates, updates, deletes, gets or lists an <code>o_auth_providers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="o_auth_providers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.o_auth_providers" /></td></tr>
</tbody></table>
...
```sql
REPLACE azure.agrifood_farming.o_auth_providers
SET 
...
```sql
DELETE FROM azure.agrifood_farming.o_auth_providers
...
```sql
EXEC azure.agrifood_farming.o_auth_providers.get_raw 
@oauth_provider_id='{{ oauth_provider_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.o_auth_providers.list_raw 
@endpoint='{{ endpoint }}' --required, 
