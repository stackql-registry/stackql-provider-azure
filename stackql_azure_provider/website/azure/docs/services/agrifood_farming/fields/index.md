...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.fields" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.fields (
party_id,
field_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.fields
SET 
...
```sql
DELETE FROM azure.agrifood_farming.fields
...
```sql
EXEC azure.agrifood_farming.fields.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.fields.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.fields.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minCreatedDateTime='{{ minCreatedDateTime }}', 
@maxCreatedDateTime='{{ maxCreatedDateTime }}', 
...
```sql
EXEC azure.agrifood_farming.fields.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.fields.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
