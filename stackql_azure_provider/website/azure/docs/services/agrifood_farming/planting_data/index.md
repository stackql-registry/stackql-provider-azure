...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.agrifood_farming.planting_data" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.agrifood_farming.planting_data (
party_id,
planting_data_id,
endpoint
)
...
```sql
REPLACE azure.agrifood_farming.planting_data
SET 
...
```sql
DELETE FROM azure.agrifood_farming.planting_data
...
```sql
EXEC azure.agrifood_farming.planting_data.get_raw 
@party_id='{{ party_id }}' --required, 
...
```sql
EXEC azure.agrifood_farming.planting_data.list_raw 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.agrifood_farming.planting_data.list_by_party_id 
@party_id='{{ party_id }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@minAvgPlantingRate='{{ minAvgPlantingRate }}', 
@maxAvgPlantingRate='{{ maxAvgPlantingRate }}', 
...
```sql
EXEC azure.agrifood_farming.planting_data.get_cascade_delete_job_details 
...
```sql
EXEC azure.agrifood_farming.planting_data.create_cascade_delete_job 
@job_id='{{ job_id }}' --required, 
