...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.webpubsub.web_pub_sub_replica_shared_private_link_resources" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.webpubsub.web_pub_sub_replica_shared_private_link_resources
...
```sql
INSERT INTO azure.webpubsub.web_pub_sub_replica_shared_private_link_resources (
properties,
resource_group_name,
resource_name,
replica_name,
...
```sql
REPLACE azure.webpubsub.web_pub_sub_replica_shared_private_link_resources
SET 
