...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recovery_services_data_replication.private_link_resources" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets the group id.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>Gets or sets the provisioning state of the private link resource. Known values are: "Canceled", "Creating", "Deleting", "Deleted", "Failed", "Succeeded", and "Updating". (Canceled, Creating, Deleting, Deleted, Failed, Succeeded, Updating)</td>
</tr>
<tr>
    <td><CopyableCode code="requiredMembers" /></td>
    <td><code>array</code></td>
    <td>Gets or sets the required member. This translates to how many Private IPs should be created for each privately linkable resource.</td>
</tr>
<tr>
    <td><CopyableCode code="requiredZoneNames" /></td>
    <td><code>array</code></td>
    <td>Gets or sets the private DNS zone names.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets the details of site recovery private link resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets the list of private link resources.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-private_link_resource_name">
    ...
    <td><code>string</code></td>
    <td>The private link name. Required.</td>
</tr>
...
systemData,
type
FROM azure.recovery_services_data_replication.private_link_resources
