...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.device_registry.namespaces" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="messaging" /></td>
    <td><code>object</code></td>
    <td>Assigned and unassigned messaging endpoints.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>List Namespace resources by resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List Namespace resources by subscription ID.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-namespace_name"><code>namespace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Migrate the resources into Namespace.</td>
</tr>
</tbody>
</table>
...
type,
uuid
FROM azure.device_registry.namespaces
...
```sql
INSERT INTO azure.device_registry.namespaces (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.device_registry.namespaces
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.device_registry.namespaces
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.device_registry.namespaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.device_registry.namespaces.migrate 
@resource_group_name='{{ resource_group_name }}' --required, 
