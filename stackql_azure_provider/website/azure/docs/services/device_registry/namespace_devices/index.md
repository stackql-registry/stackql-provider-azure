...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.device_registry.namespace_devices" /></td></tr>
</tbody></table>
...
uuid,
version
FROM azure.device_registry.namespace_devices
...
```sql
INSERT INTO azure.device_registry.namespace_devices (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.device_registry.namespace_devices
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.device_registry.namespace_devices
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.device_registry.namespace_devices
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND device_name = '{{ device_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.device_registry.namespace_devices.revoke 
@resource_group_name='{{ resource_group_name }}' --required, 
