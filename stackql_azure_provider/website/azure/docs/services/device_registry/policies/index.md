...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.device_registry.policies" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.device_registry.policies
...
```sql
INSERT INTO azure.device_registry.policies (
properties,
resource_group_name,
namespace_name,
policy_name,
...
```sql
UPDATE azure.device_registry.policies
SET 
...
```sql
REPLACE azure.device_registry.policies
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.device_registry.policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND policy_name = '{{ policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.device_registry.policies.revoke_issuer 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.device_registry.policies.activate_bring_your_own_root 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@policy_name='{{ policy_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
