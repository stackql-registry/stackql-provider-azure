...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="configuration_assignments_for_subscriptions" /></td></tr>
...
<tr>
    ...
    <td><a href="#parameter-configuration_assignment_name"><code>configuration_assignment_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
WHERE configuration_assignment_name = '{{ configuration_assignment_name }}' -- required
...
```sql
REPLACE azure.maintenance.configuration_assignments_for_subscriptions
SET 
properties = '{{ properties }}',
location = '{{ location }}'
WHERE 
