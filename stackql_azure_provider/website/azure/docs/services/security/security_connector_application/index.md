--- 
title: security_connector_application
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>security_connector_application</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="security_connector_application" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.security.security_connector_application" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-security_connector_name"><code>security_connector_name</code></a>, <a href="#parameter-application_id"><code>application_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.security.security_connector_application
...
```sql
INSERT INTO azure.security.security_connector_application (
properties,
resource_group_name,
...
- name: security_connector_application
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the security_connector_application resource.
...
```sql
REPLACE azure.security.security_connector_application
SET 
...
```sql
DELETE FROM azure.security.security_connector_application
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND security_connector_name = '{{ security_connector_name }}' --required
AND application_id = '{{ application_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
