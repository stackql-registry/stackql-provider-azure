...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="azure_dev_ops_repos" /></td></tr>
...
<tr>
    <td><CopyableCode code="parentOrgName" /></td>
    <td><code>string</code></td>
    <td>Gets or sets parent Azure DevOps Organization name.</td>
</tr>
<tr>
    <td><CopyableCode code="parentProjectName" /></td>
    <td><code>string</code></td>
    <td>Gets or sets parent Azure DevOps Project name.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets Azure DevOps Repository id.</td>
</tr>
<tr>
    <td><CopyableCode code="repoUrl" /></td>
    <td><code>string</code></td>
    <td>Gets or sets Azure DevOps Repository url.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets Azure DevOps repository visibility, whether it is public or private etc.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-security_connector_name"><code>security_connector_name</code></a>, <a href="#parameter-org_name"><code>org_name</code></a>, <a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-repo_name"><code>repo_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Returns a monitored Azure DevOps repository resource. Returns a monitored Azure DevOps repository resource.</td>
</tr>
<tr>
    <td><a href="#list"><CopyableCode code="list" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-security_connector_name"><code>security_connector_name</code></a>, <a href="#parameter-org_name"><code>org_name</code></a>, <a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Returns a list of Azure DevOps repositories onboarded to the connector. Returns a list of Azure DevOps repositories onboarded to the connector.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-security_connector_name"><code>security_connector_name</code></a>, <a href="#parameter-org_name"><code>org_name</code></a>, <a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-repo_name"><code>repo_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a monitored Azure DevOps repository resource. Creates or updates a monitored Azure DevOps repository resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-security_connector_name"><code>security_connector_name</code></a>, <a href="#parameter-org_name"><code>org_name</code></a>, <a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-repo_name"><code>repo_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Updates a monitored Azure DevOps repository resource. Updates a monitored Azure DevOps repository resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
Returns a monitored Azure DevOps repository resource. Returns a monitored Azure DevOps repository resource.
...
Returns a list of Azure DevOps repositories onboarded to the connector. Returns a list of Azure DevOps repositories onboarded to the connector.
...
Creates or updates a monitored Azure DevOps repository resource. Creates or updates a monitored Azure DevOps repository resource.
...
Updates a monitored Azure DevOps repository resource. Updates a monitored Azure DevOps repository resource.
...
```sql
REPLACE azure.security.azure_dev_ops_repos
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
