...
<tr>
    ...
    <td><code>string</code></td>
    <td>category of the standard provided.</td>
</tr>
<tr>
    <td><CopyableCode code="components" /></td>
    <td><code>array</code></td>
    <td>List of component objects containing component unique keys (such as assessment keys) to apply to standard scope. Currently only supports assessment keys.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>standard type (Custom or BuiltIn only currently).</td>
</tr>
<tr>
    <td><CopyableCode code="supportedClouds" /></td>
    <td><code>array</code></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-standard_id"><code>standard_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a specific security standard for the requested scope.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get security standards on all your resources inside a scope.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get a list of all relevant security standards over a subscription level scope.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-standard_id"><code>standard_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create a security standard on the given scope. Available only for custom standards. Will create/update the required standard definitions.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-standard_id"><code>standard_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a security standard on a scope.</td>
</tr>
</tbody>
</table>
