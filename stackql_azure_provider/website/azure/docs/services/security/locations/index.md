...
<tr>
    ...
    <td>An empty set of properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Details of a specific location.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>The location of the responsible ASC of the specific subscription (home region). For each subscription there is only one responsible location. The location in the response should be used to read or write other resources in ASC according to their ID.</td>
</tr>
</tbody>
</table>
