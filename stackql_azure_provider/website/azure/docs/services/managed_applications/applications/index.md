...
```sql
REPLACE azure.managed_applications.applications
SET 
location = '{{ location }}',
tags = '{{ tags }}',
managedBy = '{{ managedBy }}',
...
```sql
EXEC azure.managed_applications.applications.list_allowed_upgrade_plans 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.managed_applications.applications.list_tokens 
@resource_group_name='{{ resource_group_name }}' --required, 
@application_name='{{ application_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.managed_applications.applications.update_access 
@resource_group_name='{{ resource_group_name }}' --required, 
@application_name='{{ application_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
