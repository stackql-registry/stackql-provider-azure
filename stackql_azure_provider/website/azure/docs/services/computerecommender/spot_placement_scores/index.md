...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.computerecommender.spot_placement_scores" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.computerecommender.spot_placement_scores
...
```sql
EXEC azure.computerecommender.spot_placement_scores.post 
