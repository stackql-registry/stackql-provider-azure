...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.videoanalyzer.edge_modules" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.videoanalyzer.edge_modules (
id,
name,
type,
systemData,
...
```sql
REPLACE azure.videoanalyzer.edge_modules
SET 
id = '{{ id }}',
name = '{{ name }}',
type = '{{ type }}',
