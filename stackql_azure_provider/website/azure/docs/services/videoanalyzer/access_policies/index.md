...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.videoanalyzer.access_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-access_policy_name"><code>access_policy_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
```sql
UPDATE azure.videoanalyzer.access_policies
SET 
...
```sql
REPLACE azure.videoanalyzer.access_policies
SET 
properties = '{{ properties }}'
WHERE 
account_name = '{{ account_name }}' --required
