...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.videoanalyzer.pipeline_topologies" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.videoanalyzer.pipeline_topologies (
kind,
sku,
properties,
resource_group_name,
...
```sql
UPDATE azure.videoanalyzer.pipeline_topologies
SET 
kind = '{{ kind }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.videoanalyzer.pipeline_topologies
SET 
kind = '{{ kind }}',
sku = '{{ sku }}',
properties = '{{ properties }}'
