...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="live_pipelines" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.videoanalyzer.live_pipelines" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="bitrateKbps" /></td>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Current state of the pipeline (read-only). Possible values include: "Inactive", "Activating", "Active", "Deactivating".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-live_pipeline_name"><code>live_pipeline_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
Retrieves a list of live pipelines. Retrieves a list of live pipelines that have been created, along with their JSON representations.
...
```sql
UPDATE azure.videoanalyzer.live_pipelines
SET 
...
```sql
REPLACE azure.videoanalyzer.live_pipelines
SET 
properties = '{{ properties }}'
WHERE 
live_pipeline_name = '{{ live_pipeline_name }}' --required
...
Deactivates a live pipeline. Deactivates a live pipeline with the given name.
