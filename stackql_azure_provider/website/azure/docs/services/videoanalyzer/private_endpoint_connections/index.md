...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.videoanalyzer.private_endpoint_connections" /></td></tr>
</tbody></table>
...
Get all private endpoint connections. Get all private endpoint connections under video analyzer account.
...
```sql
REPLACE azure.videoanalyzer.private_endpoint_connections
SET 
