...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.fluidrelay.fluid_relay_containers" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.fluidrelay.fluid_relay_containers
...
```sql
DELETE FROM azure.fluidrelay.fluid_relay_containers
WHERE resource_group = '{{ resource_group }}' --required
AND fluid_relay_server_name = '{{ fluid_relay_server_name }}' --required
AND fluid_relay_container_name = '{{ fluid_relay_container_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
