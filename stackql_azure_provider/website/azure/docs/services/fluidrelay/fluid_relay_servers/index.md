...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.fluidrelay.fluid_relay_servers" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.fluidrelay.fluid_relay_servers
...
```sql
INSERT INTO azure.fluidrelay.fluid_relay_servers (
tags,
location,
identity,
properties,
...
```sql
UPDATE azure.fluidrelay.fluid_relay_servers
SET 
tags = '{{ tags }}',
identity = '{{ identity }}',
location = '{{ location }}',
...
```sql
REPLACE azure.fluidrelay.fluid_relay_servers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
identity = '{{ identity }}',
...
```sql
DELETE FROM azure.fluidrelay.fluid_relay_servers
WHERE resource_group = '{{ resource_group }}' --required
AND fluid_relay_server_name = '{{ fluid_relay_server_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.fluidrelay.fluid_relay_servers.list_keys 
@resource_group='{{ resource_group }}' --required, 
...
```sql
EXEC azure.fluidrelay.fluid_relay_servers.regenerate_key 
@resource_group='{{ resource_group }}' --required, 
@fluid_relay_server_name='{{ fluid_relay_server_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
