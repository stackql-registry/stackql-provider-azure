...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.sitemanager.sites" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.sitemanager.sites (
properties,
resource_group_name,
site_name,
subscription_id
...
```sql
UPDATE azure.sitemanager.sites
SET 
...
```sql
REPLACE azure.sitemanager.sites
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.sitemanager.sites
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND site_name = '{{ site_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
