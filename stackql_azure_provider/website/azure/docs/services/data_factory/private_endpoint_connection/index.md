...
```sql
INSERT INTO azure.data_factory.private_endpoint_connection (
properties,
resource_group_name,
factory_name,
...
```sql
REPLACE azure.data_factory.private_endpoint_connection
SET 
...
```sql
DELETE FROM azure.data_factory.private_endpoint_connection
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND factory_name = '{{ factory_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
