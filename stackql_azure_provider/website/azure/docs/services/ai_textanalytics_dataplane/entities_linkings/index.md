...
Creates, updates, deletes, gets or lists an <code>entities_linkings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entities_linkings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_textanalytics_dataplane.entities_linkings" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#entities_linking"><CopyableCode code="entities_linking" /></a></td>
    ...
    <td>Linked entities from a well known knowledge base. The API returns a list of recognized entities with links to a well known knowledge base. See the Supported languages in Text Analytics API for the list of enabled languages.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="entities_linking"
    values={[
        { label: 'entities_linking', value: 'entities_linking' }
    ]}
>
<TabItem value="entities_linking">

Linked entities from a well known knowledge base. The API returns a list of recognized entities with links to a well known knowledge base. See the Supported languages in Text Analytics API for the list of enabled languages.

```sql
EXEC azure.ai_textanalytics_dataplane.entities_linkings.entities_linking 
