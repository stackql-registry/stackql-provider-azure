...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_textanalytics_dataplane.languages" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#languages"><CopyableCode code="languages" /></a></td>
    ...
    <td>Detect Language. The API returns the detected language and a numeric score between 0 and 1. Scores close to 1 indicate 100% certainty that the identified language is true. See the Supported languages in Text Analytics API for the list of enabled languages.</td>
</tr>
</tbody>
</table>
...
>
<TabItem value="languages">

Detect Language. The API returns the detected language and a numeric score between 0 and 1. Scores close to 1 indicate 100% certainty that the identified language is true. See the Supported languages in Text Analytics API for the list of enabled languages.

```sql
EXEC azure.ai_textanalytics_dataplane.languages.languages 
