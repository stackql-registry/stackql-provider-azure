...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.devtestlabs.artifacts" /></td></tr>
</tbody></table>
...
title,
type
FROM azure.devtestlabs.artifacts
...
```sql
EXEC azure.devtestlabs.artifacts.generate_arm_template 
