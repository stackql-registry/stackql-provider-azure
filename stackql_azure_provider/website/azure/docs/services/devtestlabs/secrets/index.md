...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.devtestlabs.secrets" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The value of the secret for secret creation.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Specify the $expand query. Example: 'properties($select=value)'. Default value is None.</td>
</tr>
...
uniqueIdentifier,
value
FROM azure.devtestlabs.secrets
...
```sql
INSERT INTO azure.devtestlabs.secrets (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.devtestlabs.secrets
SET 
...
```sql
REPLACE azure.devtestlabs.secrets
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.devtestlabs.secrets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_name = '{{ lab_name }}' --required
AND user_name = '{{ user_name }}' --required
AND name = '{{ name }}' --required
