...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="artifact_sources" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.devtestlabs.artifact_sources" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="armTemplateFolderPath" /></td>
    <td><code>string</code></td>
    <td>The folder containing Azure Resource Manager templates.</td>
</tr>
<tr>
    <td><CopyableCode code="branchRef" /></td>
    <td><code>string</code></td>
    <td>The artifact source's branch reference.</td>
</tr>
<tr>
    <td><CopyableCode code="createdDate" /></td>
    <td><code>string (date-time)</code></td>
    <td>The artifact source's creation date.</td>
</tr>
<tr>
    <td><CopyableCode code="displayName" /></td>
    <td><code>string</code></td>
    <td>The artifact source's display name.</td>
</tr>
<tr>
    <td><CopyableCode code="folderPath" /></td>
    <td><code>string</code></td>
    <td>The folder containing artifacts.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The security token to authenticate to the artifact source.</td>
</tr>
<tr>
    <td><CopyableCode code="sourceType" /></td>
    <td><code>string</code></td>
    <td>The artifact source's type. Known values are: "VsoGit", "GitHub", and "StorageAccount".</td>
</tr>
<tr>
    <td><CopyableCode code="status" /></td>
    <td><code>string</code></td>
    <td>Indicates if the artifact source is enabled (values: Enabled, Disabled). Known values are: "Enabled" and "Disabled".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The artifact source's URI.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Specify the $expand query. Example: 'properties($select=displayName)'. Default value is None.</td>
</tr>
...
uniqueIdentifier,
uri
FROM azure.devtestlabs.artifact_sources
...
```sql
INSERT INTO azure.devtestlabs.artifact_sources (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.devtestlabs.artifact_sources
SET 
...
```sql
REPLACE azure.devtestlabs.artifact_sources
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.devtestlabs.artifact_sources
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_name = '{{ lab_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
