...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.devtestlabs.virtual_networks" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="allowedSubnets" /></td>
    <td><code>array</code></td>
    <td>The allowed subnets of the virtual network.</td>
</tr>
<tr>
    <td><CopyableCode code="createdDate" /></td>
    <td><code>string (date-time)</code></td>
    <td>The creation date of the virtual network.</td>
</tr>
<tr>
    <td><CopyableCode code="description" /></td>
    <td><code>string</code></td>
    <td>The description of the virtual network.</td>
</tr>
<tr>
    <td><CopyableCode code="externalProviderResourceId" /></td>
    <td><code>string</code></td>
    <td>The Microsoft.Network resource identifier of the virtual network.</td>
</tr>
<tr>
    <td><CopyableCode code="externalSubnets" /></td>
    <td><code>array</code></td>
    <td>The external subnet properties.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="subnetOverrides" /></td>
    <td><code>array</code></td>
    <td>The subnet overrides of the virtual network.</td>
</tr>
<tr>
...
<tr id="parameter-$expand">
    ...
    <td><code>string</code></td>
    <td>Specify the $expand query. Example: 'properties($expand=externalSubnets)'. Default value is None.</td>
</tr>
...
type,
uniqueIdentifier
FROM azure.devtestlabs.virtual_networks
...
```sql
INSERT INTO azure.devtestlabs.virtual_networks (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.devtestlabs.virtual_networks
SET 
...
```sql
REPLACE azure.devtestlabs.virtual_networks
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.devtestlabs.virtual_networks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_name = '{{ lab_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
