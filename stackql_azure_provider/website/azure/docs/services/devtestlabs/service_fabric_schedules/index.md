...
Creates, updates, deletes, gets or lists a <code>service_fabric_schedules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="service_fabric_schedules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.devtestlabs.service_fabric_schedules" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-lab_name"><code>lab_name</code></a>, <a href="#parameter-user_name"><code>user_name</code></a>, <a href="#parameter-service_fabric_name"><code>service_fabric_name</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-lab_name"><code>lab_name</code></a>, <a href="#parameter-user_name"><code>user_name</code></a>, <a href="#parameter-service_fabric_name"><code>service_fabric_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    ...
    <td>List schedules in a given service fabric.</td>
</tr>
<tr>
...
<tr id="parameter-service_fabric_name">
    <td><CopyableCode code="service_fabric_name" /></td>
    <td><code>string</code></td>
...
uniqueIdentifier,
weeklyRecurrence
FROM azure.devtestlabs.service_fabric_schedules
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND lab_name = '{{ lab_name }}' -- required
AND user_name = '{{ user_name }}' -- required
AND service_fabric_name = '{{ service_fabric_name }}' -- required
...
```sql
INSERT INTO azure.devtestlabs.service_fabric_schedules (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.devtestlabs.service_fabric_schedules
SET 
...
```sql
REPLACE azure.devtestlabs.service_fabric_schedules
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.devtestlabs.service_fabric_schedules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_name = '{{ lab_name }}' --required
AND user_name = '{{ user_name }}' --required
AND service_fabric_name = '{{ service_fabric_name }}' --required
...
```sql
EXEC azure.devtestlabs.service_fabric_schedules.execute 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@user_name='{{ user_name }}' --required, 
@service_fabric_name='{{ service_fabric_name }}' --required, 
@name='{{ name }}' --required, 
