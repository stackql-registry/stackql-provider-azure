...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.labservices.virtual_machines" /></td></tr>
</tbody></table>
...
type,
vmType
FROM azure.labservices.virtual_machines
...
```sql
EXEC azure.labservices.virtual_machines.start 
...
```sql
EXEC azure.labservices.virtual_machines.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.labservices.virtual_machines.reimage 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.labservices.virtual_machines.redeploy 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.labservices.virtual_machines.reset_password 
@resource_group_name='{{ resource_group_name }}' --required, 
@lab_name='{{ lab_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
