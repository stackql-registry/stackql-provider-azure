...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.labservices.lab_plans" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.labservices.lab_plans
...
```sql
INSERT INTO azure.labservices.lab_plans (
tags,
location,
identity,
properties,
...
```sql
UPDATE azure.labservices.lab_plans
SET 
tags = '{{ tags }}',
identity = '{{ identity }}',
...
```sql
REPLACE azure.labservices.lab_plans
SET 
tags = '{{ tags }}',
location = '{{ location }}',
identity = '{{ identity }}',
...
```sql
DELETE FROM azure.labservices.lab_plans
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_plan_name = '{{ lab_plan_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.labservices.lab_plans.save_image 
@resource_group_name='{{ resource_group_name }}' --required, 
