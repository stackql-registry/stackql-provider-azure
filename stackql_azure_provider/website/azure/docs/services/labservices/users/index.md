...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.labservices.users" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.labservices.users (
properties,
resource_group_name,
lab_name,
user_name,
...
```sql
UPDATE azure.labservices.users
SET 
...
```sql
REPLACE azure.labservices.users
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.labservices.users
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND lab_name = '{{ lab_name }}' --required
AND user_name = '{{ user_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.labservices.users.invite 
@resource_group_name='{{ resource_group_name }}' --required, 
