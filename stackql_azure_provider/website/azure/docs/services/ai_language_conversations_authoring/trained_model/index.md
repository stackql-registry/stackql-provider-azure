...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_language_conversations_authoring.trained_model" /></td></tr>
</tbody></table>
...
status,
warnings
FROM azure.ai_language_conversations_authoring.trained_model
...
```sql
DELETE FROM azure.ai_language_conversations_authoring.trained_model
WHERE trained_model_label = '{{ trained_model_label }}' --required
AND project_name = '{{ project_name }}' --required
AND endpoint = '{{ endpoint }}' --required
;
...
```sql
EXEC azure.ai_language_conversations_authoring.trained_model.get_model_evaluation_summary 
...
```sql
EXEC azure.ai_language_conversations_authoring.trained_model.get_load_snapshot_status 
@trained_model_label='{{ trained_model_label }}' --required, 
...
```sql
EXEC azure.ai_language_conversations_authoring.trained_model.evaluate_model 
@trained_model_label='{{ trained_model_label }}' --required, 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
...
```sql
EXEC azure.ai_language_conversations_authoring.trained_model.load_snapshot 
@trained_model_label='{{ trained_model_label }}' --required, 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required
;
