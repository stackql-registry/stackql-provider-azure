...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_language_conversations_authoring.exported_model" /></td></tr>
</tbody></table>
...
status,
warnings
FROM azure.ai_language_conversations_authoring.exported_model
...
```sql
INSERT INTO azure.ai_language_conversations_authoring.exported_model (
trainedModelLabel,
exported_model_name,
project_name,
endpoint
...
```sql
REPLACE azure.ai_language_conversations_authoring.exported_model
SET 
...
```sql
DELETE FROM azure.ai_language_conversations_authoring.exported_model
WHERE exported_model_name = '{{ exported_model_name }}' --required
AND project_name = '{{ project_name }}' --required
AND endpoint = '{{ endpoint }}' --required
;
