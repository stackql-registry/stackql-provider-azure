...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datalake_store.locations" /></td></tr>
</tbody></table>
...
state,
subscriptionId
FROM azure.datalake_store.locations
...
```sql
EXEC azure.datalake_store.locations.get_usage 
