...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datalake_store.firewall_rules" /></td></tr>
</tbody></table>
...
startIpAddress,
type
FROM azure.datalake_store.firewall_rules
...
```sql
INSERT INTO azure.datalake_store.firewall_rules (
properties,
resource_group_name,
account_name,
firewall_rule_name,
...
```sql
UPDATE azure.datalake_store.firewall_rules
SET 
...
```sql
REPLACE azure.datalake_store.firewall_rules
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.datalake_store.firewall_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND firewall_rule_name = '{{ firewall_rule_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
