...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.timeseriesinsights.event_sources" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The kind of the event source. Required. Known values are: "Microsoft.EventHub" and "Microsoft.IoTHub".</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Result of the List EventSources operation.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-event_source_name"><code>event_source_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-event_source_name"><code>event_source_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-kind"><code>kind</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-event_source_name"><code>event_source_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-kind"><code>kind</code></a></td>
    <td></td>
...
<tr id="parameter-event_source_name">
    <td><CopyableCode code="event_source_name" /></td>
    <td><code>string</code></td>
    <td>The name of the Time Series Insights event source associated with the specified environment. Required.</td>
</tr>
...
tags,
type
FROM azure.timeseriesinsights.event_sources
...
```sql
INSERT INTO azure.timeseriesinsights.event_sources (
location,
tags,
kind,
localTimestamp,
...
```sql
UPDATE azure.timeseriesinsights.event_sources
SET 
kind = '{{ kind }}',
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.timeseriesinsights.event_sources
SET 
location = '{{ location }}',
tags = '{{ tags }}',
kind = '{{ kind }}',
...
```sql
DELETE FROM azure.timeseriesinsights.event_sources
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND environment_name = '{{ environment_name }}' --required
AND event_source_name = '{{ event_source_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
