...
Creates, updates, deletes, gets or lists a <code>verifier_workspaces</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="verifier_workspaces" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.network.verifier_workspaces" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>String representing unique etag for the resource document.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets Verifier Workspace. Gets Verifier Workspace.</td>
</tr>
<tr>
    ...
    <td>Gets list of Verifier Workspaces. Gets list of Verifier Workspaces.</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>Creates Verifier Workspace. Creates Verifier Workspace.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Updates Verifier Workspace. Updates Verifier Workspace.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes Verifier Workspace. Deletes Verifier Workspace.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.network.verifier_workspaces
...
```sql
INSERT INTO azure.network.verifier_workspaces (
tags,
location,
properties,
resource_group_name,
...
- name: verifier_workspaces
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the verifier_workspaces resource.
...
```sql
UPDATE azure.network.verifier_workspaces
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.network.verifier_workspaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_manager_name = '{{ network_manager_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
