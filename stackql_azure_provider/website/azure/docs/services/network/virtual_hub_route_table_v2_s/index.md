--- 
title: virtual_hub_route_table_v2_s
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>virtual_hub_route_table_v2_s</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="virtual_hub_route_table_v2_s" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.network.virtual_hub_route_table_v2_s" /></td></tr>
</tbody></table>
...
provisioningState,
routes
FROM azure.network.virtual_hub_route_table_v2_s
...
```sql
INSERT INTO azure.network.virtual_hub_route_table_v2_s (
id,
properties,
name,
resource_group_name,
...
- name: virtual_hub_route_table_v2_s
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the virtual_hub_route_table_v2_s resource.
...
```sql
REPLACE azure.network.virtual_hub_route_table_v2_s
SET 
id = '{{ id }}',
...
```sql
DELETE FROM azure.network.virtual_hub_route_table_v2_s
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_hub_name = '{{ virtual_hub_name }}' --required
AND route_table_name = '{{ route_table_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
