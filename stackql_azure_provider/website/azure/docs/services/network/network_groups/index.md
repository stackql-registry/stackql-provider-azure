...
Creates, updates, deletes, gets or lists a <code>network_groups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.network.network_groups" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A description of the network group.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The type of the group member. Known values are: "VirtualNetwork" and "Subnet". (VirtualNetwork, Subnet)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets the specified network group.</td>
</tr>
<tr>
    ...
    <td>Lists the specified network group.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-network_group_name"><code>network_group_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a network group.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
systemData,
type
FROM azure.network.network_groups
...
```sql
INSERT INTO azure.network.network_groups (
properties,
resource_group_name,
...
- name: network_groups
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the network_groups resource.
...
```sql
REPLACE azure.network.network_groups
SET 
...
```sql
DELETE FROM azure.network.network_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_manager_name = '{{ network_manager_name }}' --required
AND network_group_name = '{{ network_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
