...
Creates, updates, deletes, gets or lists an <code>available_private_endpoint_types</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="available_private_endpoint_types" /></td></tr>
...
<tr>
    ...
    <td>A unique identifier of the AvailablePrivateEndpoint Type resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Display name of the resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Returns all of the resource types that can be linked to a Private Endpoint in this subscription in this region.</td>
</tr>
<tr>
