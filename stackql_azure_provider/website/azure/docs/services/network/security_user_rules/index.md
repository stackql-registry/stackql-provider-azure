...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="security_user_rules" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A description for this rule.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Indicates if the traffic matched against the rule in inbound or outbound. Required. Known values are: "Inbound" and "Outbound". (Inbound, Outbound)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Network protocol this rule applies to. Required. Known values are: "Tcp", "Udp", "Icmp", "Esp", "Any", and "Ah". (Tcp, Udp, Icmp, Esp, Any, Ah)</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>The provisioning state of the security configuration user rule resource. Known values are: "Failed", "Succeeded", "Canceled", "Creating", "Updating", and "Deleting". (Failed, Succeeded, Canceled, Creating, Updating, Deleting)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Lists all Security User Rules in a rule collection.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-configuration_name"><code>configuration_name</code></a>, <a href="#parameter-rule_collection_name"><code>rule_collection_name</code></a>, <a href="#parameter-rule_name"><code>rule_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a security user rule.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td>Deletes a security user rule.</td>
</tr>
</tbody>
</table>
...
- name: security_user_rules
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the security_user_rules resource.
...
```sql
REPLACE azure.network.security_user_rules
SET 
