...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="scope_connections" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A description of the scope connection.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-scope_connection_name"><code>scope_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get specified scope connection created by this Network Manager.</td>
</tr>
<tr>
    ...
    <td>List all scope connections created by this network manager.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-scope_connection_name"><code>scope_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates scope connection from Network Manager.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-scope_connection_name"><code>scope_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete the pending scope connection created by this network manager.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-scope_connection_name">
    <td><CopyableCode code="scope_connection_name" /></td>
    <td><code>string</code></td>
    <td>Name for the cross-tenant connection. Required.</td>
</tr>
...
AND scope_connection_name = '{{ scope_connection_name }}' -- required
...
- name: scope_connections
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the scope_connections resource.
    - name: network_manager_name
      value: "{{ network_manager_name }}"
      description: Required parameter for the scope_connections resource.
    - name: scope_connection_name
      value: "{{ scope_connection_name }}"
      description: Required parameter for the scope_connections resource.
...
```sql
REPLACE azure.network.scope_connections
SET 
