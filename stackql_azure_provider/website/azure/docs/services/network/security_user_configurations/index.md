...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="security_user_configurations" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A description of the security user configuration.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Retrieves a network manager security user configuration.</td>
</tr>
<tr>
    ...
    <td>Lists all the network manager security user configurations in a network manager, in a paginated format.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_manager_name"><code>network_manager_name</code></a>, <a href="#parameter-configuration_name"><code>configuration_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a network manager security user configuration.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td>Deletes a network manager security user configuration.</td>
</tr>
</tbody>
</table>
...
- name: security_user_configurations
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the security_user_configurations resource.
...
```sql
REPLACE azure.network.security_user_configurations
SET 
