...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="virtual_appliance_sites" /></td></tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-network_virtual_appliance_name"><code>network_virtual_appliance_name</code></a>, <a href="#parameter-site_name"><code>site_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
```sql
REPLACE azure.network.virtual_appliance_sites
SET 
id = '{{ id }}',
name = '{{ name }}',
