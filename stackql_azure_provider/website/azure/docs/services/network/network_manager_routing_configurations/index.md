--- 
title: network_manager_routing_configurations
hide_title: false
hide_table_of_contents: false
keywords:
  - network_manager_routing_configurations
  - network
  - azure
...
Creates, updates, deletes, gets or lists a <code>network_manager_routing_configurations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_manager_routing_configurations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.network.network_manager_routing_configurations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A description of the routing configuration.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="routeTableUsageMode" /></td>
    <td><code>string</code></td>
    <td>Route table usage mode defines which route table will be used by the configuration. If not defined, this will default to 'ManagedOnly'. Known values are: "ManagedOnly" and "UseExisting". (ManagedOnly, UseExisting)</td>
</tr>
<tr>
...
<tr id="parameter-configuration_name">
    ...
    <td><code>string</code></td>
    <td>The name of the network manager Routing Configuration. Required.</td>
</tr>
...
systemData,
type
FROM azure.network.network_manager_routing_configurations
...
```sql
INSERT INTO azure.network.network_manager_routing_configurations (
properties,
resource_group_name,
...
- name: network_manager_routing_configurations
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the network_manager_routing_configurations resource.
...
```sql
REPLACE azure.network.network_manager_routing_configurations
SET 
...
```sql
DELETE FROM azure.network.network_manager_routing_configurations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_manager_name = '{{ network_manager_name }}' --required
AND configuration_name = '{{ configuration_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
