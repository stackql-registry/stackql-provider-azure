...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.dapr_components" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-component_name"><code>component_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-component_name"><code>component_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a Dapr Component. Creates or updates a Dapr Component in a Managed Environment.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-environment_name"><code>environment_name</code></a>, <a href="#parameter-component_name"><code>component_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete a Dapr Component. Delete a Dapr Component from a Managed Environment.</td>
</tr>
<tr>
...
type,
version
FROM azure.appcontainers.dapr_components
...
```sql
INSERT INTO azure.appcontainers.dapr_components (
properties,
resource_group_name,
environment_name,
component_name,
...
```sql
REPLACE azure.appcontainers.dapr_components
SET 
...
```sql
DELETE FROM azure.appcontainers.dapr_components
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND environment_name = '{{ environment_name }}' --required
AND component_name = '{{ component_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.appcontainers.dapr_components.list_secrets 
@resource_group_name='{{ resource_group_name }}' --required, 
