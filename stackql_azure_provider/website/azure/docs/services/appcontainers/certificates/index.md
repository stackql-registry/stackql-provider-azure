...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.certificates" /></td></tr>
</tbody></table>
...
valid,
value
FROM azure.appcontainers.certificates
...
```sql
INSERT INTO azure.appcontainers.certificates (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.appcontainers.certificates
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.appcontainers.certificates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.appcontainers.certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND environment_name = '{{ environment_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
