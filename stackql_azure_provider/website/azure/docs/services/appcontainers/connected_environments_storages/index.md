...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.connected_environments_storages" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appcontainers.connected_environments_storages
...
```sql
INSERT INTO azure.appcontainers.connected_environments_storages (
properties,
resource_group_name,
...
```sql
REPLACE azure.appcontainers.connected_environments_storages
SET 
...
```sql
DELETE FROM azure.appcontainers.connected_environments_storages
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND connected_environment_name = '{{ connected_environment_name }}' --required
AND storage_name = '{{ storage_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
