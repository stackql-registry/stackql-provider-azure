...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.connected_environments_certificates" /></td></tr>
</tbody></table>
...
valid,
value
FROM azure.appcontainers.connected_environments_certificates
...
```sql
INSERT INTO azure.appcontainers.connected_environments_certificates (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.appcontainers.connected_environments_certificates
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.appcontainers.connected_environments_certificates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.appcontainers.connected_environments_certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND connected_environment_name = '{{ connected_environment_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
