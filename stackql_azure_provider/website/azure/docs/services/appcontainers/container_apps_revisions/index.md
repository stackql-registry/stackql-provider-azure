...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.container_apps_revisions" /></td></tr>
</tbody></table>
...
trafficWeight,
type
FROM azure.appcontainers.container_apps_revisions
...
```sql
EXEC azure.appcontainers.container_apps_revisions.activate_revision 
...
```sql
EXEC azure.appcontainers.container_apps_revisions.deactivate_revision 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_app_name='{{ container_app_name }}' --required, 
@revision_name='{{ revision_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.appcontainers.container_apps_revisions.restart_revision 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_app_name='{{ container_app_name }}' --required, 
@revision_name='{{ revision_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
