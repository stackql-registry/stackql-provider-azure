...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appcontainers.namespaces" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Checks the resource name availability. Checks if resource name is available.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.appcontainers.namespaces.check_name_availability 
