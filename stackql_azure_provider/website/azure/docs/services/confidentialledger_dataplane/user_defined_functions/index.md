...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.confidentialledger_dataplane.user_defined_functions" /></td></tr>
</tbody></table>
...
id,
code
FROM azure.confidentialledger_dataplane.user_defined_functions
...
```sql
INSERT INTO azure.confidentialledger_dataplane.user_defined_functions (
code,
function_id,
ledger_endpoint
)
...
```sql
DELETE FROM azure.confidentialledger_dataplane.user_defined_functions
WHERE function_id = '{{ function_id }}' --required
AND ledger_endpoint = '{{ ledger_endpoint }}' --required
;
```
