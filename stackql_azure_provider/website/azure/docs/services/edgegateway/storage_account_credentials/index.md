...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edgegateway.storage_account_credentials" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-accept-language"><code>accept-language</code></a></td>
    <td>Gets all the storage account credentials in a data box edge/gateway device.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.edgegateway.storage_account_credentials.get_raw 
@name='{{ name }}' --required, 
...
```sql
EXEC azure.edgegateway.storage_account_credentials.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
