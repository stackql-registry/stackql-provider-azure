...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edgegateway.shares" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.edgegateway.shares.get_raw 
@name='{{ name }}' --required, 
...
```sql
EXEC azure.edgegateway.shares.list_by_data_box_edge_device 
@device_name='{{ device_name }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
...
```sql
EXEC azure.edgegateway.shares.refresh 
