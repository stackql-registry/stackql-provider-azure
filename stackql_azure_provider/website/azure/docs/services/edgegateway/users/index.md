...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edgegateway.users" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.edgegateway.users.get_raw 
...
```sql
EXEC azure.edgegateway.users.list_by_data_box_edge_device 
@resource_group_name='{{ resource_group_name }}' --required, 
@device_name='{{ device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@accept-language='{{ accept-language }}'
