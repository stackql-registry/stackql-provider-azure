...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.policyinsights.attestations" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.policyinsights.attestations
...
```sql
INSERT INTO azure.policyinsights.attestations (
properties,
resource_group_name,
attestation_name,
subscription_id
...
```sql
REPLACE azure.policyinsights.attestations
SET 
...
```sql
DELETE FROM azure.policyinsights.attestations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND attestation_name = '{{ attestation_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
