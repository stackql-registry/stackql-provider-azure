...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerregistry_dataplane.authentication" /></td></tr>
</tbody></table>
...
SELECT
access_token
FROM azure.containerregistry_dataplane.authentication
...
```sql
EXEC azure.containerregistry_dataplane.authentication.exchange_aad_access_token_for_acr_refresh_token 
...
```sql
EXEC azure.containerregistry_dataplane.authentication.exchange_acr_refresh_token_for_acr_access_token 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
"grantType": "{{ grantType }}", 
