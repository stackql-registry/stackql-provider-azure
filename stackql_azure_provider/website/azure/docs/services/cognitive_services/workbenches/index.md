...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cognitive_services.workbenches" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.cognitive_services.workbenches.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@project_name='{{ project_name }}' --required, 
@workbench_name='{{ workbench_name }}' --required, 
...
```sql
EXEC azure.cognitive_services.workbenches.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@project_name='{{ project_name }}' --required, 
@workbench_name='{{ workbench_name }}' --required, 
