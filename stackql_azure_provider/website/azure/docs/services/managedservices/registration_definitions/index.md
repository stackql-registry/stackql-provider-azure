...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managedservices.registration_definitions" /></td></tr>
</tbody></table>
...
type
FROM azure.managedservices.registration_definitions
...
```sql
INSERT INTO azure.managedservices.registration_definitions (
properties,
plan,
...
```sql
REPLACE azure.managedservices.registration_definitions
SET 
...
```sql
DELETE FROM azure.managedservices.registration_definitions
