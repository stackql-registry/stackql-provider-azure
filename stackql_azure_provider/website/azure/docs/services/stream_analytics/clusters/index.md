...
<tr>
    <td><CopyableCode code="capacityAllocated" /></td>
    <td><code>integer</code></td>
    <td>Represents the number of streaming units currently being used on the cluster.</td>
</tr>
<tr>
    <td><CopyableCode code="capacityAssigned" /></td>
    <td><code>integer</code></td>
    <td>Represents the sum of the SUs of all streaming jobs associated with the cluster. If all of the jobs were running, this would be the capacity allocated.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The date this cluster was created.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The status of the cluster provisioning. The three terminal states are: Succeeded, Failed and Canceled. Known values are: "Succeeded", "Failed", "Canceled", and "InProgress".</td>
</tr>
<tr>
...
<tr>
    <td><a href="#list_streaming_jobs"><CopyableCode code="list_streaming_jobs" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Lists all of the streaming jobs in the given cluster.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="list_streaming_jobs"
    values={[
        { label: 'list_streaming_jobs', value: 'list_streaming_jobs' }
    ]}
>
<TabItem value="list_streaming_jobs">
