...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_features.features" /></td></tr>
</tbody></table>
...
state,
type
FROM azure.resource_features.features
...
```sql
EXEC azure.resource_features.features.register 
...
```sql
EXEC azure.resource_features.features.unregister 
@resource_provider_namespace='{{ resource_provider_namespace }}' --required, 
@feature_name='{{ feature_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
