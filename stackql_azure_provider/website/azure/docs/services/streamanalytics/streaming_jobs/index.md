...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.streamanalytics.streaming_jobs" /></td></tr>
</tbody></table>
...
transformation,
type
FROM azure.streamanalytics.streaming_jobs
...
```sql
INSERT INTO azure.streamanalytics.streaming_jobs (
tags,
location,
sku,
identity,
...
```sql
UPDATE azure.streamanalytics.streaming_jobs
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.streamanalytics.streaming_jobs
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
DELETE FROM azure.streamanalytics.streaming_jobs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND job_name = '{{ job_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.streamanalytics.streaming_jobs.start 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.streamanalytics.streaming_jobs.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@job_name='{{ job_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.streamanalytics.streaming_jobs.scale 
@resource_group_name='{{ resource_group_name }}' --required, 
@job_name='{{ job_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
