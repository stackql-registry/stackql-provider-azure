...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.streamanalytics.clusters" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.streamanalytics.clusters
...
```sql
INSERT INTO azure.streamanalytics.clusters (
tags,
location,
sku,
properties,
...
```sql
UPDATE azure.streamanalytics.clusters
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
REPLACE azure.streamanalytics.clusters
SET 
tags = '{{ tags }}',
location = '{{ location }}',
sku = '{{ sku }}',
...
```sql
DELETE FROM azure.streamanalytics.clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.streamanalytics.clusters.list_streaming_jobs 
@resource_group_name='{{ resource_group_name }}' --required, 
