...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.streamanalytics.subscriptions" /></td></tr>
</tbody></table>
...
maxCount,
type
FROM azure.streamanalytics.subscriptions
...
```sql
EXEC azure.streamanalytics.subscriptions.test_query 
...
```sql
EXEC azure.streamanalytics.subscriptions.compile_query 
@location='{{ location }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.streamanalytics.subscriptions.sample_input 
@location='{{ location }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.streamanalytics.subscriptions.test_input 
@location='{{ location }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.streamanalytics.subscriptions.test_output 
@location='{{ location }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
