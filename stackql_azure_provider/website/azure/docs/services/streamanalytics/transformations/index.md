...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.streamanalytics.transformations" /></td></tr>
</tbody></table>
...
type,
validStreamingUnits
FROM azure.streamanalytics.transformations
...
```sql
INSERT INTO azure.streamanalytics.transformations (
name,
properties,
resource_group_name,
job_name,
...
```sql
UPDATE azure.streamanalytics.transformations
SET 
name = '{{ name }}',
...
```sql
REPLACE azure.streamanalytics.transformations
SET 
name = '{{ name }}',
properties = '{{ properties }}'
WHERE 
