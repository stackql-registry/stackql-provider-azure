...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_textanalytics_authoring.project" /></td></tr>
</tbody></table>
...
FROM azure.ai_textanalytics_authoring.project
...
```sql
EXEC azure.ai_textanalytics_authoring.project.list_training_jobs 
...
```sql
EXEC azure.ai_textanalytics_authoring.project.list_deployment_resources 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@top='{{ top }}', 
@skip='{{ skip }}', 
...
```sql
EXEC azure.ai_textanalytics_authoring.project.list_deployments 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@top='{{ top }}', 
@skip='{{ skip }}', 
...
```sql
EXEC azure.ai_textanalytics_authoring.project.list_exported_models 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@top='{{ top }}', 
@skip='{{ skip }}', 
...
```sql
EXEC azure.ai_textanalytics_authoring.project.get_project 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure.ai_textanalytics_authoring.project.assign_deployment_resources 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
...
```sql
EXEC azure.ai_textanalytics_authoring.project.unassign_deployment_resources 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
...
```sql
EXEC azure.ai_textanalytics_authoring.project.swap_deployments 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
...
```sql
EXEC azure.ai_textanalytics_authoring.project.export 
@project_name='{{ project_name }}' --required, 
...
```sql
EXEC azure.ai_textanalytics_authoring.project.import 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
@format='{{ format }}' 
@@json=
...
```sql
EXEC azure.ai_textanalytics_authoring.project.copy_project_authorization 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required
;
```
...
```sql
EXEC azure.ai_textanalytics_authoring.project.copy_project 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
...
```sql
EXEC azure.ai_textanalytics_authoring.project.train 
@project_name='{{ project_name }}' --required, 
@endpoint='{{ endpoint }}' --required 
@@json=
'{
...
```sql
EXEC azure.ai_textanalytics_authoring.project.cancel_training_job 
