...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_textanalytics_authoring.projects" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string (date-time)</code></td>
    <td>Represents the project last deployment datetime.</td>
</tr>
<tr>
    <td><CopyableCode code="lastModifiedDateTime" /></td>
    <td><code>string (date-time)</code></td>
    <td>Represents the project last modification datetime. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="lastTrainedDateTime" /></td>
    <td><code>string (date-time)</code></td>
    <td>Represents the project last training datetime.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The storage container name. Required.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-project_name"><code>project_name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-projectKind"><code>projectKind</code></a>, <a href="#parameter-storageInputContainerName"><code>storageInputContainerName</code></a>, <a href="#parameter-projectName"><code>projectName</code></a>, <a href="#parameter-language"><code>language</code></a></td>
    <td></td>
    <td>The most basic operation that applies to a resource.</td>
</tr>
</tbody>
</table>
...
FROM azure.ai_textanalytics_authoring.projects
...
```sql
DELETE FROM azure.ai_textanalytics_authoring.projects
...
```sql
EXEC azure.ai_textanalytics_authoring.projects.create_project 
