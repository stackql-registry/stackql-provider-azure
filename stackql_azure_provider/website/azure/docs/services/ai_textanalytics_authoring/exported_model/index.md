...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_textanalytics_authoring.exported_model" /></td></tr>
</tbody></table>
...
FROM azure.ai_textanalytics_authoring.exported_model
...
```sql
INSERT INTO azure.ai_textanalytics_authoring.exported_model (
trainedModelLabel,
exported_model_name,
project_name,
endpoint
...
```sql
REPLACE azure.ai_textanalytics_authoring.exported_model
SET 
...
```sql
DELETE FROM azure.ai_textanalytics_authoring.exported_model
WHERE exported_model_name = '{{ exported_model_name }}' --required
AND project_name = '{{ project_name }}' --required
AND endpoint = '{{ endpoint }}' --required
;
...
```sql
EXEC azure.ai_textanalytics_authoring.exported_model.get_exported_model_manifest 
@exported_model_name='{{ exported_model_name }}' --required, 
