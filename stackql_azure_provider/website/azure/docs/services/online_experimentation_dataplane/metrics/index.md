...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.online_experimentation_dataplane.metrics" /></td></tr>
</tbody></table>
...
lastModifiedAt,
lifecycle
FROM azure.online_experimentation_dataplane.metrics
...
```sql
INSERT INTO azure.online_experimentation_dataplane.metrics (
lifecycle,
displayName,
description,
categories,
...
```sql
REPLACE azure.online_experimentation_dataplane.metrics
SET 
lifecycle = '{{ lifecycle }}',
...
```sql
DELETE FROM azure.online_experimentation_dataplane.metrics
WHERE experiment_metric_id = '{{ experiment_metric_id }}' --required
AND endpoint = '{{ endpoint }}' --required
AND If-Unmodified-Since = '{{ If-Unmodified-Since }}'
AND If-Modified-Since = '{{ If-Modified-Since }}'
