...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="role_eligibility_schedule_requests" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The approvalId of the role eligibility schedule request.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>DateTime when role eligibility schedule request was created.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Justification for the role eligibility.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="targetRoleEligibilityScheduleId" /></td>
    <td><code>string</code></td>
    <td>The resultant role eligibility schedule id or the role eligibility schedule id being updated.</td>
</tr>
<tr>
    <td><CopyableCode code="targetRoleEligibilityScheduleInstanceId" /></td>
    <td><code>string</code></td>
    <td>The role eligibility schedule instance id being updated.</td>
</tr>
<tr>
    <td><CopyableCode code="ticketInfo" /></td>
    <td><code>object</code></td>
    <td>Ticket Info of the role eligibility.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-scope"><code>scope</code></a>, <a href="#parameter-role_eligibility_schedule_request_name"><code>role_eligibility_schedule_request_name</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-role_eligibility_schedule_request_name">
    <td><CopyableCode code="role_eligibility_schedule_request_name" /></td>
    <td><code>string</code></td>
    <td>The name (guid) of the role eligibility schedule request to get. Required.</td>
</tr>
...
- name: role_eligibility_schedule_requests
  props:
    ...
    - name: role_eligibility_schedule_request_name
      value: "{{ role_eligibility_schedule_request_name }}"
      description: Required parameter for the role_eligibility_schedule_requests resource.
    - name: properties
      description: |
