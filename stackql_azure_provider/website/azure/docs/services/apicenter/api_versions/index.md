...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_versions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apicenter.api_versions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Current lifecycle stage of the API. Required. Known values are: "design", "development", "testing", "preview", "production", "deprecated", and "retired".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>API version title. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-api_name"><code>api_name</code></a>, <a href="#parameter-version_name"><code>version_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Checks if specified API version exists.</td>
</tr>
</tbody>
</table>
...
title,
type
FROM azure.apicenter.api_versions
...
```sql
INSERT INTO azure.apicenter.api_versions (
properties,
resource_group_name,
service_name,
workspace_name,
...
```sql
REPLACE azure.apicenter.api_versions
SET 
...
```sql
DELETE FROM azure.apicenter.api_versions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND api_name = '{{ api_name }}' --required
...
```sql
EXEC azure.apicenter.api_versions.head 
@resource_group_name='{{ resource_group_name }}' --required, 
