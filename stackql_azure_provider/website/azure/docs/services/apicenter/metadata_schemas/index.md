...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.apicenter.metadata_schemas" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The schema defining the type. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-metadata_schema_name"><code>metadata_schema_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-metadata_schema_name"><code>metadata_schema_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Checks if specified metadata schema exists.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-metadata_schema_name">
    <td><CopyableCode code="metadata_schema_name" /></td>
    <td><code>string</code></td>
    <td>The name of the metadata schema. Required.</td>
</tr>
...
systemData,
type
FROM azure.apicenter.metadata_schemas
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND service_name = '{{ service_name }}' -- required
AND metadata_schema_name = '{{ metadata_schema_name }}' -- required
...
```sql
INSERT INTO azure.apicenter.metadata_schemas (
properties,
resource_group_name,
service_name,
...
```sql
REPLACE azure.apicenter.metadata_schemas
SET 
...
```sql
DELETE FROM azure.apicenter.metadata_schemas
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND metadata_schema_name = '{{ metadata_schema_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.apicenter.metadata_schemas.head 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@metadata_schema_name='{{ metadata_schema_name }}' --required, 
