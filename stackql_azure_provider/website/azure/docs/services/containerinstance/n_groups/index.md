...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerinstance.n_groups" /></td></tr>
</tbody></table>
...
updateProfile,
zones
FROM azure.containerinstance.n_groups
...
```sql
INSERT INTO azure.containerinstance.n_groups (
properties,
tags,
location,
zones,
...
```sql
UPDATE azure.containerinstance.n_groups
SET 
...
```sql
REPLACE azure.containerinstance.n_groups
SET 
properties = '{{ properties }}',
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.containerinstance.n_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND ngroups_name = '{{ ngroups_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.containerinstance.n_groups.start 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.containerinstance.n_groups.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@ngroups_name='{{ ngroups_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.containerinstance.n_groups.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
@ngroups_name='{{ ngroups_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
