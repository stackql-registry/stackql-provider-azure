...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerinstance.containers" /></td></tr>
</tbody></table>
...
SELECT
content
FROM azure.containerinstance.containers
...
```sql
EXEC azure.containerinstance.containers.execute_command 
...
```sql
EXEC azure.containerinstance.containers.attach 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_group_name='{{ container_group_name }}' --required, 
@container_name='{{ container_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
