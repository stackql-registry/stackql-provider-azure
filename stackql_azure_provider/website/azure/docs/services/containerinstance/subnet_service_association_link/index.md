...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerinstance.subnet_service_association_link" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM azure.containerinstance.subnet_service_association_link
