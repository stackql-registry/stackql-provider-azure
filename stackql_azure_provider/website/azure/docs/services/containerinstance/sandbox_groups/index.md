...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerinstance.sandbox_groups" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.containerinstance.sandbox_groups
...
```sql
INSERT INTO azure.containerinstance.sandbox_groups (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.containerinstance.sandbox_groups
SET 
tags = '{{ tags }}',
identity = '{{ identity }}'
WHERE 
...
```sql
REPLACE azure.containerinstance.sandbox_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.containerinstance.sandbox_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sandbox_group_name = '{{ sandbox_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.containerinstance.sandbox_groups.connect 
@resource_group_name='{{ resource_group_name }}' --required, 
