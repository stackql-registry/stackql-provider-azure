...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.rdbms.databases" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.rdbms.databases (
properties,
resource_group_name,
server_name,
database_name,
...
```sql
DELETE FROM azure.rdbms.databases
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND database_name = '{{ database_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
