...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.rdbms.configurations" /></td></tr>
</tbody></table>
...
type,
value
FROM azure.rdbms.configurations
...
```sql
INSERT INTO azure.rdbms.configurations (
properties,
resource_group_name,
server_name,
configuration_name,
...
```sql
REPLACE azure.rdbms.configurations
SET 
