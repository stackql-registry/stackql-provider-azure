...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.rdbms.server_keys" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.rdbms.server_keys (
properties,
server_name,
key_name,
resource_group_name,
...
```sql
REPLACE azure.rdbms.server_keys
SET 
...
```sql
DELETE FROM azure.rdbms.server_keys
