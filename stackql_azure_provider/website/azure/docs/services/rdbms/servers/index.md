...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.rdbms.servers" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.rdbms.servers (
identity,
sku,
properties,
location,
...
```sql
DELETE FROM azure.rdbms.servers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.rdbms.servers.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.rdbms.servers.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.rdbms.servers.upgrade 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
