...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservicefleet.gates" /></td></tr>
</tbody></table>
...
target,
type
FROM azure.containerservicefleet.gates
...
```sql
UPDATE azure.containerservicefleet.gates
SET 
