...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservicefleet.auto_upgrade_profiles" /></td></tr>
</tbody></table>
...
type,
updateStrategyId
FROM azure.containerservicefleet.auto_upgrade_profiles
...
```sql
INSERT INTO azure.containerservicefleet.auto_upgrade_profiles (
properties,
resource_group_name,
fleet_name,
...
```sql
REPLACE azure.containerservicefleet.auto_upgrade_profiles
SET 
...
```sql
DELETE FROM azure.containerservicefleet.auto_upgrade_profiles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND fleet_name = '{{ fleet_name }}' --required
AND auto_upgrade_profile_name = '{{ auto_upgrade_profile_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
