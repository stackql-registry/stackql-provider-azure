...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservicefleet.fleet_managed_namespaces" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.containerservicefleet.fleet_managed_namespaces
...
```sql
INSERT INTO azure.containerservicefleet.fleet_managed_namespaces (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.containerservicefleet.fleet_managed_namespaces
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.containerservicefleet.fleet_managed_namespaces
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.containerservicefleet.fleet_managed_namespaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND fleet_name = '{{ fleet_name }}' --required
AND managed_namespace_name = '{{ managed_namespace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
