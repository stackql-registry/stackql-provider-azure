...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservicefleet.cluster_mesh_profiles" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.containerservicefleet.cluster_mesh_profiles
...
```sql
INSERT INTO azure.containerservicefleet.cluster_mesh_profiles (
properties,
resource_group_name,
fleet_name,
...
```sql
REPLACE azure.containerservicefleet.cluster_mesh_profiles
SET 
...
```sql
DELETE FROM azure.containerservicefleet.cluster_mesh_profiles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND fleet_name = '{{ fleet_name }}' --required
AND cluster_mesh_profile_name = '{{ cluster_mesh_profile_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.containerservicefleet.cluster_mesh_profiles.apply 
@resource_group_name='{{ resource_group_name }}' --required, 
