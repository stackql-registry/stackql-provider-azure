...
Creates, updates, deletes, gets or lists a <code>download_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="download_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.key_vault_security_domain.download_status" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_download_status"
    values={[
        { label: 'get_download_status', value: 'get_download_status' }
    ]}
>
<TabItem value="get_download_status">
...
<tbody>
<tr>
    <td><a href="#get_download_status"><CopyableCode code="get_download_status" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-vault_base_url"><code>vault_base_url</code></a></td>
    <td></td>
    <td>Retrieves the Security Domain download operation status.</td>
</tr>
</tbody>
</table>
...
status,
status_details
FROM azure.key_vault_security_domain.download_status
