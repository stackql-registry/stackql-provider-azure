...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.recoveryservices.deleted_vaults" /></td></tr>
</tbody></table>
...
startTime,
status
FROM azure.recoveryservices.deleted_vaults
...
```sql
EXEC azure.recoveryservices.deleted_vaults.undelete 
