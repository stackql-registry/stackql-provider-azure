...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.health_deidentification.jobs" /></td></tr>
</tbody></table>
...
summary,
targetLocation
FROM azure.health_deidentification.jobs
...
```sql
DELETE FROM azure.health_deidentification.jobs
WHERE name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
