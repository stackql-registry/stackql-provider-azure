...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicelinker.linker" /></td></tr>
</tbody></table>
...
type,
vNetSolution
FROM azure.servicelinker.linker
...
```sql
INSERT INTO azure.servicelinker.linker (
properties,
resource_uri,
linker_name
)
...
```sql
UPDATE azure.servicelinker.linker
SET 
...
```sql
REPLACE azure.servicelinker.linker
SET 
properties = '{{ properties }}'
WHERE 
resource_uri = '{{ resource_uri }}' --required
...
```sql
DELETE FROM azure.servicelinker.linker
WHERE resource_uri = '{{ resource_uri }}' --required
AND linker_name = '{{ linker_name }}' --required
;
```
...
```sql
EXEC azure.servicelinker.linker.list_configurations 
@resource_uri='{{ resource_uri }}' --required, 
...
```sql
EXEC azure.servicelinker.linker.validate 
@resource_uri='{{ resource_uri }}' --required, 
@linker_name='{{ linker_name }}' --required
;
```
