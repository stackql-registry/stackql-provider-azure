...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicelinker.connector" /></td></tr>
</tbody></table>
...
type,
vNetSolution
FROM azure.servicelinker.connector
...
```sql
REPLACE azure.servicelinker.connector
SET 
properties = '{{ properties }}'
WHERE 
subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.servicelinker.connector.list_dryrun 
@subscription_id='{{ subscription_id }}' --required, 
...
```sql
EXEC azure.servicelinker.connector.validate 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@location='{{ location }}' --required, 
...
```sql
EXEC azure.servicelinker.connector.generate_configurations 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@location='{{ location }}' --required, 
@connector_name='{{ connector_name }}' --required 
