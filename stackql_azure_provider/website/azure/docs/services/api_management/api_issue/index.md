...
type,
userId
FROM azure.api_management.api_issue
...
```sql
INSERT INTO azure.api_management.api_issue (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
UPDATE azure.api_management.api_issue
SET 
...
```sql
REPLACE azure.api_management.api_issue
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.api_issue
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND issue_id = '{{ issue_id }}' --required
...
```sql
EXEC azure.api_management.api_issue.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
