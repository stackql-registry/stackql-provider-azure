...
type,
userId
FROM azure.api_management.api_issue_comment
...
```sql
INSERT INTO azure.api_management.api_issue_comment (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
REPLACE azure.api_management.api_issue_comment
SET 
...
```sql
DELETE FROM azure.api_management.api_issue_comment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND issue_id = '{{ issue_id }}' --required
...
```sql
EXEC azure.api_management.api_issue_comment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
