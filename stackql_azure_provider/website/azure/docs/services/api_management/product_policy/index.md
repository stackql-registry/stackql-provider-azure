...
type,
value
FROM azure.api_management.product_policy
...
```sql
INSERT INTO azure.api_management.product_policy (
properties,
resource_group_name,
service_name,
product_id,
...
```sql
REPLACE azure.api_management.product_policy
SET 
...
```sql
DELETE FROM azure.api_management.product_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND product_id = '{{ product_id }}' --required
AND policy_id = '{{ policy_id }}' --required
...
```sql
EXEC azure.api_management.product_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
