...
type,
value
FROM azure.api_management.named_value
...
```sql
INSERT INTO azure.api_management.named_value (
properties,
resource_group_name,
service_name,
named_value_id,
...
```sql
UPDATE azure.api_management.named_value
SET 
...
```sql
REPLACE azure.api_management.named_value
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.named_value
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND named_value_id = '{{ named_value_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.named_value.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.api_management.named_value.list_value 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@named_value_id='{{ named_value_id }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.named_value.refresh_secret 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@named_value_id='{{ named_value_id }}' --required, 
@subscription_id='{{ subscription_id }}' --required
