...
systemData,
type
FROM azure.api_management.workspace_tag
...
```sql
INSERT INTO azure.api_management.workspace_tag (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.api_management.workspace_tag
SET 
...
```sql
REPLACE azure.api_management.workspace_tag
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.workspace_tag
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND tag_id = '{{ tag_id }}' --required
...
```sql
EXEC azure.api_management.workspace_tag.get_entity_state 
@resource_group_name='{{ resource_group_name }}' --required, 
