...
Creates, updates, deletes, gets or lists a <code>product_group_link</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="product_group_link" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.api_management.product_group_link" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-product_id"><code>product_id</code></a>, <a href="#parameter-group_link_id"><code>group_link_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
systemData,
type
FROM azure.api_management.product_group_link
...
```sql
INSERT INTO azure.api_management.product_group_link (
properties,
resource_group_name,
service_name,
product_id,
...
- name: product_group_link
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the product_group_link resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the product_group_link resource.
    - name: product_id
...
```sql
REPLACE azure.api_management.product_group_link
SET 
...
```sql
DELETE FROM azure.api_management.product_group_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND product_id = '{{ product_id }}' --required
AND group_link_id = '{{ group_link_id }}' --required
