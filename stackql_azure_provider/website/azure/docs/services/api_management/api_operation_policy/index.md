...
type,
value
FROM azure.api_management.api_operation_policy
...
```sql
INSERT INTO azure.api_management.api_operation_policy (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
REPLACE azure.api_management.api_operation_policy
SET 
...
```sql
DELETE FROM azure.api_management.api_operation_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND operation_id = '{{ operation_id }}' --required
...
```sql
EXEC azure.api_management.api_operation_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
