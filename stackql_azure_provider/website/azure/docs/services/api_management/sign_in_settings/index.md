...
Creates, updates, deletes, gets or lists a <code>sign_in_settings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="sign_in_settings" /></td></tr>
...
<tr>
    ...
    <td></td>
    <td>Get Sign In Settings for the Portal.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or Update Sign-In settings.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the SignInSettings.</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE azure.api_management.sign_in_settings
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
EXEC azure.api_management.sign_in_settings.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
