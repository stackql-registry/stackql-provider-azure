...
systemData,
type
FROM azure.api_management.workspace_tag_product_link
...
```sql
INSERT INTO azure.api_management.workspace_tag_product_link (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
REPLACE azure.api_management.workspace_tag_product_link
SET 
...
```sql
DELETE FROM azure.api_management.workspace_tag_product_link
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND tag_id = '{{ tag_id }}' --required
