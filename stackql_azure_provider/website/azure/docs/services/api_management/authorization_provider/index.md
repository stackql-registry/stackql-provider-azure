...
systemData,
type
FROM azure.api_management.authorization_provider
...
```sql
INSERT INTO azure.api_management.authorization_provider (
properties,
resource_group_name,
service_name,
...
```sql
REPLACE azure.api_management.authorization_provider
SET 
...
```sql
DELETE FROM azure.api_management.authorization_provider
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND authorization_provider_id = '{{ authorization_provider_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.authorization_provider.refresh_secret 
@resource_group_name='{{ resource_group_name }}' --required, 
