...
title,
type
FROM azure.api_management.api_issue_attachment
...
```sql
INSERT INTO azure.api_management.api_issue_attachment (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
REPLACE azure.api_management.api_issue_attachment
SET 
...
```sql
DELETE FROM azure.api_management.api_issue_attachment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND issue_id = '{{ issue_id }}' --required
...
```sql
EXEC azure.api_management.api_issue_attachment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
