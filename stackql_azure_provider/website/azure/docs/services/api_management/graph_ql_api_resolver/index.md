...
systemData,
type
FROM azure.api_management.graph_ql_api_resolver
...
```sql
INSERT INTO azure.api_management.graph_ql_api_resolver (
properties,
resource_group_name,
service_name,
api_id,
...
```sql
UPDATE azure.api_management.graph_ql_api_resolver
SET 
...
```sql
REPLACE azure.api_management.graph_ql_api_resolver
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.graph_ql_api_resolver
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND resolver_id = '{{ resolver_id }}' --required
...
```sql
EXEC azure.api_management.graph_ql_api_resolver.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
