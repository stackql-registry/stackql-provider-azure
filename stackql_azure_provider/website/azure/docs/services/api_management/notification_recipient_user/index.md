...
type,
userId
FROM azure.api_management.notification_recipient_user
...
```sql
INSERT INTO azure.api_management.notification_recipient_user (
resource_group_name,
service_name,
notification_name,
user_id,
...
```sql
REPLACE azure.api_management.notification_recipient_user
SET 
...
```sql
DELETE FROM azure.api_management.notification_recipient_user
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND notification_name = '{{ notification_name }}' --required
AND user_id = '{{ user_id }}' --required
...
```sql
EXEC azure.api_management.notification_recipient_user.check_entity_exists 
@resource_group_name='{{ resource_group_name }}' --required, 
