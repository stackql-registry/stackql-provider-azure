...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="delegation_settings" /></td></tr>
...
<tr>
    ...
    <td>Subscriptions delegation settings.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>A delegation Url.</td>
</tr>
<tr>
    <td><CopyableCode code="userRegistration" /></td>
    <td><code>object</code></td>
    <td>User registration delegation settings.</td>
</tr>
<tr>
    <td><CopyableCode code="validationKey" /></td>
    <td><code>string</code></td>
    <td>A base64-encoded validation key to validate, that a request is coming from Azure API Management.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Get Delegation Settings for the Portal.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or Update Delegation settings.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update Delegation settings.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the entity state (Etag) version of the DelegationSettings.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Gets the secret validation key of the DelegationSettings.</td>
</tr>
</tbody>
</table>
