...
systemData,
type
FROM azure.api_management.tenant_access
...
```sql
INSERT INTO azure.api_management.tenant_access (
properties,
resource_group_name,
service_name,
access_name,
...
```sql
UPDATE azure.api_management.tenant_access
SET 
...
```sql
EXEC azure.api_management.tenant_access.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.api_management.tenant_access.list_secrets 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@access_name='{{ access_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.tenant_access.regenerate_primary_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@access_name='{{ access_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.tenant_access.regenerate_secondary_key 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@access_name='{{ access_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
