...
systemData,
type
FROM azure.api_management.group
...
```sql
INSERT INTO azure.api_management.group (
properties,
resource_group_name,
service_name,
group_id,
...
```sql
UPDATE azure.api_management.group
SET 
...
```sql
REPLACE azure.api_management.group
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.group
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND group_id = '{{ group_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.api_management.group.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
