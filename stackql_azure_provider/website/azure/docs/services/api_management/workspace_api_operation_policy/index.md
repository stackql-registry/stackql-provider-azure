...
type,
value
FROM azure.api_management.workspace_api_operation_policy
...
```sql
INSERT INTO azure.api_management.workspace_api_operation_policy (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
REPLACE azure.api_management.workspace_api_operation_policy
SET 
...
```sql
DELETE FROM azure.api_management.workspace_api_operation_policy
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.api_management.workspace_api_operation_policy.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
