...
type,
value
FROM azure.api_management.workspace_policy_fragment
...
```sql
INSERT INTO azure.api_management.workspace_policy_fragment (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
REPLACE azure.api_management.workspace_policy_fragment
SET 
...
```sql
DELETE FROM azure.api_management.workspace_policy_fragment
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND id = '{{ id }}' --required
...
```sql
EXEC azure.api_management.workspace_policy_fragment.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.api_management.workspace_policy_fragment.list_references 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@workspace_id='{{ workspace_id }}' --required, 
@id='{{ id }}' --required, 
