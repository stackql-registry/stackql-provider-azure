...
systemData,
type
FROM azure.api_management.workspace_group
...
```sql
INSERT INTO azure.api_management.workspace_group (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.api_management.workspace_group
SET 
...
```sql
REPLACE azure.api_management.workspace_group
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.workspace_group
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND group_id = '{{ group_id }}' --required
...
```sql
EXEC azure.api_management.workspace_group.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
