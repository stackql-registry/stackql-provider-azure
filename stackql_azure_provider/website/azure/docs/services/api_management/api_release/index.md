...
Creates, updates, deletes, gets or lists an <code>api_release</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_release" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.api_management.api_release" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-service_name"><code>service_name</code></a>, <a href="#parameter-api_id"><code>api_id</code></a>, <a href="#parameter-release_id"><code>release_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
type,
updatedDateTime
FROM azure.api_management.api_release
...
```sql
INSERT INTO azure.api_management.api_release (
properties,
resource_group_name,
service_name,
api_id,
...
- name: api_release
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the api_release resource.
    - name: service_name
      value: "{{ service_name }}"
      description: Required parameter for the api_release resource.
    - name: api_id
...
```sql
UPDATE azure.api_management.api_release
SET 
...
```sql
REPLACE azure.api_management.api_release
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.api_release
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND api_id = '{{ api_id }}' --required
AND release_id = '{{ release_id }}' --required
...
```sql
EXEC azure.api_management.api_release.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
