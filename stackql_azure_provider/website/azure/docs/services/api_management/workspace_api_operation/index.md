...
type,
urlTemplate
FROM azure.api_management.workspace_api_operation
...
```sql
INSERT INTO azure.api_management.workspace_api_operation (
properties,
resource_group_name,
service_name,
workspace_id,
...
```sql
UPDATE azure.api_management.workspace_api_operation
SET 
...
```sql
REPLACE azure.api_management.workspace_api_operation
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.api_management.workspace_api_operation
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND workspace_id = '{{ workspace_id }}' --required
AND api_id = '{{ api_id }}' --required
...
```sql
EXEC azure.api_management.workspace_api_operation.get_entity_tag 
@resource_group_name='{{ resource_group_name }}' --required, 
