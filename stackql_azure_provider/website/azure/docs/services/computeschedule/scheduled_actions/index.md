...
tags,
type
FROM azure.computeschedule.scheduled_actions
...
```sql
INSERT INTO azure.computeschedule.scheduled_actions (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.computeschedule.scheduled_actions
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.computeschedule.scheduled_actions
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.computeschedule.scheduled_actions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND scheduled_action_name = '{{ scheduled_action_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.computeschedule.scheduled_actions.list_resources 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.computeschedule.scheduled_actions.virtual_machines_execute_create 
@locationparameter='{{ locationparameter }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.computeschedule.scheduled_actions.virtual_machines_execute_delete 
@locationparameter='{{ locationparameter }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
'{
...
```sql
EXEC azure.computeschedule.scheduled_actions.attach_resources 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.computeschedule.scheduled_actions.detach_resources 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.computeschedule.scheduled_actions.patch_resources 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.computeschedule.scheduled_actions.disable 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.computeschedule.scheduled_actions.enable 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.computeschedule.scheduled_actions.cancel_next_occurrence 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.computeschedule.scheduled_actions.trigger_manual_occurrence 
@resource_group_name='{{ resource_group_name }}' --required, 
@scheduled_action_name='{{ scheduled_action_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
