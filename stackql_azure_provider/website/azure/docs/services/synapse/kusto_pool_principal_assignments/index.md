...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="kusto_pool_principal_assignments" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The principal ID assigned to the cluster principal. It can be a user email, application ID, or security group name.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Cluster principal role. Known values are: "AllDatabasesAdmin" and "AllDatabasesViewer".</td>
</tr>
<tr>
