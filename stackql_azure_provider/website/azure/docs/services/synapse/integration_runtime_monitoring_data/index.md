...
Creates, updates, deletes, gets or lists an <code>integration_runtime_monitoring_data</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="integration_runtime_monitoring_data" /></td></tr>
...
<tr>
    ...
    <td></td>
    <td>Get integration runtime monitoring data. Get monitoring data for an integration runtime.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.synapse.integration_runtime_monitoring_data.list_raw 
