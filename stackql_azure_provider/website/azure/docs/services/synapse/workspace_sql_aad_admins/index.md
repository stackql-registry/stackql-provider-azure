...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="workspace_sql_aad_admins" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Workspace active directory administrator type.</td>
</tr>
<tr>
    <td><CopyableCode code="login" /></td>
    <td><code>string</code></td>
    <td>Login of the workspace active directory administrator.</td>
</tr>
<tr>
    <td><CopyableCode code="sid" /></td>
    <td><code>string</code></td>
    <td>Object ID of the workspace active directory administrator.</td>
</tr>
<tr>
    <td><CopyableCode code="tenantId" /></td>
    <td><code>string</code></td>
    <td>Tenant ID of the workspace active directory administrator.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets a workspace SQL active directory admin.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates a workspace SQL active directory admin.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-workspace_name"><code>workspace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Deletes a workspace SQL active directory admin.</td>
</tr>
</tbody>
</table>
...
- name: workspace_sql_aad_admins
  props:
    - name: resource_group_name
      value: "{{ resource_group_name }}"
      description: Required parameter for the workspace_sql_aad_admins resource.
    - name: workspace_name
