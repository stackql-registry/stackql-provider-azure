...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="extended_sql_pool_blob_auditing_policies" /></td></tr>
...
```sql
REPLACE azure.synapse.extended_sql_pool_blob_auditing_policies
SET 
...
```sql
EXEC azure.synapse.extended_sql_pool_blob_auditing_policies.list_by_sql_pool 
@resource_group_name='{{ resource_group_name }}' --required, 
