...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabricmanagedclusters.services" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.servicefabricmanagedclusters.services
...
```sql
INSERT INTO azure.servicefabricmanagedclusters.services (
properties,
tags,
location,
resource_group_name,
...
```sql
UPDATE azure.servicefabricmanagedclusters.services
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.servicefabricmanagedclusters.services
SET 
...
```sql
DELETE FROM azure.servicefabricmanagedclusters.services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND application_name = '{{ application_name }}' --required
AND service_name = '{{ service_name }}' --required
...
```sql
EXEC azure.servicefabricmanagedclusters.services.restart_replica 
@resource_group_name='{{ resource_group_name }}' --required, 
