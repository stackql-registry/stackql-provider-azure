...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_managedapplications.application_definitions" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.resource_managedapplications.application_definitions
...
```sql
INSERT INTO azure.resource_managedapplications.application_definitions (
location,
tags,
managedBy,
sku,
...
```sql
REPLACE azure.resource_managedapplications.application_definitions
SET 
location = '{{ location }}',
tags = '{{ tags }}',
managedBy = '{{ managedBy }}',
...
```sql
DELETE FROM azure.resource_managedapplications.application_definitions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND application_definition_name = '{{ application_definition_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
