...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_managedapplications.jit_requests" /></td></tr>
</tbody></table>
...
type,
updatedBy
FROM azure.resource_managedapplications.jit_requests
...
```sql
INSERT INTO azure.resource_managedapplications.jit_requests (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.resource_managedapplications.jit_requests
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.resource_managedapplications.jit_requests
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.resource_managedapplications.jit_requests
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND jit_request_name = '{{ jit_request_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
