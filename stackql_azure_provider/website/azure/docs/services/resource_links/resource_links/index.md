...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resource_links.resource_links" /></td></tr>
</tbody></table>
...
targetId,
type
FROM azure.resource_links.resource_links
...
```sql
INSERT INTO azure.resource_links.resource_links (
properties,
link_id
)
SELECT 
...
```sql
REPLACE azure.resource_links.resource_links
SET 
...
```sql
DELETE FROM azure.resource_links.resource_links
WHERE link_id = '{{ link_id }}' --required
;
```
</TabItem>
