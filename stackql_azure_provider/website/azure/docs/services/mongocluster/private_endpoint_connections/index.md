...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mongocluster.private_endpoint_connections" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.mongocluster.private_endpoint_connections
...
```sql
INSERT INTO azure.mongocluster.private_endpoint_connections (
properties,
resource_group_name,
mongo_cluster_name,
...
```sql
DELETE FROM azure.mongocluster.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND mongo_cluster_name = '{{ mongo_cluster_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
