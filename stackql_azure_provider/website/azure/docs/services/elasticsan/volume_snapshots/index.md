...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.elasticsan.volume_snapshots" /></td></tr>
</tbody></table>
...
type,
volumeName
FROM azure.elasticsan.volume_snapshots
...
```sql
INSERT INTO azure.elasticsan.volume_snapshots (
properties,
resource_group_name,
elastic_san_name,
volume_group_name,
...
```sql
DELETE FROM azure.elasticsan.volume_snapshots
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND elastic_san_name = '{{ elastic_san_name }}' --required
AND volume_group_name = '{{ volume_group_name }}' --required
AND snapshot_name = '{{ snapshot_name }}' --required
