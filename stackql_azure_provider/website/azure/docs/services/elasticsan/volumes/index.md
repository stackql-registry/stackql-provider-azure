...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.elasticsan.volumes" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.elasticsan.volumes (
properties,
resource_group_name,
elastic_san_name,
volume_group_name,
...
```sql
UPDATE azure.elasticsan.volumes
SET 
...
```sql
DELETE FROM azure.elasticsan.volumes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND elastic_san_name = '{{ elastic_san_name }}' --required
AND volume_group_name = '{{ volume_group_name }}' --required
AND volume_name = '{{ volume_name }}' --required
...
```sql
EXEC azure.elasticsan.volumes.pre_backup 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.elasticsan.volumes.pre_restore 
@resource_group_name='{{ resource_group_name }}' --required, 
@elastic_san_name='{{ elastic_san_name }}' --required, 
@volume_group_name='{{ volume_group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
