...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.deviceupdate.accounts" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.deviceupdate.accounts
...
```sql
INSERT INTO azure.deviceupdate.accounts (
tags,
location,
identity,
properties,
...
```sql
UPDATE azure.deviceupdate.accounts
SET 
tags = '{{ tags }}',
identity = '{{ identity }}',
location = '{{ location }}'
...
```sql
DELETE FROM azure.deviceupdate.accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.deviceupdate.accounts.head 
@resource_group_name='{{ resource_group_name }}' --required, 
