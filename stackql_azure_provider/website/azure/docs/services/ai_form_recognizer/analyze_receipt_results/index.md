--- 
title: analyze_receipt_results
hide_title: false
hide_table_of_contents: false
keywords:
  - analyze_receipt_results
  - ai_form_recognizer
  - azure
...
Creates, updates, deletes, gets or lists an <code>analyze_receipt_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="analyze_receipt_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_form_recognizer.analyze_receipt_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_analyze_receipt_result"
    values={[
        { label: 'get_analyze_receipt_result', value: 'get_analyze_receipt_result' }
    ]}
>
<TabItem value="get_analyze_receipt_result">
...
<tbody>
<tr>
    <td><a href="#get_analyze_receipt_result"><CopyableCode code="get_analyze_receipt_result" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-result_id"><code>result_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Get Analyze Receipt Result. Track the progress and obtain the result of the analyze receipt operation.</td>
</tr>
</tbody>
</table>
...
status,
trainResult
FROM azure.ai_form_recognizer.analyze_receipt_results
