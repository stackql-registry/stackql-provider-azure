--- 
title: analyze_layout_results
hide_title: false
hide_table_of_contents: false
keywords:
  - analyze_layout_results
  - ai_form_recognizer
  - azure
...
Creates, updates, deletes, gets or lists an <code>analyze_layout_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="analyze_layout_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_form_recognizer.analyze_layout_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_analyze_layout_result"
    values={[
        { label: 'get_analyze_layout_result', value: 'get_analyze_layout_result' }
    ]}
>
<TabItem value="get_analyze_layout_result">
...
<tbody>
<tr>
    <td><a href="#get_analyze_layout_result"><CopyableCode code="get_analyze_layout_result" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-result_id"><code>result_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Get Analyze Layout Result. Track the progress and obtain the result of the analyze layout operation.</td>
</tr>
</tbody>
</table>
...
status,
trainResult
FROM azure.ai_form_recognizer.analyze_layout_results
