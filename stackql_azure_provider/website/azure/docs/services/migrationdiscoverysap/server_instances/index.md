...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrationdiscoverysap.server_instances" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.migrationdiscoverysap.server_instances
...
```sql
INSERT INTO azure.migrationdiscoverysap.server_instances (
properties,
resource_group_name,
...
```sql
UPDATE azure.migrationdiscoverysap.server_instances
SET 
...
```sql
DELETE FROM azure.migrationdiscoverysap.server_instances
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sap_discovery_site_name = '{{ sap_discovery_site_name }}' --required
AND sap_instance_name = '{{ sap_instance_name }}' --required
AND server_instance_name = '{{ server_instance_name }}' --required
