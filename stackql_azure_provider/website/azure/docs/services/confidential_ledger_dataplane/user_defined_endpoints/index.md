...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.confidential_ledger_dataplane.user_defined_endpoints" /></td></tr>
</tbody></table>
...
metadata,
modules
FROM azure.confidential_ledger_dataplane.user_defined_endpoints
...
```sql
INSERT INTO azure.confidential_ledger_dataplane.user_defined_endpoints (
metadata,
modules,
ledger_endpoint
)
