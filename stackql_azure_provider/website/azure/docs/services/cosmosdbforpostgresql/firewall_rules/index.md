...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmosdbforpostgresql.firewall_rules" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.cosmosdbforpostgresql.firewall_rules
...
```sql
INSERT INTO azure.cosmosdbforpostgresql.firewall_rules (
properties,
resource_group_name,
cluster_name,
firewall_rule_name,
...
```sql
REPLACE azure.cosmosdbforpostgresql.firewall_rules
SET 
...
```sql
DELETE FROM azure.cosmosdbforpostgresql.firewall_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND firewall_rule_name = '{{ firewall_rule_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
