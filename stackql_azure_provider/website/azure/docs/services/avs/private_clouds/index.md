...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.avs.private_clouds" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.avs.private_clouds (
tags,
location,
properties,
sku,
...
```sql
UPDATE azure.avs.private_clouds
SET 
tags = '{{ tags }}',
sku = '{{ sku }}',
identity = '{{ identity }}',
...
```sql
REPLACE azure.avs.private_clouds
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.avs.private_clouds
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND private_cloud_name = '{{ private_cloud_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.avs.private_clouds.list_admin_credentials 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.avs.private_clouds.get_vcf_license 
@resource_group_name='{{ resource_group_name }}' --required, 
@private_cloud_name='{{ private_cloud_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.avs.private_clouds.rotate_vcenter_password 
@resource_group_name='{{ resource_group_name }}' --required, 
@private_cloud_name='{{ private_cloud_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.avs.private_clouds.rotate_nsxt_password 
@resource_group_name='{{ resource_group_name }}' --required, 
@private_cloud_name='{{ private_cloud_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
