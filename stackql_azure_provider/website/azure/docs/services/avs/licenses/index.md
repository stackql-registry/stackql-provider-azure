...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.avs.licenses" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.avs.licenses (
properties,
resource_group_name,
private_cloud_name,
license_name,
...
```sql
DELETE FROM azure.avs.licenses
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND private_cloud_name = '{{ private_cloud_name }}' --required
AND license_name = '{{ license_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.avs.licenses.get_properties 
@resource_group_name='{{ resource_group_name }}' --required, 
