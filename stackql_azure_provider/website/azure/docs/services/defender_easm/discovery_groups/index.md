...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.defender_easm.discovery_groups" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM azure.defender_easm.discovery_groups
...
```sql
EXEC azure.defender_easm.discovery_groups.get_raw 
...
```sql
EXEC azure.defender_easm.discovery_groups.put 
@group_name='{{ group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
...
```sql
EXEC azure.defender_easm.discovery_groups.list_raw 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC azure.defender_easm.discovery_groups.list_runs 
@group_name='{{ group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
...
```sql
EXEC azure.defender_easm.discovery_groups.run 
@group_name='{{ group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
...
```sql
EXEC azure.defender_easm.discovery_groups.validate 
@group_name='{{ group_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
