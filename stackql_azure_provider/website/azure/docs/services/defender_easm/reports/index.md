...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.defender_easm.reports" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.defender_easm.reports.billable 
...
```sql
EXEC azure.defender_easm.reports.snapshot 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@endpoint='{{ endpoint }}' --required
...
```sql
EXEC azure.defender_easm.reports.summary 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@endpoint='{{ endpoint }}' --required
