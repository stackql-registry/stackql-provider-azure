...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datamigration.sql_migration_services" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.datamigration.sql_migration_services
...
```sql
INSERT INTO azure.datamigration.sql_migration_services (
properties,
location,
tags,
resource_group_name,
...
```sql
UPDATE azure.datamigration.sql_migration_services
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.datamigration.sql_migration_services
SET 
...
```sql
DELETE FROM azure.datamigration.sql_migration_services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sql_migration_service_name = '{{ sql_migration_service_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.datamigration.sql_migration_services.list_auth_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.datamigration.sql_migration_services.list_migrations 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_migration_service_name='{{ sql_migration_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.datamigration.sql_migration_services.list_monitoring_data 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_migration_service_name='{{ sql_migration_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.datamigration.sql_migration_services.regenerate_auth_keys 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_migration_service_name='{{ sql_migration_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.datamigration.sql_migration_services.delete_node 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_migration_service_name='{{ sql_migration_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
