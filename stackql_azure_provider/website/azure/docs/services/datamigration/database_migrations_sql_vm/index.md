...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.datamigration.database_migrations_sql_vm" /></td></tr>
</tbody></table>
...
type
FROM azure.datamigration.database_migrations_sql_vm
...
```sql
INSERT INTO azure.datamigration.database_migrations_sql_vm (
properties,
resource_group_name,
...
```sql
REPLACE azure.datamigration.database_migrations_sql_vm
SET 
...
```sql
DELETE FROM azure.datamigration.database_migrations_sql_vm
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sql_virtual_machine_name = '{{ sql_virtual_machine_name }}' --required
AND target_db_name = '{{ target_db_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.datamigration.database_migrations_sql_vm.cancel 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.datamigration.database_migrations_sql_vm.cutover 
@resource_group_name='{{ resource_group_name }}' --required, 
@sql_virtual_machine_name='{{ sql_virtual_machine_name }}' --required, 
@target_db_name='{{ target_db_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
