...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.purview_datamap.relationship" /></td></tr>
</tbody></table>
...
referredEntities,
relationship
FROM azure.purview_datamap.relationship
...
```sql
INSERT INTO azure.purview_datamap.relationship (
attributes,
typeName,
lastModifiedTS,
createTime,
...
```sql
UPDATE azure.purview_datamap.relationship
SET 
...
```sql
DELETE FROM azure.purview_datamap.relationship
WHERE guid = '{{ guid }}' --required
AND endpoint = '{{ endpoint }}' --required
;
```
