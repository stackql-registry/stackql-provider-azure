...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.purview_datamap.lineage" /></td></tr>
</tbody></table>
...
relations,
widthCounts
FROM azure.purview_datamap.lineage
...
```sql
EXEC azure.purview_datamap.lineage.get_next_page 
@guid='{{ guid }}' --required, 
