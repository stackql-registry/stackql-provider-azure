...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appnetwork.app_link_members" /></td></tr>
</tbody></table>
...
type,
upgradeProfile
FROM azure.appnetwork.app_link_members
...
```sql
INSERT INTO azure.appnetwork.app_link_members (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.appnetwork.app_link_members
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.appnetwork.app_link_members
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.appnetwork.app_link_members
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND app_link_name = '{{ app_link_name }}' --required
AND app_link_member_name = '{{ app_link_member_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
