...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_containers.container_apps_revisions" /></td></tr>
</tbody></table>
...
trafficWeight,
type
FROM azure.app_containers.container_apps_revisions
...
```sql
EXEC azure.app_containers.container_apps_revisions.activate_revision 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_app_name='{{ container_app_name }}' --required, 
@revision_name='{{ revision_name }}' --required, 
...
```sql
EXEC azure.app_containers.container_apps_revisions.deactivate_revision 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_app_name='{{ container_app_name }}' --required, 
@revision_name='{{ revision_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.app_containers.container_apps_revisions.restart_revision 
@resource_group_name='{{ resource_group_name }}' --required, 
@container_app_name='{{ container_app_name }}' --required, 
@revision_name='{{ revision_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
