...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="connected_environments_certificates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_containers.connected_environments_certificates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-connected_environment_name"><code>connected_environment_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td></td>
    <td>Get the Certificates in a given connected environment. Get the Certificates in a given connected environment.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-connected_environment_name"><code>connected_environment_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
...
valid,
value
FROM azure.app_containers.connected_environments_certificates
...
```sql
INSERT INTO azure.app_containers.connected_environments_certificates (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.app_containers.connected_environments_certificates
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.app_containers.connected_environments_certificates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.app_containers.connected_environments_certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND connected_environment_name = '{{ connected_environment_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
