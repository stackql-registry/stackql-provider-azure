...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dataprotection.export_jobs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Triggers export of jobs and returns an OperationID to track.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.dataprotection.export_jobs.trigger 
