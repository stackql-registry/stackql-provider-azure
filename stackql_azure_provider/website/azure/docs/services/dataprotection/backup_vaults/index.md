...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dataprotection.backup_vaults" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.dataprotection.backup_vaults (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.dataprotection.backup_vaults
SET 
identity = '{{ identity }}',
...
```sql
REPLACE azure.dataprotection.backup_vaults
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.dataprotection.backup_vaults
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND vault_name = '{{ vault_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
