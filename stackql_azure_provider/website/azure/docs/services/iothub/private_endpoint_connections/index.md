...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iothub.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get private endpoint connection. Get private endpoint connection properties.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>List private endpoint connections. List private endpoint connection properties.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Update private endpoint connection. Update the status of a private endpoint connection with the specified name.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-resource_name"><code>resource_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete private endpoint connection. Delete private endpoint connection with the specified name.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.iothub.private_endpoint_connections
...
```sql
UPDATE azure.iothub.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.iothub.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
