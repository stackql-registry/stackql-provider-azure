...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dependency_map.discovery_sources" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.dependency_map.discovery_sources
...
```sql
INSERT INTO azure.dependency_map.discovery_sources (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.dependency_map.discovery_sources
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.dependency_map.discovery_sources
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.dependency_map.discovery_sources
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND map_name = '{{ map_name }}' --required
AND source_name = '{{ source_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
