...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dependency_map.maps" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.dependency_map.maps
...
```sql
INSERT INTO azure.dependency_map.maps (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.dependency_map.maps
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.dependency_map.maps
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.dependency_map.maps
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND map_name = '{{ map_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.dependency_map.maps.get_dependency_view_for_focused_machine 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.dependency_map.maps.get_connections_with_connected_machine_for_focused_machine 
@resource_group_name='{{ resource_group_name }}' --required, 
@map_name='{{ map_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.dependency_map.maps.get_connections_for_process_on_focused_machine 
@resource_group_name='{{ resource_group_name }}' --required, 
@map_name='{{ map_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.dependency_map.maps.export_dependencies 
@resource_group_name='{{ resource_group_name }}' --required, 
@map_name='{{ map_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
