...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.deviceregistry.credentials" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-namespace_name"><code>namespace_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>List Credential resources by Namespace.</td>
</tr>
<tr>
...
tags,
type
FROM azure.deviceregistry.credentials
...
```sql
INSERT INTO azure.deviceregistry.credentials (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.deviceregistry.credentials
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.deviceregistry.credentials
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.deviceregistry.credentials
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.deviceregistry.credentials.list_by_resource_group 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.deviceregistry.credentials.synchronize 
@resource_group_name='{{ resource_group_name }}' --required, 
@namespace_name='{{ namespace_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
