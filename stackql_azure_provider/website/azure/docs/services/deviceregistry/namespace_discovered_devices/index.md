...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.deviceregistry.namespace_discovered_devices" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.deviceregistry.namespace_discovered_devices
...
```sql
INSERT INTO azure.deviceregistry.namespace_discovered_devices (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.deviceregistry.namespace_discovered_devices
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.deviceregistry.namespace_discovered_devices
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.deviceregistry.namespace_discovered_devices
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND discovered_device_name = '{{ discovered_device_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
