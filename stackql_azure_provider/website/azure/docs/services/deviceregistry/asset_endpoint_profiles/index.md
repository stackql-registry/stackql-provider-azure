...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.deviceregistry.asset_endpoint_profiles" /></td></tr>
</tbody></table>
...
type,
uuid
FROM azure.deviceregistry.asset_endpoint_profiles
...
```sql
INSERT INTO azure.deviceregistry.asset_endpoint_profiles (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.deviceregistry.asset_endpoint_profiles
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.deviceregistry.asset_endpoint_profiles
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.deviceregistry.asset_endpoint_profiles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND asset_endpoint_profile_name = '{{ asset_endpoint_profile_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
