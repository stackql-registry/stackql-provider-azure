...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.deviceregistry.namespaces" /></td></tr>
</tbody></table>
...
type,
uuid
FROM azure.deviceregistry.namespaces
...
```sql
INSERT INTO azure.deviceregistry.namespaces (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.deviceregistry.namespaces
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.deviceregistry.namespaces
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.deviceregistry.namespaces
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND namespace_name = '{{ namespace_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.deviceregistry.namespaces.migrate 
@resource_group_name='{{ resource_group_name }}' --required, 
