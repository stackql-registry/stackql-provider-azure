...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workloadorchestration.config_templates" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.workloadorchestration.config_templates
...
```sql
UPDATE azure.workloadorchestration.config_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workloadorchestration.config_templates
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workloadorchestration.config_templates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND config_template_name = '{{ config_template_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.workloadorchestration.config_templates.remove_version 
@resource_group_name='{{ resource_group_name }}' --required, 
