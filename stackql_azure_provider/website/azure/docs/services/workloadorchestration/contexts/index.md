...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workloadorchestration.contexts" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.workloadorchestration.contexts
...
```sql
INSERT INTO azure.workloadorchestration.contexts (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.workloadorchestration.contexts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workloadorchestration.contexts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workloadorchestration.contexts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND context_name = '{{ context_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
