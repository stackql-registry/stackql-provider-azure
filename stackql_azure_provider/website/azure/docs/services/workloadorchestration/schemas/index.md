...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workloadorchestration.schemas" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.workloadorchestration.schemas
...
```sql
UPDATE azure.workloadorchestration.schemas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
REPLACE azure.workloadorchestration.schemas
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.workloadorchestration.schemas
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.workloadorchestration.schemas.remove_version 
@resource_group_name='{{ resource_group_name }}' --required, 
