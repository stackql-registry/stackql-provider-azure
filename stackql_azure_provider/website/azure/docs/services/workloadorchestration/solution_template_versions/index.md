...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.workloadorchestration.solution_template_versions" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.workloadorchestration.solution_template_versions
...
```sql
EXEC azure.workloadorchestration.solution_template_versions.bulk_deploy_solution 
...
```sql
EXEC azure.workloadorchestration.solution_template_versions.bulk_publish_solution 
@resource_group_name='{{ resource_group_name }}' --required, 
@solution_template_name='{{ solution_template_name }}' --required, 
@solution_template_version_name='{{ solution_template_version_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
