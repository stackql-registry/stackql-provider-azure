...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_content_understanding.results" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#delete_result"><CopyableCode code="delete_result" /></a></td>
    <td><CopyableCode code="delete" /></td>
    <td><a href="#parameter-operation_id"><code>operation_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
    <td>Mark the result of an analysis operation for deletion.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="delete_result"
    values={[
        { label: 'delete_result', value: 'delete_result' }
    ]}
>
<TabItem value="delete_result">

Mark the result of an analysis operation for deletion.

```sql
DELETE FROM azure.ai_content_understanding.results
