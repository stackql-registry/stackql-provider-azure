...
Creates, updates, deletes, gets or lists a <code>copy_analyzers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="copy_analyzers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_content_understanding.copy_analyzers" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#copy_analyzer"><CopyableCode code="copy_analyzer" /></a></td>
    ...
    <td>Create a copy of the source analyzer to the current location.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="copy_analyzer"
    values={[
        { label: 'copy_analyzer', value: 'copy_analyzer' }
    ]}
>
<TabItem value="copy_analyzer">

Create a copy of the source analyzer to the current location.

```sql
EXEC azure.ai_content_understanding.copy_analyzers.copy_analyzer 
