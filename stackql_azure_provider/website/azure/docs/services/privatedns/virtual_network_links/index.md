...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.privatedns.virtual_network_links" /></td></tr>
</tbody></table>
...
FROM azure.privatedns.virtual_network_links
...
```sql
INSERT INTO azure.privatedns.virtual_network_links (
tags,
location,
etag,
properties,
...
```sql
UPDATE azure.privatedns.virtual_network_links
SET 
tags = '{{ tags }}',
location = '{{ location }}',
etag = '{{ etag }}',
...
```sql
REPLACE azure.privatedns.virtual_network_links
SET 
tags = '{{ tags }}',
location = '{{ location }}',
etag = '{{ etag }}',
...
```sql
DELETE FROM azure.privatedns.virtual_network_links
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND private_zone_name = '{{ private_zone_name }}' --required
AND virtual_network_link_name = '{{ virtual_network_link_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
