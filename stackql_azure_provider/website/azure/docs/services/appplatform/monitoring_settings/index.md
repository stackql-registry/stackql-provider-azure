...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.monitoring_settings" /></td></tr>
</tbody></table>
...
traceEnabled,
type
FROM azure.appplatform.monitoring_settings
...
```sql
EXEC azure.appplatform.monitoring_settings.update_patch 
@resource_group_name='{{ resource_group_name }}' --required, 
