...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.configuration_services" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appplatform.configuration_services
...
```sql
INSERT INTO azure.appplatform.configuration_services (
properties,
resource_group_name,
service_name,
...
```sql
REPLACE azure.appplatform.configuration_services
SET 
...
```sql
DELETE FROM azure.appplatform.configuration_services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND configuration_service_name = '{{ configuration_service_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.appplatform.configuration_services.validate 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.appplatform.configuration_services.validate_resource 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@configuration_service_name='{{ configuration_service_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
