...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.gateway_route_configs" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appplatform.gateway_route_configs
...
```sql
INSERT INTO azure.appplatform.gateway_route_configs (
properties,
resource_group_name,
service_name,
gateway_name,
...
```sql
REPLACE azure.appplatform.gateway_route_configs
SET 
...
```sql
DELETE FROM azure.appplatform.gateway_route_configs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND gateway_name = '{{ gateway_name }}' --required
AND route_config_name = '{{ route_config_name }}' --required
