...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.application_live_views" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appplatform.application_live_views
...
```sql
INSERT INTO azure.appplatform.application_live_views (
properties,
resource_group_name,
service_name,
...
```sql
REPLACE azure.appplatform.application_live_views
SET 
...
```sql
DELETE FROM azure.appplatform.application_live_views
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND application_live_view_name = '{{ application_live_view_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
