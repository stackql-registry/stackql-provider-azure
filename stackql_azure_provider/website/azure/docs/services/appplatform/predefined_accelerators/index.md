...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.predefined_accelerators" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appplatform.predefined_accelerators
...
```sql
EXEC azure.appplatform.predefined_accelerators.disable 
...
```sql
EXEC azure.appplatform.predefined_accelerators.enable 
@resource_group_name='{{ resource_group_name }}' --required, 
@service_name='{{ service_name }}' --required, 
@application_accelerator_name='{{ application_accelerator_name }}' --required, 
@predefined_accelerator_name='{{ predefined_accelerator_name }}' --required, 
