...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.certificates" /></td></tr>
</tbody></table>
...
thumbprint,
type
FROM azure.appplatform.certificates
...
```sql
INSERT INTO azure.appplatform.certificates (
properties,
resource_group_name,
service_name,
certificate_name,
...
```sql
REPLACE azure.appplatform.certificates
SET 
...
```sql
DELETE FROM azure.appplatform.certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
