...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.appplatform.service_registries" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.appplatform.service_registries
...
```sql
INSERT INTO azure.appplatform.service_registries (
resource_group_name,
service_name,
...
```sql
REPLACE azure.appplatform.service_registries
SET 
...
```sql
DELETE FROM azure.appplatform.service_registries
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND service_name = '{{ service_name }}' --required
AND service_registry_name = '{{ service_registry_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
