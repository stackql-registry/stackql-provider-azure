...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.purview_workflow.task_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Update the status of a workflow task request.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC azure.purview_workflow.task_status.update 
