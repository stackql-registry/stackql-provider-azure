...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.purview_workflow.workflow_runs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-viewMode"><code>viewMode</code></a>, <a href="#parameter-timeWindow"><code>timeWindow</code></a>, <a href="#parameter-orderby"><code>orderby</code></a>, <a href="#parameter-runStatuses"><code>runStatuses</code></a>, <a href="#parameter-workflowIds"><code>workflowIds</code></a>, <a href="#parameter-requestors"><code>requestors</code></a>, <a href="#parameter-maxpagesize"><code>maxpagesize</code></a></td>
...
<tr id="parameter-runStatuses">
    <td><CopyableCode code="runStatuses" /></td>
    <td><code>array</code></td>
    <td>Filter workflow runs by workflow run status. Default value is None.</td>
</tr>
...
<tr id="parameter-viewMode">
    ...
    <td><code>string</code></td>
    <td>To filter user's workflow runs or view as admin. Default value is None.</td>
</tr>
...
```sql
EXEC azure.purview_workflow.workflow_runs.list_raw 
