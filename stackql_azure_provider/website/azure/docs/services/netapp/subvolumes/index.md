...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.netapp.subvolumes" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.netapp.subvolumes (
properties,
resource_group_name,
account_name,
pool_name,
...
```sql
UPDATE azure.netapp.subvolumes
SET 
...
```sql
DELETE FROM azure.netapp.subvolumes
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND pool_name = '{{ pool_name }}' --required
AND volume_name = '{{ volume_name }}' --required
...
```sql
EXEC azure.netapp.subvolumes.get_metadata 
@resource_group_name='{{ resource_group_name }}' --required, 
