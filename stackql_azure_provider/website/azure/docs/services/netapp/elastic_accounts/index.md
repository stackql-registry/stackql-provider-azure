...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.netapp.elastic_accounts" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.netapp.elastic_accounts
...
```sql
INSERT INTO azure.netapp.elastic_accounts (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.netapp.elastic_accounts
SET 
identity = '{{ identity }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.netapp.elastic_accounts
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.netapp.elastic_accounts
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
