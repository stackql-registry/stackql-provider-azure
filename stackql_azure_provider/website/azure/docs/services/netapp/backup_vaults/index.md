...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.netapp.backup_vaults" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.netapp.backup_vaults
...
```sql
INSERT INTO azure.netapp.backup_vaults (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.netapp.backup_vaults
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.netapp.backup_vaults
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.netapp.backup_vaults
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND backup_vault_name = '{{ backup_vault_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
