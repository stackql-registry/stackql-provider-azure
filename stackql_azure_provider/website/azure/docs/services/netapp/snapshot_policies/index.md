...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.netapp.snapshot_policies" /></td></tr>
</tbody></table>
...
type,
weeklySchedule
FROM azure.netapp.snapshot_policies
...
```sql
INSERT INTO azure.netapp.snapshot_policies (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.netapp.snapshot_policies
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.netapp.snapshot_policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND snapshot_policy_name = '{{ snapshot_policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.netapp.snapshot_policies.list_volumes 
@resource_group_name='{{ resource_group_name }}' --required, 
