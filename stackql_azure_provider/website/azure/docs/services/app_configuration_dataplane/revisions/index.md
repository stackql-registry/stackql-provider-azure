...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_configuration_dataplane.revisions" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_revisions"
    values={[
        { label: 'get_revisions', value: 'get_revisions' }
    ]}
>
<TabItem value="get_revisions">
