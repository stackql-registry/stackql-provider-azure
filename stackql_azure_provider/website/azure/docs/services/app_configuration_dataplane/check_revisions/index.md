...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_configuration_dataplane.check_revisions" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.app_configuration_dataplane.check_revisions.check_revisions 
