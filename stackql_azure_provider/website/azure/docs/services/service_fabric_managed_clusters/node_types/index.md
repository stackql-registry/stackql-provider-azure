...
```sql
REPLACE azure.service_fabric_managed_clusters.node_types
SET 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.list_fault_simulation 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.deallocate 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.delete_node 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.redeploy 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.start_fault_simulation 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
...
```sql
EXEC azure.service_fabric_managed_clusters.node_types.stop_fault_simulation 
@resource_group_name='{{ resource_group_name }}' --required, 
@cluster_name='{{ cluster_name }}' --required, 
@node_type_name='{{ node_type_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
