...
Creates, updates, deletes, gets or lists a <code>git_hub_owner</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="git_hub_owner" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securitydevops.git_hub_owner" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of monitored GitHub owners. Returns a list of monitored GitHub owners.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-git_hub_connector_name"><code>git_hub_connector_name</code></a>, <a href="#parameter-git_hub_owner_name"><code>git_hub_owner_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create or update a monitored GitHub owner. Create or update a monitored GitHub owner.</td>
</tr>
<tr>
...
systemData,
type
FROM azure.securitydevops.git_hub_owner
...
Returns a list of monitored GitHub owners. Returns a list of monitored GitHub owners.
...
```sql
INSERT INTO azure.securitydevops.git_hub_owner (
properties,
resource_group_name,
...
- name: git_hub_owner
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the git_hub_owner resource.
...
```sql
UPDATE azure.securitydevops.git_hub_owner
SET 
...
```sql
REPLACE azure.securitydevops.git_hub_owner
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
