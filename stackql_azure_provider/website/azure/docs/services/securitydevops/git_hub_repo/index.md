...
Creates, updates, deletes, gets or lists a <code>git_hub_repo</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="git_hub_repo" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securitydevops.git_hub_repo" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securitydevops.git_hub_repo
...
```sql
INSERT INTO azure.securitydevops.git_hub_repo (
properties,
resource_group_name,
...
- name: git_hub_repo
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the git_hub_repo resource.
...
```sql
UPDATE azure.securitydevops.git_hub_repo
SET 
...
```sql
REPLACE azure.securitydevops.git_hub_repo
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
