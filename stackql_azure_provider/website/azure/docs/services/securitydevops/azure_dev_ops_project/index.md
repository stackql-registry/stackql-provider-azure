...
Creates, updates, deletes, gets or lists an <code>azure_dev_ops_project</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="azure_dev_ops_project" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securitydevops.azure_dev_ops_project" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Gets or sets AzureDevOps Project Id.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-azure_dev_ops_connector_name"><code>azure_dev_ops_connector_name</code></a>, <a href="#parameter-azure_dev_ops_org_name"><code>azure_dev_ops_org_name</code></a>, <a href="#parameter-azure_dev_ops_project_name"><code>azure_dev_ops_project_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Creates or updates an Azure DevOps Project. Creates or updates an Azure DevOps Project.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-azure_dev_ops_connector_name"><code>azure_dev_ops_connector_name</code></a>, <a href="#parameter-azure_dev_ops_org_name"><code>azure_dev_ops_org_name</code></a>, <a href="#parameter-azure_dev_ops_project_name"><code>azure_dev_ops_project_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update monitored AzureDevOps Project details. Update monitored AzureDevOps Project details.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
systemData,
type
FROM azure.securitydevops.azure_dev_ops_project
...
Creates or updates an Azure DevOps Project. Creates or updates an Azure DevOps Project.

```sql
INSERT INTO azure.securitydevops.azure_dev_ops_project (
properties,
resource_group_name,
...
- name: azure_dev_ops_project
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the azure_dev_ops_project resource.
...
Update monitored AzureDevOps Project details. Update monitored AzureDevOps Project details.

```sql
UPDATE azure.securitydevops.azure_dev_ops_project
SET 
...
```sql
REPLACE azure.securitydevops.azure_dev_ops_project
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
