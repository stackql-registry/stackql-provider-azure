...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securitydevops.github_repo" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securitydevops.github_repo
...
```sql
INSERT INTO azure.securitydevops.github_repo (
properties,
resource_group_name,
...
```sql
UPDATE azure.securitydevops.github_repo
SET 
...
```sql
REPLACE azure.securitydevops.github_repo
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
