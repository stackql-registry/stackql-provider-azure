...
Creates, updates, deletes, gets or lists a <code>github_owner</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="github_owner" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.securitydevops.github_owner" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.securitydevops.github_owner
...
```sql
INSERT INTO azure.securitydevops.github_owner (
properties,
resource_group_name,
...
- name: github_owner
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the github_owner resource.
...
```sql
UPDATE azure.securitydevops.github_owner
SET 
...
```sql
REPLACE azure.securitydevops.github_owner
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
