...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.media.streaming_locators" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.media.streaming_locators
...
```sql
INSERT INTO azure.media.streaming_locators (
properties,
resource_group_name,
account_name,
...
```sql
DELETE FROM azure.media.streaming_locators
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND streaming_locator_name = '{{ streaming_locator_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.media.streaming_locators.list_content_keys 
...
```sql
EXEC azure.media.streaming_locators.list_paths 
@resource_group_name='{{ resource_group_name }}' --required, 
@account_name='{{ account_name }}' --required, 
@streaming_locator_name='{{ streaming_locator_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
