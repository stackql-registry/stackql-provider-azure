...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.media.private_endpoint_connections" /></td></tr>
</tbody></table>
...
provisioningState,
type
FROM azure.media.private_endpoint_connections
...
```sql
INSERT INTO azure.media.private_endpoint_connections (
properties,
resource_group_name,
account_name,
name,
...
```sql
REPLACE azure.media.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.media.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
