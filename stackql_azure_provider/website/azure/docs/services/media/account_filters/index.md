...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.media.account_filters" /></td></tr>
</tbody></table>
...
tracks,
type
FROM azure.media.account_filters
...
```sql
INSERT INTO azure.media.account_filters (
properties,
resource_group_name,
account_name,
filter_name,
...
```sql
UPDATE azure.media.account_filters
SET 
...
```sql
REPLACE azure.media.account_filters
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.media.account_filters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND filter_name = '{{ filter_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
