...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mysqlflexibleservers.configurations" /></td></tr>
</tbody></table>
...
type,
value
FROM azure.mysqlflexibleservers.configurations
...
```sql
INSERT INTO azure.mysqlflexibleservers.configurations (
properties,
resource_group_name,
server_name,
configuration_name,
...
```sql
UPDATE azure.mysqlflexibleservers.configurations
SET 
...
```sql
REPLACE azure.mysqlflexibleservers.configurations
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
EXEC azure.mysqlflexibleservers.configurations.batch_update 
@resource_group_name='{{ resource_group_name }}' --required, 
