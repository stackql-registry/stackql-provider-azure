...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.mysqlflexibleservers.long_running_backup" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.mysqlflexibleservers.long_running_backup (
properties,
resource_group_name,
server_name,
backup_name,
...
```sql
DELETE FROM azure.mysqlflexibleservers.long_running_backup
