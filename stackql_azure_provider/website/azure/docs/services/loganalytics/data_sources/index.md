...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.loganalytics.data_sources" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.loganalytics.data_sources
...
```sql
INSERT INTO azure.loganalytics.data_sources (
properties,
etag,
kind,
tags,
...
```sql
REPLACE azure.loganalytics.data_sources
SET 
...
```sql
DELETE FROM azure.loganalytics.data_sources
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND data_source_name = '{{ data_source_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
