...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.loganalytics.summary_logs" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.loganalytics.summary_logs
...
```sql
INSERT INTO azure.loganalytics.summary_logs (
properties,
resource_group_name,
workspace_name,
summary_logs_name,
...
```sql
REPLACE azure.loganalytics.summary_logs
SET 
...
```sql
DELETE FROM azure.loganalytics.summary_logs
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND summary_logs_name = '{{ summary_logs_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.loganalytics.summary_logs.start 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.loganalytics.summary_logs.stop 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@summary_logs_name='{{ summary_logs_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.loganalytics.summary_logs.retry_bin 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@summary_logs_name='{{ summary_logs_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
