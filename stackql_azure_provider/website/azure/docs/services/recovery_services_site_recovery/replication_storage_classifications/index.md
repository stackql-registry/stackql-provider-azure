...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="replication_storage_classifications" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Friendly name of the Storage classification.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets the details of a storage classification. Gets the details of the specified storage classification.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets the list of storage classification objects under a fabric. Lists the storage classifications available in the specified fabric.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Gets the list of storage classification objects under a vault. Lists the storage classifications in the vault.</td>
</tr>
</tbody>
</table>
