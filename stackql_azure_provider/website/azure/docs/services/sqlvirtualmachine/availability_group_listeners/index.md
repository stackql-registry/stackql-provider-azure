...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.sqlvirtualmachine.availability_group_listeners" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.sqlvirtualmachine.availability_group_listeners
...
```sql
INSERT INTO azure.sqlvirtualmachine.availability_group_listeners (
properties,
resource_group_name,
sql_virtual_machine_group_name,
...
```sql
REPLACE azure.sqlvirtualmachine.availability_group_listeners
SET 
...
```sql
DELETE FROM azure.sqlvirtualmachine.availability_group_listeners
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND sql_virtual_machine_group_name = '{{ sql_virtual_machine_group_name }}' --required
AND availability_group_listener_name = '{{ availability_group_listener_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
