--- 
title: isp_cache_nodes_operations
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>isp_cache_nodes_operations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="isp_cache_nodes_operations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.connectedcache.isp_cache_nodes_operations" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_isp_customer_resource', value: 'list_by_isp_customer_resource' }
    ]}
>
<TabItem value="get">
...
<TabItem value="list_by_isp_customer_resource">
...
<tr>
    <td><a href="#list_by_isp_customer_resource"><CopyableCode code="list_by_isp_customer_resource" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#get_bgp_cidrs"><CopyableCode code="get_bgp_cidrs" /></a></td>
...
tags,
type
FROM azure.connectedcache.isp_cache_nodes_operations
...
```sql
INSERT INTO azure.connectedcache.isp_cache_nodes_operations (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.connectedcache.isp_cache_nodes_operations
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.connectedcache.isp_cache_nodes_operations
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.connectedcache.isp_cache_nodes_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND customer_resource_name = '{{ customer_resource_name }}' --required
AND cache_node_resource_name = '{{ cache_node_resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
<Tabs
    defaultValue="get_bgp_cidrs"
    values={[
        { label: 'get_bgp_cidrs', value: 'get_bgp_cidrs' },
...
>
<TabItem value="get_bgp_cidrs">

This api gets ispCacheNode resource information.

```sql
EXEC azure.connectedcache.isp_cache_nodes_operations.get_bgp_cidrs 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.connectedcache.isp_cache_nodes_operations.get_cache_node_install_details 
@resource_group_name='{{ resource_group_name }}' --required, 
@customer_resource_name='{{ customer_resource_name }}' --required, 
@cache_node_resource_name='{{ cache_node_resource_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.connectedcache.isp_cache_nodes_operations.get_cache_node_auto_update_history 
@resource_group_name='{{ resource_group_name }}' --required, 
@customer_resource_name='{{ customer_resource_name }}' --required, 
@cache_node_resource_name='{{ cache_node_resource_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.connectedcache.isp_cache_nodes_operations.get_cache_node_mcc_issue_details_history 
@resource_group_name='{{ resource_group_name }}' --required, 
@customer_resource_name='{{ customer_resource_name }}' --required, 
@cache_node_resource_name='{{ cache_node_resource_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
