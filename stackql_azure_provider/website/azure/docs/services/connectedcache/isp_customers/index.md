...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.connectedcache.isp_customers" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.connectedcache.isp_customers
...
```sql
INSERT INTO azure.connectedcache.isp_customers (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.connectedcache.isp_customers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.connectedcache.isp_customers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.connectedcache.isp_customers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND customer_resource_name = '{{ customer_resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
