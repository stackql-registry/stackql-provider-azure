--- 
title: enterprise_mcc_customers
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>enterprise_mcc_customers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="enterprise_mcc_customers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.connectedcache.enterprise_mcc_customers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the enterprise mcc customer resource information using this get call.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>This api gets the information about all enterprise mcc customer resources under the given subscription and resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>This api gets information about all enterpriseMccCustomer resources under the given subscription.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>This api creates an enterprise mcc customer with the specified create parameters.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-customer_resource_name"><code>customer_resource_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>This api updates an existing enterprise mcc customer resource.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-customer_resource_name"><code>customer_resource_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>This api deletes an existing enterprise mcc customer resource.</td>
</tr>
</tbody>
</table>
...
tags,
type
FROM azure.connectedcache.enterprise_mcc_customers
...
```sql
INSERT INTO azure.connectedcache.enterprise_mcc_customers (
tags,
location,
properties,
resource_group_name,
...
- name: enterprise_mcc_customers
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the enterprise_mcc_customers resource.
...
```sql
UPDATE azure.connectedcache.enterprise_mcc_customers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.connectedcache.enterprise_mcc_customers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.connectedcache.enterprise_mcc_customers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND customer_resource_name = '{{ customer_resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
