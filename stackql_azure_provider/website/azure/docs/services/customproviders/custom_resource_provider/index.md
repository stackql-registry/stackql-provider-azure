...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.customproviders.custom_resource_provider" /></td></tr>
</tbody></table>
...
type,
validations
FROM azure.customproviders.custom_resource_provider
...
```sql
INSERT INTO azure.customproviders.custom_resource_provider (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.customproviders.custom_resource_provider
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.customproviders.custom_resource_provider
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.customproviders.custom_resource_provider
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_provider_name = '{{ resource_provider_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
