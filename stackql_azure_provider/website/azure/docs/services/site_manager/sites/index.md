...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.site_manager.sites" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>List Site resources by resource group.</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.site_manager.sites (
properties,
resource_group_name,
site_name,
subscription_id
...
```sql
UPDATE azure.site_manager.sites
SET 
...
```sql
REPLACE azure.site_manager.sites
SET 
properties = '{{ properties }}'
WHERE 
resource_group_name = '{{ resource_group_name }}' --required
...
```sql
DELETE FROM azure.site_manager.sites
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND site_name = '{{ site_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
