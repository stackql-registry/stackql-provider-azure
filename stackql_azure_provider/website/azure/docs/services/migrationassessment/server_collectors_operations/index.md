...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrationassessment.server_collectors_operations" /></td></tr>
</tbody></table>
...
type,
updatedTimestamp
FROM azure.migrationassessment.server_collectors_operations
...
```sql
INSERT INTO azure.migrationassessment.server_collectors_operations (
properties,
resource_group_name,
project_name,
...
```sql
DELETE FROM azure.migrationassessment.server_collectors_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND project_name = '{{ project_name }}' --required
AND server_collector_name = '{{ server_collector_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
