...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrationassessment.sql_assessment_v2_operations" /></td></tr>
</tbody></table>
...
type,
updatedTimestamp
FROM azure.migrationassessment.sql_assessment_v2_operations
...
```sql
INSERT INTO azure.migrationassessment.sql_assessment_v2_operations (
properties,
resource_group_name,
project_name,
group_name,
...
```sql
DELETE FROM azure.migrationassessment.sql_assessment_v2_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND project_name = '{{ project_name }}' --required
AND group_name = '{{ group_name }}' --required
AND assessment_name = '{{ assessment_name }}' --required
...
```sql
EXEC azure.migrationassessment.sql_assessment_v2_operations.download_url 
