...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrationassessment.avs_assessments_operations" /></td></tr>
</tbody></table>
...
FROM azure.migrationassessment.avs_assessments_operations
...
```sql
INSERT INTO azure.migrationassessment.avs_assessments_operations (
properties,
resource_group_name,
project_name,
group_name,
...
```sql
DELETE FROM azure.migrationassessment.avs_assessments_operations
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND project_name = '{{ project_name }}' --required
AND group_name = '{{ group_name }}' --required
AND assessment_name = '{{ assessment_name }}' --required
...
```sql
EXEC azure.migrationassessment.avs_assessments_operations.download_url 
