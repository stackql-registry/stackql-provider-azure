...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.compute_recommender.spot_placement_scores" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Describes what are the supported resource types for a diagnostic.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets Spot Placement Scores metadata.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-location"><code>location</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Generates placement scores for Spot VM skus.</td>
</tr>
</tbody>
</table>
...
systemData,
type
FROM azure.compute_recommender.spot_placement_scores
...
```sql
EXEC azure.compute_recommender.spot_placement_scores.post 
