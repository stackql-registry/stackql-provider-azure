...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managedapplications.application_definitions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The storage account id for bring your own storage scenario.</td>
</tr>
<tr>
...
<tr id="parameter-application_definition_name">
    ...
    <td><code>string</code></td>
    <td>The name of the managed application definition. Required.</td>
</tr>
...
tags,
type
FROM azure.managedapplications.application_definitions
...
```sql
INSERT INTO azure.managedapplications.application_definitions (
location,
tags,
managedBy,
sku,
...
```sql
UPDATE azure.managedapplications.application_definitions
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.managedapplications.application_definitions
SET 
location = '{{ location }}',
tags = '{{ tags }}',
managedBy = '{{ managedBy }}',
...
```sql
DELETE FROM azure.managedapplications.application_definitions
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND application_definition_name = '{{ application_definition_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
