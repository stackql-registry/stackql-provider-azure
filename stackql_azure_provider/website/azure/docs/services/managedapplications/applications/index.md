...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managedapplications.applications" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The managed application provisioning state. Known values are: "NotSpecified", "Accepted", "Running", "Deleting", "Deleted", "Canceled", "Failed", "Succeeded", and "Updating".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-application_name"><code>application_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-metadata"><code>metadata</code></a>, <a href="#parameter-status"><code>status</code></a>, <a href="#parameter-subStatus"><code>subStatus</code></a></td>
    <td></td>
...
type,
updatedBy
FROM azure.managedapplications.applications
...
```sql
INSERT INTO azure.managedapplications.applications (
location,
tags,
managedBy,
sku,
...
- name: applications
  props:
    ...
    - name: plan
      description: |
        Plan for the managed application. All required parameters must be populated in order to send to Azure.
      value:
        name: "{{ name }}"
        publisher: "{{ publisher }}"
        product: "{{ product }}"
...
```sql
UPDATE azure.managedapplications.applications
SET 
location = '{{ location }}',
tags = '{{ tags }}',
managedBy = '{{ managedBy }}',
...
```sql
REPLACE azure.managedapplications.applications
SET 
location = '{{ location }}',
tags = '{{ tags }}',
managedBy = '{{ managedBy }}',
...
```sql
DELETE FROM azure.managedapplications.applications
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND application_name = '{{ application_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
<Tabs
    defaultValue="list_allowed_upgrade_plans"
    values={[
...
```sql
EXEC azure.managedapplications.applications.list_allowed_upgrade_plans 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.managedapplications.applications.list_tokens 
@resource_group_name='{{ resource_group_name }}' --required, 
@application_name='{{ application_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.managedapplications.applications.refresh_permissions 
@resource_group_name='{{ resource_group_name }}' --required, 
@application_name='{{ application_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managedapplications.applications.update_access 
@resource_group_name='{{ resource_group_name }}' --required, 
@application_name='{{ application_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
