...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managedapplications.jit_requests" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The JIT request provisioning state. Known values are: "NotSpecified", "Accepted", "Running", "Deleting", "Deleted", "Canceled", "Failed", "Succeeded", and "Updating".</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Lists all JIT requests within the resource group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Lists all JIT requests within the subscription.</td>
</tr>
<tr>
...
type,
updatedBy
FROM azure.managedapplications.jit_requests
...
```sql
INSERT INTO azure.managedapplications.jit_requests (
location,
tags,
properties,
resource_group_name,
...
```sql
UPDATE azure.managedapplications.jit_requests
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.managedapplications.jit_requests
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managedapplications.jit_requests
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND jit_request_name = '{{ jit_request_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
