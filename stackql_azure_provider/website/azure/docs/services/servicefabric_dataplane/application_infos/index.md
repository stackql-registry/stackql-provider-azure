...
Creates, updates, deletes, gets or lists an <code>application_infos</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="application_infos" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric_dataplane.application_infos" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_application_info"
    values={[
        { label: 'get_application_info', value: 'get_application_info' }
    ]}
>
<TabItem value="get_application_info">
...
<tbody>
<tr>
    <td><CopyableCode code="ApplicationDefinitionKind" /></td>
...
<tr>
    <td><CopyableCode code="ManagedApplicationIdentity" /></td>
    <td><code>object</code></td>
    <td>Managed application identity description.</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#get_application_info"><CopyableCode code="get_application_info" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-application_id"><code>application_id</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td><a href="#parameter-ExcludeApplicationParameters"><code>ExcludeApplicationParameters</code></a>, <a href="#parameter-timeout"><code>timeout</code></a></td>
    <td>Gets information about a Service Fabric application. Returns the information about the application that was created or in the process of being created in the Service Fabric cluster and whose name matches the one specified as the parameter. The response includes the name, type, status, parameters, and other details about the application.</td>
</tr>
</tbody>
</table>
...
TypeName,
TypeVersion
FROM azure.servicefabric_dataplane.application_infos
