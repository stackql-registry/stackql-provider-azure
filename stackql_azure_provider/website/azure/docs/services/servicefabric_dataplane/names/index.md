...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric_dataplane.names" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.servicefabric_dataplane.names (
Name,
endpoint,
timeout
)
...
```sql
DELETE FROM azure.servicefabric_dataplane.names
