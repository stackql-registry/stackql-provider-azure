...
Creates, updates, deletes, gets or lists a <code>node_event_lists</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="node_event_lists" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric_dataplane.node_event_lists" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-node_name"><code>node_name</code></a>, <a href="#parameter-EndTimeUtc"><code>EndTimeUtc</code></a>, <a href="#parameter-StartTimeUtc"><code>StartTimeUtc</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
...
<Tabs
    defaultValue="get_node_event_list"
    values={[
        { label: 'get_node_event_list', value: 'get_node_event_list' }
    ]}
>
<TabItem value="get_node_event_list">

Gets a Node-related events. The response is list of NodeEvent objects.
