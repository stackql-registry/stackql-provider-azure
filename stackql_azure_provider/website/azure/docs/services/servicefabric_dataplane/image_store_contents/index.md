...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric_dataplane.image_store_contents" /></td></tr>
</tbody></table>
...
StoreFiles,
StoreFolders
FROM azure.servicefabric_dataplane.image_store_contents
...
```sql
DELETE FROM azure.servicefabric_dataplane.image_store_contents
WHERE content_path = '{{ content_path }}' --required
AND endpoint = '{{ endpoint }}' --required
AND timeout = '{{ timeout }}'
;
