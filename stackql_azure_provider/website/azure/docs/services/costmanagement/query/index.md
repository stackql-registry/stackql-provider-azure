...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.costmanagement.query" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.costmanagement.query.usage 
...
```sql
EXEC azure.costmanagement.query.usage_by_external_cloud_provider_type 
