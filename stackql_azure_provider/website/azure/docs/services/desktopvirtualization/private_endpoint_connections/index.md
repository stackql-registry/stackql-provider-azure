...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.desktopvirtualization.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-host_pool_name"><code>host_pool_name</code></a>, <a href="#parameter-private_endpoint_connection_name"><code>private_endpoint_connection_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get a private endpoint connection.</td>
</tr>
<tr>
...
systemData,
type
FROM azure.desktopvirtualization.private_endpoint_connections
...
```sql
UPDATE azure.desktopvirtualization.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.desktopvirtualization.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND workspace_name = '{{ workspace_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
