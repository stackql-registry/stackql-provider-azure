...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.desktopvirtualization.scaling_plan_pooled_schedules" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.desktopvirtualization.scaling_plan_pooled_schedules
...
```sql
INSERT INTO azure.desktopvirtualization.scaling_plan_pooled_schedules (
properties,
resource_group_name,
scaling_plan_name,
...
```sql
UPDATE azure.desktopvirtualization.scaling_plan_pooled_schedules
SET 
...
```sql
DELETE FROM azure.desktopvirtualization.scaling_plan_pooled_schedules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND scaling_plan_name = '{{ scaling_plan_name }}' --required
AND scaling_plan_schedule_name = '{{ scaling_plan_schedule_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
