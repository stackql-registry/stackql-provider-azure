...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.desktopvirtualization.application_groups" /></td></tr>
</tbody></table>
...
type,
workspaceArmPath
FROM azure.desktopvirtualization.application_groups
...
```sql
INSERT INTO azure.desktopvirtualization.application_groups (
tags,
location,
managedBy,
kind,
...
```sql
UPDATE azure.desktopvirtualization.application_groups
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.desktopvirtualization.application_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
managedBy = '{{ managedBy }}',
...
```sql
DELETE FROM azure.desktopvirtualization.application_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND application_group_name = '{{ application_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
