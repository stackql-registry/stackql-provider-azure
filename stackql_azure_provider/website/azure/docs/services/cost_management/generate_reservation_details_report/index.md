...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cost_management.generate_reservation_details_report" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.cost_management.generate_reservation_details_report.by_billing_profile_id 
@billing_account_id='{{ billing_account_id }}' --required, 
