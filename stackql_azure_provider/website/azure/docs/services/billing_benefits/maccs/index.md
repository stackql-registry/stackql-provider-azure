...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.billing_benefits.maccs" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.billing_benefits.maccs.write_off 
@resource_group_name='{{ resource_group_name }}' --required, 
@macc_name='{{ macc_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.billing_benefits.maccs.charge_shortfall 
@resource_group_name='{{ resource_group_name }}' --required, 
@macc_name='{{ macc_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
