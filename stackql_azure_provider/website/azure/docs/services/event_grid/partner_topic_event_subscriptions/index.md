...
```sql
REPLACE azure.event_grid.partner_topic_event_subscriptions
SET 
...
```sql
EXEC azure.event_grid.partner_topic_event_subscriptions.get_full_url 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.event_grid.partner_topic_event_subscriptions.get_delivery_attributes 
@resource_group_name='{{ resource_group_name }}' --required, 
@partner_topic_name='{{ partner_topic_name }}' --required, 
@event_subscription_name='{{ event_subscription_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
