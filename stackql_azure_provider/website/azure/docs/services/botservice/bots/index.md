...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.botservice.bots" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.botservice.bots (
location,
tags,
sku,
kind,
...
```sql
DELETE FROM azure.botservice.bots
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
