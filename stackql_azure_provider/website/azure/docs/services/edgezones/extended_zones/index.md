...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.edgezones.extended_zones" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.edgezones.extended_zones
...
```sql
EXEC azure.edgezones.extended_zones.register 
...
```sql
EXEC azure.edgezones.extended_zones.unregister 
@extended_zone_name='{{ extended_zone_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
```
