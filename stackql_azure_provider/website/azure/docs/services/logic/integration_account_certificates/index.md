...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="integration_account_certificates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.logic.integration_account_certificates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The key details in the key vault.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-integration_account_name"><code>integration_account_name</code></a>, <a href="#parameter-certificate_name"><code>certificate_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr id="parameter-certificate_name">
    ...
    <td><code>string</code></td>
    <td>The integration account certificate name. Required.</td>
</tr>
...
tags,
type
FROM azure.logic.integration_account_certificates
...
```sql
INSERT INTO azure.logic.integration_account_certificates (
location,
tags,
properties,
resource_group_name,
...
```sql
REPLACE azure.logic.integration_account_certificates
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.logic.integration_account_certificates
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND integration_account_name = '{{ integration_account_name }}' --required
AND certificate_name = '{{ certificate_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
