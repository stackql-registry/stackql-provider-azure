...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resiliencemanagement.recovery_jobs" /></td></tr>
</tbody></table>
...
type,
userComments
FROM azure.resiliencemanagement.recovery_jobs
...
```sql
EXEC azure.resiliencemanagement.recovery_jobs.cancel 
...
```sql
EXEC azure.resiliencemanagement.recovery_jobs.resume 
@service_group_name='{{ service_group_name }}' --required, 
@recovery_plan_name='{{ recovery_plan_name }}' --required, 
@recovery_job_name='{{ recovery_job_name }}' --required, 
@operation-id='{{ operation-id }}' --required 
...
```sql
EXEC azure.resiliencemanagement.recovery_jobs.retry 
@service_group_name='{{ service_group_name }}' --required, 
@recovery_plan_name='{{ recovery_plan_name }}' --required, 
@recovery_job_name='{{ recovery_job_name }}' --required, 
@operation-id='{{ operation-id }}' --required
