...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.resiliencemanagement.drill_runs" /></td></tr>
</tbody></table>
...
type,
userComments
FROM azure.resiliencemanagement.drill_runs
...
```sql
EXEC azure.resiliencemanagement.drill_runs.fail_over 
...
```sql
EXEC azure.resiliencemanagement.drill_runs.reprotect 
@service_group_name='{{ service_group_name }}' --required, 
@drill_name='{{ drill_name }}' --required, 
@drill_run_name='{{ drill_run_name }}' --required, 
@operation-id='{{ operation-id }}' --required
...
```sql
EXEC azure.resiliencemanagement.drill_runs.add_notes 
@service_group_name='{{ service_group_name }}' --required, 
@drill_name='{{ drill_name }}' --required, 
@drill_run_name='{{ drill_run_name }}' --required, 
@operation-id='{{ operation-id }}' --required 
...
```sql
EXEC azure.resiliencemanagement.drill_runs.resume 
@service_group_name='{{ service_group_name }}' --required, 
@drill_name='{{ drill_name }}' --required, 
@drill_run_name='{{ drill_run_name }}' --required, 
@operation-id='{{ operation-id }}' --required
...
```sql
EXEC azure.resiliencemanagement.drill_runs.mark_as_complete 
@service_group_name='{{ service_group_name }}' --required, 
@drill_name='{{ drill_name }}' --required, 
@drill_run_name='{{ drill_run_name }}' --required, 
@operation-id='{{ operation-id }}' --required 
