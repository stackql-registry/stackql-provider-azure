...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.guestconfig.guest_configuration_assignments_vmss" /></td></tr>
</tbody></table>
...
type,
vmssVMList
FROM azure.guestconfig.guest_configuration_assignments_vmss
...
```sql
DELETE FROM azure.guestconfig.guest_configuration_assignments_vmss
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND vmss_name = '{{ vmss_name }}' --required
AND name = '{{ name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
