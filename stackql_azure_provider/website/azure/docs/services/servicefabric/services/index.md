...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric.services" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.servicefabric.services
...
```sql
INSERT INTO azure.servicefabric.services (
properties,
location,
tags,
resource_group_name,
...
```sql
UPDATE azure.servicefabric.services
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.servicefabric.services
SET 
properties = '{{ properties }}',
location = '{{ location }}',
tags = '{{ tags }}'
...
```sql
DELETE FROM azure.servicefabric.services
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND application_name = '{{ application_name }}' --required
AND service_name = '{{ service_name }}' --required
