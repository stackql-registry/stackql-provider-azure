...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric.cluster_versions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Indicates if this version is for Windows or Linux operating system. Known values are: "Windows" and "Linux". (Windows, Linux)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets information about a Service Fabric cluster code version available in the specified location. Gets information about an available Service Fabric cluster code version.</td>
</tr>
<tr>
...
<tr id="parameter-environment">
    <td><CopyableCode code="environment" /></td>
    <td><code>string</code></td>
    <td>The operating system of the cluster. The default means all. Known values are: "Windows" and "Linux". Required.</td>
</tr>
...
supportExpiryUtc,
type
FROM azure.servicefabric.cluster_versions
