...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric.applications" /></td></tr>
</tbody></table>
...
typeVersion,
upgradePolicy
FROM azure.servicefabric.applications
...
```sql
INSERT INTO azure.servicefabric.applications (
properties,
location,
tags,
identity,
...
```sql
UPDATE azure.servicefabric.applications
SET 
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
REPLACE azure.servicefabric.applications
SET 
properties = '{{ properties }}',
location = '{{ location }}',
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.servicefabric.applications
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND application_name = '{{ application_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
