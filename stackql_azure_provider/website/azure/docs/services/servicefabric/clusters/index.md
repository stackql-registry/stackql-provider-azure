...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric.clusters" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.servicefabric.clusters (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.servicefabric.clusters
SET 
...
```sql
REPLACE azure.servicefabric.clusters
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.servicefabric.clusters
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
