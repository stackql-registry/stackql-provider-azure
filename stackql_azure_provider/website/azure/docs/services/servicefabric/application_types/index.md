...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.servicefabric.application_types" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.servicefabric.application_types
...
```sql
INSERT INTO azure.servicefabric.application_types (
properties,
location,
tags,
resource_group_name,
...
```sql
REPLACE azure.servicefabric.application_types
SET 
...
```sql
DELETE FROM azure.servicefabric.application_types
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND application_type_name = '{{ application_type_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
