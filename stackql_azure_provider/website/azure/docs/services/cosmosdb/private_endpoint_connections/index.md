...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmosdb.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>List all private endpoint connections on a Cosmos DB account.</td>
</tr>
<tr>
...
systemData,
type
FROM azure.cosmosdb.private_endpoint_connections
...
```sql
INSERT INTO azure.cosmosdb.private_endpoint_connections (
properties,
resource_group_name,
account_name,
...
```sql
REPLACE azure.cosmosdb.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.cosmosdb.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND account_name = '{{ account_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
