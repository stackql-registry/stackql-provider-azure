...
Creates, updates, deletes, gets or lists a <code>partition_key_range_id</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="partition_key_range_id" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmosdb.partition_key_range_id" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-account_name"><code>account_name</code></a>, <a href="#parameter-database_rid"><code>database_rid</code></a>, <a href="#parameter-collection_rid"><code>collection_rid</code></a>, <a href="#parameter-partition_key_range_id"><code>partition_key_range_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-$filter"><code>$filter</code></a></td>
    <td></td>
    <td>Retrieves the metrics determined by the given filter for the given partition key range id.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-partition_key_range_id">
    <td><CopyableCode code="partition_key_range_id" /></td>
    <td><code>string</code></td>
    <td>Partition Key Range Id for which to get data. Required.</td>
</tr>
...
timeGrain,
unit
FROM azure.cosmosdb.partition_key_range_id
WHERE resource_group_name = '{{ resource_group_name }}' -- required
AND account_name = '{{ account_name }}' -- required
AND database_rid = '{{ database_rid }}' -- required
AND collection_rid = '{{ collection_rid }}' -- required
AND partition_key_range_id = '{{ partition_key_range_id }}' -- required
