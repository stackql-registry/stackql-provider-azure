...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="suppression_list_addresses" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Email address of the recipient. Required.</td>
</tr>
<tr>
    <td><CopyableCode code="firstName" /></td>
    <td><code>string</code></td>
    <td>The first name of the email recipient.</td>
</tr>
<tr>
    <td><CopyableCode code="lastModified" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date the address was last updated in a suppression list.</td>
</tr>
<tr>
    <td><CopyableCode code="lastName" /></td>
    <td><code>string</code></td>
    <td>The last name of the email recipient.</td>
</tr>
<tr>
    <td><CopyableCode code="notes" /></td>
    <td><code>string</code></td>
    <td>An optional property to provide contextual notes or a description for an address.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-suppression_list_name"><code>suppression_list_name</code></a>, <a href="#parameter-address_id"><code>address_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Get. Get a SuppressionListAddress.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Get. Get all the addresses in a suppression list.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-suppression_list_name"><code>suppression_list_name</code></a>, <a href="#parameter-address_id"><code>address_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Create Or Update. Create or update a SuppressionListAddress.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-domain_name"><code>domain_name</code></a>, <a href="#parameter-suppression_list_name"><code>suppression_list_name</code></a>, <a href="#parameter-address_id"><code>address_id</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete. Operation to delete a single address from a suppression list.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-address_id">
    <td><CopyableCode code="address_id" /></td>
    <td><code>string</code></td>
    <td>The id of the address in a suppression list. Required.</td>
</tr>
...
AND address_id = '{{ address_id }}' -- required
...
```sql
REPLACE azure.communication.suppression_list_addresses
SET 
