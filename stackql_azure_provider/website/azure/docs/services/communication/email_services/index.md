...
Creates, updates, deletes, gets or lists an <code>email_services</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="email_services" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The location where the email service stores its data at rest. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Get. Get the EmailService and its properties.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a></td>
    <td></td>
    <td>Create Or Update. Create a new EmailService or update an existing EmailService.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Update. Operation to update an existing EmailService.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-email_service_name"><code>email_service_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>Delete. Operation to delete a EmailService.</td>
</tr>
<tr>
    <td><a href="#list_verified_exchange_online_domains"><CopyableCode code="list_verified_exchange_online_domains" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
    <td>List Verified Domains From Exchange Online. Get a list of domains that are fully verified in Exchange Online.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="list_verified_exchange_online_domains"
    values={[
        { label: 'list_verified_exchange_online_domains', value: 'list_verified_exchange_online_domains' }
    ]}
>
<TabItem value="list_verified_exchange_online_domains">
