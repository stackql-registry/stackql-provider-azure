...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.hybrid_compute.settings" /></td></tr>
</tbody></table>
...
tenantId,
type
FROM azure.hybrid_compute.settings
...
```sql
UPDATE azure.hybrid_compute.settings
SET 
...
```sql
EXEC azure.hybrid_compute.settings.patch 
@resource_group_name='{{ resource_group_name }}' --required, 
