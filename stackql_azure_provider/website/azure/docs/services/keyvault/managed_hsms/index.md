...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.keyvault.managed_hsms" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.keyvault.managed_hsms (
properties,
sku,
identity,
location,
...
```sql
UPDATE azure.keyvault.managed_hsms
SET 
...
```sql
REPLACE azure.keyvault.managed_hsms
SET 
properties = '{{ properties }}',
sku = '{{ sku }}',
identity = '{{ identity }}',
