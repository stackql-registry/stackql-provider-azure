...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.keyvault.private_endpoint_connections" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Properties of the private endpoint object.</td>
</tr>
<tr>
    <td><CopyableCode code="privateLinkServiceConnectionState" /></td>
    <td><code>object</code></td>
    <td>Approval state of the private link connection.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>Provisioning state of the private endpoint connection. Known values are: "Succeeded", "Creating", "Updating", "Deleting", "Failed", and "Disconnected". (Succeeded, Creating, Updating, Deleting, Failed, Disconnected)</td>
</tr>
<tr>
...
<tr id="parameter-private_endpoint_connection_name">
    ...
    <td><code>string</code></td>
    <td>Name of the private endpoint connection associated with the key vault. Required.</td>
</tr>
...
tags,
type
FROM azure.keyvault.private_endpoint_connections
...
```sql
DELETE FROM azure.keyvault.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND vault_name = '{{ vault_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
...
```sql
EXEC azure.keyvault.private_endpoint_connections.put 
