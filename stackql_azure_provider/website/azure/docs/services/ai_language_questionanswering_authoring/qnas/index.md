...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.ai_language_questionanswering_authoring.qnas" /></td></tr>
</tbody></table>
...
questions,
source
FROM azure.ai_language_questionanswering_authoring.qnas
...
```sql
UPDATE azure.ai_language_questionanswering_authoring.qnas
SET 
op = '{{ op }}',
value = '{{ value }}'
WHERE 
