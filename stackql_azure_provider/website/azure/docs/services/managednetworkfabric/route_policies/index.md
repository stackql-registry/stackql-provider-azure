...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managednetworkfabric.route_policies" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.managednetworkfabric.route_policies
...
```sql
INSERT INTO azure.managednetworkfabric.route_policies (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.managednetworkfabric.route_policies
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managednetworkfabric.route_policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND route_policy_name = '{{ route_policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managednetworkfabric.route_policies.update_administrative_state 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.managednetworkfabric.route_policies.validate_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@route_policy_name='{{ route_policy_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managednetworkfabric.route_policies.commit_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@route_policy_name='{{ route_policy_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
