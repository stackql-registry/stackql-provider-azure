...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managednetworkfabric.network_taps" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.managednetworkfabric.network_taps
...
```sql
INSERT INTO azure.managednetworkfabric.network_taps (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.managednetworkfabric.network_taps
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managednetworkfabric.network_taps
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_tap_name = '{{ network_tap_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managednetworkfabric.network_taps.update_administrative_state 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.managednetworkfabric.network_taps.resync 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_tap_name='{{ network_tap_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
