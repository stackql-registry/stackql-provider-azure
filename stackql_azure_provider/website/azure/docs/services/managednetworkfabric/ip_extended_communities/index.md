...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ip_extended_communities" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managednetworkfabric.ip_extended_communities" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="ipExtendedCommunityRules" /></td>
    <td><code>array</code></td>
    <td>List of IP Extended Community Rules. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-ip_extended_community_name"><code>ip_extended_community_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-ip_extended_community_name">
    <td><CopyableCode code="ip_extended_community_name" /></td>
    <td><code>string</code></td>
    <td>Name of the IP Extended Community. Required.</td>
</tr>
...
tags,
type
FROM azure.managednetworkfabric.ip_extended_communities
...
```sql
INSERT INTO azure.managednetworkfabric.ip_extended_communities (
tags,
location,
properties,
resource_group_name,
...
- name: ip_extended_communities
  props:
    ...
    - name: ip_extended_community_name
      value: "{{ ip_extended_community_name }}"
      description: Required parameter for the ip_extended_communities resource.
...
```sql
UPDATE azure.managednetworkfabric.ip_extended_communities
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managednetworkfabric.ip_extended_communities
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND ip_extended_community_name = '{{ ip_extended_community_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
