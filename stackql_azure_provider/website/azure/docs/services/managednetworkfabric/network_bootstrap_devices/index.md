...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managednetworkfabric.network_bootstrap_devices" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.managednetworkfabric.network_bootstrap_devices
...
```sql
INSERT INTO azure.managednetworkfabric.network_bootstrap_devices (
tags,
location,
properties,
identity,
...
```sql
UPDATE azure.managednetworkfabric.network_bootstrap_devices
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managednetworkfabric.network_bootstrap_devices
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_bootstrap_device_name = '{{ network_bootstrap_device_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managednetworkfabric.network_bootstrap_devices.reboot 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.managednetworkfabric.network_bootstrap_devices.refresh_configuration 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_bootstrap_device_name='{{ network_bootstrap_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.managednetworkfabric.network_bootstrap_devices.upgrade 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_bootstrap_device_name='{{ network_bootstrap_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.managednetworkfabric.network_bootstrap_devices.update_administrative_state 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_bootstrap_device_name='{{ network_bootstrap_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.managednetworkfabric.network_bootstrap_devices.resync_passwords 
@resource_group_name='{{ resource_group_name }}' --required, 
@network_bootstrap_device_name='{{ network_bootstrap_device_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
