...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.managednetworkfabric.ip_communities" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.managednetworkfabric.ip_communities
...
```sql
INSERT INTO azure.managednetworkfabric.ip_communities (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.managednetworkfabric.ip_communities
SET 
tags = '{{ tags }}',
...
```sql
DELETE FROM azure.managednetworkfabric.ip_communities
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND ip_community_name = '{{ ip_community_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
