...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.defender_easm_dataplane.saved_filters" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.defender_easm_dataplane.saved_filters.put 
@filter_name='{{ filter_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
...
```sql
EXEC azure.defender_easm_dataplane.saved_filters.list_raw 
@subscription_id='{{ subscription_id }}' --required, 
@resource_group_name='{{ resource_group_name }}' --required, 
@workspace_name='{{ workspace_name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
