...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.postgresqlflexibleservers.administrators_microsoft_entra" /></td></tr>
</tbody></table>
...
tenantId,
type
FROM azure.postgresqlflexibleservers.administrators_microsoft_entra
...
```sql
INSERT INTO azure.postgresqlflexibleservers.administrators_microsoft_entra (
properties,
resource_group_name,
server_name,
object_id,
...
```sql
REPLACE azure.postgresqlflexibleservers.administrators_microsoft_entra
SET 
...
```sql
DELETE FROM azure.postgresqlflexibleservers.administrators_microsoft_entra
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND object_id = '{{ object_id }}' --required
AND subscription_id = '{{ subscription_id }}' --required
