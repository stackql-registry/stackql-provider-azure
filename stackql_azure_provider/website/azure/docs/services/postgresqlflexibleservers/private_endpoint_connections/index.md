...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.postgresqlflexibleservers.private_endpoint_connections" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.postgresqlflexibleservers.private_endpoint_connections
...
```sql
UPDATE azure.postgresqlflexibleservers.private_endpoint_connections
SET 
...
```sql
DELETE FROM azure.postgresqlflexibleservers.private_endpoint_connections
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND server_name = '{{ server_name }}' --required
AND private_endpoint_connection_name = '{{ private_endpoint_connection_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
