...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.postgresqlflexibleservers.maintenance_events" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.postgresqlflexibleservers.maintenance_events
...
```sql
EXEC azure.postgresqlflexibleservers.maintenance_events.reschedule 
...
```sql
EXEC azure.postgresqlflexibleservers.maintenance_events.apply_now 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@maintenance_event_id='{{ maintenance_event_id }}' --required, 
@subscription_id='{{ subscription_id }}' --required
