...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.postgresqlflexibleservers.configurations" /></td></tr>
</tbody></table>
...
unit,
value
FROM azure.postgresqlflexibleservers.configurations
...
```sql
UPDATE azure.postgresqlflexibleservers.configurations
SET 
...
```sql
EXEC azure.postgresqlflexibleservers.configurations.put 
@resource_group_name='{{ resource_group_name }}' --required, 
