...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.postgresqlflexibleservers.backups_long_term_retention" /></td></tr>
</tbody></table>
...
```sql
EXEC azure.postgresqlflexibleservers.backups_long_term_retention.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@server_name='{{ server_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
