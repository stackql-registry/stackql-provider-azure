...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.extendedlocation.resource_sync_rules" /></td></tr>
</tbody></table>
...
targetResourceGroup,
type
FROM azure.extendedlocation.resource_sync_rules
...
```sql
INSERT INTO azure.extendedlocation.resource_sync_rules (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.extendedlocation.resource_sync_rules
SET 
...
```sql
REPLACE azure.extendedlocation.resource_sync_rules
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}'
...
```sql
DELETE FROM azure.extendedlocation.resource_sync_rules
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND resource_name = '{{ resource_name }}' --required
AND child_resource_name = '{{ child_resource_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
