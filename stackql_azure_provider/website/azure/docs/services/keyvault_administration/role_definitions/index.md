...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.keyvault_administration.role_definitions" /></td></tr>
</tbody></table>
...
roleName,
type
FROM azure.keyvault_administration.role_definitions
...
```sql
INSERT INTO azure.keyvault_administration.role_definitions (
properties,
scope,
...
```sql
REPLACE azure.keyvault_administration.role_definitions
SET 
...
```sql
DELETE FROM azure.keyvault_administration.role_definitions
WHERE scope = '{{ scope }}' --required
AND role_definition_name = '{{ role_definition_name }}' --required
AND vault_base_url = '{{ vault_base_url }}' --required
;
