...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.networkcloud.virtual_machines" /></td></tr>
</tbody></table>
...
volumes
FROM azure.networkcloud.virtual_machines
...
```sql
INSERT INTO azure.networkcloud.virtual_machines (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.networkcloud.virtual_machines
SET 
identity = '{{ identity }}',
...
```sql
REPLACE azure.networkcloud.virtual_machines
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.networkcloud.virtual_machines
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_machine_name = '{{ virtual_machine_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.networkcloud.virtual_machines.assign_relay 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.networkcloud.virtual_machines.power_off 
@resource_group_name='{{ resource_group_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required 
@@json=
...
```sql
EXEC azure.networkcloud.virtual_machines.reimage 
@resource_group_name='{{ resource_group_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.networkcloud.virtual_machines.restart 
@resource_group_name='{{ resource_group_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
...
```sql
EXEC azure.networkcloud.virtual_machines.start 
@resource_group_name='{{ resource_group_name }}' --required, 
@virtual_machine_name='{{ virtual_machine_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
;
