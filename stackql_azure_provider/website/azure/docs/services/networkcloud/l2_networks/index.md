...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.networkcloud.l2_networks" /></td></tr>
</tbody></table>
...
FROM azure.networkcloud.l2_networks
...
```sql
INSERT INTO azure.networkcloud.l2_networks (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.networkcloud.l2_networks
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.networkcloud.l2_networks
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.networkcloud.l2_networks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND l2_network_name = '{{ l2_network_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
