...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="bare_metal_machine_key_sets" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.networkcloud.bare_metal_machine_key_sets" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The date and time after which the users in this key set will be removed from the bare metal machines. Required.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="jumpHostsAllowed" /></td>
    <td><code>array</code></td>
    <td>The list of IP addresses of jump hosts with management network access from which a login will be allowed for the users. Required.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="osGroupName" /></td>
    <td><code>string</code></td>
    <td>The name of the group that users will be assigned to on the operating system of the machines.</td>
</tr>
<tr>
    <td><CopyableCode code="privilegeLevel" /></td>
    <td><code>string</code></td>
    <td>The access level allowed for the users in this key set. Required. Known values are: "Standard", "Superuser", and "Other". (Standard, Superuser, Other)</td>
</tr>
<tr>
    <td><CopyableCode code="privilegeLevelName" /></td>
    <td><code>string</code></td>
    <td>The name of the access level to apply when the privilege level is set to Other.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>The provisioning state of the bare metal machine key set. Known values are: "Succeeded", "Failed", "Canceled", "Accepted", and "Provisioning". (Succeeded, Failed, Canceled, Accepted, Provisioning)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-bare_metal_machine_key_set_name"><code>bare_metal_machine_key_set_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-bare_metal_machine_key_set_name">
    <td><CopyableCode code="bare_metal_machine_key_set_name" /></td>
    <td><code>string</code></td>
    <td>The name of the bare metal machine key set. Required.</td>
</tr>
...
userList,
userListStatus
FROM azure.networkcloud.bare_metal_machine_key_sets
...
```sql
INSERT INTO azure.networkcloud.bare_metal_machine_key_sets (
tags,
location,
properties,
extendedLocation,
...
- name: bare_metal_machine_key_sets
  props:
    ...
    - name: bare_metal_machine_key_set_name
      value: "{{ bare_metal_machine_key_set_name }}"
      description: Required parameter for the bare_metal_machine_key_sets resource.
...
```sql
UPDATE azure.networkcloud.bare_metal_machine_key_sets
SET 
...
```sql
REPLACE azure.networkcloud.bare_metal_machine_key_sets
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.networkcloud.bare_metal_machine_key_sets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND bare_metal_machine_key_set_name = '{{ bare_metal_machine_key_set_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
