...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.networkcloud.access_bridges" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.networkcloud.access_bridges
...
```sql
INSERT INTO azure.networkcloud.access_bridges (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.networkcloud.access_bridges
SET 
...
```sql
REPLACE azure.networkcloud.access_bridges
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.networkcloud.access_bridges
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND access_bridge_name = '{{ access_bridge_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
