...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="consoles" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.networkcloud.consoles" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The more detailed status of the console. Known values are: "Ready" and "Error". (Ready, Error)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The indicator of whether the console access is enabled. Required. Known values are: "True" and "False". (True, False)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The date and time after which the key will be disallowed access.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The resource ID of the private link service that is used to provide virtual machine console access.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>The provisioning state of the virtual machine console. Known values are: "Succeeded", "Failed", "Canceled", "Accepted", and "Provisioning". (Succeeded, Failed, Canceled, Accepted, Provisioning)</td>
</tr>
<tr>
    <td><CopyableCode code="sshPublicKey" /></td>
    <td><code>object</code></td>
    <td>SshPublicKey represents the public key used to authenticate with a resource through SSH.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="virtualMachineAccessId" /></td>
    <td><code>string</code></td>
    <td>The unique identifier for the virtual machine that is used to access the console.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-virtual_machine_name"><code>virtual_machine_name</code></a>, <a href="#parameter-console_name"><code>console_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-virtual_machine_name"><code>virtual_machine_name</code></a>, <a href="#parameter-console_name"><code>console_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-properties"><code>properties</code></a>, <a href="#parameter-extendedLocation"><code>extendedLocation</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-console_name">
    <td><CopyableCode code="console_name" /></td>
    <td><code>string</code></td>
    <td>The name of the virtual machine console. Required.</td>
</tr>
...
FROM azure.networkcloud.consoles
...
```sql
INSERT INTO azure.networkcloud.consoles (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.networkcloud.consoles
SET 
...
```sql
REPLACE azure.networkcloud.consoles
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.networkcloud.consoles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_machine_name = '{{ virtual_machine_name }}' --required
AND console_name = '{{ console_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
