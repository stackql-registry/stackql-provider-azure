...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.voiceservices.test_lines" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.voiceservices.test_lines
...
```sql
INSERT INTO azure.voiceservices.test_lines (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.voiceservices.test_lines
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.voiceservices.test_lines
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.voiceservices.test_lines
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND communications_gateway_name = '{{ communications_gateway_name }}' --required
AND test_line_name = '{{ test_line_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
