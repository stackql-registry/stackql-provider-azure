...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="script_actions" /></td></tr>
...
<Tabs
    defaultValue="get_execution_async_operation_status"
    values={[
        { label: 'get_execution_async_operation_status', value: 'get_execution_async_operation_status' },
        { label: 'get_execution_detail', value: 'get_execution_detail' },
        { label: 'list_by_cluster', value: 'list_by_cluster' }
    ]}
>
<TabItem value="get_execution_async_operation_status">
...
<TabItem value="get_execution_detail">
...
<tbody>
<tr>
    <td><a href="#get_execution_async_operation_status"><CopyableCode code="get_execution_async_operation_status" /></a></td>
    ...
    <td></td>
    <td>Gets the async operation status of execution operation.</td>
</tr>
<tr>
    <td><a href="#get_execution_detail"><CopyableCode code="get_execution_detail" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    ...
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-cluster_name"><code>cluster_name</code></a>, <a href="#parameter-script_name"><code>script_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a></td>
    <td></td>
...
<tr id="parameter-script_name">
    ...
    <td><code>string</code></td>
    <td>The name of the script. Required.</td>
</tr>
