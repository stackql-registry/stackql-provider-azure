...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dnsresolver.dns_forwarding_rulesets" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO azure.dnsresolver.dns_forwarding_rulesets (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.dnsresolver.dns_forwarding_rulesets
SET 
...
```sql
REPLACE azure.dnsresolver.dns_forwarding_rulesets
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.dnsresolver.dns_forwarding_rulesets
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND dns_forwarding_ruleset_name = '{{ dns_forwarding_ruleset_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
