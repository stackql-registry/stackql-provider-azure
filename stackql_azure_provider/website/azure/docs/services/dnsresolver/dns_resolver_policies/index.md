...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dnsresolver.dns_resolver_policies" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.dnsresolver.dns_resolver_policies
...
```sql
INSERT INTO azure.dnsresolver.dns_resolver_policies (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.dnsresolver.dns_resolver_policies
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.dnsresolver.dns_resolver_policies
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.dnsresolver.dns_resolver_policies
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND dns_resolver_policy_name = '{{ dns_resolver_policy_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.dnsresolver.dns_resolver_policies.list_by_virtual_network 
@resource_group_name='{{ resource_group_name }}' --required, 
