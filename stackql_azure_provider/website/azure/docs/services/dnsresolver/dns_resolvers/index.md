...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="dns_resolvers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.dnsresolver.dns_resolvers" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="dnsResolverState" /></td>
    <td><code>string</code></td>
    <td>The current status of the DNS resolver. This is a read-only property and any attempt to set this value will be ignored. Known values are: "Connected" and "Disconnected". (Connected, Disconnected)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current provisioning state of the DNS resolver. This is a read-only property and any attempt to set this value will be ignored. Known values are: "Creating", "Updating", "Deleting", "Succeeded", "Failed", and "Canceled". (Creating, Updating, Deleting, Succeeded, Failed, Canceled)</td>
</tr>
<tr>
    <td><CopyableCode code="resourceGuid" /></td>
    <td><code>string</code></td>
    <td>The resourceGuid property of the DNS resolver resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Lists DNS resolvers within a resource group.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-$top"><code>$top</code></a></td>
    <td>Lists DNS resolvers in all resource groups of a subscription.</td>
</tr>
<tr>
    <td><a href="#create_or_update"><CopyableCode code="create_or_update" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-resource_group_name"><code>resource_group_name</code></a>, <a href="#parameter-dns_resolver_name"><code>dns_resolver_name</code></a>, <a href="#parameter-subscription_id"><code>subscription_id</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-properties"><code>properties</code></a></td>
    <td></td>
    <td>Creates or updates a DNS resolver.</td>
</tr>
<tr>
...
```sql
INSERT INTO azure.dnsresolver.dns_resolvers (
tags,
location,
properties,
resource_group_name,
...
```sql
UPDATE azure.dnsresolver.dns_resolvers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.dnsresolver.dns_resolvers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.dnsresolver.dns_resolvers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND dns_resolver_name = '{{ dns_resolver_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
