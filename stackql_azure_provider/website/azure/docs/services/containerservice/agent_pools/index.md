...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservice.agent_pools" /></td></tr>
</tbody></table>
...
windowsProfile,
workloadRuntime
FROM azure.containerservice.agent_pools
...
```sql
INSERT INTO azure.containerservice.agent_pools (
properties,
resource_group_name,
resource_name,
agent_pool_name,
...
```sql
REPLACE azure.containerservice.agent_pools
SET 
...
```sql
EXEC azure.containerservice.agent_pools.get_available_agent_pool_versions 
@resource_group_name='{{ resource_group_name }}' --required, 
...
```sql
EXEC azure.containerservice.agent_pools.get_upgrade_profile 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
...
```sql
EXEC azure.containerservice.agent_pools.abort_latest_operation 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@agent_pool_name='{{ agent_pool_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.containerservice.agent_pools.complete_upgrade 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@agent_pool_name='{{ agent_pool_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
...
```sql
EXEC azure.containerservice.agent_pools.upgrade_node_image_version 
@resource_group_name='{{ resource_group_name }}' --required, 
@resource_name='{{ resource_name }}' --required, 
@agent_pool_name='{{ agent_pool_name }}' --required, 
@subscription_id='{{ subscription_id }}' --required
