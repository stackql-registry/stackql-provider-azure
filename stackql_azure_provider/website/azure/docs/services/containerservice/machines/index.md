...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.containerservice.machines" /></td></tr>
</tbody></table>
...
type,
zones
FROM azure.containerservice.machines
...
```sql
INSERT INTO azure.containerservice.machines (
properties,
zones,
resource_group_name,
resource_name,
...
```sql
REPLACE azure.containerservice.machines
SET 
