...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.computelimit.shared_limit_caps" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.computelimit.shared_limit_caps
...
```sql
INSERT INTO azure.computelimit.shared_limit_caps (
properties,
location,
vm_family_name,
subscription_id
...
```sql
REPLACE azure.computelimit.shared_limit_caps
SET 
...
```sql
DELETE FROM azure.computelimit.shared_limit_caps
WHERE location = '{{ location }}' --required
AND vm_family_name = '{{ vm_family_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.computelimit.shared_limit_caps.set_member_cap_overrides 
@location='{{ location }}' --required, 
