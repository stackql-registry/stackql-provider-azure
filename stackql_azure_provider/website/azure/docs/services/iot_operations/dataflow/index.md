...
Creates, updates, deletes, gets or lists a <code>dataflow</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="dataflow" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iot_operations.dataflow" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Mode for Dataflow. Optional; defaults to Enabled. Known values are: "Enabled" and "Disabled". (Enabled, Disabled)</td>
</tr>
<tr>
    <td><CopyableCode code="operations" /></td>
    <td><code>array</code></td>
    <td>List of operations including source and destination references as well as transformation. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>The status for the dataflow.</td>
</tr>
<tr>
...
<tbody>
<tr id="parameter-dataflow_name">
    <td><CopyableCode code="dataflow_name" /></td>
    <td><code>string</code></td>
    <td>Name of Instance dataflowProfile dataflow resource. Required.</td>
</tr>
...
```sql
INSERT INTO azure.iot_operations.dataflow (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
- name: dataflow
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the dataflow resource.
    - name: instance_name
      value: "{{ instance_name }}"
      description: Required parameter for the dataflow resource.
...
```sql
REPLACE azure.iot_operations.dataflow
SET 
...
```sql
DELETE FROM azure.iot_operations.dataflow
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND dataflow_profile_name = '{{ dataflow_profile_name }}' --required
AND dataflow_name = '{{ dataflow_name }}' --required
