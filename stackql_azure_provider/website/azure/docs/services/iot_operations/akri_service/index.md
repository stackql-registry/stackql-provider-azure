...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iot_operations.akri_service" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.iot_operations.akri_service
...
```sql
INSERT INTO azure.iot_operations.akri_service (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
```sql
REPLACE azure.iot_operations.akri_service
SET 
...
```sql
DELETE FROM azure.iot_operations.akri_service
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND akri_service_name = '{{ akri_service_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
