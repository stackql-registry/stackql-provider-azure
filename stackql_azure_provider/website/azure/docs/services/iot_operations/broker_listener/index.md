...
Creates, updates, deletes, gets or lists a <code>broker_listener</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="broker_listener" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.iot_operations.broker_listener" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Ports on which this listener accepts client connections. Required.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Kubernetes Service name of this listener.</td>
</tr>
<tr>
    <td><CopyableCode code="serviceType" /></td>
    <td><code>string</code></td>
    <td>Kubernetes Service type of this listener. Known values are: "ClusterIp", "LoadBalancer", and "NodePort". (ClusterIp, LoadBalancer, NodePort)</td>
</tr>
<tr>
...
<tr id="parameter-listener_name">
    <td><CopyableCode code="listener_name" /></td>
    <td><code>string</code></td>
    <td>Name of Instance broker listener resource. Required.</td>
</tr>
...
```sql
INSERT INTO azure.iot_operations.broker_listener (
properties,
extendedLocation,
resource_group_name,
instance_name,
...
- name: broker_listener
  props:
    - name: resource_group_name
      ...
      description: Required parameter for the broker_listener resource.
    - name: instance_name
      value: "{{ instance_name }}"
      description: Required parameter for the broker_listener resource.
    - name: broker_name
...
```sql
REPLACE azure.iot_operations.broker_listener
SET 
...
```sql
DELETE FROM azure.iot_operations.broker_listener
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND instance_name = '{{ instance_name }}' --required
AND broker_name = '{{ broker_name }}' --required
AND listener_name = '{{ listener_name }}' --required
