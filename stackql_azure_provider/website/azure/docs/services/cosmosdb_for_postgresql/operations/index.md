...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmosdb_for_postgresql.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The intended executor of the operation. Known values are: "NotSpecified", "user", and "system".</td>
</tr>
<tr>
...
origin,
properties
FROM azure.cosmosdb_for_postgresql.operations
;
```
</TabItem>
</Tabs>
