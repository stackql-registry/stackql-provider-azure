...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmosdb_for_postgresql.roles" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The password of the cluster role. If an identity is used, password will not be required.</td>
</tr>
<tr>
    <td><CopyableCode code="provisioningState" /></td>
    <td><code>string</code></td>
    <td>Provisioning state of the role. Known values are: "Succeeded", "Canceled", "InProgress", and "Failed".</td>
</tr>
<tr>
    <td><CopyableCode code="roleType" /></td>
    <td><code>string</code></td>
    <td>Known values are: "user" and "admin".</td>
</tr>
<tr>
...
<tr id="parameter-role_name">
    ...
    <td><code>string</code></td>
    <td>The name of the cluster role. Required.</td>
</tr>
...
systemData,
type
FROM azure.cosmosdb_for_postgresql.roles
...
```sql
INSERT INTO azure.cosmosdb_for_postgresql.roles (
properties,
resource_group_name,
cluster_name,
role_name,
...
```sql
DELETE FROM azure.cosmosdb_for_postgresql.roles
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND cluster_name = '{{ cluster_name }}' --required
AND role_name = '{{ role_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
