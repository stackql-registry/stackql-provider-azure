...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="activity_logs" /></td></tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>the event name. This value should not be confused with OperationName. For practical purposes, OperationName might be more appealing to end users.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>the event level. Known values are: "Critical", "Error", "Warning", "Informational", and "Verbose". (Critical, Error, Warning, Informational, Verbose)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>the set of pairs (usually a Dictionary) that includes details about the event.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>the resource provider name of the impacted resource.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>a string describing the status of the operation. Some typical values are: Started, In progress, Succeeded, Failed, Resolved.</td>
</tr>
<tr>
    <td><CopyableCode code="subStatus" /></td>
    <td><code>object</code></td>
    <td>the event sub status. Most of the time, when included, this captures the HTTP status code of the REST call. Common values are: OK (HTTP Status Code: 200), Created (HTTP Status Code: 201), Accepted (HTTP Status Code: 202), No Content (HTTP Status Code: 204), Bad Request(HTTP Status Code: 400), Not Found (HTTP Status Code: 404), Conflict (HTTP Status Code: 409), Internal Server Error (HTTP Status Code: 500), Service Unavailable (HTTP Status Code:503), Gateway Timeout (HTTP Status Code: 504).</td>
</tr>
<tr>
