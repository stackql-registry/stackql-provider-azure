...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.planetarycomputer_dataplane.ingestion" /></td></tr>
</tbody></table>
...
skipExistingItems,
sourceCatalogUrl
FROM azure.planetarycomputer_dataplane.ingestion
...
```sql
UPDATE azure.planetarycomputer_dataplane.ingestion
SET 
...
```sql
EXEC azure.planetarycomputer_dataplane.ingestion.list_runs 
@collection_id='{{ collection_id }}' --required, 
...
```sql
EXEC azure.planetarycomputer_dataplane.ingestion.list_sources 
@endpoint='{{ endpoint }}' --required, 
@$top='{{ $top }}', 
@$skip='{{ $skip }}'
;
