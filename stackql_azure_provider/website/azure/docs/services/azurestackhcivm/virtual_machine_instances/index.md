...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.virtual_machine_instances" /></td></tr>
</tbody></table>
...
type,
vmId
FROM azure.azurestackhcivm.virtual_machine_instances
...
```sql
INSERT INTO azure.azurestackhcivm.virtual_machine_instances (
properties,
extendedLocation,
identity,
resource_uri
...
```sql
UPDATE azure.azurestackhcivm.virtual_machine_instances
SET 
...
```sql
REPLACE azure.azurestackhcivm.virtual_machine_instances
SET 
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.azurestackhcivm.virtual_machine_instances
WHERE resource_uri = '{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.start 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.stop 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.restart 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.pause 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.save 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.virtual_machine_instances.list_raw 
@resource_uri='{{ resource_uri }}' --required
;
```
</TabItem>
