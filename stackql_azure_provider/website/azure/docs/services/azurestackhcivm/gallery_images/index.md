...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.gallery_images" /></td></tr>
</tbody></table>
...
FROM azure.azurestackhcivm.gallery_images
...
```sql
INSERT INTO azure.azurestackhcivm.gallery_images (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurestackhcivm.gallery_images
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.azurestackhcivm.gallery_images
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.azurestackhcivm.gallery_images
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND gallery_image_name = '{{ gallery_image_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
