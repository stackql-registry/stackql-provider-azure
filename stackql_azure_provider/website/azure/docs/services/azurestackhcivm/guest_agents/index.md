...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.guest_agents" /></td></tr>
</tbody></table>
...
systemData,
type
FROM azure.azurestackhcivm.guest_agents
...
```sql
INSERT INTO azure.azurestackhcivm.guest_agents (
properties,
resource_uri
)
SELECT 
...
```sql
DELETE FROM azure.azurestackhcivm.guest_agents
WHERE resource_uri = '{{ resource_uri }}' --required
;
```
</TabItem>
...
```sql
EXEC azure.azurestackhcivm.guest_agents.list_by_virtual_machine_instance 
