...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.storage_containers" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.azurestackhcivm.storage_containers
...
```sql
INSERT INTO azure.azurestackhcivm.storage_containers (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurestackhcivm.storage_containers
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.azurestackhcivm.storage_containers
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.azurestackhcivm.storage_containers
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND storage_container_name = '{{ storage_container_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
