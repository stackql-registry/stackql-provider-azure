...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.network_security_groups" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.azurestackhcivm.network_security_groups
...
```sql
INSERT INTO azure.azurestackhcivm.network_security_groups (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurestackhcivm.network_security_groups
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.azurestackhcivm.network_security_groups
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.azurestackhcivm.network_security_groups
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND network_security_group_name = '{{ network_security_group_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
