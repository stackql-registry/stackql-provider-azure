...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.virtual_hard_disks" /></td></tr>
</tbody></table>
...
tags,
type
FROM azure.azurestackhcivm.virtual_hard_disks
...
```sql
INSERT INTO azure.azurestackhcivm.virtual_hard_disks (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurestackhcivm.virtual_hard_disks
SET 
tags = '{{ tags }}',
...
```sql
REPLACE azure.azurestackhcivm.virtual_hard_disks
SET 
tags = '{{ tags }}',
location = '{{ location }}',
properties = '{{ properties }}',
...
```sql
DELETE FROM azure.azurestackhcivm.virtual_hard_disks
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND virtual_hard_disk_name = '{{ virtual_hard_disk_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
...
```sql
EXEC azure.azurestackhcivm.virtual_hard_disks.upload 
@resource_group_name='{{ resource_group_name }}' --required, 
