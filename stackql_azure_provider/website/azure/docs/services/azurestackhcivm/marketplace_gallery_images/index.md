...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.azurestackhcivm.marketplace_gallery_images" /></td></tr>
</tbody></table>
...
type,
version
FROM azure.azurestackhcivm.marketplace_gallery_images
...
```sql
INSERT INTO azure.azurestackhcivm.marketplace_gallery_images (
tags,
location,
properties,
extendedLocation,
...
```sql
UPDATE azure.azurestackhcivm.marketplace_gallery_images
SET 
tags = '{{ tags }}'
WHERE 
...
```sql
REPLACE azure.azurestackhcivm.marketplace_gallery_images
SET 
tags = '{{ tags }}',
location = '{{ location }}',
...
```sql
DELETE FROM azure.azurestackhcivm.marketplace_gallery_images
WHERE resource_group_name = '{{ resource_group_name }}' --required
AND marketplace_gallery_image_name = '{{ marketplace_gallery_image_name }}' --required
AND subscription_id = '{{ subscription_id }}' --required
;
